...
import os
import sys
def _find_marker_path(home_pattern:str,upstream:int,debug_flag:bool=False)->str:
    try:
        import os, fnmatch
...
if "__main__"== __name__ :
    ...
    start_path,marker_file=_find_marker_path(marker_file,10,debug_flag=marker_debug)
