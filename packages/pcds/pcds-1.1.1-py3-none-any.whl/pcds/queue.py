...
Description: Queue class creates queue data structure
    ...
    __len__(), __str__(), 
    __repr__(), __del__(), enQueue(data), deQueue(), clear(), copy()  
...
Last Modified: Wednesday August 07 2024 4:00 PM
...
class Queue:
   ...
   # __len__(self) returns the number of data in the queue
    ...
    # copy() method copies the queue data structure to a new queue instance
    def copy(self):
        newstack=Queue(self.__maxsize)
        for data in self.__data:
            newstack.__data.append(u.copy(data))
