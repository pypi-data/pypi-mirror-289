...
Last Modified: Tuesday August 06 2024 3:25 PM
Version:1.2.5
...
class DLinkedList:
    ...
    # copy() copies the doubly linked list instance to a new instance
    def copy(self):        
        newdlnkl=DLinkedList(self.getName())
        ...
        newdlnkl.__curNode=newdlnkl.__head.next.next # at tmpnodes[1]
        # building the backward links
        for i in range(1,newdlnkl.__size):
            newdlnkl.__curNode.prev=tmpnodes[i-1]
            newdlnkl.__curNode=newdlnkl.__curNode.next
        newdlnkl.__curNode=newdlnkl.__head.next
        return newdlnkl
...
#
    ...
    # save(self, directory=datadir, filename=None, enc=True) saves all data 
