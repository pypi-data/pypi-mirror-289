...
"""
Netflix-specific UDFs

See:
* https://sourcegraph.netflix.net/stash.corp.netflix.com/BDP/spark-docs/-/blob/docs/netflixdateudfs.md
* https://sourcegraph.netflix.net/stash.corp.netflix.com/BDP/trino-docs/-/blob/docs/netflixdateudfs.md
* https://sourcegraph.netflix.net/stash.corp.netflix.com/BDP/snowflake-docs/-/blob/docs/Netflix-Date-UDFs.md
- integer, string, date, timestamp
"""
import re
