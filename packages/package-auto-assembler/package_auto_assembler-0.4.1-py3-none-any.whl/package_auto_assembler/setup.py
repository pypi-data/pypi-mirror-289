...
setup(
    ...
    install_requires=['### package_auto_assembler.py', 'pip_audit==2.7.3', 'pyyaml', 'nbconvert', 'requests', 'mkdocs==1.6.0', 'nbconvert==7.16.4', 'pandas==2.1.1', 'attrs>=22.2.0', 'nbformat', 'numpy==1.26.0', 'stdlib-list', 'click'],
    ...
    author="Kyrylo Mordan", author_email="parachute.repo@gmail.com", description="A tool to automate package creation within ci based on just .py and optionally .ipynb file.", keywords="['python', 'packaging']", version="0.4.1"
)
