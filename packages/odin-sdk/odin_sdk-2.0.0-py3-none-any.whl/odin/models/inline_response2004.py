...
import six
from odin.models.dns_api_response import DnsAPIResponse  # noqa: F401,E501

class InlineResponse2004(DnsAPIResponse):
    ...
    """
    swagger_types = {
        'data': 'list[EshandlerDNS]',
        'pagination': 'DnsSearchPagination'
    }
    if hasattr(DnsAPIResponse, "swagger_types"):
        swagger_types.update(DnsAPIResponse.swagger_types)

    attribute_map = {
        'data': 'data',
        'pagination': 'pagination'
    }
    if hasattr(DnsAPIResponse, "attribute_map"):
        attribute_map.update(DnsAPIResponse.attribute_map)
    ...
    def __init__(self, data=None, pagination=None, *args, **kwargs):  # noqa: E501
        ...
        DnsAPIResponse.__init__(self, *args, **kwargs)
