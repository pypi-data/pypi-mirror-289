...
import six
from odin.models.exposed_api_response import ExposedAPIResponse  # noqa: F401,E501

class InlineResponse2009(ExposedAPIResponse):
    ...
    """
    swagger_types = {
        'data': 'ExposedSearchCount'
    }
    if hasattr(ExposedAPIResponse, "swagger_types"):
        swagger_types.update(ExposedAPIResponse.swagger_types)

    attribute_map = {
        'data': 'data'
    }
    if hasattr(ExposedAPIResponse, "attribute_map"):
        attribute_map.update(ExposedAPIResponse.attribute_map)
    ...
    def __init__(self, data=None, *args, **kwargs):  # noqa: E501
        ...
        if data is not None:
            self.data = data
        ExposedAPIResponse.__init__(self, *args, **kwargs)
