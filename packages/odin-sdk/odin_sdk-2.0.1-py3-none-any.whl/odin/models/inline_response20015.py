...
import six
from odin.models.api_response import APIResponse  # noqa: F401,E501

class InlineResponse20015(APIResponse):
    ...
    """
    swagger_types = {
        'data': 'list[IpservicesIPSummaryData]',
        'pagination': 'SearchPagination'
    }
    if hasattr(APIResponse, "swagger_types"):
        swagger_types.update(APIResponse.swagger_types)

    attribute_map = {
        'data': ' data',
        'pagination': 'pagination'
    }
    if hasattr(APIResponse, "attribute_map"):
        attribute_map.update(APIResponse.attribute_map)
    ...
    def data(self):
        ...
        :rtype: list[IpservicesIPSummaryData]
        """
        return self._data
    ...
    def data(self, data):
        ...
        :type: list[IpservicesIPSummaryData]
        """
