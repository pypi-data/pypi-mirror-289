...
var gpapi = {
    ...
    file: {
        ...
        path: {
            workspace: workspace,
            model: workspace+"/modules/",
            screen: workspace+"/data/screenshot/",
    ...
    strack: {
        ...
        result:undefined,
        export: api_strack_export,
        save_res: {},
        load: api_strack_load,
        daos: [],
        add: api_strack_insert,
        delete: api_strack_delect,
        clear: api_strack_clear,
        run: api_strack_run,
        test: api_strack_test,
        res: api_strack_res_get_path,
        file:api_strack_file
