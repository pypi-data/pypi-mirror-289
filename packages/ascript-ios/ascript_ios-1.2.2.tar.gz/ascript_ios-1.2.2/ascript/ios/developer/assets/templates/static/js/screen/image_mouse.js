...
function img_mouseup(e) {
    ...
    // }else{
    //     // alert("点击")
    //     var pos = getPointOfImage();
    //     api_sys_copy(`${pos.x},${pos.y}`)
    // }
...
function changeImageMarkSize() {
    ...
    //         var width = p.region_position.right - p.region_position.left;
    //         var height = p.region_position.bottom - p.region_position.top;
    //         var marky = p.region_position.top/(rimgw/cimgw);
    //         var markx = p.region_position.left/(rimgw/cimgw);
    ...
    //         var width = p.rectangle[2].x - p.rectangle[0].x;
    //         var height = p.rectangle[1].y - p.rectangle[0].y;
    //         var marky = p.rectangle[0].y/(rimgw/cimgw);
    //         var markx = p.rectangle[0].x/(rimgw/cimgw);
    //         var markw = width/(rimgw/cimgw);
    //         var markh = height/(rimgw/cimgw);
