/*! For license information please see dd43h3r4.js.LICENSE.txt */
export const id=2882;export const ids=[2882];export const modules={53935:(t,i,e)=>{e.d(i,{A:()=>a});const o=t=>t<10?`0${t}`:t;function a(t){const i=Math.floor(t/3600),e=Math.floor(t%3600/60),a=Math.floor(t%3600%60);return i>0?`${i}:${o(e)}:${o(a)}`:e>0?`${e}:${o(a)}`:a>0?""+a:null}},49371:(t,i,e)=>{e.d(i,{PN:()=>n,jm:()=>s,sR:()=>r,t1:()=>a,yu:()=>l});e(31238);const o={"HA-Frontend-Base":`${location.protocol}//${location.host}`},a=(t,i,e)=>t.callApi("POST","config/config_entries/flow",{handler:i,show_advanced_options:Boolean(t.userData?.showAdvanced),entry_id:e},o),n=(t,i)=>t.callApi("GET",`config/config_entries/flow/${i}`,void 0,o),s=(t,i,e)=>t.callApi("POST",`config/config_entries/flow/${i}`,e,o),r=(t,i)=>t.callApi("DELETE",`config/config_entries/flow/${i}`),l=(t,i)=>t.callApi("GET","config/config_entries/flow_handlers"+(i?`?type=${i}`:""))},61399:(t,i,e)=>{e.d(i,{mx:()=>o,sF:()=>a});const o=["sunday","monday","tuesday","wednesday","thursday","friday","saturday"],a=(t,i)=>t.callWS({type:"schedule/create",...i})},25705:(t,i,e)=>{e.d(i,{PF:()=>s,CR:()=>a,ls:()=>n});var o=e(53935);const a=(t,i)=>t.callWS({type:"timer/create",...i}),n=t=>{if(!t.attributes.remaining)return;let i=function(t){const i=t.split(":").map(Number);return 3600*i[0]+60*i[1]+i[2]}(t.attributes.remaining);if("active"===t.state){const e=(new Date).getTime(),o=new Date(t.last_changed).getTime();i=Math.max(i-(e-o)/1e3,0)}return i},s=(t,i,e)=>{if(!i)return null;if("idle"===i.state||0===e)return t.formatEntityState(i);let a=(0,o.A)(e||0)||"0";return"paused"===i.state&&(a=`${a} (${t.formatEntityState(i)})`),a}},63283:(t,i,e)=>{e.d(i,{W:()=>r});var o=e(98597),a=e(49371),n=e(31238),s=e(50006);const r=(t,i)=>(0,s.g)(t,i,{flowType:"config_flow",loadDevicesAndAreas:!0,createFlow:async(t,e)=>{const[o]=await Promise.all([(0,a.t1)(t,e,i.entryId),t.loadFragmentTranslation("config"),t.loadBackendTranslation("config",e),t.loadBackendTranslation("selector",e),t.loadBackendTranslation("title",e)]);return o},fetchFlow:async(t,i)=>{const e=await(0,a.PN)(t,i);return await t.loadFragmentTranslation("config"),await t.loadBackendTranslation("config",e.handler),await t.loadBackendTranslation("selector",e.handler),e},handleFlowStep:a.jm,deleteFlow:a.sR,renderAbortDescription(t,i){const e=t.localize(`component.${i.translation_domain||i.handler}.config.abort.${i.reason}`,i.description_placeholders);return e?o.qy`
      ...
      `},renderShowFormProgressHeader(t,i){return t.localize(`component.${i.handler}.config.step.${i.step_id}.title`)||t.localize(`component.${i.handler}.title`)},renderShowFormProgressDescription(t,i){const e=t.localize(`component.${i.translation_domain||i.handler}.config.progress.${i.progress_action}`,i.description_placeholders);return e?o.qy`
        ...
        ${this._params?.domain?a.s6:a.qy`<mwc-button
      ...
      `;else if(this._loading||void 0===this._helperFlows)t=a.qy`<ha-circular-progress
        indeterminate
      ></ha-circular-progress>`;else{const i=[];for(const t of Object.keys(_))i.push([t,this.hass.localize(`ui.panel.config.helpers.types.${t}`)||t]);for(const t of this._helperFlows)i.push([t,(0,h.p$)(this.hass.localize,t)]);i.sort(((t,i)=>t[1].localeCompare(i[1]))),t=a.qy`
        <mwc-list
          innerRole="listbox"
          itemRoles="option"
          ...
          dialogInitialFocus
        >
          ${i.map((([t,i])=>{const e=!(t in _)||(0,r.x)(this.hass,t);return a.qy`
              <ha-list-item
                .disabled=${!e}
                hasmeta
                .domain=${t}
    ...
    `}},{kind:"method",key:"_valueChanged",value:function(t){this._item=t.detail.value}},{kind:"method",key:"_createItem",value:async function(){if(this._domain&&this._item){this._submitting=!0,this._error="";try{const t=await _[this._domain].create(this.hass,this._item);this._params?.dialogClosedCallback&&t.id&&this._params.dialogClosedCallback({flowFinished:!0,entityId:`${this._domain}.${t.id}`}),this.closeDialog()}catch(t){this._error=t.message||"Unknown error"}finally{this._submitting=!1}}}},{kind:"method",key:"_domainPicked",value:async function(t){if(!(t=>!(!t.detail.selected||"property"!==t.detail.source||(t.currentTarget.selected=!1,0)))(t))return;const i=t.currentTarget.domain;if(i in _){this._loading=!0;try{await _[i].import(),this._domain=i}finally{this._loading=!1}this._focusForm()}else(0,u.W)(this,{startFlowHandler:i,manifest:await(0,h.QC)(this.hass,i),dialogClosedCallback:this._params.dialogClosedCallback}),this.closeDialog()}},{kind:"method",key:"_focusForm",value:async function(){await this.updateComplete,(this._form?.lastElementChild).focus()}},{kind:"method",key:"_goBack",value:function(){this._domain=void 0,this._item=void 0,this._error=void 0}},{kind:"get",static:!0,key:"styles",value:function(){return[g.nA,a.AH`
      ...
      `]}}]}}),a.WF)},47424:(t,i,e)=>{e.d(i,{MR:()=>o,a_:()=>a,bg:()=>n});const o=t=>`https://brands.home-assistant.io/${t.brand?"brands/":""}${t.useFallback?"_/":""}${t.domain}/${t.darkOptimized?"dark_":""}${t.type}.png`,a=t=>t.split("/")[4],n=t=>t.startsWith("https://brands.home-assistant.io/")},87777:(t,i,e)=>{var o=e(98597);class a extends o.WF{static get styles(){return[o.AH`
        :host {
          display: block;
          position: absolute;
          outline: none;
...
//# sourceMappingURL=dd43h3r4.js.map