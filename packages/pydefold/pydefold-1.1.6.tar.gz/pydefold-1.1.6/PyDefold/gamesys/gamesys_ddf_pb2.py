...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _COLLECTIONPROXYDESC.fields_by_name['collection'
        ]._serialized_options = b'\xa0\xbb\x18\x01'
    _SETCONSTANTPARTICLEFX.fields_by_name['value']._options = None
    _SETCONSTANTPARTICLEFX.fields_by_name['value'
        ]._serialized_options = b'\xa0\xb5\x18\x01'
    _SETCONSTANT.fields_by_name['value']._options = None
    _SETCONSTANT.fields_by_name['value'
        ]._serialized_options = b'\xa0\xb5\x18\x01'
