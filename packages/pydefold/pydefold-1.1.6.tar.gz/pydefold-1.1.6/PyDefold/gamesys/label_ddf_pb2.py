...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'gamesys.label_ddf_pb2',
    globals())
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _LABELDESC.fields_by_name['material'
