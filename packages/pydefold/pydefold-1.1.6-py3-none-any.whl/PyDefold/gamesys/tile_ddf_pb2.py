...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'gamesys.tile_ddf_pb2',
    globals())
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b'\n\x18com.dynamo.gamesys.protoB\x04Tile'
    _PLAYBACK.values_by_name['PLAYBACK_NONE']._options = None
    _PLAYBACK.values_by_name['PLAYBACK_NONE'
        ]._serialized_options = b'\xc2\xc1\x18\x04None'
    _PLAYBACK.values_by_name['PLAYBACK_ONCE_FORWARD']._options = None
    _PLAYBACK.values_by_name['PLAYBACK_ONCE_FORWARD'
        ]._serialized_options = b'\xc2\xc1\x18\x0cOnce Forward'
    _PLAYBACK.values_by_name['PLAYBACK_ONCE_BACKWARD']._options = None
    _PLAYBACK.values_by_name['PLAYBACK_ONCE_BACKWARD'
        ]._serialized_options = b'\xc2\xc1\x18\rOnce Backward'
    _PLAYBACK.values_by_name['PLAYBACK_ONCE_PINGPONG']._options = None
    _PLAYBACK.values_by_name['PLAYBACK_ONCE_PINGPONG'
        ]._serialized_options = b'\xc2\xc1\x18\x0eOnce Ping Pong'
    _PLAYBACK.values_by_name['PLAYBACK_LOOP_FORWARD']._options = None
    _PLAYBACK.values_by_name['PLAYBACK_LOOP_FORWARD'
        ]._serialized_options = b'\xc2\xc1\x18\x0cLoop Forward'
    _PLAYBACK.values_by_name['PLAYBACK_LOOP_BACKWARD']._options = None
    _PLAYBACK.values_by_name['PLAYBACK_LOOP_BACKWARD'
        ]._serialized_options = b'\xc2\xc1\x18\rLoop Backward'
    _PLAYBACK.values_by_name['PLAYBACK_LOOP_PINGPONG']._options = None
    _PLAYBACK.values_by_name['PLAYBACK_LOOP_PINGPONG'
        ]._serialized_options = b'\xc2\xc1\x18\x0eLoop Ping Pong'
    _SPRITETRIMMINGMODE.values_by_name['SPRITE_TRIM_MODE_OFF']._options = None
    _SPRITETRIMMINGMODE.values_by_name['SPRITE_TRIM_MODE_OFF'
        ]._serialized_options = b'\xc2\xc1\x18\x03Off'
    _SPRITETRIMMINGMODE.values_by_name['SPRITE_TRIM_MODE_4']._options = None
    _SPRITETRIMMINGMODE.values_by_name['SPRITE_TRIM_MODE_4'
        ]._serialized_options = b'\xc2\xc1\x18\n4 Vertices'
    _SPRITETRIMMINGMODE.values_by_name['SPRITE_TRIM_MODE_5']._options = None
    _SPRITETRIMMINGMODE.values_by_name['SPRITE_TRIM_MODE_5'
        ]._serialized_options = b'\xc2\xc1\x18\n5 Vertices'
    _SPRITETRIMMINGMODE.values_by_name['SPRITE_TRIM_MODE_6']._options = None
    _SPRITETRIMMINGMODE.values_by_name['SPRITE_TRIM_MODE_6'
        ]._serialized_options = b'\xc2\xc1\x18\n6 Vertices'
    _SPRITETRIMMINGMODE.values_by_name['SPRITE_TRIM_MODE_7']._options = None
    _SPRITETRIMMINGMODE.values_by_name['SPRITE_TRIM_MODE_7'
        ]._serialized_options = b'\xc2\xc1\x18\n7 Vertices'
    _SPRITETRIMMINGMODE.values_by_name['SPRITE_TRIM_MODE_8']._options = None
    _SPRITETRIMMINGMODE.values_by_name['SPRITE_TRIM_MODE_8'
        ]._serialized_options = b'\xc2\xc1\x18\n8 Vertices'
    _SPRITETRIMMINGMODE.values_by_name['SPRITE_TRIM_POLYGONS']._options = None
    _SPRITETRIMMINGMODE.values_by_name['SPRITE_TRIM_POLYGONS'
        ]._serialized_options = b'\xc2\xc1\x18\x08Polygons'
