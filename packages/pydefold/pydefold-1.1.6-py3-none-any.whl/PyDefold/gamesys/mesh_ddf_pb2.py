...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'gamesys.mesh_ddf_pb2',
    globals())
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MESHDESC_PRIMITIVETYPE.values_by_name['PRIMITIVE_LINES'
        ]._serialized_options = b'\xc2\xc1\x18\x05Lines'
    _MESHDESC_PRIMITIVETYPE.values_by_name['PRIMITIVE_TRIANGLES'
        ]._options = None
    _MESHDESC_PRIMITIVETYPE.values_by_name['PRIMITIVE_TRIANGLES'
        ]._serialized_options = b'\xc2\xc1\x18\tTriangles'
    _MESHDESC_PRIMITIVETYPE.values_by_name['PRIMITIVE_TRIANGLE_STRIP'
        ]._options = None
    _MESHDESC_PRIMITIVETYPE.values_by_name['PRIMITIVE_TRIANGLE_STRIP'
        ]._serialized_options = b'\xc2\xc1\x18\x0eTriangle Strip'
    _MESHDESC.fields_by_name['material']._options = None
    _MESHDESC.fields_by_name['material'
        ]._serialized_options = b'\xa0\xbb\x18\x01'
    _MESHDESC.fields_by_name['vertices']._options = None
    _MESHDESC.fields_by_name['vertices'
        ]._serialized_options = b'\xa0\xbb\x18\x01'
    _MESHDESC.fields_by_name['textures']._options = None
    _MESHDESC.fields_by_name['textures'
        ]._serialized_options = b'\xa0\xbb\x18\x01'
