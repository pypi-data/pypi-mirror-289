...
import TATR
from TATR.util.misc import inverse_sigmoid
from .utils import gen_encoder_output_proposals, MLP, _get_activation_fn, gen_sineembed_for_position

from TATR.models.dino.ops.functions import MSDeformAttnFunction
from TATR.models.dino.ops.functions import ms_deform_attn_core_pytorch
    ...
    def __init__(self, d_model=256, nhead=8,
        ...
        if deformable_encoder:
            encoder_layer = DeformableTransformerEncoderLayer(d_model, dim_feedforward,
                                                              dropout, activation,
                                                              num_feature_levels, nhead, enc_n_points, add_channel_attention=add_channel_attention, use_deformable_box_attn=use_deformable_box_attn,
