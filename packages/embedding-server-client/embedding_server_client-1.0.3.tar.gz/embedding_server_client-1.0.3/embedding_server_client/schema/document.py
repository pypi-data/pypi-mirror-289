...
from embedding_server_client.schema.document_status import DocumentInsertionStatus, RetrievalStatus
...
class Document(Base):
    ...
    document_url: str
    split_ids: List[int]
    summary_ids: Optional[List[int]]


@dataclass
class DocumentQuery(Base):
    """
    Dataclass representing a DocumentQuery response.
    """
    document_id: int
    document_url: str
