...
def describe(df: pd.DataFrame, config:BaseSettings,data_types: dict=None)-> TableDescription:
...
def describe_invalid(df: pd.DataFrame, errors: list, config: BaseSettings) -> TableDescription:
    """
