...
class CACStrandPostprocBatchpostprocPlot2d(BaseModel):
    ...
    x_val: Optional[str] = Field(
        default=None, description="Value to be plotted on the x-axis. This field corresponds to a parameter in the input YAML-file. E.g. 'solve.source_parameters.sine.frequency' will create a 2D plot with frequency on the x-axis."
    )
