from video.utils import generate_videoclip_from_image
from yta_multimedia.video.generation.constants import GOOGLE_SEARCH_IMAGE_ABSOLUTE_PATH
...
class GoogleSearch():
    ...
    def generate(self):
        clip = generate_videoclip_from_image(GOOGLE_SEARCH_IMAGE_ABSOLUTE_PATH)
