...
from .schemas_sdk import AvailableModelModel, ProviderModel, ModelCreatorModel
...
class ModelsAPI:
    ...
    def get_model_creators(self, model_type_name: Optional[str] = None) -> List[ModelCreatorModel]:
        params = {}
        if model_type_name:
            params['model_type_name'] = model_type_name
