...
serving_cli = typer.Typer(name="serving", help="Manage your inference serving in Zetta Workspace.", no_args_is_help=True)


@serving_cli.command(name="list", help="List all inference instance that are currently running.")
