...
def flickermeter(samples, reference_voltage, reference_frequency, nominal_voltage, nominal_frequency, returns='all_parameters'):
    ...
    typhoon.test.IEC61000.rms
    """
    return _impl_flickmeter.flickermeter(samples, reference_voltage, reference_frequency, nominal_voltage, nominal_frequency, returns)
...
def power_quantities(voltage_samples: pandas.Series, current_samples: pandas.Series, nominal_grid_freq: float,
    ...
    """
    return _impl_power_quantities.power_quantities(voltage_samples, current_samples, nominal_grid_freq, reference_split)
...
def power_quantities_three_phase(
    ...
    return _impl_power_quantities_three_phase.power_quantities_three_phase(
        voltages_samples, currents_samples, nominal_grid_freq, line_voltage, reference_split)
