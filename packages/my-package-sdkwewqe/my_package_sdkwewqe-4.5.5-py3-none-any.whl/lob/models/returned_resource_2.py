...
from lob.models.details_7 import Details7


class ReturnedResource2(object):

    """Implementation of the 'returned_resource2' model.

    TODO: type model description here.

    Attributes:
        resource_type (str): Mailpiece type for the creative
        details (Details7): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the ReturnedResource2 class"""
    ...
    def from_dictionary(cls,
        ...
        details = Details7.from_dictionary(dictionary.get('details')) if dictionary.get('details') else None
