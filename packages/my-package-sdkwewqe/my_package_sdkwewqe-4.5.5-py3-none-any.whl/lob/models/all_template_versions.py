...
class AllTemplateVersions(object):

    """Implementation of the 'all_template_versions' model.
    ...
    Attributes:
        ...
        data (List[TemplateVersion]): list of template versions
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the AllTemplateVersions class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [TemplateVersion.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
