...
class BillingGroupsResponse(object):

    """Implementation of the 'BillingGroupsResponse' model.
    ...
    Attributes:
        ...
        data (List[BillingGroup]): list of billing_groups
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the BillingGroupsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [BillingGroup.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
