...
class BuckslipsResponse(object):

    """Implementation of the 'BuckslipsResponse' model.
    ...
    Attributes:
        ...
        data (List[Buckslip]): list of buckslips
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the BuckslipsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Buckslip.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
