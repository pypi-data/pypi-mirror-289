...
class AllLetters(object):
    ...
    """Implementation of the 'all_letters' model.
    ...
    Attributes:
        ...
        data (List[NoExtraService | Registered | Certified] | None): list of
            letters
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the AllLetters class"""
    ...
    def from_dictionary(cls,
        ...
        data = APIHelper.deserialize_union_type(UnionTypeLookUp.get('letter'), dictionary.get('data'), False) if dictionary.get('data') is not None else APIHelper.SKIP
