...
class AllAddresses(object):
    ...
    """Implementation of the 'all_addresses' model.
    ...
    Attributes:
        ...
        data (List[AddressUs | AddressIntl] | None): list of addresses
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the AllAddresses class"""
    ...
    def from_dictionary(cls,
        ...
        data = APIHelper.deserialize_union_type(UnionTypeLookUp.get('address2'), dictionary.get('data'), False) if dictionary.get('data') is not None else APIHelper.SKIP
