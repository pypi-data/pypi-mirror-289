...
class CardsOrdersResponse(object):

    """Implementation of the 'CardsOrdersResponse' model.
    ...
    Attributes:
        ...
        data (List[CardOrder]): List of card orders
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the CardsOrdersResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [CardOrder.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
