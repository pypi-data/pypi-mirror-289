...
class RequiredAddressColumns(object):

    """Implementation of the 'RequiredAddressColumns' model.

    The mapping of column headers in your file to Lob-required fields for the
    resource created. See our <a
    ...
    def __init__(self,
                 ...
                 address_state=None,
                 address_zip=None):
        """Constructor for the RequiredAddressColumns class"""
