...
class UsReverseGeocodeLookups0Error1(object):

    """Implementation of the 'UsReverseGeocodeLookups0Error1' model.
    ...
    def __init__(self,
                 error=None):
        """Constructor for the UsReverseGeocodeLookups0Error1 class"""
