...
class Wordsatcheckbottom(object):

    """Implementation of the 'wordsatcheckbottom' model.
    ...
    def __init__(self,
        ...
        """Constructor for the Wordsatcheckbottom class"""
    ...
    def from_dictionary(cls,
        ...
        to = APIHelper.deserialize_union_type(UnionTypeLookUp.get('WordsatcheckbottomTo'), dictionary.get('to'), False) if dictionary.get('to') is not None else None
        mfrom = APIHelper.deserialize_union_type(UnionTypeLookUp.get('WordsatcheckbottomFrom'), dictionary.get('from'), False) if dictionary.get('from') is not None else None
        ...
        logo = APIHelper.deserialize_union_type(UnionTypeLookUp.get('WordsatcheckbottomLogo'), dictionary.get('logo'), False) if dictionary.get('logo') is not None else APIHelper.SKIP
        check_bottom = dictionary.get("check_bottom") if dictionary.get("check_bottom") else APIHelper.SKIP
        attachment = APIHelper.deserialize_union_type(UnionTypeLookUp.get('WordsatcheckbottomAttachment'), dictionary.get('attachment'), False) if dictionary.get('attachment') is not None else APIHelper.SKIP
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.message,
                ...
                and UnionTypeLookUp.get('WordsatcheckbottomTo').validate(dictionary.to).is_valid \
                and UnionTypeLookUp.get('WordsatcheckbottomFrom').validate(dictionary.mfrom).is_valid \
        ...
        return APIHelper.is_valid_type(value=dictionary.get('message'),
            ...
            and APIHelper.is_valid_type(value=dictionary.get('use_type'),
                                        type_callable=lambda value: isinstance(value, object)) \
            and UnionTypeLookUp.get('WordsatcheckbottomTo').validate(dictionary.get('to')).is_valid \
            and UnionTypeLookUp.get('WordsatcheckbottomFrom').validate(dictionary.get('from')).is_valid \
