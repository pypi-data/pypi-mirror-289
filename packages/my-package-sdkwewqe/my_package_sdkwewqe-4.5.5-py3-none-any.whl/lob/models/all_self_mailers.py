...
class AllSelfMailers(object):

    """Implementation of the 'all_self_mailers' model.
    ...
    Attributes:
        ...
        data (List[SelfMailer]): list of self_mailers
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the AllSelfMailers class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [SelfMailer.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
