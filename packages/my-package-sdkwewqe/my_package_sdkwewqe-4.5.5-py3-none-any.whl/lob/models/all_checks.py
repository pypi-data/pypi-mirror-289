...
class AllChecks(object):
    ...
    """Implementation of the 'all_checks' model.
    ...
    Attributes:
        ...
        data (List[Check]): list of checks
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the AllChecks class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Check.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
