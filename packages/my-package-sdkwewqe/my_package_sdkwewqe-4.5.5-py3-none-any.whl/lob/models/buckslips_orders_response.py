...
class BuckslipsOrdersResponse(object):

    """Implementation of the 'BuckslipsOrdersResponse' model.
    ...
    Attributes:
        ...
        data (List[BuckslipOrder]): List of buckslip orders
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the BuckslipsOrdersResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [BuckslipOrder.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
