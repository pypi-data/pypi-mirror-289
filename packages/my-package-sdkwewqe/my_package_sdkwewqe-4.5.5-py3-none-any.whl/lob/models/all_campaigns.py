...
class AllCampaigns(object):

    """Implementation of the 'all_campaigns' model.
    ...
    Attributes:
        ...
        data (List[Campaign]): list of campaigns
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the AllCampaigns class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Campaign.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
