...
class CheckEditableProps(object):

    """Implementation of the 'check_editable_props' model.
    ...
    def __init__(self,
                 ...
                 logo=APIHelper.SKIP,
                 check_bottom=APIHelper.SKIP,
                 attachment=APIHelper.SKIP,
                 billing_group_id=APIHelper.SKIP):
        """Constructor for the CheckEditableProps class"""
        ...
        if logo is not APIHelper.SKIP:
            self.logo = logo 
        if check_bottom is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        to = APIHelper.deserialize_union_type(UnionTypeLookUp.get('CheckEditablePropsTo'), dictionary.get('to'), False) if dictionary.get('to') is not None else None
        mfrom = APIHelper.deserialize_union_type(UnionTypeLookUp.get('CheckEditablePropsFrom'), dictionary.get('from'), False) if dictionary.get('from') is not None else None
        ...
        logo = APIHelper.deserialize_union_type(UnionTypeLookUp.get('CheckEditablePropsLogo'), dictionary.get('logo'), False) if dictionary.get('logo') is not None else APIHelper.SKIP
        check_bottom = dictionary.get("check_bottom") if dictionary.get("check_bottom") else APIHelper.SKIP
        attachment = APIHelper.deserialize_union_type(UnionTypeLookUp.get('CheckEditablePropsAttachment'), dictionary.get('attachment'), False) if dictionary.get('attachment') is not None else APIHelper.SKIP
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.use_type,
                ...
                and UnionTypeLookUp.get('CheckEditablePropsTo').validate(dictionary.to).is_valid \
                and UnionTypeLookUp.get('CheckEditablePropsFrom').validate(dictionary.mfrom).is_valid \
        ...
        return APIHelper.is_valid_type(value=dictionary.get('use_type'),
                                       type_callable=lambda value: isinstance(value, object)) \
            and UnionTypeLookUp.get('CheckEditablePropsTo').validate(dictionary.get('to')).is_valid \
            and UnionTypeLookUp.get('CheckEditablePropsFrom').validate(dictionary.get('from')).is_valid \
