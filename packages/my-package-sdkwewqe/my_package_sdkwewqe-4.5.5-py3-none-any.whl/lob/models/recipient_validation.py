...
class RecipientValidation(object):

    """Implementation of the 'recipient_validation' model.

    TODO: type model description here.

    Attributes:
        id (str): Unique identifier prefixed with `id_validation_`.
        recipient (str): The name of the person whose identity is being
            validated.
    ...
    def __init__(self,
        ...
        """Constructor for the RecipientValidation class"""
