...
class LetterDetailsReturned(object):

    """Implementation of the 'letter_details_returned' model.

    Properties that the letters in your Creative should have. Check within in
    order to add a QR code to your creative.
    ...
    def __init__(self,
        ...
        """Constructor for the LetterDetailsReturned class"""
