...
class QrCode1(object):

    """Implementation of the 'QrCode1' model.
    ...
    def __init__(self,
        ...
        """Constructor for the QrCode1 class"""
    ...
    def from_dictionary(cls,
        ...
        redirect_url = APIHelper.deserialize_union_type(UnionTypeLookUp.get('QrCode1RedirectUrl'), dictionary.get('redirect_url'), False) if dictionary.get('redirect_url') is not None else APIHelper.SKIP
