...
class AllBankAccounts(object):

    """Implementation of the 'all_bank_accounts' model.
    ...
    Attributes:
        ...
        data (List[BankAccount]): list of bank_accounts
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the AllBankAccounts class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [BankAccount.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
