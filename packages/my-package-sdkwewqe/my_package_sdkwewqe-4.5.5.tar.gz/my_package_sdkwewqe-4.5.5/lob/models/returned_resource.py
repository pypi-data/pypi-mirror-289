...
from lob.models.details_5 import Details5


class ReturnedResource(object):

    """Implementation of the 'returned_resource' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ReturnedResource class"""
    ...
    def from_dictionary(cls,
        ...
        details = Details5.from_dictionary(dictionary.get('details')) if dictionary.get('details') else None
