...
class BulkIntlVerifications0Error1(object):

    """Implementation of the 'BulkIntlVerifications0Error1' model.
    ...
    def __init__(self,
                 error=None):
        """Constructor for the BulkIntlVerifications0Error1 class"""
