...
from lob.models.extra_service_1_enum import ExtraService1Enum
...
class Certified(object):
    ...
    """Implementation of the 'certified' model.

    TODO: type model description here.

    Attributes:
        extra_service (ExtraService1Enum): TODO: type description here.
        tracking_number (str): The tracking number will be here immediately
            upon creation. Dummy tracking numbers are created in test mode.
    ...
    def __init__(self,
        ...
        """Constructor for the Certified class"""
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.extra_service,
                                           type_callable=lambda value: ExtraService1Enum.validate(value)) \
                and APIHelper.is_valid_type(value=dictionary.tracking_events,
                                            type_callable=lambda value: TrackingEventCertified.validate(value),
                                            is_model_dict=True,
        ...
        return APIHelper.is_valid_type(value=dictionary.get('extra_service'),
                                       type_callable=lambda value: ExtraService1Enum.validate(value)) \
            and APIHelper.is_valid_type(value=dictionary.get('tracking_events'),
                                        type_callable=lambda value: TrackingEventCertified.validate(value),
                                        is_model_dict=True,
                                        is_inner_model_dict=True) \
