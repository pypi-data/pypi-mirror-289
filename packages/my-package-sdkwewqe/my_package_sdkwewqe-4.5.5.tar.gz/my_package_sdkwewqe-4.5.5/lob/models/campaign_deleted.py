...
class CampaignDeleted(object):

    """Implementation of the 'campaign_deleted' model.
    ...
    Attributes:
        ...
        deleted (bool): True if the resource has been successfully deleted.
    ...
    def __init__(self,
        ...
        """Constructor for the CampaignDeleted class"""
