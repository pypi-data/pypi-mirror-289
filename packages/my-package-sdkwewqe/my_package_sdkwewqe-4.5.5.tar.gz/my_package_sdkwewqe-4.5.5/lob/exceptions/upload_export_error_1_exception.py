...
class UploadExportError1Exception(lob.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the UploadExportError1Exception class
        ...
        """
        super(UploadExportError1Exception, self).__init__(reason, response)
