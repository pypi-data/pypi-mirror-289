...
class WirelessSsidsSplashSettingsArgs:
    def __init__(__self__, *,
                 ...
                 allow_simultaneous_logins: Optional[pulumi.Input[bool]] = None,
                 billing: Optional[pulumi.Input['WirelessSsidsSplashSettingsBillingArgs']] = None,
                 block_all_traffic_before_sign_on: Optional[pulumi.Input[bool]] = None,
                 controller_disconnection_behavior: Optional[pulumi.Input[str]] = None,
                 ...
                 splash_timeout: Optional[pulumi.Input[int]] = None,
                 splash_url: Optional[pulumi.Input[str]] = None,
                 theme_id: Optional[pulumi.Input[str]] = None,
                 use_redirect_url: Optional[pulumi.Input[bool]] = None,
                 use_splash_url: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[bool] allow_simultaneous_logins: Whether or not to allow simultaneous logins from different devices.
        :param pulumi.Input['WirelessSsidsSplashSettingsBillingArgs'] billing: Details associated with billing splash
        :param pulumi.Input[bool] block_all_traffic_before_sign_on: How restricted allowing traffic should be. If true, all traffic types are blocked until the splash page is acknowledged. If false, all non-HTTP traffic is allowed before the splash page is acknowledged.
        :param pulumi.Input[str] controller_disconnection_behavior: How login attempts should be handled when the controller is unreachable.
        ...
        :param pulumi.Input[str] redirect_url: The custom redirect URL where the users will go after the splash page.
        ...
        :param pulumi.Input[int] splash_timeout: Splash timeout in minutes.
        :param pulumi.Input[str] splash_url: The custom splash URL of the click-through splash page.
        :param pulumi.Input[str] theme_id: The id of the selected splash theme.
        :param pulumi.Input[bool] use_redirect_url: The Boolean indicating whether the the user will be redirected to the custom redirect URL after the splash page.
        :param pulumi.Input[bool] use_splash_url: Boolean indicating whether the users will be redirected to the custom splash url
        :param pulumi.Input[str] welcome_message: The welcome message for the users on the splash page.
        """
    ...
    def allow_simultaneous_logins(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def allow_simultaneous_logins(self, value: Optional[pulumi.Input[bool]]):
    ...
    def block_all_traffic_before_sign_on(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def block_all_traffic_before_sign_on(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "block_all_traffic_before_sign_on", value)

    @property
    @pulumi.getter(name="controllerDisconnectionBehavior")
    def controller_disconnection_behavior(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def controller_disconnection_behavior(self, value: Optional[pulumi.Input[str]]):
    ...
    def splash_timeout(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def splash_timeout(self, value: Optional[pulumi.Input[int]]):
    ...
    def use_redirect_url(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def use_redirect_url(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "use_redirect_url", value)

    @property
    @pulumi.getter(name="useSplashUrl")
    def use_splash_url(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def use_splash_url(self, value: Optional[pulumi.Input[bool]]):
...
class _WirelessSsidsSplashSettingsState:
    def __init__(__self__, *,
                 ...
                 splash_timeout: Optional[pulumi.Input[int]] = None,
                 splash_url: Optional[pulumi.Input[str]] = None,
                 ssid_number: Optional[pulumi.Input[int]] = None,
                 theme_id: Optional[pulumi.Input[str]] = None,
                 use_redirect_url: Optional[pulumi.Input[bool]] = None,
                 use_splash_url: Optional[pulumi.Input[bool]] = None,
                 welcome_message: Optional[pulumi.Input[str]] = None):
        ...
        :param pulumi.Input['WirelessSsidsSplashSettingsSplashImageArgs'] splash_image: The image used in the splash page.
        :param pulumi.Input['WirelessSsidsSplashSettingsSplashLogoArgs'] splash_logo: The logo used in the splash page.
        :param pulumi.Input[str] splash_page: The type of splash page for this SSID
        :param pulumi.Input['WirelessSsidsSplashSettingsSplashPrepaidFrontArgs'] splash_prepaid_front: The prepaid front image used in the splash page.
        :param pulumi.Input[int] splash_timeout: Splash timeout in minutes.
        :param pulumi.Input[str] splash_url: The custom splash URL of the click-through splash page.
        :param pulumi.Input[int] ssid_number: SSID number
        :param pulumi.Input[str] theme_id: The id of the selected splash theme.
        :param pulumi.Input[bool] use_redirect_url: The Boolean indicating whether the the user will be redirected to the custom redirect URL after the splash page.
        :param pulumi.Input[bool] use_splash_url: Boolean indicating whether the users will be redirected to the custom splash url
        :param pulumi.Input[str] welcome_message: The welcome message for the users on the splash page.
    ...
    def ssid_number(self) -> Optional[pulumi.Input[int]]:
        """
        SSID number
        """
    ...
    @ssid_number.setter
    def ssid_number(self, value: Optional[pulumi.Input[int]]):
...
class WirelessSsidsSplashSettings(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 allow_simultaneous_logins: Optional[pulumi.Input[bool]] = None,
                 billing: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsBillingArgs']]] = None,
                 block_all_traffic_before_sign_on: Optional[pulumi.Input[bool]] = None,
                 controller_disconnection_behavior: Optional[pulumi.Input[str]] = None,
                 guest_sponsorship: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsGuestSponsorshipArgs']]] = None,
                 network_id: Optional[pulumi.Input[str]] = None,
                 number: Optional[pulumi.Input[str]] = None,
                 redirect_url: Optional[pulumi.Input[str]] = None,
                 sentry_enrollment: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsSentryEnrollmentArgs']]] = None,
                 splash_image: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsSplashImageArgs']]] = None,
                 splash_logo: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsSplashLogoArgs']]] = None,
                 splash_prepaid_front: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsSplashPrepaidFrontArgs']]] = None,
                 splash_timeout: Optional[pulumi.Input[int]] = None,
                 splash_url: Optional[pulumi.Input[str]] = None,
                 theme_id: Optional[pulumi.Input[str]] = None,
                 use_redirect_url: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[bool] allow_simultaneous_logins: Whether or not to allow simultaneous logins from different devices.
        :param pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsBillingArgs']] billing: Details associated with billing splash
        :param pulumi.Input[bool] block_all_traffic_before_sign_on: How restricted allowing traffic should be. If true, all traffic types are blocked until the splash page is acknowledged. If false, all non-HTTP traffic is allowed before the splash page is acknowledged.
        :param pulumi.Input[str] controller_disconnection_behavior: How login attempts should be handled when the controller is unreachable.
        :param pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsGuestSponsorshipArgs']] guest_sponsorship: Details associated with guest sponsored splash
        :param pulumi.Input[str] network_id: networkId path parameter. Network ID
        :param pulumi.Input[str] number: number path parameter.
        :param pulumi.Input[str] redirect_url: The custom redirect URL where the users will go after the splash page.
        :param pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsSentryEnrollmentArgs']] sentry_enrollment: Systems Manager sentry enrollment splash settings.
        :param pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsSplashImageArgs']] splash_image: The image used in the splash page.
        :param pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsSplashLogoArgs']] splash_logo: The logo used in the splash page.
        :param pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsSplashPrepaidFrontArgs']] splash_prepaid_front: The prepaid front image used in the splash page.
        :param pulumi.Input[int] splash_timeout: Splash timeout in minutes.
        :param pulumi.Input[str] splash_url: The custom splash URL of the click-through splash page.
        :param pulumi.Input[str] theme_id: The id of the selected splash theme.
        :param pulumi.Input[bool] use_redirect_url: The Boolean indicating whether the the user will be redirected to the custom redirect URL after the splash page.
    ...
    def get(resource_name: str,
            ...
            number: Optional[pulumi.Input[str]] = None,
            redirect_url: Optional[pulumi.Input[str]] = None,
            self_registration: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsSelfRegistrationArgs']]] = None,
            sentry_enrollment: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsSentryEnrollmentArgs']]] = None,
            splash_image: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsSplashImageArgs']]] = None,
            splash_logo: Optional[pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsSplashLogoArgs']]] = None,
            splash_page: Optional[pulumi.Input[str]] = None,
            ...
            use_redirect_url: Optional[pulumi.Input[bool]] = None,
            use_splash_url: Optional[pulumi.Input[bool]] = None,
            welcome_message: Optional[pulumi.Input[str]] = None) -> 'WirelessSsidsSplashSettings':
        """
        ...
        :param pulumi.Input[str] number: number path parameter.
        :param pulumi.Input[str] redirect_url: The custom redirect URL where the users will go after the splash page.
        :param pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsSelfRegistrationArgs']] self_registration: Self-registration for splash with Meraki authentication.
        :param pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsSentryEnrollmentArgs']] sentry_enrollment: Systems Manager sentry enrollment splash settings.
        :param pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsSplashImageArgs']] splash_image: The image used in the splash page.
        :param pulumi.Input[pulumi.InputType['WirelessSsidsSplashSettingsSplashLogoArgs']] splash_logo: The logo used in the splash page.
        :param pulumi.Input[str] splash_page: The type of splash page for this SSID
    ...
    @property
    @pulumi.getter(name="allowSimultaneousLogins")
    def allow_simultaneous_logins(self) -> pulumi.Output[bool]:
        """
        Whether or not to allow simultaneous logins from different devices.
        """
        return pulumi.get(self, "allow_simultaneous_logins")
    ...
    @property
    @pulumi.getter(name="blockAllTrafficBeforeSignOn")
    def block_all_traffic_before_sign_on(self) -> pulumi.Output[bool]:
        """
        How restricted allowing traffic should be. If true, all traffic types are blocked until the splash page is acknowledged. If false, all non-HTTP traffic is allowed before the splash page is acknowledged.
        """
        return pulumi.get(self, "block_all_traffic_before_sign_on")
    ...
    @property
    @pulumi.getter(name="controllerDisconnectionBehavior")
    def controller_disconnection_behavior(self) -> pulumi.Output[str]:
        """
        How login attempts should be handled when the controller is unreachable.
        """
        return pulumi.get(self, "controller_disconnection_behavior")
    ...
    @property
    @pulumi.getter(name="splashTimeout")
    def splash_timeout(self) -> pulumi.Output[int]:
        """
        Splash timeout in minutes.
        """
        return pulumi.get(self, "splash_timeout")
    ...
    @property
    @pulumi.getter(name="splashUrl")
    def splash_url(self) -> pulumi.Output[str]:
        """
        The custom splash URL of the click-through splash page.
        """
        return pulumi.get(self, "splash_url")
    ...
    @property
    @pulumi.getter(name="ssidNumber")
    def ssid_number(self) -> pulumi.Output[int]:
        """
        SSID number
        """
        return pulumi.get(self, "ssid_number")
    ...
    @property
    @pulumi.getter(name="useRedirectUrl")
    def use_redirect_url(self) -> pulumi.Output[bool]:
        """
        The Boolean indicating whether the the user will be redirected to the custom redirect URL after the splash page.
        """
        return pulumi.get(self, "use_redirect_url")
    ...
    @property
    @pulumi.getter(name="useSplashUrl")
    def use_splash_url(self) -> pulumi.Output[bool]:
        """
        Boolean indicating whether the users will be redirected to the custom splash url
        """
        return pulumi.get(self, "use_splash_url")
