...
class LoginSecurityArgs:
    def __init__(__self__, *,
                 ...
                 enforce_login_ip_ranges: Optional[pulumi.Input[bool]] = None,
                 enforce_password_expiration: Optional[pulumi.Input[bool]] = None,
                 enforce_strong_passwords: Optional[pulumi.Input[bool]] = None,
                 enforce_two_factor_auth: Optional[pulumi.Input[bool]] = None,
                 idle_timeout_minutes: Optional[pulumi.Input[int]] = None,
                 login_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 num_different_passwords: Optional[pulumi.Input[int]] = None,
                 password_expiration_days: Optional[pulumi.Input[int]] = None):
        """
        ...
        :param pulumi.Input[bool] enforce_login_ip_ranges: Boolean indicating whether organization will restrict access to Dashboard (including the API) from certain IP addresses.
        :param pulumi.Input[bool] enforce_password_expiration: Boolean indicating whether users are forced to change their password every X number of days.
        :param pulumi.Input[bool] enforce_strong_passwords: Boolean indicating whether users will be forced to choose strong passwords for their accounts. Strong passwords are at least 8 characters that contain 3 of the following: number, uppercase letter, lowercase letter, and symbol
        :param pulumi.Input[bool] enforce_two_factor_auth: Boolean indicating whether users in this organization will be required to use an extra verification code when logging in to Dashboard. This code will be sent to their mobile phone via SMS, or can be generated by the authenticator application.
        :param pulumi.Input[int] idle_timeout_minutes: Number of minutes users can remain idle before being logged out of their accounts.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] login_ip_ranges: List of acceptable IP ranges. Entries can be single IP addresses, IP address ranges, and CIDR subnets.
        :param pulumi.Input[int] num_different_passwords: Number of recent passwords that new password must be distinct from.
        :param pulumi.Input[int] password_expiration_days: Number of days after which users will be forced to change their password.
        """
    ...
    def account_lockout_attempts(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def account_lockout_attempts(self, value: Optional[pulumi.Input[int]]):
    ...
    def enforce_account_lockout(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def enforce_account_lockout(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "enforce_account_lockout", value)

    @property
    @pulumi.getter(name="enforceDifferentPasswords")
    def enforce_different_passwords(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def enforce_different_passwords(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "enforce_different_passwords", value)

    @property
    @pulumi.getter(name="enforceIdleTimeout")
    def enforce_idle_timeout(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def enforce_idle_timeout(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "enforce_idle_timeout", value)

    @property
    @pulumi.getter(name="enforceLoginIpRanges")
    def enforce_login_ip_ranges(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def enforce_login_ip_ranges(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "enforce_login_ip_ranges", value)

    @property
    @pulumi.getter(name="enforcePasswordExpiration")
    def enforce_password_expiration(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def enforce_password_expiration(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "enforce_password_expiration", value)

    @property
    @pulumi.getter(name="enforceStrongPasswords")
    def enforce_strong_passwords(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def enforce_strong_passwords(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "enforce_strong_passwords", value)

    @property
    @pulumi.getter(name="enforceTwoFactorAuth")
    def enforce_two_factor_auth(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def enforce_two_factor_auth(self, value: Optional[pulumi.Input[bool]]):
    ...
    def login_ip_ranges(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    def login_ip_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "login_ip_ranges", value)

    @property
    @pulumi.getter(name="numDifferentPasswords")
    def num_different_passwords(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def num_different_passwords(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "num_different_passwords", value)

    @property
    @pulumi.getter(name="passwordExpirationDays")
    def password_expiration_days(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def password_expiration_days(self, value: Optional[pulumi.Input[int]]):
...
class LoginSecurity(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            num_different_passwords: Optional[pulumi.Input[int]] = None,
            organization_id: Optional[pulumi.Input[str]] = None,
            password_expiration_days: Optional[pulumi.Input[int]] = None) -> 'LoginSecurity':
        """
    ...
    @property
    @pulumi.getter(name="accountLockoutAttempts")
    def account_lockout_attempts(self) -> pulumi.Output[int]:
        """
        Number of consecutive failed login attempts after which users' accounts will be locked.
        """
        return pulumi.get(self, "account_lockout_attempts")
    ...
    @property
    @pulumi.getter(name="enforceAccountLockout")
    def enforce_account_lockout(self) -> pulumi.Output[bool]:
        """
        Boolean indicating whether users' Dashboard accounts will be locked out after a specified number of consecutive failed login attempts.
        """
        return pulumi.get(self, "enforce_account_lockout")
    ...
    @property
    @pulumi.getter(name="enforceDifferentPasswords")
    def enforce_different_passwords(self) -> pulumi.Output[bool]:
        """
        Boolean indicating whether users, when setting a new password, are forced to choose a new password that is different from any past passwords.
        """
        return pulumi.get(self, "enforce_different_passwords")
    ...
    @property
    @pulumi.getter(name="enforceIdleTimeout")
    def enforce_idle_timeout(self) -> pulumi.Output[bool]:
        """
        Boolean indicating whether users will be logged out after being idle for the specified number of minutes.
        """
        return pulumi.get(self, "enforce_idle_timeout")
    ...
    @property
    @pulumi.getter(name="enforceLoginIpRanges")
    def enforce_login_ip_ranges(self) -> pulumi.Output[bool]:
        """
        Boolean indicating whether organization will restrict access to Dashboard (including the API) from certain IP addresses.
        """
        return pulumi.get(self, "enforce_login_ip_ranges")
    ...
    @property
    @pulumi.getter(name="enforcePasswordExpiration")
    def enforce_password_expiration(self) -> pulumi.Output[bool]:
        """
        Boolean indicating whether users are forced to change their password every X number of days.
        """
        return pulumi.get(self, "enforce_password_expiration")
    ...
    @property
    @pulumi.getter(name="enforceStrongPasswords")
    def enforce_strong_passwords(self) -> pulumi.Output[bool]:
        """
        Boolean indicating whether users will be forced to choose strong passwords for their accounts. Strong passwords are at least 8 characters that contain 3 of the following: number, uppercase letter, lowercase letter, and symbol
        """
        return pulumi.get(self, "enforce_strong_passwords")
    ...
    @property
    @pulumi.getter(name="enforceTwoFactorAuth")
    def enforce_two_factor_auth(self) -> pulumi.Output[bool]:
        """
        Boolean indicating whether users in this organization will be required to use an extra verification code when logging in to Dashboard. This code will be sent to their mobile phone via SMS, or can be generated by the authenticator application.
        """
        return pulumi.get(self, "enforce_two_factor_auth")
    ...
    @property
    @pulumi.getter(name="idleTimeoutMinutes")
    def idle_timeout_minutes(self) -> pulumi.Output[int]:
        """
        Number of minutes users can remain idle before being logged out of their accounts.
        """
        return pulumi.get(self, "idle_timeout_minutes")
    ...
    @property
    @pulumi.getter(name="loginIpRanges")
    def login_ip_ranges(self) -> pulumi.Output[Sequence[str]]:
        """
        List of acceptable IP ranges. Entries can be single IP addresses, IP address ranges, and CIDR subnets.
        """
        return pulumi.get(self, "login_ip_ranges")
    ...
    @property
    @pulumi.getter(name="numDifferentPasswords")
    def num_different_passwords(self) -> pulumi.Output[int]:
        """
        Number of recent passwords that new password must be distinct from.
        """
        return pulumi.get(self, "num_different_passwords")
    ...
    @property
    @pulumi.getter(name="passwordExpirationDays")
    def password_expiration_days(self) -> pulumi.Output[int]:
        """
        Number of days after which users will be forced to change their password.
        """
        return pulumi.get(self, "password_expiration_days")
