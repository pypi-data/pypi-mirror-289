...
class SwitchRoutingInterfacesDhcp(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 dhcp_lease_time: Optional[pulumi.Input[str]] = None,
                 dhcp_mode: Optional[pulumi.Input[str]] = None,
                 dhcp_options: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SwitchRoutingInterfacesDhcpDhcpOptionArgs']]]]] = None,
                 dhcp_relay_server_ips: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 dns_custom_nameservers: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 dns_nameservers_option: Optional[pulumi.Input[str]] = None,
                 fixed_ip_assignments: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SwitchRoutingInterfacesDhcpFixedIpAssignmentArgs']]]]] = None,
                 interface_id: Optional[pulumi.Input[str]] = None,
                 reserved_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SwitchRoutingInterfacesDhcpReservedIpRangeArgs']]]]] = None,
                 serial: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ## Example Usage
        ...
        :param pulumi.Input[str] dhcp_lease_time: The DHCP lease time config for the dhcp server running on the switch stack interface ('30 minutes', '1 hour', '4 hours', '12 hours', '1 day' or '1 week')
        :param pulumi.Input[str] dhcp_mode: The DHCP mode options for the switch stack interface ('dhcpDisabled', 'dhcpRelay' or 'dhcpServer')
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SwitchRoutingInterfacesDhcpDhcpOptionArgs']]]] dhcp_options: Array of DHCP options consisting of code, type and value for the DHCP server running on the switch stack interface
        :param pulumi.Input[Sequence[pulumi.Input[str]]] dhcp_relay_server_ips: The DHCP relay server IPs to which DHCP packets would get relayed for the switch stack interface
        :param pulumi.Input[Sequence[pulumi.Input[str]]] dns_custom_nameservers: The DHCP name server IPs when DHCP name server option is 'custom'
        :param pulumi.Input[str] dns_nameservers_option: The DHCP name server option for the dhcp server running on the switch stack interface ('googlePublicDns', 'openDns' or 'custom')
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SwitchRoutingInterfacesDhcpFixedIpAssignmentArgs']]]] fixed_ip_assignments: Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
        :param pulumi.Input[str] interface_id: interfaceId path parameter. Interface ID
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SwitchRoutingInterfacesDhcpReservedIpRangeArgs']]]] reserved_ip_ranges: Array of DHCP reserved IP assignments for the DHCP server running on the switch stack interface
        :param pulumi.Input[str] serial: serial path parameter.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            interface_id: Optional[pulumi.Input[str]] = None,
            reserved_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SwitchRoutingInterfacesDhcpReservedIpRangeArgs']]]]] = None,
            serial: Optional[pulumi.Input[str]] = None) -> 'SwitchRoutingInterfacesDhcp':
        """
