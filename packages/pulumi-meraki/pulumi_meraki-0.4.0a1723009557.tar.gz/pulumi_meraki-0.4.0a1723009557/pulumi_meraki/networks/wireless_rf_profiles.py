...
class WirelessRfProfilesArgs:
    ...
    def band_selection_type(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def band_selection_type(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "band_selection_type", value)

    @property
    @pulumi.getter(name="clientBalancingEnabled")
    def client_balancing_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def client_balancing_enabled(self, value: Optional[pulumi.Input[bool]]):
    ...
    def min_bitrate_type(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def min_bitrate_type(self, value: Optional[pulumi.Input[str]]):
...
class WirelessRfProfiles(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="bandSelectionType")
    def band_selection_type(self) -> pulumi.Output[str]:
        """
        Band selection can be set to either 'ssid' or 'ap'. This param is required on creation.
        """
        return pulumi.get(self, "band_selection_type")
    ...
    @property
    @pulumi.getter(name="clientBalancingEnabled")
    def client_balancing_enabled(self) -> pulumi.Output[bool]:
        """
        Steers client to best available access point. Can be either true or false. Defaults to true.
        """
        return pulumi.get(self, "client_balancing_enabled")
    ...
    @property
    @pulumi.getter(name="minBitrateType")
    def min_bitrate_type(self) -> pulumi.Output[str]:
        """
        Minimum bitrate can be set to either 'band' or 'ssid'. Defaults to band.
        """
        return pulumi.get(self, "min_bitrate_type")
