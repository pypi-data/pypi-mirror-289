...
class WirelessSettingsArgs:
    def __init__(__self__, *,
                 ...
                 ipv6_bridge_enabled: Optional[pulumi.Input[bool]] = None,
                 led_lights_on: Optional[pulumi.Input[bool]] = None,
                 location_analytics_enabled: Optional[pulumi.Input[bool]] = None,
                 meshing_enabled: Optional[pulumi.Input[bool]] = None,
                 named_vlans: Optional[pulumi.Input['WirelessSettingsNamedVlansArgs']] = None,
                 upgradestrategy: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a WirelessSettings resource.
        :param pulumi.Input[str] network_id: networkId path parameter. Network ID
        :param pulumi.Input[bool] ipv6_bridge_enabled: Toggle for enabling or disabling IPv6 bridging in a network (Note: if enabled, SSIDs must also be configured to use bridge mode)
        :param pulumi.Input[bool] led_lights_on: Toggle for enabling or disabling LED lights on all APs in the network (making them run dark)
        :param pulumi.Input[bool] location_analytics_enabled: Toggle for enabling or disabling location analytics for your network
        :param pulumi.Input[bool] meshing_enabled: Toggle for enabling or disabling meshing in a network
        :param pulumi.Input['WirelessSettingsNamedVlansArgs'] named_vlans: Named VLAN settings for wireless networks.
        :param pulumi.Input[str] upgradestrategy: The upgrade strategy to apply to the network. Must be one of 'minimizeUpgradeTime' or 'minimizeClientDowntime'. Requires firmware version MR 26.8 or higher'
        """
    ...
    def ipv6_bridge_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def ipv6_bridge_enabled(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "ipv6_bridge_enabled", value)

    @property
    @pulumi.getter(name="ledLightsOn")
    def led_lights_on(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def led_lights_on(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "led_lights_on", value)

    @property
    @pulumi.getter(name="locationAnalyticsEnabled")
    def location_analytics_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def location_analytics_enabled(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "location_analytics_enabled", value)

    @property
    @pulumi.getter(name="meshingEnabled")
    def meshing_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def meshing_enabled(self, value: Optional[pulumi.Input[bool]]):
    ...
    @property
    @pulumi.getter
    def upgradestrategy(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def upgradestrategy(self, value: Optional[pulumi.Input[str]]):
...
class WirelessSettings(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location_analytics_enabled: Optional[pulumi.Input[bool]] = None,
                 meshing_enabled: Optional[pulumi.Input[bool]] = None,
                 named_vlans: Optional[pulumi.Input[pulumi.InputType['WirelessSettingsNamedVlansArgs']]] = None,
                 network_id: Optional[pulumi.Input[str]] = None,
                 upgradestrategy: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[bool] location_analytics_enabled: Toggle for enabling or disabling location analytics for your network
        :param pulumi.Input[bool] meshing_enabled: Toggle for enabling or disabling meshing in a network
        :param pulumi.Input[pulumi.InputType['WirelessSettingsNamedVlansArgs']] named_vlans: Named VLAN settings for wireless networks.
        :param pulumi.Input[str] network_id: networkId path parameter. Network ID
        :param pulumi.Input[str] upgradestrategy: The upgrade strategy to apply to the network. Must be one of 'minimizeUpgradeTime' or 'minimizeClientDowntime'. Requires firmware version MR 26.8 or higher'
        """
        ...
    ...
    def get(resource_name: str,
            ...
            named_vlans: Optional[pulumi.Input[pulumi.InputType['WirelessSettingsNamedVlansArgs']]] = None,
            network_id: Optional[pulumi.Input[str]] = None,
            regulatory_domain: Optional[pulumi.Input[pulumi.InputType['WirelessSettingsRegulatoryDomainArgs']]] = None,
            upgradestrategy: Optional[pulumi.Input[str]] = None) -> 'WirelessSettings':
        """
        ...
        :param pulumi.Input[pulumi.InputType['WirelessSettingsNamedVlansArgs']] named_vlans: Named VLAN settings for wireless networks.
        :param pulumi.Input[str] network_id: networkId path parameter. Network ID
        :param pulumi.Input[pulumi.InputType['WirelessSettingsRegulatoryDomainArgs']] regulatory_domain: Regulatory domain information for this network.
        :param pulumi.Input[str] upgradestrategy: The upgrade strategy to apply to the network. Must be one of 'minimizeUpgradeTime' or 'minimizeClientDowntime'. Requires firmware version MR 26.8 or higher'
        """
    ...
    @property
    @pulumi.getter(name="ipv6BridgeEnabled")
    def ipv6_bridge_enabled(self) -> pulumi.Output[bool]:
        """
        Toggle for enabling or disabling IPv6 bridging in a network (Note: if enabled, SSIDs must also be configured to use bridge mode)
        """
        return pulumi.get(self, "ipv6_bridge_enabled")
    ...
    @property
    @pulumi.getter(name="ledLightsOn")
    def led_lights_on(self) -> pulumi.Output[bool]:
        """
        Toggle for enabling or disabling LED lights on all APs in the network (making them run dark)
        """
        return pulumi.get(self, "led_lights_on")
    ...
    @property
    @pulumi.getter(name="locationAnalyticsEnabled")
    def location_analytics_enabled(self) -> pulumi.Output[bool]:
        """
        Toggle for enabling or disabling location analytics for your network
        """
        return pulumi.get(self, "location_analytics_enabled")
    ...
    @property
    @pulumi.getter(name="meshingEnabled")
    def meshing_enabled(self) -> pulumi.Output[bool]:
        """
        Toggle for enabling or disabling meshing in a network
        """
        return pulumi.get(self, "meshing_enabled")
    ...
    @property
    @pulumi.getter
    def upgradestrategy(self) -> pulumi.Output[str]:
        """
        The upgrade strategy to apply to the network. Must be one of 'minimizeUpgradeTime' or 'minimizeClientDowntime'. Requires firmware version MR 26.8 or higher'
        """
        return pulumi.get(self, "upgradestrategy")
