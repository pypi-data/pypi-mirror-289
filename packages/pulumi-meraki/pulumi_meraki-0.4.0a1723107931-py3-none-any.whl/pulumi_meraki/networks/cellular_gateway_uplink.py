...
class CellularGatewayUplink(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bandwidth_limits: Optional[pulumi.Input[pulumi.InputType['CellularGatewayUplinkBandwidthLimitsArgs']]] = None,
                 network_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ## Example Usage
        ...
        :param pulumi.Input[pulumi.InputType['CellularGatewayUplinkBandwidthLimitsArgs']] bandwidth_limits: The bandwidth settings for the 'cellular' uplink
        :param pulumi.Input[str] network_id: networkId path parameter. Network ID
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            bandwidth_limits: Optional[pulumi.Input[pulumi.InputType['CellularGatewayUplinkBandwidthLimitsArgs']]] = None,
            network_id: Optional[pulumi.Input[str]] = None) -> 'CellularGatewayUplink':
        """
