...
def create_parser(subparsers):
    ...
    parent_parser = create_parser.add_subparsers(dest="parent_classifier", help="Classifier of a parent artefact")
    for classifier in Classifier.ordered_classifiers():
        classifier_parser = parent_parser.add_parser(classifier)
        classifier_parser.add_argument("parent_name", help="Name of a parent artefact").completer = ParentCompleter()

    create_parser.add_argument(
        "-a", "--aspect",
        choices=["customer", "persona", "concept", "technology", "step"],
