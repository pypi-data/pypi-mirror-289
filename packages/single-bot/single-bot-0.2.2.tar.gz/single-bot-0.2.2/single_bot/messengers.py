    ...
    def _create_dispatcher(self):
        ...
        async def message_handler(message: Message):
            ...
            def get_message_content():
                ...
                if message.voice:
                    content.append({"type": "voice", "content": message.voice.model_dump()})
                if message.video:
                    content.append({"type": "video", "content": message.video.model_dump()})
                if message.document:
                    content.append({"type": "document", "content": message.document.model_dump()})
                if message.audio:
                    content.append({"type": "audio", "content": message.audio.model_dump()})
                if message.caption:
            ...
            request = {
                ...
                "message": {"text": message.text , "content": get_message_content()},
            }
