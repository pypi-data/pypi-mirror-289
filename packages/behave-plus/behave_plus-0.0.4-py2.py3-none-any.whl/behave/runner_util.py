...
# FUNCTIONS:
# -----------------------------------------------------------------------------
def parse_features(feature_files, language=None, job_language=None):
    """
    ...
    :param job_language:      Default job language to use.
    ...
    for location in feature_files:
        ...
        feature = parser.parse_file(filename, language=language, job_language=job_language)
        if feature:
            # -- VALID FEATURE:
