...
import re, warnings as wa, inspect
...
_T_coroutine = _var("_T_coroutine", bound = tcs.Callable[..., Coroutine[Any, Any, list[AppCommand]]])

_DiscordHandler = tcs.Union[Interaction[Client], Message] # since 0.3.24
...
class Fencord:
    ...
    @staticmethod
    def returnName(handler: _DiscordHandler, /, target: tcs.Optional[Member] = None, mention: tcs.Optional[bool] = None, name: tcs.Optional[bool] = None):
        """
        \\@since 0.3.24 \\
        \\@author Aveyzan
        ```ts \\
    ...
    @staticmethod
    def commandInvoked(name: str, author: tcs.Union[Interaction, Message], /, parameters: tcs.Optional[dict[str, str]] = None, error: tcs.Optional[str] = None):
        """
        \\@since 0.3.24 \\
        \\@author Aveyzan
        ```ts \\
...
#            return _decorator
    ...
    def sync(self, server: tcs.Optional[Snowflake] = None):
        """
        \\@since 0.3.25 \\
        \\@author Aveyzan
        ```ts \\
