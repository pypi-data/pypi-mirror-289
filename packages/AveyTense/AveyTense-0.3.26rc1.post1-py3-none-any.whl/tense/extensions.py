...
import warnings, uuid, random as ra, re, tense.tcs as tcs, tense.primary as t, math as m
from tense.primary import abroad, reckon
...
_AbroadValue1 = _uni[tcs.AbroadValue1[_T], t.ModernString]
_AbroadValue2 = _uni[tcs.AbroadValue2[_T], t.ModernString]
_AbroadModifier = _uni[tcs.AbroadModifier[_T], t.ModernString]
...
class NennɅIAbroads:
    ...
    def abroadConvect(self, *values: _AbroadConvectType[_T]) -> _AbroadInitializer:
        ...
        if reckon(values) == 0:
            ...
            raise err(s)
        for e in values:
            if not isinstance(e, (_ReckonNGT, int, float, complex, t.ModernString)):
...
class NennɅIStringz:
    ...
    def sanitize(self, string: str, /, mode = 0):
        ...
        if not isinstance(string, str):
            ...
            raise err(s)
        elif not isinstance(mode, t.TenseType):
            err = TypeError
