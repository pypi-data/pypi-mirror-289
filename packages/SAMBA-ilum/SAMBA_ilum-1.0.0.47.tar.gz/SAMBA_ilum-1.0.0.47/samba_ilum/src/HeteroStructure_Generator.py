...
for k in range(n_Lattice):
    ...
    for i in range(len(VTemp0)):
        temp_formula += str(VTemp0[i]) + str(VTemp1[i])
    formula.append(temp_stoichiometry) 
    #---------------------------------
...
for i in range(len(formula)):
    ...
    if (i < (len(formula) -1)): formula_bilayer += '_'
...
if (n_structures != 0):
   ...
   for i in range(n_structures):
       ...
       # poscar_new.write(f'\n')
       #-----------------------------------------------------------------------------
       poscar_new.write(f'SAMBA {n_Lattice}L/{formula_bilayer}/{nions_1}_{nions_2}')
       if (n_Lattice == 3):  poscar_new.write(f'_{nions_3}')
       poscar_new.write(f'/{mismatch_12[i]}_{angle1}')
       if (n_Lattice == 3):  poscar_new.write(f'/{mismatch_13[i]}_{angle3}')
       poscar_new.write(f'/{unique_id} \n')
       #-----------------------------------
