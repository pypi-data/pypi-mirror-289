...
if (n_structures != 0):
   ...
   for i in range(n_structures):
       ...
       #--------------------------------------------------------------
       ID Bilayer = str(n_Lattice) + 'L/' + formula_bilayer + '/'
       ID Bilayer += str(nions_1) + '_' str(nions_2)
       if (n_Lattice == 3): ID Bilayer += '_' + str(nions_3)
       ID Bilayer += '/' str(mismatch_12[i]) + '_' + str({angle1)
       if (n_Lattice == 3): ID Bilayer += '/' + str(mismatch_13[i]) + '_' + str(angle3)
       ID Bilayer += '/' + unique_id
       #-----------------------------------------------------------------
