...
for k in range(n_Lattice):
    ...
    #==========================================================================
    # Gerando ID de identificação dos arquivos POSCAR (caso não possuam) ======
    #==========================================================================

    #=========================================================
    poscar = open(diret + 'temp0_' + label + '_temp.vasp', "r")
    ...
    if (VTemp[0] != 'SAMBA'):
       ...
       for i in range(len(VTemp0)):
           temp_r += str(VTemp0[i])
           if (i < len(VTemp0)-1): temp_r += '+'
       #----------------------------------------
       temp_ni = ' '
       VTemp1 = poscar.readline().split()
       for i in range(len(VTemp1)):
           temp_ni += str(VTemp1[i]) + ' '
       #----------------------------------
       poscar.close()
       #-------------

       # ============================================================
       # Gerando a formula química da Rede ==========================
       # ============================================================
       formula_quimica = ''
       #---------------------------
       for i in range(len(VTemp0)):
           formula_quimica += str(VTemp0[i]) + str(VTemp1[i])

       # ============================================================
       # Gerando a ID ===============================================
       # ============================================================
       replace_line = 'SAMBA ' + temp_r + temp_ni + '1L/' + formula_quimica + '/' + unique_id + '\n'

       #==================================================================================
       with open(diret + 'temp0_' + label + '.vasp', 'r') as file: line = file.readlines()
       line[0] = replace_line
       with open(diret + 'temp0_' + label + '.vasp', 'w') as file: file.writelines(line)
       #================================================================================
