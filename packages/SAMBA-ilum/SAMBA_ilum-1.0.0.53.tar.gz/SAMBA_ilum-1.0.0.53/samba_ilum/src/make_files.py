...
for i in range(len(files)):
    ...
    for j in range(len(task)):
        ...
        if (task[j][:5] != 'bader'):
           #------------------------
           shutil.copyfile(dir_inputs + '/INCAR_' + task[j],  dir_out + '/' + files[i] + '/' + task[j] + '/INCAR')
           #---------------------------------
           ...
           #===============================================================
           with open( dir_out + '/' + files[i] + '/' + task[j] + '/INCAR', "r") as file:  content = file.read()
           ...
           with open( dir_out + '/' + files[i] + '/' + task[j] + '/INCAR', "w") as file: file.write(content)
        ...
        if (task[j][:5] == 'bader'):
           ...
           for k in range(len(files2)):
              if (files2[k] != 'Charge_transfer'):
                 ...
                 #------------------------------------------------------------------------------------------------------------------------
                 shutil.copyfile(dir_inputs + '/INCAR_' + task[j],  dir_out + '/' + files[i] + '/' + task[j] + '/' + files2[k] + '/INCAR')
                 ...
                 # Atualizando o arquivo INCAR -------------------------------
                 #------------------------------------------------------------
                 with open(dir_out + '/' + files[i] + '/' + task[j] + '/' + files2[k] + '/INCAR', "r") as file:  content = file.read()
                 content = content.replace('replace_encut', str(ENCUT))
                 content = content.replace('replace_lreal', str(lreal))
                 content = content.replace('replace_vdW', str(vdW))
                 content = content.replace('# AMIN', str(amin))
