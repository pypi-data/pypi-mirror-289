...
for i in range(len(files)):
    ...
    new_name = diret2 + '/' +  n_ion + '_' + VTemp1[0] + '_' + VTemp1[1] + '_' + VTemp1[-1] + '_' + number
    os.rename(current_name, new_name)

    #------------------------------------------
    poscar = open(diret2 + '/' + new_name, "r")
    VTemp = poscar.readline()
    poscar.close()
    #=-----------------------------------------
    with open(diret2 + '/' + new_name, 'r') as file: line = file.readlines()
    line[0] = VTemp + '_' + number
    with open(diret2 + '/' + new_name, 'w') as file: file.writelines(line)
    #=--------------------------------------------------------------------
