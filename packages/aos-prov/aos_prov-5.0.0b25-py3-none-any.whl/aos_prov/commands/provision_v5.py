...
from aos_prov.utils.common import generate_random_password, print_message, print_error
from aos_prov.utils.config import Config


def run_provision_v5(config: Config, unit_address: str, cloud_api: CloudAPI, nodes_count = 2):
    unit_communication = UnitCommunicationV5(unit_address)

    if nodes_count > 4:
        print_error('Supports maximum only 4 nodes. Process 4 nodes...')
        nodes_count = 4
