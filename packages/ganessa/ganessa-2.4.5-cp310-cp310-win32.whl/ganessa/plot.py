...
def plotmesx(mes, symbattr: str, nlx: int = 6, ncx: int = 4, cmt: str = '', fgname: str = None,
            inter: bool = True, orient: Literal['h', 'v', ''] = '', xkcd: bool = False) -> None:
    ...
    if nf == 1:
        plotmes(mes, symbattr, nl, nc, cmt, fgni, inter, orient, prefix, xkcd)
        return
    for i in range(nf):
        si = '_' + str(i+1)
        if fgname:
        ...
        plotmes(mes[i*nl*nc:(i+1)*nl*nc], symbattr, nl, nc, cmt=cmt + si,
                fgname=fgni, inter=inter, orient=orient, prefix_title=prefix, xkcd=xkcd)
...
def plotmes(mes, symbattr: str, nl: int = 3, nc: int = 2, cmt: str = '', fgname: str = None,
            ...
            prefix_title: str = '', xkcd: bool = False) -> None:
