    ...
    def create(
        ...
        *,
        ...
        if not server_side_inference:
            ...
            if stream:
                return _process_openai_stream(session_id, reference_id, intent, application_ref_name, messages, response, evaluation_enabled, completion_params, timing, callback)
            else:
                timing.time_request_end = time.time()
