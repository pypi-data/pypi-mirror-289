...
class Algo:
    ...
    def __init__(self, name: str):
        ...
        algo = ik_registry.create_algorithm(name=name, public_hub=False, private_hub=False)
        if algo is None:
    ...
    def _get_compatible_os_list(self) -> List[str]:
        ...
        if self._info.os == ikomia.utils.OSType.WIN:
            return ["WINDOWS"]
        if self._info.os == ikomia.utils.OSType.LINUX:
            return ["LINUX"]
        return []
