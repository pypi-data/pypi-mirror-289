...
IPP_DEPRECATED("is deprecated. All functions in the ippCH domain are obsolete and will be removed in one of the future Intel IPP releases. Use the following link for opening a ticket and providing feedback: https://supporttickets.intel.com/ if you have concerns.")\
