...
def signal_strength(image, position, size=50, color=WIDGET_DEFAULT_COLOR, percentage=100, value = 0.0, title=""):
    """
    by AI:
    """
    ratio = 2.33
    ...
    cv2.line(image, bottom_left, bottom_right, WIDGET_DEFAULT_GREEN, 1)
    cv2.line(image, bottom_right, top_right, WIDGET_DEFAULT_GREEN, 1)
   ...
   # print( bottom_right, " /// ", top_right )
    ...
    if fill_level > 0:
        ...
        cv2.fillPoly(image, [pts], WIDGET_DEFAULT_GREEN )
