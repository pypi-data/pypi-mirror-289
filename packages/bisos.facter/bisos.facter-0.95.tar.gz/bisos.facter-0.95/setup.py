...
#
####+BEGIN: b:py3:pypi/nextVersion :increment "0.01"  :curDevVer "0.92" :pypiNextVer "0.95"

# ./pypiUploadVer exists -- pypiNextVer=0.95 -- installedVersion=nil
def pkgVersion():
        return '0.95'   # Version Nu To Be Uploaded
