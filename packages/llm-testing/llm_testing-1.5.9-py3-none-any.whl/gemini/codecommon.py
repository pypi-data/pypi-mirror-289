...
class CodeGenerator(ABC):
    ...
    def generate_response_from_file(self, file_path: str) -> str:
        with open(file_path, 'r') as file:
            file_content = file.read()

        prompt = (
            f"Please generate a response based on the content of the following file:\n\n"
            f"{file_content}\n\n"
        )
        ...
        self.log_text(f"File: {file_path}", content)
