...
def clearScene() -> None:
    ...
    """
def getSelectedDistanceMaps() -> meshlib.mrmeshpy.vectorDistanceMap:
    """
    Get copies of all selected voxel grids in the scene.
    """
def getSelectedMeshEdges() -> meshlib.mrmeshpy.vectorUndirectedEdgeBitSet:
    """
    Get selected edge bitsets of the selected mesh objects.
    """
def getSelectedMeshFaces() -> meshlib.mrmeshpy.vectorFaceBitSet:
    """
...
def getSelectedMeshes() -> meshlib.mrmeshpy.vectorMesh:
    ...
    """
def getSelectedObjects() -> meshlib.mrmeshpy.vectorSceneObject:
    ...
def getSelectedPointCloudPoints() -> meshlib.mrmeshpy.vectorVertBitSet:
    """
    Get selected point bitsets of the selected point cloud objects.
    """
def getSelectedPointClouds() -> meshlib.mrmeshpy.vectorPointCloud:
    """
    Get copies of all selected point clouds in the scene.
    """
def getSelectedPolylines() -> meshlib.mrmeshpy.vectorPolyline3:
    """
    Get copies of all selected polylines in the scene.
    """
def getSelectedVoxels() -> meshlib.mrmeshpy.vectorVdbVolume:
    """
    Get copies of all selected voxel grids in the scene.
    """
...
def selectByType(typeName: str) -> None:
    ...
    """
def setSelectedMeshEdges(arg0: meshlib.mrmeshpy.vectorUndirectedEdgeBitSet) -> None:
    """
    Set selected edge bitsets of the selected mesh objects.
    """
def setSelectedMeshFaces(arg0: meshlib.mrmeshpy.vectorFaceBitSet) -> None:
    """
    Set selected face bitsets of the selected mesh objects.
    """
def setSelectedPointCloudPoints(arg0: meshlib.mrmeshpy.vectorVertBitSet) -> None:
    """
