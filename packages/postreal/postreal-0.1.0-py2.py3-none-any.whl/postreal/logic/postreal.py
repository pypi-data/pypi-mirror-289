...
# models / mappers
# ---------------------------------------------------------
# from ..models.postreal import PostrealApp
# from .. import mappers
...
class PostrealCrawler(AsyncCrawler):
    "Example class for Postreal crawler"
    MODEL = PostrealApp
    ...
    async def get_data(self, kind, path, **kwargs):
        """
        Example a crawling function for Postreal crawler.
