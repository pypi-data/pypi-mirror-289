...
from postreal.models.script import PostrealScript as Item
from postreal.models.script import PostrealScriptRequest as Request
from postreal.models.script import PostrealScriptResponse as Response
...
@click.pass_obj
def script(env):
    """subcommands for managing scripts for postreal"""
...
@click.pass_obj
def create(env, path):
    """Create a new script for postreal"""
...
@click.pass_obj
def read(env):
    """Find and list existing scripts for postreal"""
    # force config loading
    config.callback()
...
@click.pass_obj
def update(env):
    """Update and existing scripts for postreal"""
    # force config loading
    config.callback()
...
@click.pass_obj
def delete(env):
    """Delete an existing scripts for postreal"""
    # force config loading
    config.callback()
