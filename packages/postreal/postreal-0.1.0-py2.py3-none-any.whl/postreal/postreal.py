...
for port in ACTIVE_PORTS:
    prefix= "/".join(["", "postreal", port.__name__.split('.')[-1]])
...
if __name__ == "__main__":
    """
    $ uvicorn postreal.postreal:app --reload --reload-delay 1 --reload-dir ~/your/code/postreal --reload-exclude 'venv' --loop uvloop
    """
