"""
This file supports Base Items Pattern for postreal
"""
...
class Item(BaseModel):
    ...
    id: UID_TYPE = Field(
        "101_postreal",
        description="postreal unique identifier",
        examples=[
    ...
    name: str | None = Field(
        "postreal no name",
        description="postreal name",
        examples=[
            "nice-item",
        ],
    )
    description: str | None = Field(
        "a nice postreal object",
        description="postreal human more descriptive name",
        examples=[
            "A Nice Item",
        ],
    )
