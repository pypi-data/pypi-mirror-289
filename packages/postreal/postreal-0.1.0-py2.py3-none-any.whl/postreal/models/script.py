"""
This file supports Script Pattern for postreal
"""
...
# ScriptItem
# ---------------------------------------------------------
class PostrealScript(Item):
    """A Postreal Script model"""
    pass
...
# ScriptRequest
# ---------------------------------------------------------
class PostrealScriptRequest(Request):
    
    """A Postreal request to Script manager.
...
# ScriptResponse
# ---------------------------------------------------------
class PostrealScriptResponse(Response):
    
    """A Postreal response to Script manager.
    Contains the search results given by a request.
    """
    data: Dict[UID_TYPE, PostrealScript] = {}
