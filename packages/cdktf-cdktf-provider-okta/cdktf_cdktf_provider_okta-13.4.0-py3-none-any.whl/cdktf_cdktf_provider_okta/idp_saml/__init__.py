...
class IdpSaml(
    ...
    def __init__(
        ...
        *,
        ...
        :param issuer: URI that identifies the issuer. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#issuer IdpSaml#issuer}
        :param kid: The ID of the signing key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#kid IdpSaml#kid}
        :param name: Name of the IdP. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#name IdpSaml#name}
        :param sso_url: URL of binding-specific endpoint to send an AuthnRequest message to IdP. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#sso_url IdpSaml#sso_url}
        :param account_link_action: Specifies the account linking action for an IdP user. Default: ``AUTO``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#account_link_action IdpSaml#account_link_action}
        :param account_link_group_include: Group memberships to determine link candidates. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#account_link_group_include IdpSaml#account_link_group_include}
        :param acs_type: The type of ACS. It can be ``INSTANCE`` or ``ORG``. Default: ``INSTANCE``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#acs_type IdpSaml#acs_type}
        :param deprovisioned_action: Action for a previously deprovisioned IdP user during authentication. Can be ``NONE`` or ``REACTIVATE``. Default: ``NONE``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#deprovisioned_action IdpSaml#deprovisioned_action}
        :param groups_action: Provisioning action for IdP user's group memberships. It can be ``NONE``, ``SYNC``, ``APPEND``, or ``ASSIGN``. Default: ``NONE``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#groups_action IdpSaml#groups_action}
        :param groups_assignment: List of Okta Group IDs to add an IdP user as a member with the ``ASSIGN`` ``groups_action``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#groups_assignment IdpSaml#groups_assignment}
        :param groups_attribute: IdP user profile attribute name (case-insensitive) for an array value that contains group memberships. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#groups_attribute IdpSaml#groups_attribute}
        :param groups_filter: Whitelist of Okta Group identifiers that are allowed for the ``APPEND`` or ``SYNC`` ``groups_action``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#groups_filter IdpSaml#groups_filter}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#id IdpSaml#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param issuer_mode: Indicates whether Okta uses the original Okta org domain URL, or a custom domain URL. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#issuer_mode IdpSaml#issuer_mode}
        :param max_clock_skew: Maximum allowable clock-skew when processing messages from the IdP. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#max_clock_skew IdpSaml#max_clock_skew}
        :param name_format: The name identifier format to use. By default ``urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#name_format IdpSaml#name_format}
        :param profile_master: Determines if the IdP should act as a source of truth for user profile attributes. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#profile_master IdpSaml#profile_master}
        :param provisioning_action: Provisioning action for an IdP user during authentication. Default: ``AUTO``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#provisioning_action IdpSaml#provisioning_action}
        :param request_signature_algorithm: The XML digital Signature Algorithm used when signing an ``AuthnRequest`` message. It can be ``SHA-256`` or ``SHA-1``. Default: ``SHA-256``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#request_signature_algorithm IdpSaml#request_signature_algorithm}
        ...
        :param response_signature_algorithm: The minimum XML digital signature algorithm allowed when verifying a ``SAMLResponse`` message or Assertion element. It can be ``SHA-256`` or ``SHA-1``. Default: ``SHA-256`` Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#response_signature_algorithm IdpSaml#response_signature_algorithm}
        :param response_signature_scope: Specifies whether to verify a ``SAMLResponse`` message or Assertion element XML digital signature. It can be ``RESPONSE``, ``ASSERTION``, or ``ANY``. Default: ``ANY`` Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#response_signature_scope IdpSaml#response_signature_scope}
        :param sso_binding: The method of making an SSO request. It can be set to ``HTTP-POST`` or ``HTTP-REDIRECT``. Default: ``HTTP-POST``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#sso_binding IdpSaml#sso_binding}
        :param sso_destination: URI reference indicating the address to which the AuthnRequest message is sent. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#sso_destination IdpSaml#sso_destination}
        :param status: Default to ``ACTIVE``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#status IdpSaml#status}
        :param subject_filter: Optional regular expression pattern used to filter untrusted IdP usernames. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#subject_filter IdpSaml#subject_filter}
        :param subject_format: The name format. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#subject_format IdpSaml#subject_format}
        :param subject_match_attribute: Okta user profile attribute for matching transformed IdP username. Only for matchType ``CUSTOM_ATTRIBUTE``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#subject_match_attribute IdpSaml#subject_match_attribute}
        :param subject_match_type: Determines the Okta user profile attribute match conditions for account linking and authentication of the transformed IdP username. By default, it is set to ``USERNAME``. It can be set to ``USERNAME``, ``EMAIL``, ``USERNAME_OR_EMAIL`` or ``CUSTOM_ATTRIBUTE``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#subject_match_type IdpSaml#subject_match_type}
        :param suspended_action: Action for a previously suspended IdP user during authentication. Can be ``NONE`` or ``REACTIVATE``. Default: ``NONE``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#suspended_action IdpSaml#suspended_action}
        :param username_template: Okta EL Expression to generate or transform a unique username for the IdP user. Default: ``idpuser.email``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#username_template IdpSaml#username_template}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing IdpSaml that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.10.0/docs/resources/idp_saml#import import section} in the documentation of this resource for the id to use
