# CDKTF prebuilt bindings for okta/okta provider version 4.10.0

This repo builds and publishes the [Terraform okta provider](https://registry.terraform.io/providers/okta/okta/4.10.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform okta provider](https://registry.terraform.io/providers/okta/okta/4.10.0)
