...
import pytest
from dccXMLJSONConv.dccConv import dcc
...
"""
def testXMLFielListWithSpacesAtTheBEginning():
    data_dir = os.path.join(os.path.dirname(__file__), '/home/seeger01/repos/1_7calibrationanddccsampledata/AndereScheine/grabbedFiles/downloads/DKD-Akustik-DCC/')
    xml_file_path = os.path.join(data_dir, '4180_2583081_XMLList_GP.xml')
    # Read the XML file
    with open(xml_file_path, 'r') as xml_file:
        xml_data = xml_file.read()
    dict=XMLToJson(str(xml_data))
