...
"""
    ...
    _type = 'Route'
    @_explicitize_args
    def __init__(self, children=None, label=Component.REQUIRED, icon=Component.UNDEFINED, caseSensitive=Component.UNDEFINED, path=Component.UNDEFINED, id=Component.UNDEFINED, lazy=Component.UNDEFINED, loader=Component.UNDEFINED, action=Component.UNDEFINED, hasErrorBoundary=Component.UNDEFINED, shouldRevalidate=Component.UNDEFINED, handle=Component.UNDEFINED, index=Component.UNDEFINED, element=Component.UNDEFINED, hydrateFallbackElement=Component.UNDEFINED, errorElement=Component.UNDEFINED, Component=Component.UNDEFINED, HydrateFallback=Component.UNDEFINED, ErrorBoundary=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'Component', 'ErrorBoundary', 'HydrateFallback', 'action', 'caseSensitive', 'element', 'errorElement', 'handle', 'hasErrorBoundary', 'hydrateFallbackElement', 'icon', 'index', 'label', 'lazy', 'loader', 'path', 'shouldRevalidate']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'Component', 'ErrorBoundary', 'HydrateFallback', 'action', 'caseSensitive', 'element', 'errorElement', 'handle', 'hasErrorBoundary', 'hydrateFallbackElement', 'icon', 'index', 'label', 'lazy', 'loader', 'path', 'shouldRevalidate']
        ...
        super(Route, self).__init__(children=children, **args)
