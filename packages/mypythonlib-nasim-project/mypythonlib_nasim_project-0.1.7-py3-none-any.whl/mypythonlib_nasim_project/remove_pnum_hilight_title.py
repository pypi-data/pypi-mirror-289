...
def process_text_file(input_file_path, output_file_path, phrases, titles):
...
def process_directory(input_directory, output_directory, phrases, titles):
    print("Hello World")
    ...
    for file_name in os.listdir(input_directory):
        if file_name.endswith('.txt'):
            ...
            process_text_file(input_file_path, output_file_path, phrases, titles)
            print(f"Processed file saved as {output_file_path}")

if __name__ == "__main__":
    input_directory = os.path.join(current_file_path, "txt_processed/0-main_txt")
    output_directory = os.path.join(current_file_path, "txt_processed/1-page_nb_cln")
    ...
    process_directory(input_directory, output_directory, phrases_to_remove, titles_to_mark)
