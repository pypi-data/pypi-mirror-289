...
class TestHelixDAMUpload:
    def test_upload_file(self, hd: HelixDAM, valid_depot_path_with_preview: str):
        img_bytes = hd.download_preview(
            depot_path=valid_depot_path_with_preview,
        )

        assert img_bytes is not None
        assert len(img_bytes) > 1024
        ...
        img_bytes_2 = hd.download_preview(
            depot_path=valid_depot_path_with_preview,
        )
        assert img_bytes == img_bytes_2
