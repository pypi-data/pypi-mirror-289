...
class IX509CertificatePem(_constructs_77d1e7e8.IConstruct, typing_extensions.Protocol):
    ...
    def cert(self) -> _aws_cdk_aws_secretsmanager_ceddda9d.ISecret:
        '''The public certificate chain for this X.509 Certificate encoded in {@link https://en.wikipedia.org/wiki/Privacy-Enhanced_MailPEM format}. The text of the chain is stored in the 'SecretString' of the given secret. To extract the public certificate simply copy the contents of the SecretString to a file.'''
        ...

    @builtins.property
    @jsii.member(jsii_name="key")
    def key(self) -> _aws_cdk_aws_secretsmanager_ceddda9d.ISecret:
        '''The private key for this X509Certificate encoded in {@link https://en.wikipedia.org/wiki/Privacy-Enhanced_MailPEM format}. The text of the key is stored in the 'SecretString' of the given secret. To extract the public certificate simply copy the contents of the SecretString to a file.
...
class MountableBlockVolume(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        :param scope: -
        :param block_volume: The {@link https://docs.aws.amazon.com/cdk/api/latest/docs/@aws-cdk_aws-ec2.Volume.htmlEBS Block Volume} that will be mounted by this object.
...
class MountableBlockVolumeProps:
    ...
    def block_volume(self) -> _aws_cdk_aws_ec2_ceddda9d.IVolume:
        '''The {@link https://docs.aws.amazon.com/cdk/api/latest/docs/@aws-cdk_aws-ec2.Volume.htmlEBS Block Volume} that will be mounted by this object.'''
...
class MountableEfs(metaclass=jsii.JSIIMeta, jsii_type="aws-rfdk.MountableEfs"):
    ...
    def __init__(
        ...
        *,
        ...
        '''
        :param scope: -
        :param filesystem: The {@link https://docs.aws.amazon.com/cdk/api/latest/docs/@aws-cdk_aws-efs.FileSystem.htmlEFS} filesystem that will be mounted by the object.
...
class MountableEfsProps:
    ...
    def filesystem(self) -> _aws_cdk_aws_efs_ceddda9d.IFileSystem:
        '''The {@link https://docs.aws.amazon.com/cdk/api/latest/docs/@aws-cdk_aws-efs.FileSystem.htmlEFS} filesystem that will be mounted by the object.'''
...
class MountableFsxLustre(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        :param scope: -
        :param filesystem: The {@link https://docs.aws.amazon.com/cdk/api/latest/docs/@aws-cdk_aws-fsx.LustreFileSystem.htmlFSx for Lustre} filesystem that will be mounted by the object.
...
class MountableFsxLustreProps:
    ...
    def filesystem(self) -> _aws_cdk_aws_fsx_ceddda9d.LustreFileSystem:
        '''The {@link https://docs.aws.amazon.com/cdk/api/latest/docs/@aws-cdk_aws-fsx.LustreFileSystem.htmlFSx for Lustre} filesystem that will be mounted by the object.'''
        result = self._values.get("filesystem")
        assert result is not None, "Required property 'filesystem' is missing"
...
class IMountingInstance(
    ...
    {@link https://docs.aws.amazon.com/cdk/api/latest/docs/@aws-cdk_aws-ec2.Instance.htmlEC2 Instance}
    or an {@link https://docs.aws.amazon.com/cdk/api/latest/docs/@aws-cdk_aws-autoscaling.AutoScalingGroup.htmlEC2 Auto Scaling Group}
    '''
