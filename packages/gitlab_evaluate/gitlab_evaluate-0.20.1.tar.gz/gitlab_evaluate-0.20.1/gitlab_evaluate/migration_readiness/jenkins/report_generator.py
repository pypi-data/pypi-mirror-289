...
class ReportGenerator():
    ...
    def get_raw_data(self):
        ...
        '''
        job_data = []
        for job in self.jenkins_client.list_of_jobs():
            job_name = job['name']
            job_history = self.jenkins_client.get_job_history(job_name)
            ...
            resource_usage = self.jenkins_client.get_resource_usage(job_name)
