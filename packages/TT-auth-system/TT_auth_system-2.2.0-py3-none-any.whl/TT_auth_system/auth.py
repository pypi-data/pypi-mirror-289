...
class OTCAuthSystem:
    ...
    def validate_code_and_generate_cookie(self, code: str) -> Optional[Tuple[str, str]]:
        ...
        if code_entry:
            ...
            cookie['auth_token']['max-age'] = 12 * 3600  # 12 hours in seconds
    ...
    def add_user(self, first_name: str, last_name: Optional[str], email_address: str, authorized_flag: bool = False, admin_flag: bool = False) -> bool:
