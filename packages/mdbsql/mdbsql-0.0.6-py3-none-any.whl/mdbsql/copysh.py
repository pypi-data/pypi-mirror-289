...
class TbFiles:
    ...
    def __init__(self):
        ...
        self.path1 = os.path.join(top_path, 'support', 'tb_list.txt')
        self.path2 = os.path.join(top_path, 'support', 'cp_list.txt')
        self.d_path = None
        self.data_path = None
        self.share_path = None
        self.before_max_time = None
    ...
    def tb_file(self):
        ...
        if self.before_max_time and now_max_time <= self.before_max_time:
            return
        else:
            self.before_max_time = now_max_time
