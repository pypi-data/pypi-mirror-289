...
class SoilMoisture:
    ...
    def smap_data_using_gee(region, start_date=None, end_date=None, how='max', bands=("sm_surface",), no_of_days=5) -> GEEImage:
        ...
        """
        if end_date is None:
            date_range = GEEImageCollection.get_date_range(no_of_days=no_of_days)
        elif start_date is None:
            date_range = GEEImageCollection.get_date_range(no_of_days=no_of_days, end_date=end_date)
        else:
