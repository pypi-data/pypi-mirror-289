...
# Aufgabe sind 5 unterschiedliche Unit-Tests der Regressor-Klasse

# Test ob eingegegebene Regressor-Klassen-Namen auch wirklich existieren -> falschen reg.-Namen übergeben
# input daten ~numerisch -> nicht-numemische Werte übergeben
# Test auf X != Array? -> tuple oder dict übergeben
# Test ob predict funktioniert -> predict anhand von Vorgabewerten testen (Fernseherpreis zu Bildschirmdiagonale)
# Test ob score funktioniert? -> score anhand von Vorgabewerten testen (Fernseherpreis zu Bildschirmdiagonale)
