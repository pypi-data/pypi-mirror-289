...
class ControllerAgent:
    ...
    def get_tree_txt_files(self):
        ...
        if not os.path.exists(tree_path):
            logger.info(f"Directory does not exist: {tree_path}")
    ...
    async def scan_and_update(self, files):
        ...
        logger.info(f"Final step: {list(files)}")
    ...
    async def replace_all_code_in_file(self, file_path, new_code_snippet):
        ...
        try:
            ...
            logger.info(f"The codes have been successfully written in... {file_path}.")
        except Exception as e:
