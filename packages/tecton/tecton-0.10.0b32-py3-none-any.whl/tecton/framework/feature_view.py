...
class FeatureView(base_tecton_object.BaseTectonObject):
    ...
    def prevent_destroy(self) -> bool:
        """If set to True, Tecton will block destructive actions taken on this Feature View."""
    ...
    def list_jobs(self) -> List[materialization_api.TectonJob]:
        """
        Retrieves the list of all jobs (materialization and dataset generation) for this feature view.
...
class FeatureTable(FeatureView):
    ...
    def alert_email(self) -> Optional[str]:
        """
        Email that alerts for this FeatureTable will be sent to.
        """
        return self._spec.alert_email
    ...
    def timestamp_field(self) -> Optional[str]:
        """
        The column name that refers to the timestamp for records that are produced by the feature view. This parameter
