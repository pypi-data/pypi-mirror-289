...
class ServerGroup(_message.Message):
    __slots__ = ["autoscaling_enabled", "desired_nodes", "fco_metadata", "feature_server_group", "max_nodes", "min_nodes", "options", "server_group_id", "transform_server_group", "type"]
