...
class CancelDatasetJobResponse(_message.Message):
    ...
    job: DatasetJob
    def __init__(self, job: Optional[Union[DatasetJob, Mapping]] = ...) -> None: ...

class CancelJobRequest(_message.Message):
    __slots__ = ["feature_view", "job_id", "workspace"]
    ...
    job_id: str
    workspace: str
    def __init__(self, job_id: Optional[str] = ..., workspace: Optional[str] = ..., feature_view: Optional[str] = ...) -> None: ...
...
class DatasetJob(_message.Message):
    __slots__ = ["attempts", "created_at", "id", "saved_feature_data_frame", "state", "updated_at", "workspace"]
    ...
    workspace: str
    def __init__(self, id: Optional[str] = ..., workspace: Optional[str] = ..., saved_feature_data_frame: Optional[str] = ..., created_at: Optional[Union[_timestamp_pb2.Timestamp, Mapping]] = ..., updated_at: Optional[Union[_timestamp_pb2.Timestamp, Mapping]] = ..., state: Optional[str] = ..., attempts: Optional[Iterable[Union[JobAttempt, Mapping]]] = ...) -> None: ...
...
class ListJobsRequest(_message.Message):
    __slots__ = ["feature_view", "workspace"]
    FEATURE_VIEW_FIELD_NUMBER: ClassVar[int]
    WORKSPACE_FIELD_NUMBER: ClassVar[int]
    feature_view: str
    workspace: str
    def __init__(self, workspace: Optional[str] = ..., feature_view: Optional[str] = ...) -> None: ...
...
class MaterializationJob(_message.Message):
    __slots__ = ["attempts", "created_at", "end_time", "feature_view", "id", "ingest_path", "job_type", "next_attempt_at", "offline", "online", "start_time", "state", "updated_at", "workspace"]
    ATTEMPTS_FIELD_NUMBER: ClassVar[int]
    CREATED_AT_FIELD_NUMBER: ClassVar[int]
