...
class DatasetGenerationParameters(_message.Message):
    __slots__ = ["batch_config", "cluster_config", "dataset", "datetime_range", "expected_schema", "extra_config", "feature_service", "feature_view", "from_source", "result_path", "spine"]
