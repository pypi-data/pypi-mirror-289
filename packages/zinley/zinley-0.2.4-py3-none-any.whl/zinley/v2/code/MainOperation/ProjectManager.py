...
class ProjectManager:
    ...
    async def execute_files_creation(self, instructions):
        for instruction in instructions:
            print("---------------------------------------------------------------------------------------")
            try:
                print(f"Executing Step {instruction['Title']} with pipeline {instruction['Pipeline']}")
            except:
            ...
            if function_name == "create_and_add_file_to_xcodeproj":
                if pipeline == "1":
                    ...
                    print(f"Unknown creating pipeline: {pipeline}")
                ...
                if pipeline == "1":
                    ...
                    print(f"Unknown moving pipeline: {pipeline}")
            else:
