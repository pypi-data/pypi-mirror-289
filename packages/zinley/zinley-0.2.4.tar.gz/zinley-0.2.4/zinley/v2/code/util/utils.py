...
def create_file_modification_times(project_path):
    ...
    with open(os.path.join(project_path, "Zinley", "Project_analysis", "file_modification_times.txt"), "w") as f:
...
def get_new_or_modified_file(project_path):
    previous_file_mod_times = set(
        read_file_lines(os.path.join(project_path, "Zinley", "Project_analysis", "file_modification_times.txt")))
