...
from milgeo import Geometry, GeometriesList, Point, Line, Polygon
...
@pytest.mark.parametrize("name, coordinates, sidc, fill_color, fill_opacity, "
                         "observation_datetime, quantity, expected_exception", [
                             ...
                             ("Invalid fill opacity", [(0, 0)], None, "#ff0000ff", "2", None, None, ValueError),
                             ...
                             ("Invalid Polygon coordinates", [[[0, 0], [1, 1]]], "Polygon", None, None, None, None, ValueError),
                             ("Invalid Polygon LinearRing", [[[0, 0], [1, 1], [2, 2]]], "Polygon", None, None, None, None, ValueError),
                             ("Invalid LineString coordinates", [[0, 0]], "LineString", None, None, None, None, ValueError),
                         ])
