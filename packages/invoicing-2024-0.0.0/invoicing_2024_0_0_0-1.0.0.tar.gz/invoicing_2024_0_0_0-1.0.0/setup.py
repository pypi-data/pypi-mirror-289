...
setup(
    name='invoicing-2024-0.0.0',  # * Your package will have this name
    ...
    author='__token__',  # Your name
    author_email='youremail@gmail.com',  # Your email
    url='https://pythonhow.com',  # Homepage of your library (e.g. github or your website)
