...
async def transferencias(task):
    try:
        ...
        screenshot_path = take_screenshot()
        existing_pre_venda_position = find_target_position(screenshot_path, "Pré-Vendas", attempts=15)
...
if __name__ == "__main__":
    task_fake = {
    'datEntradaFila': '2024-08-06T17:23:28.135-03:00',
    'configEntrada': {
        'itens': [{'qtd': 1, 'codigoProduto': '2826', 'unidadeMedida': 'UN', 'descricaoProduto': 'FILTRO MANN W7MULTI18'}],
        'processo': '2c8ee738-7447-4517-aee7-ce2c9d25cea9',
        'urlRetorno': 'https://public.simrede.com.br/simplifica',
        'precisaRetorno': True,
        'uuidSimplifica': '13311a86-568b-4c47-b2d3-f18ea4a465ed',
        'cnpjEmpresaOrigem': '07473735011892',
        'dataTransferencia': '2024-08-06T03:00:00',
        'nomeEmpresaOrigem': 'SANTA CRUZ AV INDEPENDENCIA',
        'cnpjEmpresaDestino': '07473735014050',
        'nomeEmpresaDestino': 'SANTA CRUZ BIG',
        'filialEmpresaOrigem': '118',
        'filialEmpresaDestino': '140'
    },
    'uuidProcesso': '2c8ee738-7447-4517-aee7-ce2c9d25cea9',
    'nomProcesso': 'Sim Rede - Simplifica Transferências',
    'uuidFila': '11621b3b-27df-4d6d-8c8c-a027bbd6e236'
}
