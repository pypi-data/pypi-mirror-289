...
from allure_commons_il.utils import uuid4
from allure_commons_il.utils import represent
from allure_commons_il.utils import platform_label
from allure_commons_il.utils import host_tag, thread_tag
from allure_commons_il.utils import md5
from allure_commons_il.reporter import AllureReporter
from allure_commons_il.model2 import TestStepResult, TestResult, TestBeforeResult, TestAfterResult
from allure_commons_il.model2 import TestResultContainer
from allure_commons_il.model2 import StatusDetails
...
class AllureListener:
    ...
    def pytest_fixture_setup(self, fixturedef, request):
        ...
        for index, finalizer in enumerate(finalizers):
            ...
            finalizers[index] = allure_commons_il.fixture(finalizer, parent_uuid=container_uuid, name=name)
