...
def cleanup_factory(plugin):
    def clean_up():
        name = allure_commons_il.plugin_manager.get_name(plugin)
        allure_commons_il.plugin_manager.unregister(name=name)
    return clean_up
...
def pytest_addhooks(pluginmanager):
    ...
    allure_commons_il.plugin_manager.register(title_helper)
...
def pytest_configure(config):
    ...
    allure_commons_il.plugin_manager.register(test_helper)
    ...
    if report_dir:
        ...
        allure_commons_il.plugin_manager.register(test_listener)
        config.add_cleanup(cleanup_factory(test_listener))

        file_logger = AllureFileLogger(report_dir, clean)
        allure_commons_il.plugin_manager.register(file_logger)
