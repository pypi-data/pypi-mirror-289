...
class TaskManager:
    ...
    def process_section(self, section: str, prompt: str, section_number: int, quiet: bool, debug: bool) -> str:
    ...
    def execute_tasks(self, template: str, sections: List[Dict[str, str]], prompt: str, quiet: bool, debug: bool) -> str:
        results = []
        for i, section in enumerate(sections, 1):
            result = self.process_section(section["content"], prompt, i, quiet, debug)
    ...
    def compile_results(self, template: str, sections: List[Dict[str, str]], prompt: str, quiet: bool, debug: bool) -> str:
        return self.execute_tasks(template, sections, prompt, quiet, debug)