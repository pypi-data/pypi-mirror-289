...
class UpdateColor:
    async def update_color(
        ...
        Parameters:
            ...
            color (:obj:`~techgram.enums.ReplyColor` | :obj:`~techgram.enums.ProfileColor`):
                Color type.
                Pass :obj:`~techgram.enums.ReplyColor` to set reply color or
                :obj:`~techgram.enums.ProfileColor` to set profile color.
