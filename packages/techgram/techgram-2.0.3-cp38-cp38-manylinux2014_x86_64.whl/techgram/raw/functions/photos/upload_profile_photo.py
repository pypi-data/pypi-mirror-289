...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <techgram.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <techgram.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <techgram.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <techgram.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <techgram.raw.base.photos.Photo>`
    """
