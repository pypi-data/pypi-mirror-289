...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <techgram.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <techgram.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <techgram.raw.base.SecureValueError>`):
            N/A
