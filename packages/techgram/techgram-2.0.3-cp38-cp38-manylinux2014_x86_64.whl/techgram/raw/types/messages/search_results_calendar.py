...
class SearchResultsCalendar(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.messages.SearchResultsCalendar`.
    ...
    Parameters:
        ...
        periods (List of :obj:`SearchResultsCalendarPeriod <techgram.raw.base.SearchResultsCalendarPeriod>`):
            N/A
