...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <techgram.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <techgram.raw.base.auth.CodeType>`, *optional*):
            N/A
