...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~techgram.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~techgram.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~techgram.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "techgram". Get the first 50 results
                async for message in app.search_global("techgram", limit=50):
                    print(message.text)
