...
import techgram
from techgram.types.messages_and_media.message import Str
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~techgram.types.PollOption`):
        ...
        question_entities (List of :obj:`~techgram.types.MessageEntity`, *optional*):
        ...
        explanation_entities (List of :obj:`~techgram.types.MessageEntity`, *optional*):
