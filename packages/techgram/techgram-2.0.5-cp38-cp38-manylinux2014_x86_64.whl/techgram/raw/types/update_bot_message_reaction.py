...
class UpdateBotMessageReaction(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        actor (:obj:`Peer <techgram.raw.base.Peer>`):
            N/A

        old_reactions (List of :obj:`Reaction <techgram.raw.base.Reaction>`):
            N/A

        new_reactions (List of :obj:`Reaction <techgram.raw.base.Reaction>`):
            N/A
