...
class BroadcastStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.stats.BroadcastStats`.
    ...
    Parameters:
        period (:obj:`StatsDateRangeDays <techgram.raw.base.StatsDateRangeDays>`):
            N/A

        followers (:obj:`StatsAbsValueAndPrev <techgram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        views_per_post (:obj:`StatsAbsValueAndPrev <techgram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        shares_per_post (:obj:`StatsAbsValueAndPrev <techgram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        reactions_per_post (:obj:`StatsAbsValueAndPrev <techgram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        views_per_story (:obj:`StatsAbsValueAndPrev <techgram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        shares_per_story (:obj:`StatsAbsValueAndPrev <techgram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        reactions_per_story (:obj:`StatsAbsValueAndPrev <techgram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        enabled_notifications (:obj:`StatsPercentValue <techgram.raw.base.StatsPercentValue>`):
            N/A

        growth_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        followers_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        mute_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        interactions_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        iv_interactions_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        views_by_source_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        new_followers_by_source_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        reactions_by_emotion_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        story_interactions_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        story_reactions_by_emotion_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        recent_posts_interactions (List of :obj:`PostInteractionCounters <techgram.raw.base.PostInteractionCounters>`):
            N/A
