...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~techgram.types.InputMediaPhoto`, :obj:`~techgram.types.InputMediaVideo`, :obj:`~techgram.types.InputMediaAudio` and :obj:`~techgram.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~techgram.types.Message`: On success, a list of the sent messages is returned.
