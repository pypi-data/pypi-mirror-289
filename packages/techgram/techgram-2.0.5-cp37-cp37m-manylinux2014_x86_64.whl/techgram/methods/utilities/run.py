...
class Run:
    def run(
        ...
        :meth:`~techgram.Client.start`, :meth:`~techgram.idle` and :meth:`~techgram.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`techgram.compose`.
