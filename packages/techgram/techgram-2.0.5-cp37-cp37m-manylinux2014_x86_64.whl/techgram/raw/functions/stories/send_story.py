...
class SendStory(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        media (:obj:`InputMedia <techgram.raw.base.InputMedia>`):
            N/A

        privacy_rules (List of :obj:`InputPrivacyRule <techgram.raw.base.InputPrivacyRule>`):
            N/A
        ...
        fwd_from_id (:obj:`InputPeer <techgram.raw.base.InputPeer>`, *optional*):
            N/A
