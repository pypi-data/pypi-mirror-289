...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`MessagesFilter <techgram.raw.base.MessagesFilter>`):
            N/A
        ...
        from_id (:obj:`InputPeer <techgram.raw.base.InputPeer>`, *optional*):
            N/A

        saved_peer_id (:obj:`InputPeer <techgram.raw.base.InputPeer>`, *optional*):
            N/A

        saved_reaction (List of :obj:`Reaction <techgram.raw.base.Reaction>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.Messages <techgram.raw.base.messages.Messages>`
    """
