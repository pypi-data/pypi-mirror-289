...
class InputBusinessBotRecipients(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.InputBusinessBotRecipients`.
    ...
    Parameters:
        ...
        users (List of :obj:`InputUser <techgram.raw.base.InputUser>`, *optional*):
            N/A

        exclude_users (List of :obj:`InputUser <techgram.raw.base.InputUser>`, *optional*):
            N/A
