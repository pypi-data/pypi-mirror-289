...
class SendEncryptedFile(TLObject):  # type: ignore
    ...
    Parameters:
        peer (:obj:`InputEncryptedChat <techgram.raw.base.InputEncryptedChat>`):
            N/A
        ...
        file (:obj:`InputEncryptedFile <techgram.raw.base.InputEncryptedFile>`):
            N/A
    ...
    Returns:
        :obj:`messages.SentEncryptedMessage <techgram.raw.base.messages.SentEncryptedMessage>`
    """
