...
class AttachMenuBotIcon(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.AttachMenuBotIcon`.
    ...
    Parameters:
        ...
        icon (:obj:`Document <techgram.raw.base.Document>`):
            N/A

        colors (List of :obj:`AttachMenuBotIconColor <techgram.raw.base.AttachMenuBotIconColor>`, *optional*):
            N/A
