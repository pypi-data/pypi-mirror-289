...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <techgram.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <techgram.raw.base.GroupCallParticipant>`):
            N/A
