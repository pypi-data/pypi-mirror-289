...
class GroupCallParticipantVideo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.GroupCallParticipantVideo`.
    ...
    Parameters:
        ...
        source_groups (List of :obj:`GroupCallParticipantVideoSourceGroup <techgram.raw.base.GroupCallParticipantVideoSourceGroup>`):
            N/A
