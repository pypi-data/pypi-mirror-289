...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <techgram.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <techgram.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <techgram.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <techgram.raw.base.updates.State>`):
            N/A
