...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <techgram.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <techgram.raw.base.MessagePeerReaction>`, *optional*):
            N/A
