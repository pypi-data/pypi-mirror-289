...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <techgram.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <techgram.raw.base.Reaction>`, *optional*):
            N/A
