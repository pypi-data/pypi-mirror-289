...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <techgram.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <techgram.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <techgram.raw.base.InlineBotWebView>`, *optional*):
            N/A
