...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <techgram.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <techgram.raw.base.Peer>`):
            N/A
