...
class GetBotCallbackAnswer(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        password (:obj:`InputCheckPasswordSRP <techgram.raw.base.InputCheckPasswordSRP>`, *optional*):
            N/A

    Returns:
        :obj:`messages.BotCallbackAnswer <techgram.raw.base.messages.BotCallbackAnswer>`
    """
