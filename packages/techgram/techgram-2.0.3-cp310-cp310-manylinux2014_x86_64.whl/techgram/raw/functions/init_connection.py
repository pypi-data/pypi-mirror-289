...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~techgram.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <techgram.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <techgram.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~techgram.raw.types`
    """
