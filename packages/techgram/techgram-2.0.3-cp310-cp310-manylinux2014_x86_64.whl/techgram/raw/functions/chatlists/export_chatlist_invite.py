...
class ExportChatlistInvite(TLObject):  # type: ignore
    ...
    Parameters:
        chatlist (:obj:`InputChatlist <techgram.raw.base.InputChatlist>`):
            N/A

        title (``str``):
            N/A

        peers (List of :obj:`InputPeer <techgram.raw.base.InputPeer>`):
            N/A

    Returns:
        :obj:`chatlists.ExportedChatlistInvite <techgram.raw.base.chatlists.ExportedChatlistInvite>`
    """
