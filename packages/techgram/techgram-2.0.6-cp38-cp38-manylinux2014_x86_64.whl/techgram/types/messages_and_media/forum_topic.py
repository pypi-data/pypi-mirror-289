...
class ForumTopic(Object):
    ...
    Parameters:
        ...
        creator (:obj:`~techgram.types.Chat`, *optional*):
            Topic creator.

        top_message (:obj:`~techgram.types.Message`, *optional*):
    ...
    @staticmethod
    def _parse(client: "techgram.Client", forum_topic: "raw.types.ForumTopic", messages: dict = {},  users: dict = {}, chats: dict = {}) -> "ForumTopic":
