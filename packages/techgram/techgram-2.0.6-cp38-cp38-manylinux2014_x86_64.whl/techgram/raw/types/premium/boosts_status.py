...
class BoostsStatus(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.premium.BoostsStatus`.
    ...
    Parameters:
        ...
        premium_audience (:obj:`StatsPercentValue <techgram.raw.base.StatsPercentValue>`, *optional*):
            N/A

        prepaid_giveaways (List of :obj:`PrepaidGiveaway <techgram.raw.base.PrepaidGiveaway>`, *optional*):
            N/A
