...
class InputStorePaymentPremiumGiveaway(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.InputStorePaymentPurpose`.
    ...
    Parameters:
        boost_peer (:obj:`InputPeer <techgram.raw.base.InputPeer>`):
            N/A
        ...
        additional_peers (List of :obj:`InputPeer <techgram.raw.base.InputPeer>`, *optional*):
            N/A
