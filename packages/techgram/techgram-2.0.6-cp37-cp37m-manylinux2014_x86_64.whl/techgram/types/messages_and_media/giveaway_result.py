...
import techgram
from techgram import errors, raw, utils
...
class GiveawayResult(Object):
    ...
    Parameters:
        chat (List of :obj:`~techgram.types.Chat`):
        ...
        winners (List of :obj:`~techgram.types.User`):
        ...
        launch_message (:obj:`~techgram.types.Message`, *optional*):
