...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <techgram.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <techgram.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <techgram.raw.base.PremiumSubscriptionOption>`):
            N/A
