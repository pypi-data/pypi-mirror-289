...
class ChannelAdminLogEventActionParticipantToggleAdmin(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.ChannelAdminLogEventAction`.
    ...
    Parameters:
        prev_participant (:obj:`ChannelParticipant <techgram.raw.base.ChannelParticipant>`):
            N/A

        new_participant (:obj:`ChannelParticipant <techgram.raw.base.ChannelParticipant>`):
            N/A
