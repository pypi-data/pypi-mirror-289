...
class AutoSaveSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.account.AutoSaveSettings`.
    ...
    Parameters:
        users_settings (:obj:`AutoSaveSettings <techgram.raw.base.AutoSaveSettings>`):
            N/A

        chats_settings (:obj:`AutoSaveSettings <techgram.raw.base.AutoSaveSettings>`):
            N/A

        broadcasts_settings (:obj:`AutoSaveSettings <techgram.raw.base.AutoSaveSettings>`):
            N/A

        exceptions (List of :obj:`AutoSaveException <techgram.raw.base.AutoSaveException>`):
            N/A
