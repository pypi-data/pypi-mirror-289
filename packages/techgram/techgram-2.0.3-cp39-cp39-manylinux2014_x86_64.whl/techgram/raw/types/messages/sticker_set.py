...
class StickerSet(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.messages.StickerSet`.
    ...
    Parameters:
        set (:obj:`StickerSet <techgram.raw.base.StickerSet>`):
            N/A

        packs (List of :obj:`StickerPack <techgram.raw.base.StickerPack>`):
            N/A

        keywords (List of :obj:`StickerKeyword <techgram.raw.base.StickerKeyword>`):
            N/A

        documents (List of :obj:`Document <techgram.raw.base.Document>`):
            N/A
