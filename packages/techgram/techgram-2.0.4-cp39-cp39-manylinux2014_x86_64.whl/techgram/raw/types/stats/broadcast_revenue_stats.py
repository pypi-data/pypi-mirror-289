...
class BroadcastRevenueStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.stats.BroadcastRevenueStats`.
    ...
    Parameters:
        ...
        revenue_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        balances (:obj:`BroadcastRevenueBalances <techgram.raw.base.BroadcastRevenueBalances>`):
            N/A
