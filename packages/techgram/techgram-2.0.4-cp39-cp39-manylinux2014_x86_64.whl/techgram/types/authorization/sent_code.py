...
class SentCode(Object):
    ...
    Parameters:
        type (:obj:`~techgram.enums.SentCodeType`):
            Type of the current sent code.

        phone_code_hash (``str``):
            Confirmation code identifier useful for the next authorization steps (either
            :meth:`~techgram.Client.sign_in` or :meth:`~techgram.Client.sign_up`).

        next_type (:obj:`~techgram.enums.NextCodeType`, *optional*):
            Type of the next code to be sent with :meth:`~techgram.Client.resend_code`.

        timeout (``int``, *optional*):
            Delay in seconds before calling :meth:`~techgram.Client.resend_code`.
    """
