...
class Folder(Object):
    ...
    Parameters:
        ...
        included_chats (List of :obj:`~techgram.types.Chat`, *optional*):
            A list of included chats in folder.

        excluded_chats (List of :obj:`~techgram.types.Chat`, *optional*):
            A list of excluded chats in folder.

        pinned_chats (List of :obj:`~techgram.types.Chat`, *optional*):
        ...
        color (:obj:`~techgram.enums.FolderColor`, *optional*)
            Chat reply color.
    """
    ...
    async def delete(self):
        """Bound method *delete* of :obj:`~techgram.types.Folder`.
    ...
    async def update(
        ...
        """Bound method *update_peers* of :obj:`~techgram.types.Folder`.
        ...
        Parameters:
            ...
            color (:obj:`~techgram.enums.FolderColor`, *optional*):
                Color type.
                Pass :obj:`~techgram.enums.FolderColor` to set folder color.
    ...
    async def include_chat(self, chat_id: Union[int, str]):
        """Bound method *include_chat* of :obj:`~techgram.types.Folder`.
    ...
    async def exclude_chat(self, chat_id: Union[int, str]):
        """Bound method *exclude_chat* of :obj:`~techgram.types.Folder`.
    ...
    async def update_color(self, color: "enums.FolderColor"):
        """Bound method *update_color* of :obj:`~techgram.types.Folder`.
    ...
    async def pin_chat(self, chat_id: Union[int, str]):
        """Bound method *pin_chat* of :obj:`~techgram.types.Folder`.
    ...
    async def remove_chat(self, chat_id: Union[int, str]):
        """Bound method *remove_chat* of :obj:`~techgram.types.Folder`.
    ...
    async def export_link(self):
        """Bound method *export_link* of :obj:`~techgram.types.Folder`.
