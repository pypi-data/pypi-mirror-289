...
class User(Object, Update):
    ...
    Parameters:
        ...
        status (:obj:`~techgram.enums.UserStatus`, *optional*):
            User's last seen & online status. ``None``, for bots.

        last_online_date (:py:obj:`~datetime.datetime`, *optional*):
            Last online date of a user. Only available in case status is :obj:`~techgram.enums.UserStatus.OFFLINE`.

        next_offline_date (:py:obj:`~datetime.datetime`, *optional*):
            Date when a user will automatically go offline. Only available in case status is :obj:`~techgram.enums.UserStatus.ONLINE`.
        ...
        emoji_status (:obj:`~techgram.types.EmojiStatus`, *optional*):
            Emoji status.
        ...
        raw (:obj:`~techgram.raw.base.User` | :obj:`~techgram.raw.base.UserStatus`, *optional*):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~techgram.types.User`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~techgram.types.User`.
    ...
    def block(self):
        """Bound method *block* of :obj:`~techgram.types.User`.
    ...
    def unblock(self):
        """Bound method *unblock* of :obj:`~techgram.types.User`.
    ...
    def get_common_chats(self):
        """Bound method *get_common_chats* of :obj:`~techgram.types.User`.
