...
class Chat(Object):
    ...
    Parameters:
        ...
        type (:obj:`~techgram.enums.ChatType`, *optional*):
            Type of chat.
        ...
        usernames (List of :obj:`~techgram.types.Username`, *optional*):
        ...
        photo (:obj:`~techgram.types.ChatPhoto`, *optional*):
            Chat photo. Suitable for downloads only.

        stories (List of :obj:`~techgram.types.Story`, *optional*):
            The list of chat's stories if available.

        wallpaper (:obj:`~techgram.types.Document`, *optional*):
            Chat wallpaper.

        bio (``str``, *optional*):
            Bio of the other party in a private chat.
            Returned only in :meth:`~techgram.Client.get_chat`.
        ...
        members (List of :obj:`~techgram.types.User`, *optional*):
        ...
        restrictions (List of :obj:`~techgram.types.Restriction`, *optional*):
            The list of reasons why this chat might be unavailable to some users.
            This field is available only in case *is_restricted* is True.

        permissions (:obj:`~techgram.types.ChatPermissions` *optional*):
            Default chat member permissions, for groups and supergroups.

        distance (``int``, *optional*):
            Distance in meters of this group chat from your location.
            Returned only in :meth:`~techgram.Client.get_nearby_chats`.

        personal_channel (:obj:`~techgram.types.Chat`, *optional*):
            The personal channel linked to this chat.
            Returned only in :meth:`~techgram.Client.get_chat`.

        personal_channel_message (:obj:`~techgram.types.Message`, *optional*):
            The last message in the personal channel of this chat.
            Returned only in :meth:`~techgram.Client.get_chat`.

        linked_chat (:obj:`~techgram.types.Chat`, *optional*):
            The linked discussion group (in case of channels) or the linked channel (in case of supergroups).
            Returned only in :meth:`~techgram.Client.get_chat`.

        send_as_chat (:obj:`~techgram.types.Chat`, *optional*):
            The default "send_as" chat.
            Returned only in :meth:`~techgram.Client.get_chat`.

        available_reactions (:obj:`~techgram.types.ChatReactions`, *optional*):
        ...
        reply_color (:obj:`~techgram.types.ChatColor`, *optional*):
            Chat reply color.

        profile_color (:obj:`~techgram.types.ChatColor`, *optional*):
            Chat profile color.

        business_info (:obj:`~techgram.types.BusinessInfo`, *optional*):
            Business information of a chat.

        business_intro (:obj:`~techgram.types.BusinessIntro`, *optional*):
            For private chats with business accounts, the intro of the business.

        birthday (:obj:`~techgram.types.Birthday`, *optional*):
        ...
        raw (:obj:`~techgram.raw.base.Chat` | :obj:`~techgram.raw.base.User` | :obj:`~techgram.raw.base.ChatFull` | :obj:`~techgram.raw.base.UserFull`, *optional*):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~techgram.types.Chat`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~techgram.types.Chat`.
    ...
    async def set_title(self, title: str) -> bool:
        """Bound method *set_title* of :obj:`~techgram.types.Chat`.
    ...
    async def set_description(self, description: str) -> bool:
        """Bound method *set_description* of :obj:`~techgram.types.Chat`.
    ...
    async def set_photo(
        ...
        *,
        ...
        """Bound method *set_photo* of :obj:`~techgram.types.Chat`.
        ...
        Parameters:
            photo (``str`` | ``BinaryIO``, *optional*):
                New chat photo. You can pass a :obj:`~techgram.types.Photo` file_id, a file path to upload a new photo
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.

            video (``str`` | ``BinaryIO``, *optional*):
                New chat video. You can pass a :obj:`~techgram.types.Video` file_id, a file path to upload a new video
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.
    ...
    async def set_ttl(self, ttl_seconds: int) -> "types.Message":
        """Bound method *set_ttl* of :obj:`~techgram.types.Chat`.
        ...
        Returns:
            :obj:`~techgram.types.Message`: On success, the generated service message is returned.
        """
    ...
    async def ban_member(
        ...
        """Bound method *ban_member* of :obj:`~techgram.types.Chat`.
        ...
        Returns:
            :obj:`~techgram.types.Message` | ``bool``: On success, a service message will be returned (when applicable), otherwise, in
    ...
    async def unban_member(
        ...
        """Bound method *unban_member* of :obj:`~techgram.types.Chat`.
    ...
    async def restrict_member(
        ...
        Parameters:
            ...
            permissions (:obj:`~techgram.types.ChatPermissions`):
        ...
        Returns:
            :obj:`~techgram.types.Chat`: On success, a chat object is returned.
    ...
    async def promote_member(
        ...
        """Bound method *promote_member* of :obj:`~techgram.types.Chat`.
        ...
        Parameters:
            ...
            privileges (:obj:`~techgram.types.ChatPrivileges`, *optional*):
                New user privileges.
    ...
    async def join(self):
        """Bound method *join* of :obj:`~techgram.types.Chat`.
    ...
    async def leave(self):
        """Bound method *leave* of :obj:`~techgram.types.Chat`.
    ...
    async def export_invite_link(self):
        """Bound method *export_invite_link* of :obj:`~techgram.types.Chat`.
    ...
    async def get_member(
        ...
        """Bound method *get_member* of :obj:`~techgram.types.Chat`.
        ...
        Returns:
            :obj:`~techgram.types.ChatMember`: On success, a chat member is returned.
        """
    ...
    def get_members(
        ...
        """Bound method *get_members* of :obj:`~techgram.types.Chat`.
        ...
        Parameters:
            query (``str``, *optional*):
                ...
                A query string is applicable only for :obj:`~techgram.enums.ChatMembersFilter.SEARCH`,
                :obj:`~techgram.enums.ChatMembersFilter.BANNED` and :obj:`~techgram.enums.ChatMembersFilter.RESTRICTED`
                filters only.

            limit (``int``, *optional*):
                Limits the number of members to be retrieved.

            filter (:obj:`~techgram.enums.ChatMembersFilter`, *optional*):
                Filter used to select the kind of members you want to retrieve. Only applicable for supergroups
                and channels.

        Returns:
            ``Generator``: On success, a generator yielding :obj:`~techgram.types.ChatMember` objects is returned.
        """
    ...
    async def add_members(
        ...
        """Bound method *add_members* of :obj:`~techgram.types.Chat`.
    ...
    async def mark_unread(self, ) -> bool:
        """Bound method *mark_unread* of :obj:`~techgram.types.Chat`.
    ...
    async def set_protected_content(self, enabled: bool) -> bool:
        """Bound method *set_protected_content* of :obj:`~techgram.types.Chat`.
    ...
    async def unpin_all_messages(self) -> bool:
        """Bound method *unpin_all_messages* of :obj:`~techgram.types.Chat`.
    ...
    async def mute(self, mute_until: datetime = None) -> bool:
        """Bound method *mute* of :obj:`~techgram.types.Chat`.
    ...
    async def unmute(self) -> bool:
        """Bound method *unmute* of :obj:`~techgram.types.Chat`.
