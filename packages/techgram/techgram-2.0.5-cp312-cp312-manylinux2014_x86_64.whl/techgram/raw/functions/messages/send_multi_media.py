...
class SendMultiMedia(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        multi_media (List of :obj:`InputSingleMedia <techgram.raw.base.InputSingleMedia>`):
            N/A
        ...
        reply_to (:obj:`InputReplyTo <techgram.raw.base.InputReplyTo>`, *optional*):
            N/A
        ...
        quick_reply_shortcut (:obj:`InputQuickReplyShortcut <techgram.raw.base.InputQuickReplyShortcut>`, *optional*):
            N/A
