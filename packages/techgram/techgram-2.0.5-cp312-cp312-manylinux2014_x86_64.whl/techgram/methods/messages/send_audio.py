...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~techgram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~techgram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~techgram.Client.stop_transmission`, None is returned.
