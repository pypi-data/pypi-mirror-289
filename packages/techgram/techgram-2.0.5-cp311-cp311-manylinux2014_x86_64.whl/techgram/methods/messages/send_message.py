...
class SendMessage:
    async def send_message(
        ...
        Returns:
            :obj:`~techgram.types.Message`: On success, the sent text message is returned.
        ...
        Example:
            .. code-block:: python
                ...
                await app.send_message("me", "https://docs.techgram.org",
                ...
                await app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("Docs", url="https://docs.techgram.org")]
                        ]))
        """
