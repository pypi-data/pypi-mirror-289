...
from techgram.utils import PyromodConfig
from techgram.types import ListenerTypes, CallbackQuery, Identifier, Listener
...
class CallbackQueryHandler(Handler):
    ...
    It is intended to be used with :meth:`~techgram.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~techgram.Client.on_callback_query` decorator.
    ...
    Other parameters:
        client (:obj:`~techgram.Client`):
            The Client itself, useful when you want to call other API methods inside the message handler.

        callback_query (:obj:`~techgram.types.CallbackQuery`):
    ...
    async def check_if_has_matching_listener(
        self, client: "techgram.Client", query: CallbackQuery
    ) -> Tuple[bool, Listener]:
        """
    ...
    async def check(self, client: "techgram.Client", query: CallbackQuery):
        """
    ...
    async def resolve_future_or_callback(
        self, client: "techgram.Client", query: CallbackQuery, *args
    ):
        """
