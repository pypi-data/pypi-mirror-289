...
class SponsoredMessageReportResultChooseOption(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.channels.SponsoredMessageReportResult`.
    ...
    Parameters:
        ...
        options (List of :obj:`SponsoredMessageReportOption <techgram.raw.base.SponsoredMessageReportOption>`):
            N/A
