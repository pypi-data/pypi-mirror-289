...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~techgram.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~techgram.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~techgram.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~techgram.types.CallbackGame`, *optional*):
