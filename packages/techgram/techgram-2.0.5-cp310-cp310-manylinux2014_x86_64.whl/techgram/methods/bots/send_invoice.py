...
import techgram
from techgram import enums, raw, utils, types
...
class SendInvoice:
    async def send_invoice(
        ...
        Parameters:
            ...
            prices (List of :obj:`~techgram.types.LabeledPrice`):
        ...
        Returns:
            :obj:`~techgram.types.Message`: On success, the sent invoice message is returned.
