...
class BusinessInfo(Object):
    ...
    Parameters:
        ...
        greeting_message (:obj:`~techgram.types.BusinessMessage`, *optional*):
            Greeting message of the business.

        away_message (:obj:`~techgram.types.BusinessMessage`, *optional*):
            Away message of the business.

        working_hours (:obj:`~techgram.types.BusinessWorkingHours`, *optional*):
