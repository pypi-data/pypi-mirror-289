...
from techgram.types import Message, CallbackQuery, InlineQuery, PreCheckoutQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update
...
"""Filter messages that contain :obj:`~techgram.types.Giveaway` objects."""
...
"""Filter messages that contain :obj:`~techgram.types.GiveawayResult` objects."""
...
"""Filter messages that contain :obj:`~techgram.types.GiftCode` objects."""
...
"""Filter messages that contain :obj:`~techgram.types.Story` objects."""
...
def commander(commands: Union[str, List[str]], handler: Union[str, List[str]] = None, sudo: bool = False, devs: bool = False, case_sensitive: bool = False):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~techgram.types.PreCheckoutQuery`: The filter will match ``payload``.
