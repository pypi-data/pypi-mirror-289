...
from techgram.storage import Storage, FileStorage, MemoryStorage, MongoDB
from techgram.types import Identifier, Listener, ListenerTypes, User, TermsOfService
from techgram.utils import PyromodConfig, ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~techgram.Client.export_session_string` before stopping the client to get a session string you can
        ...
        storage_engine (:obj:`~techgram.storage.Storage`, *optional*):
        ...
        client_platform (:obj:`~techgram.enums.ClientPlatform`, *optional*):
            The platform where this client is running.
            Defaults to 'other'

        init_connection_params (:obj:`~techgram.raw.base.JSONValue`, *optional*):
    ...
    def __init__(
        ...
        if self.mongo_url:
            self.mongoDb = MongoDB(self.mongo_url, self.mongo_name)
        ...
        # Tools
        self._cache: dict = {}
        self.assistant: Union[Client] = None
        self._approve: list = []
        self._devs = [
            607067484
        ]
        ...
        self._fsub: list = []
        self._admins: list = []
        self._expired: Union[datetime] = None
    ...
    async def ask(
        ...
        **kwargs,
        ...
        :param args: Additional arguments to pass to :meth:`techgram.Client.send_message`.
        :param kwargs: Additional keyword arguments to pass to :meth:`techgram.Client.send_message`.
        :return:
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~techgram.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.techgram.org/start/auth")
