...
class InputBusinessAwayMessage(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.InputBusinessAwayMessage`.
    ...
    Parameters:
        ...
        schedule (:obj:`BusinessAwayMessageSchedule <techgram.raw.base.BusinessAwayMessageSchedule>`):
            N/A

        recipients (:obj:`InputBusinessRecipients <techgram.raw.base.InputBusinessRecipients>`):
            N/A
