...
class ReactionsNotifySettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.ReactionsNotifySettings`.
    ...
    Parameters:
        sound (:obj:`NotificationSound <techgram.raw.base.NotificationSound>`):
            N/A

        show_previews (``bool``):
            N/A

        messages_notify_from (:obj:`ReactionNotificationsFrom <techgram.raw.base.ReactionNotificationsFrom>`, *optional*):
            N/A

        stories_notify_from (:obj:`ReactionNotificationsFrom <techgram.raw.base.ReactionNotificationsFrom>`, *optional*):
            N/A
