...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <techgram.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <techgram.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <techgram.raw.base.payments.ValidatedRequestedInfo>`
    """
