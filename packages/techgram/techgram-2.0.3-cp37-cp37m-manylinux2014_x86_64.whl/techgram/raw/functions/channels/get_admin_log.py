...
class GetAdminLog(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        events_filter (:obj:`ChannelAdminLogEventsFilter <techgram.raw.base.ChannelAdminLogEventsFilter>`, *optional*):
            N/A

        admins (List of :obj:`InputUser <techgram.raw.base.InputUser>`, *optional*):
            N/A

    Returns:
        :obj:`channels.AdminLogResults <techgram.raw.base.channels.AdminLogResults>`
    """
