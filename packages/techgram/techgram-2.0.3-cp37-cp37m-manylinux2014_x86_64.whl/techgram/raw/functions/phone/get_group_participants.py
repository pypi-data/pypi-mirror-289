...
class GetGroupParticipants(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <techgram.raw.base.InputGroupCall>`):
            N/A

        ids (List of :obj:`InputPeer <techgram.raw.base.InputPeer>`):
            N/A
    ...
    Returns:
        :obj:`phone.GroupParticipants <techgram.raw.base.phone.GroupParticipants>`
    """
