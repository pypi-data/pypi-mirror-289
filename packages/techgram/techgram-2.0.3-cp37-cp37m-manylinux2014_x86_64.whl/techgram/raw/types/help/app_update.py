...
class AppUpdate(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.help.AppUpdate`.
    ...
    Parameters:
        ...
        entities (List of :obj:`MessageEntity <techgram.raw.base.MessageEntity>`):
            N/A
        ...
        sticker (:obj:`Document <techgram.raw.base.Document>`, *optional*):
            N/A
