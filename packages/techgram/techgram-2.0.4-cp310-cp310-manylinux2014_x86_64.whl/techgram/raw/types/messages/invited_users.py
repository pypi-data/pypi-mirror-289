...
class InvitedUsers(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.messages.InvitedUsers`.
    ...
    Parameters:
        updates (:obj:`Updates <techgram.raw.base.Updates>`):
            N/A

        missing_invitees (List of :obj:`MissingInvitee <techgram.raw.base.MissingInvitee>`):
            N/A
