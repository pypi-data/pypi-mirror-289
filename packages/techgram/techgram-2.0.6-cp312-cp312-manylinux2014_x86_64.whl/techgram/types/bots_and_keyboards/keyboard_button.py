...
class KeyboardButton(Object):
    ...
    Parameters:
        ...
        request_poll (:obj:`~techgram.types.RequestPollInfo`, *optional*):
            If specified, the poll be sent when the button is pressed.

        request_peer (:obj:`~techgram.types.RequestChannelInfo` | :obj:`~techgram.types.RequestChatInfo` | :obj:`~techgram.types.RequestUserInfo`, *optional*):
