...
import techgram
from techgram.types import ListenerTypes, Message, Identifier
...
class MessageHandler(Handler):
    ...
    :meth:`~techgram.Client.on_message` decorator.
    ...
    Other parameters:
        ...
        message (:obj:`~techgram.types.Message`):
    ...
    async def check_if_has_matching_listener(self, client: "techgram.Client", message: Message):
        """
    ...
    async def check(self, client: "techgram.Client", message: Message):
        """
    ...
    async def resolve_future_or_callback(self, client: "techgram.Client", message: Message, *args):
        """
