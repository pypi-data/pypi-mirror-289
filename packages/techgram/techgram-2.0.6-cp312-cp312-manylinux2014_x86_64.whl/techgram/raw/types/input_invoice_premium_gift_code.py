...
class InputInvoicePremiumGiftCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.InputInvoice`.
    ...
    Parameters:
        purpose (:obj:`InputStorePaymentPurpose <techgram.raw.base.InputStorePaymentPurpose>`):
            N/A

        option (:obj:`PremiumGiftCodeOption <techgram.raw.base.PremiumGiftCodeOption>`):
            N/A
