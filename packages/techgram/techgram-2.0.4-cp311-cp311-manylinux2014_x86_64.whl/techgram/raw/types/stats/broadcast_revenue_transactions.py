...
class BroadcastRevenueTransactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.stats.BroadcastRevenueTransactions`.
    ...
    Parameters:
        ...
        transactions (List of :obj:`BroadcastRevenueTransaction <techgram.raw.base.BroadcastRevenueTransaction>`):
            N/A
