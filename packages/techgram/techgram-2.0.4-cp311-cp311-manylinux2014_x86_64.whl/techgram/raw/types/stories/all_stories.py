...
class AllStories(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.stories.AllStories`.
    ...
    Parameters:
        ...
        peer_stories (List of :obj:`PeerStories <techgram.raw.base.PeerStories>`):
            N/A
        ...
        stealth_mode (:obj:`StoriesStealthMode <techgram.raw.base.StoriesStealthMode>`):
            N/A
