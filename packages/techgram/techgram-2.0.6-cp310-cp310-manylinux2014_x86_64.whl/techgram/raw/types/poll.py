...
class Poll(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.Poll`.
    ...
    Parameters:
        ...
        question (:obj:`TextWithEntities <techgram.raw.base.TextWithEntities>`):
            N/A

        answers (List of :obj:`PollAnswer <techgram.raw.base.PollAnswer>`):
            N/A
