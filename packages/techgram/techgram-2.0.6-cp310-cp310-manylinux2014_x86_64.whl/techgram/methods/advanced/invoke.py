...
from techgram.methods.messages.business_session import get_session
...
class Invoke:
    async def invoke(
        ...
        Available functions are listed in the :obj:`functions <techgram.api.functions>` package and may accept compound
        data types from :obj:`types <techgram.api.types>` as well as bare types such as ``int``, ``str``, etc...
