...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <techgram.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <techgram.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <techgram.raw.base.account.EmailVerified>`
    """
