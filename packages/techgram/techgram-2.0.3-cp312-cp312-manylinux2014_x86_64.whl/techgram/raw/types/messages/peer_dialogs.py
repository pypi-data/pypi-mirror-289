...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <techgram.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <techgram.raw.base.Message>`):
            N/A
