...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <techgram.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <techgram.raw.base.PopularContact>`):
            N/A
