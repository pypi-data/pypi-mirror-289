...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <techgram.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <techgram.raw.base.ThemeSettings>`, *optional*):
            N/A
