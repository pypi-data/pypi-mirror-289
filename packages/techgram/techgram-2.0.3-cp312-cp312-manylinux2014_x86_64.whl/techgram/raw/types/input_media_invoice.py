...
class InputMediaInvoice(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        provider_data (:obj:`DataJSON <techgram.raw.base.DataJSON>`):
            N/A

        photo (:obj:`InputWebDocument <techgram.raw.base.InputWebDocument>`, *optional*):
            N/A

        start_param (``str``, *optional*):
            N/A

        extended_media (:obj:`InputMedia <techgram.raw.base.InputMedia>`, *optional*):
            N/A
