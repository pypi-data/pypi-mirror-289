...
class ExportedChatlistInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.chatlists.ExportedChatlistInvite`.
    ...
    Parameters:
        filter (:obj:`DialogFilter <techgram.raw.base.DialogFilter>`):
            N/A

        invite (:obj:`ExportedChatlistInvite <techgram.raw.base.ExportedChatlistInvite>`):
            N/A
