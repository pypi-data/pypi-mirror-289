...
class MegagroupStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.stats.MegagroupStats`.
    ...
    Parameters:
        ...
        members (:obj:`StatsAbsValueAndPrev <techgram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        messages (:obj:`StatsAbsValueAndPrev <techgram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        viewers (:obj:`StatsAbsValueAndPrev <techgram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        posters (:obj:`StatsAbsValueAndPrev <techgram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        growth_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        members_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        new_members_by_source_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        messages_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        actions_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        weekdays_graph (:obj:`StatsGraph <techgram.raw.base.StatsGraph>`):
            N/A

        top_posters (List of :obj:`StatsGroupTopPoster <techgram.raw.base.StatsGroupTopPoster>`):
            N/A

        top_admins (List of :obj:`StatsGroupTopAdmin <techgram.raw.base.StatsGroupTopAdmin>`):
            N/A

        top_inviters (List of :obj:`StatsGroupTopInviter <techgram.raw.base.StatsGroupTopInviter>`):
            N/A
