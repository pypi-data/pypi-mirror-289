...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~techgram.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <techgram.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <techgram.raw.base.VideoSize>`, *optional*):
            N/A
