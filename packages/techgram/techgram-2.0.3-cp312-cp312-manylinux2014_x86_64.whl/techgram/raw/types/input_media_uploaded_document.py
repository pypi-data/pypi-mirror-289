...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Parameters:
        file (:obj:`InputFile <techgram.raw.base.InputFile>`):
            N/A
        ...
        thumb (:obj:`InputFile <techgram.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <techgram.raw.base.InputDocument>`, *optional*):
            N/A
