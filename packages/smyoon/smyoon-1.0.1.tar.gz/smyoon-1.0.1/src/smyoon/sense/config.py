...
class SensitivityConfig:
    ...
    def __init__(self, default: SensitivityScale, by_tags: Dict[str, SensitivityScale]):
        ...
        self.by_tags: Dict[str, SensitivityScale] = by_tags
...
class APIConfig:
    def __init__(
        ...
        speaker_language: str = 'en-US',
        speaker_host: str = None,
    ):
        """
        Args:
        ...
        """
        self.window_hop: WindowHop = window_hop
        ...
        self.event_host: Optional[str] = event_host

        self.speaker_recognition: bool = speaker_recognition
        self.speaker_language: str = speaker_language
        self.speaker_host: Optional[str] = speaker_host

    def get_event_host(self) -> str:
        return 'https://api.cochl.ai/sense/api/v1' if self.event_host is None else self.event_host

    def get_speaker_host(self) -> str:
        return 'https://sr-api.beta.cochl.ai/api/v1' if self.speaker_host is None else self.speaker_host
