...
class Project(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 applications: Optional[pulumi.Input[pulumi.InputType['ProjectApplicationsArgs']]] = None,
                 attributes: Optional[pulumi.Input[pulumi.InputType['ProjectAttributesArgs']]] = None,
                 authentication: Optional[pulumi.Input[pulumi.InputType['ProjectAuthenticationArgs']]] = None,
                 authorization: Optional[pulumi.Input[pulumi.InputType['ProjectAuthorizationArgs']]] = None,
                 connectors: Optional[pulumi.Input[pulumi.InputType['ProjectConnectorsArgs']]] = None,
                 flows: Optional[pulumi.Input[Mapping[str, pulumi.Input[pulumi.InputType['ProjectFlowsArgs']]]]] = None,
                 jwt_templates: Optional[pulumi.Input[pulumi.InputType['ProjectJwtTemplatesArgs']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 project_settings: Optional[pulumi.Input[pulumi.InputType['ProjectProjectSettingsArgs']]] = None,
                 styles: Optional[pulumi.Input[pulumi.InputType['ProjectStylesArgs']]] = None,
                 tag: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
