...
import torch
from torch.utils.data import distributed, DataLoader, dataloader, Dataset
import torch.nn.functional as F

from ycsai.utils import RANK, LOGGER
from ycsai.utils.torch_utils import (
    torch_distributed_zero_first,
)
from ycsai.data.augmentations import (
    Albumentations, mixup, letterbox, 
...
class LoadImagesAndLabels(Dataset):
    ...
    cache_version = 1.0  # dataset labels *.cache version
    ...
    def load_mosaic(self, index):
        ...
        # Augment
        img4, labels4 = copy_paste(img4, labels4, p=self.hyp['copy_paste'])
    ...
    def load_mosaic9(self, index):
        ...
        # Augment
        img9, labels9 = copy_paste(img9, labels9, p=self.hyp['copy_paste'])
