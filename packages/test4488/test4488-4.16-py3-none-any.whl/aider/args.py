...
def get_parser(default_config_files, git_root):
    parser = configargparse.ArgumentParser(
        description="tenten is your AI Copilot",
...
#     )
    ...
    group.add_argument(
        ...
        type=int,
        default=2048,
        help="Max number of tokens to use for repo map, use 0 to disable (default: 2048)",
    )
    group.add_argument(
    ...
    group.add_argument(
        "--user-input-color",
        default="#32FF32",
        help="Set the color for user input (default: #32FF32)",
    )
    group.add_argument(
        "--tool-output-color",
        default=None,
    ...
    group.add_argument(
        "--tool-error-color",
        default="#FF3333",
        help="Set the color for tool error messages (default: FF3333)",
    )
    group.add_argument(
        "--assistant-output-color",
        default="#00FFFF",
        help="Set the color for assistant output (default: #00FFFF)",
    )
    group.add_argument(
        "--code-theme",
        default="monokai",
...
#         action=argparse.BooleanOptionalAction,
#         default=False,
#         help="Attribute aider code changes in the git author name (default: False)",
#     )
#     group.add_argument(
#         "--attribute-committer",
#         action=argparse.BooleanOptionalAction,
#         default=False,
#         help="Attribute aider commits in the git committer name (default: False)",
#     )
#     group.add_argument(
...
#         "--browser",
#         action="store_true",
#         help="Run tenten in your browser",
#         default=False,
#     )
