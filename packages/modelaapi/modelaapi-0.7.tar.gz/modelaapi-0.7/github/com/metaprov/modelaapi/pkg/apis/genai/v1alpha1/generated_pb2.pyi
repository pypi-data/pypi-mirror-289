...
class APIKeyGroupStatus(_message.Message):
    ...
    def __init__(self, observedGeneration: _Optional[int] = ..., storageConnectionName: _Optional[str] = ..., totalTokens: _Optional[int] = ..., totalRequests: _Optional[int] = ..., totalCost: _Optional[float] = ..., apiKeys: _Optional[_Iterable[_Union[APIKeyStatus, _Mapping]]] = ..., updatedAt: _Optional[_Union[_generated_pb2_1_1.Time, _Mapping]] = ..., conditions: _Optional[_Iterable[_Union[_generated_pb2_1_1.Condition, _Mapping]]] = ...) -> None: ...
