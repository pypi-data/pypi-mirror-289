...
struct mj_recompile {
  ...
  static constexpr char doc[] = "Recompile spec to model, preserving the state.";
  using type = void (mjSpec *, const mjVFS *, mjModel *, mjData *);
...
struct mj_copyBack {
  ...
  static constexpr char doc[] = "Copy (possibly modified) model fields back into spec.";
  using type = void (mjSpec *, const mjModel *);
...
struct mju_rotVecMat {
  ...
  static constexpr char doc[] = "Deprecated, use mju_mulMatVec3(res, mat, vec).";
...
struct mju_rotVecMatT {
  ...
  static constexpr char doc[] = "Deprecated, use mju_mulMatTVec3(res, mat, vec).";
  using type = void (mjtNum (*)[3], const mjtNum (*)[3], const mjtNum (*)[9]);
  static constexpr auto param_names = std::make_tuple("res", "vec", "mat");
...
struct mjs_attachBody {
  ...
  static constexpr char doc[] = "Attach child body to a parent frame, return 0 on success.";
  using type = int (mjsFrame *, const mjsBody *, const char *, const char *);
...
struct mjs_attachFrame {
  ...
  static constexpr char doc[] = "Attach child frame to a parent body, return 0 on success.";
  using type = int (mjsBody *, const mjsFrame *, const char *, const char *);
  static constexpr auto param_names = std::make_tuple("parent", "child", "prefix", "suffix");
...
struct mjs_addBody {
  ...
  using type = mjsBody * (mjsBody *, mjsDefault *);
...
struct mjs_addSite {
  ...
  using type = mjsSite * (mjsBody *, mjsDefault *);
  static constexpr auto param_names = std::make_tuple("body", "def_");
...
struct mjs_addJoint {
  ...
  using type = mjsJoint * (mjsBody *, mjsDefault *);
  static constexpr auto param_names = std::make_tuple("body", "def_");
...
struct mjs_addGeom {
  ...
  using type = mjsGeom * (mjsBody *, mjsDefault *);
  static constexpr auto param_names = std::make_tuple("body", "def_");
...
struct mjs_addCamera {
  ...
  using type = mjsCamera * (mjsBody *, mjsDefault *);
  static constexpr auto param_names = std::make_tuple("body", "def_");
...
struct mjs_addLight {
  ...
  using type = mjsLight * (mjsBody *, mjsDefault *);
  static constexpr auto param_names = std::make_tuple("body", "def_");
...
struct mjs_addActuator {
  ...
  using type = mjsActuator * (mjSpec *, mjsDefault *);
...
struct mjs_addPair {
  ...
  using type = mjsPair * (mjSpec *, mjsDefault *);
  static constexpr auto param_names = std::make_tuple("s", "def_");
...
struct mjs_addEquality {
  ...
  using type = mjsEquality * (mjSpec *, mjsDefault *);
  static constexpr auto param_names = std::make_tuple("s", "def_");
...
struct mjs_addTendon {
  ...
  using type = mjsTendon * (mjSpec *, mjsDefault *);
  static constexpr auto param_names = std::make_tuple("s", "def_");
...
struct mjs_addMesh {
  ...
  using type = mjsMesh * (mjSpec *, mjsDefault *);
  static constexpr auto param_names = std::make_tuple("s", "def_");
...
struct mjs_addMaterial {
  ...
  using type = mjsMaterial * (mjSpec *, mjsDefault *);
  static constexpr auto param_names = std::make_tuple("s", "def_");
...
struct mjs_findBody {
  ...
  static constexpr char doc[] = "Find body in model by name.";
...
struct mjs_findMesh {
  static constexpr char name[] = "mjs_findMesh";
  static constexpr char doc[] = "Find mesh by name.";
  using type = mjsMesh * (mjSpec *, const char *);
  static constexpr auto param_names = std::make_tuple("s", "name");
...
struct mjs_findKeyframe {
  static constexpr char name[] = "mjs_findKeyframe";
  static constexpr char doc[] = "Find keyframe by name.";
  using type = mjsKey * (mjSpec *, const char *);
  static constexpr auto param_names = std::make_tuple("s", "name");

  MUJOCO_ALWAYS_INLINE static type& GetFunc() {
    return ::mjs_findKeyframe;
  }
};
...
struct mjs_firstChild {
  ...
  static constexpr char doc[] = "Return body's first child of given type.";
  using type = mjsElement * (mjsBody *, mjtObj);
  static constexpr auto param_names = std::make_tuple("body", "type");
...
struct mjs_nextChild {
  ...
  static constexpr char doc[] = "Return body's next child of the same type; return NULL if child is last.";
  using type = mjsElement * (mjsBody *, mjsElement *);
  static constexpr auto param_names = std::make_tuple("body", "child");
...
struct mjs_setActivePlugins {
  static constexpr char name[] = "mjs_setActivePlugins";
  static constexpr char doc[] = "Set active plugins.";
  using type = void (mjSpec *, void *);
  static constexpr auto param_names = std::make_tuple("s", "activeplugins");

  MUJOCO_ALWAYS_INLINE static type& GetFunc() {
    return ::mjs_setActivePlugins;
  }
};
...
struct mjs_setDefault {
  ...
  using type = void (mjsElement *, mjsDefault *);
...
struct mjs_setFrame {
  ...
  static constexpr char doc[] = "Set element's enlcosing frame.";
