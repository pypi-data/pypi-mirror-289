...
class Transform(object):
    ...
    def transform(self, transform_config_dir: str, src_model_uri: str, dst_model_uri: str, src_dataset_uri: str=''):
        """
        ...
        cvt_copy_model(transform_config_filepath, src_model_uri, dst_model_uri, src_dataset_uri)