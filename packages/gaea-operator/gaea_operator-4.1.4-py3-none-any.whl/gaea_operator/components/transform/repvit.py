...
def repvit_transform(args):
    ...
    config = RepViTConfig(windmill_client=windmill_client, tracker_client=tracker_client, metadata=metadata)
    ...
    model_template = ModelTemplate(windmill_client=windmill_client,
                                   ...
                                   algorithm=ModelTemplate.REPVIT_NAME)
