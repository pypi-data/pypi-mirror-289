...
class MultiAttributeImageClassificationMetric(BaseModel):
    """
    MultiAttribute Image Classification Metric
    """
    metrics: Optional[List[Union[
        AccuracyMetric]]] = None    # 仅存放全体任务的平均指标
    all_metrics: Optional[List[ImageClassificationMetric]] = None    # 存放每个属性的结果