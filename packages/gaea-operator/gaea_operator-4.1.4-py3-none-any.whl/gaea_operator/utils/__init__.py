...
from .consts import DEFAULT_TRAIN_CONFIG_FILE_NAME, \
    ...
    DEFAULT_DATA_MINING_FOLDER_NAME, \
    DEFAULT_DATA_LABEL_FOLDER_NAME, \
    DEFAULT_NET_SEARCH_FOLDER_NAME, \
    DEFAULT_AIGC_FOLDER_NAME, \
    DEFAULT_DATA_UPLOAD_FOLDER_NAME, \
    DEFAULT_DATA_SELECT_FOLDER_NAME, \
    DEFAULT_TRAFFIC_BUCKET
