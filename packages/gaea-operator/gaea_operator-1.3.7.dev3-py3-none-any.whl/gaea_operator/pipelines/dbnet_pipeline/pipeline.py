...
NAME_TO_IMAGES = {
    ...
    TransformEval.name():
        [
            ...
            Image(kind=Accelerator.KUNLUN,
                  name="iregistry.baidu-int.com/windmill-public/inference/kunlun:20240806_1722945340960"),
            Image(kind=Accelerator.ASCEND,
                  name="")
        ],
    Package.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/inference/nvidia:20240806_1722945340655"),
            Image(kind=Accelerator.KUNLUN,
                  name="iregistry.baidu-int.com/windmill-public/inference/nvidia:20240806_1722945340960"),
            Image(kind=Accelerator.ASCEND,
                  name="")
        ],
    Inference.name():
