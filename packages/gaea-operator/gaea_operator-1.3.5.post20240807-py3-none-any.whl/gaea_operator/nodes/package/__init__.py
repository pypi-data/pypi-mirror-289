...
class Package(BaseNode):
    ...
    def __init__(self,
        ...
        compute_tips = {Accelerator.NVIDIA: ["training"],
        ...
        properties = Properties(accelerator=accelerator,
                                ...
                                modelFormats={
                                    Accelerator.NVIDIA: {f"{self.name()}.transform_model_name": ["TensorRT"],
                                                         f"{self.name()}.ensemble_model_name": ["Python", "TensorRT"]},
                                    Accelerator.KUNLUN: {f"{self.name()}.transform_model_name": ["PaddleLite"],
                                                         f"{self.name()}.ensemble_model_name": ["Python", "PaddleLite"]}
                                })
