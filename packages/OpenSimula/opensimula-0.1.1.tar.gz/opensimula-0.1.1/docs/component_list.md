...
- [Building definition components](component_list_building.md): Building, Space_type, Space, Exterior_surface, Interior_surface, Underground_surface, Virtual_exterior_surface, Virtual_interior_surface, Opening.
