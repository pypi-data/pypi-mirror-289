...
class AnswerMessagesManager(object):
    ...
    async def proxy(self) -> tuple[types.ProxyMessageInfo, BaseException | None]:
        ...
        if proxy_message_info is None:
            ...
            return proxy_message_info, aiogram.exceptions.TelegramNotFound('chat_not_found', 'chat_not_found')
