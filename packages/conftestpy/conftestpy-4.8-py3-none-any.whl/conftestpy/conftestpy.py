...
class Conftest:
    ...
    def _replace_js_(self):
        ...
        res = re.sub('seconds. </div>',
                     ...
                     f'<iframe style="width:30%;height:{300+self.module_num*10}px;margin:-290px 0px 0px 59.5%" width="100%" height="100%" '
                     'frameborder="no" border="0" src="assets/e2.html"></iframe>'
