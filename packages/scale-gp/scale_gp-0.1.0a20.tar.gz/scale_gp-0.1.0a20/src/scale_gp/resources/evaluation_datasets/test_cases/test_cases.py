    ...
    def batch(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(items, test_case_batch_params.TestCaseBatchParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncTestCasesResource(AsyncAPIResource):
    ...
    async def batch(
        ...
        *,
        ...
        return await self._post(
            f"/v4/evaluation-datasets/{evaluation_dataset_id}/test-cases/batch",
            body=await async_maybe_transform(items, test_case_batch_params.TestCaseBatchParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=TestCaseBatchResponse,
