    ...
    def batch(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(items, test_case_result_batch_params.TestCaseResultBatchParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncTestCaseResultsResource(AsyncAPIResource):
    ...
    async def batch(
        ...
        *,
        ...
        return await self._post(
            f"/v4/evaluations/{evaluation_id}/test-case-results/batch",
            body=await async_maybe_transform(items, test_case_result_batch_params.TestCaseResultBatchParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=TestCaseResultBatchResponse,
