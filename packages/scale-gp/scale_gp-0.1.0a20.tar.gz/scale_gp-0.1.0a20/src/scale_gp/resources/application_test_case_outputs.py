    ...
    def batch(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(items, application_test_case_output_batch_params.ApplicationTestCaseOutputBatchParams),
            options=make_request_options(
        ...
        *,
        ...
        return await self._post(
            ...
            body=await async_maybe_transform(
                items, application_test_case_output_batch_params.ApplicationTestCaseOutputBatchParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
