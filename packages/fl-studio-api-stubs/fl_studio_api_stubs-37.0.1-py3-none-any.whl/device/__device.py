...
def getPortNumber() -> int:
    ...
    functions like [device.midiOutMsg()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/device/device#device.__device.midiOutMsg) send their data to)
...
def stopRepeatMidiEvent() -> None:
    ...
    Refer to [device.repeatMidiEvent()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/device/device#device.__device.repeatMidiEvent).
