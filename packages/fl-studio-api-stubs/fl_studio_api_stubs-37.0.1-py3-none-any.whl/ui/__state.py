...
def getSnapMode() -> int:
    ...
    * `int`: a snap mode from [this list](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/midi/snap modes)
...
def snapMode(value: int) -> int:
    ...
    a snapping mode. To select a value directly, use [ui.setSnapMode()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/ui/state#ui.__state.setSnapMode).
...
def setSnapMode(value: int) -> None:
    ...
    modes. To increment or decrement the value, use [ui.snapMode()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/ui/state#ui.__state.snapMode).

    ## Args

    * `value` (`int`): a snap mode from [this list](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/midi/snap modes)
...
def setHintMsg(msg: str) -> None:
    ...
    [hint message icon tutorial](https://il-group.github.io/FL-Studio-API-Stubs/tutorials/hint_message_icons).
...
def showNotification(notificationId: int):
    ...
    [ui.setHintMsg()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/ui/state#ui.__state.setHintMsg), except with less customization. Currently
