...
class FlMidiMsg:
    ...
    def pmeFlags(self) -> int:
        ...
        [PME Flags](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/midi/pme flags)
        constants from the [midi](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/midi) module to analyse the flags.
