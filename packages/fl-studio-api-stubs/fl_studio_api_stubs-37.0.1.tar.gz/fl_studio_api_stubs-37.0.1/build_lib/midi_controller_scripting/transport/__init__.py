...
def globalTransport(
    ...
    * `command` (`int`): command to execute, refer to [FL Studio manual](https://www.image-line.com/fl-studio-learning/fl-studio-online-manual/html/midi_scripting.htm#globalTransportCommands).
    ...
    * `flags` (`int`, optional): ??? refer to [FL Studio manual](https://www.image-line.com/fl-studio-learning/fl-studio-online-manual/html/midi_scripting.htm#globalTransportFlags).
...
def getSongPos(mode: int = -1) -> 'float | int':
    ...
    * This will get the position in the song in song mode, or the position
      in the pattern, depending on the state of [transport.getLoopMode()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/transport#transport.getLoopMode).

    ## Args

    * `mode` (`int`, optional): mode for return:
          * [default] (`-1`):  [fractional time](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/tutorials/time_units/#fractional). Returns as `float`.

          * `SONGLENGTH_MS` (`0`): milliseconds (as `int`).

          * `SONGLENGTH_S` (`1`): seconds (as `int`).

          * `SONGLENGTH_ABSTICKS` (`2`): [absolute ticks](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/tutorials/time_units/#ticks) (as `int`).

          * `SONGLENGTH_BARS` (`3`): [B:S:T format](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/tutorials/time_units/#bst), bars component (as `int`).

          * `SONGLENGTH_STEPS` (`4`): [B:S:T format](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/tutorials/time_units/#bst), steps component (as `int`).

          * `SONGLENGTH_TICKS` (`5`): [B:S:T format](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/tutorials/time_units/#bst), ticks component (as `int`).

    ## Example Usage

    The [transport.getSongPosHint()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/transport#transport.getSongPosHint) function (returning time in
    [B:S:T](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/tutorials/time_units/#bst)
...
def setSongPos(position: 'float | int', mode: int = -1) -> None:
    ...
    * `mode` (`int`, optional): mode for `position`:
          * [default] (`-1`):  [fractional time](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/tutorials/time_units/#fractional). Requires position to be passed as type `float`.
...
def getSongLength(mode: int) -> int:
    ...
    * `mode` (`int`): mode for length:
          ...
          * `SONGLENGTH_ABSTICKS` (`2`): [absolute ticks](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/tutorials/time_units/#ticks).

          * `SONGLENGTH_BARS` (`3`): [B:S:T format](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/tutorials/time_units/#bst), bars component.

          * `SONGLENGTH_STEPS` (`4`): [B:S:T format](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/tutorials/time_units/#bst), steps component.

          * `SONGLENGTH_TICKS` (`5`): [B:S:T format](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/tutorials/time_units/#bst), ticks component.
...
def getSongPosHint() -> str:
    ...
    [playlist.getVisTimeBar()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/playlist/performance#playlist.__performance.getVisTimeBar), [playlist.getVisTimeStep()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/playlist/performance#playlist.__performance.getVisTimeStep)
    and [playlist.getVisTimeTick()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/playlist/performance#playlist.__performance.getVisTimeTick) instead.
...
def markerJumpJog(value: int, flags: int = midi.GT_All) -> None:
    ...
    * `flags` (`int`, optional): ??? refer to the [FL Studio manual](https://www.image-line.com/fl-studio-learning/fl-studio-online-manual/html/midi_scripting.htm#globalTransportFlags).
