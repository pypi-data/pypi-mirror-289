...
def selectedChannel(
    ...
    of [channels.channelNumber()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/channels/properties#channels.__properties.channelNumber) by returning global indexes.
...
def getChannelVolume(
    ...
    for channels is defined in [midi.ChannelDefaultVolume](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/midi/miscellaneous#midi.__miscellaneous.ChannelDefaultVolume).
...
def getChannelType(index: int, useGlobalIndex: bool = False) -> int:
    ...
    * `int`: type of channel, one of the [channel type constants](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/midi/channel types).
...
def incEventValue(eventId: int, step: int, res: float = 1 / 24) -> int:
    ...
    Use result as new value in [general.processRECEvent()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/general/fl_state#general.__fl_state.processRECEvent).
    ...
    * `int`: incremented event value, for use in [general.processRECEvent()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/general/fl_state#general.__fl_state.processRECEvent).
...
def processRECEvent(eventId: int, value: int, flags: int, /) -> int:
    ...
    * This function is deprecated here, and moved to [general.processRECEvent()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/general/fl_state#general.__fl_state.processRECEvent)
      as of API version 7.
