...
def getStepParam(
    ...
    * [channels.getCurrentStepParam()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/channels/sequencer#channels.__sequencer.getCurrentStepParam)

    * [channels.setStepParameterByIndex()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/channels/sequencer#channels.__sequencer.setStepParameterByIndex)
...
def getCurrentStepParam(
    ...
    * How is it different from [channels.getStepParam()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/channels/sequencer#channels.__sequencer.getStepParam)?
