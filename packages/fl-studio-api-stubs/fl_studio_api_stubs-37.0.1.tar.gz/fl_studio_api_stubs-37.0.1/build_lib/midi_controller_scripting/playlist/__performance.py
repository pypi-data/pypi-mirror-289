...
def getDisplayZone() -> int:
    ...
    This value can be set using [playlist.liveDisplayZone()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/playlist/performance#playlist.__performance.liveDisplayZone).
...
def getLiveStatus(index: int, mode: int = midi.LB_Status_Default) -> int:
     ...
     * `int`: live status of track: refer to [FL Studio manual](https://www.image-line.com/fl-studio-learning/fl-studio-online-manual/html/midi_scripting.htm#getLiveStatusMode).
...
def triggerLiveClip(
    ...
    * `flags` (`int`): live clip trigger flags. Refer to [FL Studio manual](https://www.image-line.com/fl-studio-learning/fl-studio-online-manual/html/midi_scripting.htm#triggerLiveClipFlags).
...
def getVisTimeBar() -> int:
    ...
    [time format documentation](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/tutorials/time_units).
