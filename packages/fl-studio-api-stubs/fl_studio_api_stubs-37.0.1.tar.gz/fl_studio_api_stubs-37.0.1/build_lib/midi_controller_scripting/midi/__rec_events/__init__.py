...
For more information, check out the [tutorial on event mapping](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/tutorials/event_mapping).
