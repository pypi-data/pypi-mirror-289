...
them with the return value of [channels.getRecEventId()](https://il-group.github.io/FL-Studio-API-Stubs/midi_controller_scripting/channels/properties#channels.__properties.getRecEventId).
