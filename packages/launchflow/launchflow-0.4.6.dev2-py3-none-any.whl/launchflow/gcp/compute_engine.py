...
from launchflow.models.enums import EnvironmentType, ResourceProduct, ServiceProduct
from launchflow.models.flow_state import EnvironmentState
from launchflow.node import Inputs, Outputs
from launchflow.resource import Resource, ResourceInputs
...
class ComputeEngineService(GCPService):
    ...
    def __init__(
        ...
        self._mig = RegionalManagedInstanceGroup(
            name, target_size=target_size, region=region
        )
    ...
    def resources(self) -> List[Resource]:
        return [self._mig, self._firewall_rule, self._artifact_registry]
