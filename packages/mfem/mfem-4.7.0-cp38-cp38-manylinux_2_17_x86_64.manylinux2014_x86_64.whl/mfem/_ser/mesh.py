...
class Mesh(object):
    ...
    def KnotRemove(self, kv):
        r"""KnotRemove(Mesh self, VectorPtrArray kv)"""
...
class MeshPartitioner(object):
    ...
    def __init__(self, mesh_, num_parts_, partitioning_=None, part_method=1):
        r"""__init__(MeshPartitioner self, Mesh mesh_, int num_parts_, int * partitioning_=None, int part_method=1) -> MeshPartitioner"""
