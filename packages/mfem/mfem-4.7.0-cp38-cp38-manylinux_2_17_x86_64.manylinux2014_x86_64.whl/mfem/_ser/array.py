...
class intArrayPtrArray(object):
    r"""Proxy of C++ mfem::Array< mfem::Array< int > * > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    __swig_destroy__ = _array.delete_intArrayPtrArray

    def GetData(self, *args):
        r"""
        GetData(intArrayPtrArray self) -> intArray
        GetData(intArrayPtrArray self) -> mfem::Array< int > *const *
        """
        return _array.intArrayPtrArray_GetData(self, *args)
    GetData = _swig_new_instance_method(_array.intArrayPtrArray_GetData)

    def GetMemory(self, *args):
        r"""
        GetMemory(intArrayPtrArray self) -> mfem::Memory< mfem::Array< int > * >
        GetMemory(intArrayPtrArray self) -> mfem::Memory< mfem::Array< int > * > const &
        """
        return _array.intArrayPtrArray_GetMemory(self, *args)
    GetMemory = _swig_new_instance_method(_array.intArrayPtrArray_GetMemory)

    def UseDevice(self):
        r"""UseDevice(intArrayPtrArray self) -> bool"""
        return _array.intArrayPtrArray_UseDevice(self)
    UseDevice = _swig_new_instance_method(_array.intArrayPtrArray_UseDevice)

    def OwnsData(self):
        r"""OwnsData(intArrayPtrArray self) -> bool"""
        return _array.intArrayPtrArray_OwnsData(self)
    OwnsData = _swig_new_instance_method(_array.intArrayPtrArray_OwnsData)

    def StealData(self, p):
        r"""StealData(intArrayPtrArray self, mfem::Array< int > *** p)"""
        return _array.intArrayPtrArray_StealData(self, p)
    StealData = _swig_new_instance_method(_array.intArrayPtrArray_StealData)

    def LoseData(self):
        r"""LoseData(intArrayPtrArray self)"""
        return _array.intArrayPtrArray_LoseData(self)
    LoseData = _swig_new_instance_method(_array.intArrayPtrArray_LoseData)

    def MakeDataOwner(self):
        r"""MakeDataOwner(intArrayPtrArray self)"""
        return _array.intArrayPtrArray_MakeDataOwner(self)
    MakeDataOwner = _swig_new_instance_method(_array.intArrayPtrArray_MakeDataOwner)

    def Size(self):
        r"""Size(intArrayPtrArray self) -> int"""
        return _array.intArrayPtrArray_Size(self)
    Size = _swig_new_instance_method(_array.intArrayPtrArray_Size)

    def SetSize(self, *args):
        r"""
        SetSize(intArrayPtrArray self, int nsize)
        SetSize(intArrayPtrArray self, int nsize, intArray initval)
        SetSize(intArrayPtrArray self, int nsize, mfem::MemoryType mt)
        """
        return _array.intArrayPtrArray_SetSize(self, *args)
    SetSize = _swig_new_instance_method(_array.intArrayPtrArray_SetSize)

    def Capacity(self):
        r"""Capacity(intArrayPtrArray self) -> int"""
        return _array.intArrayPtrArray_Capacity(self)
    Capacity = _swig_new_instance_method(_array.intArrayPtrArray_Capacity)

    def Reserve(self, capacity):
        r"""Reserve(intArrayPtrArray self, int capacity)"""
        return _array.intArrayPtrArray_Reserve(self, capacity)
    Reserve = _swig_new_instance_method(_array.intArrayPtrArray_Reserve)

    def Append(self, *args):
        r"""
        Append(intArrayPtrArray self, intArray el) -> int
        Append(intArrayPtrArray self, mfem::Array< int > *const * els, int nels) -> int
        Append(intArrayPtrArray self, intArrayPtrArray els) -> int
        """
        ...
        return _array.intArrayPtrArray_Append(self, *args)


    def Prepend(self, el):
        r"""Prepend(intArrayPtrArray self, intArray el) -> int"""
        return _array.intArrayPtrArray_Prepend(self, el)
    Prepend = _swig_new_instance_method(_array.intArrayPtrArray_Prepend)

    def Last(self, *args):
        r"""
        Last(intArrayPtrArray self) -> intArray
        Last(intArrayPtrArray self) -> intArray
        """
        return _array.intArrayPtrArray_Last(self, *args)
    Last = _swig_new_instance_method(_array.intArrayPtrArray_Last)

    def DeleteLast(self):
        r"""DeleteLast(intArrayPtrArray self)"""
        return _array.intArrayPtrArray_DeleteLast(self)
    DeleteLast = _swig_new_instance_method(_array.intArrayPtrArray_DeleteLast)

    def DeleteAll(self):
        r"""DeleteAll(intArrayPtrArray self)"""
        return _array.intArrayPtrArray_DeleteAll(self)
    DeleteAll = _swig_new_instance_method(_array.intArrayPtrArray_DeleteAll)

    def Copy(self, copy):
        r"""Copy(intArrayPtrArray self, intArrayPtrArray copy)"""
        return _array.intArrayPtrArray_Copy(self, copy)
    Copy = _swig_new_instance_method(_array.intArrayPtrArray_Copy)

    def MakeRef(self, *args):
        r"""
        MakeRef(intArrayPtrArray self, mfem::Array< int > ** data_, int size_, bool own_data=False)
        MakeRef(intArrayPtrArray self, mfem::Array< int > ** data_, int size, mfem::MemoryType mt, bool own_data)
        MakeRef(intArrayPtrArray self, intArrayPtrArray master)
        """
        return _array.intArrayPtrArray_MakeRef(self, *args)
    MakeRef = _swig_new_instance_method(_array.intArrayPtrArray_MakeRef)

    def GetSubArray(self, offset, sa_size, sa):
        r"""GetSubArray(intArrayPtrArray self, int offset, int sa_size, intArrayPtrArray sa)"""
        return _array.intArrayPtrArray_GetSubArray(self, offset, sa_size, sa)
    GetSubArray = _swig_new_instance_method(_array.intArrayPtrArray_GetSubArray)

    def begin(self, *args):
        r"""
        begin(intArrayPtrArray self) -> intArray
        begin(intArrayPtrArray self) -> mfem::Array< int > *const *
        """
        return _array.intArrayPtrArray_begin(self, *args)
    begin = _swig_new_instance_method(_array.intArrayPtrArray_begin)

    def end(self, *args):
        r"""
        end(intArrayPtrArray self) -> intArray
        end(intArrayPtrArray self) -> mfem::Array< int > *const *
        """
        return _array.intArrayPtrArray_end(self, *args)
    end = _swig_new_instance_method(_array.intArrayPtrArray_end)

    def MemoryUsage(self):
        r"""MemoryUsage(intArrayPtrArray self) -> std::size_t"""
        return _array.intArrayPtrArray_MemoryUsage(self)
    MemoryUsage = _swig_new_instance_method(_array.intArrayPtrArray_MemoryUsage)

    def Read(self, on_dev=True):
        r"""Read(intArrayPtrArray self, bool on_dev=True) -> mfem::Array< int > *const *"""
        return _array.intArrayPtrArray_Read(self, on_dev)
    Read = _swig_new_instance_method(_array.intArrayPtrArray_Read)

    def HostRead(self):
        r"""HostRead(intArrayPtrArray self) -> mfem::Array< int > *const *"""
        return _array.intArrayPtrArray_HostRead(self)
    HostRead = _swig_new_instance_method(_array.intArrayPtrArray_HostRead)

    def Write(self, on_dev=True):
        r"""Write(intArrayPtrArray self, bool on_dev=True) -> mfem::Array< int > **"""
        return _array.intArrayPtrArray_Write(self, on_dev)
    Write = _swig_new_instance_method(_array.intArrayPtrArray_Write)

    def HostWrite(self):
        r"""HostWrite(intArrayPtrArray self) -> mfem::Array< int > **"""
        return _array.intArrayPtrArray_HostWrite(self)
    HostWrite = _swig_new_instance_method(_array.intArrayPtrArray_HostWrite)

    def ReadWrite(self, on_dev=True):
        r"""ReadWrite(intArrayPtrArray self, bool on_dev=True) -> mfem::Array< int > **"""
        return _array.intArrayPtrArray_ReadWrite(self, on_dev)
    ReadWrite = _swig_new_instance_method(_array.intArrayPtrArray_ReadWrite)

    def HostReadWrite(self):
        r"""HostReadWrite(intArrayPtrArray self) -> mfem::Array< int > **"""
        return _array.intArrayPtrArray_HostReadWrite(self)
    HostReadWrite = _swig_new_instance_method(_array.intArrayPtrArray_HostReadWrite)

    def __init__(self, *args):
        r"""
        __init__(intArrayPtrArray self) -> intArrayPtrArray
        __init__(intArrayPtrArray self, mfem::MemoryType mt) -> intArrayPtrArray
        __init__(intArrayPtrArray self, int asize) -> intArrayPtrArray
        __init__(intArrayPtrArray self, int asize, mfem::MemoryType mt) -> intArrayPtrArray
        __init__(intArrayPtrArray self, mfem::Array< int > ** data_, int asize, bool own_data=False) -> intArrayPtrArray
        __init__(intArrayPtrArray self, intArrayPtrArray src) -> intArrayPtrArray
        __init__(intArrayPtrArray self, intArrayPtrArray src) -> intArrayPtrArray
        __init__(intArrayPtrArray self, void * List_or_Tuple, mfem::Array< int > ** _unused) -> intArrayPtrArray
        """
        _array.intArrayPtrArray_swiginit(self, _array.new_intArrayPtrArray(*args))

    def __setitem__(self, i, v):
        r"""__setitem__(intArrayPtrArray self, int i, intArray v)"""

        i = int(i)


        return _array.intArrayPtrArray___setitem__(self, i, v)


    def Assign(self, *args):
        r"""
        Assign(intArrayPtrArray self, mfem::Array< int > *const * arg2)
        Assign(intArrayPtrArray self, intArray a)
        """
        return _array.intArrayPtrArray_Assign(self, *args)
    Assign = _swig_new_instance_method(_array.intArrayPtrArray_Assign)
    ...
    def __getitem__(self, param):
        r"""__getitem__(intArrayPtrArray self, PyObject * param) -> PyObject *"""
        return _array.intArrayPtrArray___getitem__(self, param)
    __getitem__ = _swig_new_instance_method(_array.intArrayPtrArray___getitem__)

# Register intArrayPtrArray in _array:
_array.intArrayPtrArray_swigregister(intArrayPtrArray)
