...
class ElementTransformation(object):
    ...
    mesh = property(_eltrans.ElementTransformation_mesh_get, _eltrans.ElementTransformation_mesh_set, doc=r"""mesh : p.q(const).mfem::Mesh""")
    ...
    def Weight(self):
        r"""Weight(ElementTransformation self) -> mfem::real_t"""
...
class InverseElementTransformation(object):
    ...
    def SetReferenceTol(self, ref_sp_tol):
        r"""SetReferenceTol(InverseElementTransformation self, mfem::real_t ref_sp_tol)"""
    ...
    def SetPhysicalRelTol(self, phys_rel_tol):
        r"""SetPhysicalRelTol(InverseElementTransformation self, mfem::real_t phys_rel_tol)"""
    ...
    def SetElementTol(self, el_tol):
        r"""SetElementTol(InverseElementTransformation self, mfem::real_t el_tol)"""
...
class IsoparametricTransformation(ElementTransformation):
    ...
    def _TransformBack(self, pt, ip, phys_tol=1e-15):
        r"""_TransformBack(IsoparametricTransformation self, Vector pt, IntegrationPoint ip, mfem::real_t const phys_tol=1e-15) -> int"""
        return _eltrans.IsoparametricTransformation__TransformBack(self, pt, ip, phys_tol)
    _TransformBack = _swig_new_instance_method(_eltrans.IsoparametricTransformation__TransformBack)
...
class FaceElementTransformations(IsoparametricTransformation):
    ...
    def CheckConsistency(self, *args, **kwargs):
        r"""CheckConsistency(FaceElementTransformations self, int print_level=0, std::ostream & out=out) -> mfem::real_t"""
