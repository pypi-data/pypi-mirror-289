...
class RowNode(object):
    ...
    __repr__ = _swig_repr
    Value = property(_sparsemat.RowNode_Value_get, _sparsemat.RowNode_Value_set, doc=r"""Value : mfem::real_t""")
...
class SparseMatrix(mfem._ser.matrix.AbstractSparseMatrix):
    ...
    def __init__(self, *args):
        ...
        __init__(SparseMatrix self, int * i, int * j, mfem::real_t * data, int m, int n) -> SparseMatrix
        __init__(SparseMatrix self, int * i, int * j, mfem::real_t * data, int m, int n, bool ownij, bool owna, bool issorted) -> SparseMatrix
    ...
    def GetData(self, *args):
        r"""
        GetData(SparseMatrix self) -> mfem::real_t
        GetData(SparseMatrix self) -> mfem::real_t const *
        """
    ...
    def GetMemoryData(self, *args):
        r"""
        GetMemoryData(SparseMatrix self) -> mfem::Memory< mfem::real_t >
        GetMemoryData(SparseMatrix self) -> mfem::Memory< mfem::real_t > const &
        """
    ...
    def ReadData(self, on_dev=True):
        r"""ReadData(SparseMatrix self, bool on_dev=True) -> mfem::real_t const *"""
    ...
    def WriteData(self, on_dev=True):
        r"""WriteData(SparseMatrix self, bool on_dev=True) -> mfem::real_t *"""
    ...
    def ReadWriteData(self, on_dev=True):
        r"""ReadWriteData(SparseMatrix self, bool on_dev=True) -> mfem::real_t *"""
    ...
    def HostReadData(self):
        r"""HostReadData(SparseMatrix self) -> mfem::real_t const *"""
    ...
    def HostWriteData(self):
        r"""HostWriteData(SparseMatrix self) -> mfem::real_t *"""
    ...
    def HostReadWriteData(self):
        r"""HostReadWriteData(SparseMatrix self) -> mfem::real_t *"""
    ...
    def GetRowEntries(self, *args):
        r"""
        GetRowEntries(SparseMatrix self, int const row) -> mfem::real_t
        GetRowEntries(SparseMatrix self, int const row) -> mfem::real_t const *
        """
    ...
    def Elem(self, *args):
        r"""
        Elem(SparseMatrix self, int i, int j) -> mfem::real_t
        Elem(SparseMatrix self, int i, int j) -> mfem::real_t const &
        """
    ...
    def __call__(self, *args):
        r"""
        __call__(SparseMatrix self, int i, int j) -> mfem::real_t
        __call__(SparseMatrix self, int i, int j) -> mfem::real_t const &
        """
    ...
    def AddMult(self, x, y, a=1.0):
        r"""AddMult(SparseMatrix self, Vector x, Vector y, mfem::real_t const a=1.0)"""
    ...
    def AddMultTranspose(self, x, y, a=1.0):
        r"""AddMultTranspose(SparseMatrix self, Vector x, Vector y, mfem::real_t const a=1.0)"""
    ...
    def PartAddMult(self, rows, x, y, a=1.0):
        r"""PartAddMult(SparseMatrix self, intArray rows, Vector x, Vector y, mfem::real_t const a=1.0)"""
    ...
    def InnerProduct(self, x, y):
        r"""InnerProduct(SparseMatrix self, Vector x, Vector y) -> mfem::real_t"""
    ...
    def GetRowNorml1(self, irow):
        r"""GetRowNorml1(SparseMatrix self, int irow) -> mfem::real_t"""
    ...
    def EliminateRow(self, *args):
        r"""
        EliminateRow(SparseMatrix self, int row, mfem::real_t const sol, Vector rhs)
    ...
    def EliminateRowColDiag(self, rc, value):
        r"""EliminateRowColDiag(SparseMatrix self, int rc, mfem::real_t value)"""
    ...
    def EliminateRowCol(self, *args):
        r"""
        EliminateRowCol(SparseMatrix self, int rc, mfem::real_t const sol, Vector rhs, mfem::Operator::DiagonalPolicy dpolicy=DIAG_ONE)
    ...
    def EliminateZeroRows(self, threshold=1e-12):
        r"""EliminateZeroRows(SparseMatrix self, mfem::real_t const threshold=1e-12)"""
    ...
    def GetJacobiScaling(self):
        r"""GetJacobiScaling(SparseMatrix self) -> mfem::real_t"""
    ...
    def Jacobi(self, b, x0, x1, sc, use_abs_diag=False):
        r"""Jacobi(SparseMatrix self, Vector b, Vector x0, Vector x1, mfem::real_t sc, bool use_abs_diag=False)"""
    ...
    def DiagScale(self, b, x, sc=1.0, use_abs_diag=False):
        r"""DiagScale(SparseMatrix self, Vector b, Vector x, mfem::real_t sc=1.0, bool use_abs_diag=False)"""
    ...
    def Jacobi2(self, b, x0, x1, sc=1.0):
        r"""Jacobi2(SparseMatrix self, Vector b, Vector x0, Vector x1, mfem::real_t sc=1.0)"""
    ...
    def Jacobi3(self, b, x0, x1, sc=1.0):
        r"""Jacobi3(SparseMatrix self, Vector b, Vector x0, Vector x1, mfem::real_t sc=1.0)"""
    ...
    def Threshold(self, tol, fix_empty_rows=False):
        r"""Threshold(SparseMatrix self, mfem::real_t tol, bool fix_empty_rows=False)"""
    ...
    def _Get_(self, col):
        r"""_Get_(SparseMatrix self, int const col) -> mfem::real_t"""
    ...
    def SearchRow(self, *args):
        r"""
        SearchRow(SparseMatrix self, int const col) -> mfem::real_t
        SearchRow(SparseMatrix self, int const row, int const col) -> mfem::real_t &
        """
    ...
    def _Add_(self, *args):
        r"""
        _Add_(SparseMatrix self, int const col, mfem::real_t const a)
        _Add_(SparseMatrix self, int const row, int const col, mfem::real_t const a)
        """
    ...
    def _Set_(self, *args):
        r"""
        _Set_(SparseMatrix self, int const col, mfem::real_t const a)
        _Set_(SparseMatrix self, int const row, int const col, mfem::real_t const a)
        """
        return _sparsemat.SparseMatrix__Set_(self, *args)
    _Set_ = _swig_new_instance_method(_sparsemat.SparseMatrix__Set_)

    def Set(self, i, j, val):
        r"""Set(SparseMatrix self, int const i, int const j, mfem::real_t const val)"""
    ...
    def ScaleRow(self, row, scale):
        r"""ScaleRow(SparseMatrix self, int const row, mfem::real_t const scale)"""
    ...
    def Add(self, *args):
        r"""
        Add(SparseMatrix self, int const i, int const j, mfem::real_t const val)
        Add(SparseMatrix self, mfem::real_t const a, SparseMatrix B)
        """
        return _sparsemat.SparseMatrix_Add(self, *args)
    Add = _swig_new_instance_method(_sparsemat.SparseMatrix_Add)

    def __imul__(self, a):
        r"""__imul__(SparseMatrix self, mfem::real_t a) -> SparseMatrix"""
    ...
    def IsSymmetric(self):
        r"""IsSymmetric(SparseMatrix self) -> mfem::real_t"""
    ...
    def MaxNorm(self):
        r"""MaxNorm(SparseMatrix self) -> mfem::real_t"""
    ...
    def CountSmallElems(self, tol):
        r"""CountSmallElems(SparseMatrix self, mfem::real_t tol) -> int"""
...
def SparseMatrixFunction(S, f):
    r"""SparseMatrixFunction(SparseMatrix S, mfem::real_t (*)(mfem::real_t) f)"""
