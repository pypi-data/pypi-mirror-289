...
class NonlinearFormIntegrator(object):
    ...
    def SetNURBSPatchIntRule(self, pr):
        r"""SetNURBSPatchIntRule(NonlinearFormIntegrator self, NURBSMeshRules pr)"""
        return _nonlininteg.NonlinearFormIntegrator_SetNURBSPatchIntRule(self, pr)
    SetNURBSPatchIntRule = _swig_new_instance_method(_nonlininteg.NonlinearFormIntegrator_SetNURBSPatchIntRule)

    def HasNURBSPatchIntRule(self):
        r"""HasNURBSPatchIntRule(NonlinearFormIntegrator self) -> bool"""
        return _nonlininteg.NonlinearFormIntegrator_HasNURBSPatchIntRule(self)
    HasNURBSPatchIntRule = _swig_new_instance_method(_nonlininteg.NonlinearFormIntegrator_HasNURBSPatchIntRule)
