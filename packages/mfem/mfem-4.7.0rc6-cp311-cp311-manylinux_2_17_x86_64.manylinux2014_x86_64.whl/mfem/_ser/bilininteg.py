...
class DGDiffusionIntegrator(BilinearFormIntegrator):
    ...
    def GetRule(self, order, T):
        r"""GetRule(DGDiffusionIntegrator self, int order, FaceElementTransformations T) -> IntegrationRule"""
        return _bilininteg.DGDiffusionIntegrator_GetRule(self, order, T)
