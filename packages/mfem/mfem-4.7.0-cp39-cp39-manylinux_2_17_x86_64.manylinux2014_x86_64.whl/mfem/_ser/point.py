...
class Point(mfem._ser.element.Element):
    ...
    def SetVertices(self, *args):
        r"""
        SetVertices(Point self, intArray v)
        SetVertices(Point self, int const * ind)
        """
        return _point.Point_SetVertices(self, *args)
    SetVertices = _swig_new_instance_method(_point.Point_SetVertices)
