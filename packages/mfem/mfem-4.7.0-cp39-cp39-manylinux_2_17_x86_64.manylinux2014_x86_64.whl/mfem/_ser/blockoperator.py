...
class BlockOperator(mfem._ser.operators.Operator):
    ...
    def SetDiagonalBlock(self, iblock, op, c=1.0):
        r"""SetDiagonalBlock(BlockOperator self, int iblock, Operator op, mfem::real_t c=1.0)"""
    ...
    def SetBlock(self, iRow, iCol, op, c=1.0):
        r"""SetBlock(BlockOperator self, int iRow, int iCol, Operator op, mfem::real_t c=1.0)"""
    ...
    def GetBlockCoef(self, i, j):
        r"""GetBlockCoef(BlockOperator self, int i, int j) -> mfem::real_t"""
    ...
    def SetBlockCoef(self, i, j, c):
        r"""SetBlockCoef(BlockOperator self, int i, int j, mfem::real_t c)"""
