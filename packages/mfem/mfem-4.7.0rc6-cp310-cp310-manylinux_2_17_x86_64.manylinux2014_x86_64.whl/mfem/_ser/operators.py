...
class OperatorPtrArray(object):
    ...
    def MakeRef(self, *args):
        r"""
        MakeRef(OperatorPtrArray self, mfem::Operator ** data_, int size_, bool own_data=False)
        MakeRef(OperatorPtrArray self, mfem::Operator ** data_, int size, mfem::MemoryType mt, bool own_data)
    ...
    def __init__(self, *args):
        ...
        __init__(OperatorPtrArray self, mfem::Operator ** data_, bool own_data=False) -> OperatorPtrArray
...
class SolverPtrArray(object):
    ...
    def MakeRef(self, *args):
        r"""
        MakeRef(SolverPtrArray self, mfem::Solver ** data_, int size_, bool own_data=False)
        MakeRef(SolverPtrArray self, mfem::Solver ** data_, int size, mfem::MemoryType mt, bool own_data)
    ...
    def __init__(self, *args):
        ...
        __init__(SolverPtrArray self, mfem::Solver ** data_, bool own_data=False) -> SolverPtrArray
...
def Swap(*args):
    ...
    Swap(OperatorPtrArray arg1, OperatorPtrArray arg2)
    Swap(SolverPtrArray arg1, SolverPtrArray arg2)
    """
...
class Operator(object):
    ...
    def ArrayAddMult(self, X, Y, a=1.0):
        r"""ArrayAddMult(Operator self, mfem::Array< mfem::Vector const * > const & X, VectorPtrArray Y, mfem::real_t const a=1.0)"""
    ...
    def ArrayAddMultTranspose(self, X, Y, a=1.0):
        r"""ArrayAddMultTranspose(Operator self, mfem::Array< mfem::Vector const * > const & X, VectorPtrArray Y, mfem::real_t const a=1.0)"""
...
class TimeDependentOperator(Operator):
    ...
    def __init__(self, *args):
        ...
        __init__(TimeDependentOperator self, int h, int w, mfem::real_t t_=0.0, mfem::TimeDependentOperator::Type type_=EXPLICIT) -> TimeDependentOperator
        """
    ...
    def ImplicitSolve(self, dt, x, k):
        r"""ImplicitSolve(TimeDependentOperator self, mfem::real_t const dt, Vector x, Vector k)"""
    ...
    def GetImplicitGradient(self, x, k, shift):
        r"""GetImplicitGradient(TimeDependentOperator self, Vector x, Vector k, mfem::real_t shift) -> Operator"""
    ...
    def SUNImplicitSetup(self, x, fx, jok, jcur, gamma):
        r"""SUNImplicitSetup(TimeDependentOperator self, Vector x, Vector fx, int jok, int * jcur, mfem::real_t gamma) -> int"""
    ...
    def SUNImplicitSolve(self, b, x, tol):
        r"""SUNImplicitSolve(TimeDependentOperator self, Vector b, Vector x, mfem::real_t tol) -> int"""
...
class SecondOrderTimeDependentOperator(TimeDependentOperator):
    ...
    def ImplicitSolve(self, *args):
        r"""
        ImplicitSolve(SecondOrderTimeDependentOperator self, mfem::real_t const dt, Vector x, Vector k)
