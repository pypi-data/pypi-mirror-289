...
class Poly_1D(object):
    ...
    def GetPoints(self, p, btype):
        r"""GetPoints(Poly_1D self, int const p, int const btype) -> mfem::real_t const *"""
    ...
    def OpenPoints(self, *args, **kwargs):
        r"""OpenPoints(Poly_1D self, int const p, int const btype=GaussLegendre) -> mfem::real_t const *"""
    ...
    def ClosedPoints(self, *args, **kwargs):
        r"""ClosedPoints(Poly_1D self, int const p, int const btype=GaussLobatto) -> mfem::real_t const *"""
