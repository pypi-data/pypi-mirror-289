...
class NewmarkSolver(SecondOrderODESolver):
    ...
    def __init__(self, beta_=0.25, gamma_=0.5):
        r"""__init__(NewmarkSolver self, mfem::real_t beta_=0.25, mfem::real_t gamma_=0.5) -> NewmarkSolver"""
...
class GeneralizedAlpha2Solver(SecondOrderODESolver):
    ...
    def __init__(self, rho_inf=1.0):
        r"""__init__(GeneralizedAlpha2Solver self, mfem::real_t rho_inf=1.0) -> GeneralizedAlpha2Solver"""
