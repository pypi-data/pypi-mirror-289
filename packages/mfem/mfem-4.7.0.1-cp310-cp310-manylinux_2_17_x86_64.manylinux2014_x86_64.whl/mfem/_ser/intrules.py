...
class IntegrationRulePtrArray(object):
    ...
    def MakeRef(self, *args):
        r"""
        MakeRef(IntegrationRulePtrArray self, mfem::IntegrationRule ** data_, int size_, bool own_data=False)
        MakeRef(IntegrationRulePtrArray self, mfem::IntegrationRule ** data_, int size, mfem::MemoryType mt, bool own_data)
    ...
    def __init__(self, *args):
        ...
        __init__(IntegrationRulePtrArray self, mfem::IntegrationRule ** data_, bool own_data=False) -> IntegrationRulePtrArray
...
class NURBSMeshRules(object):
    ...
    def GetElementRule(self, elem, patch, ijk, kv, deleteRule):
        r"""GetElementRule(NURBSMeshRules self, int const elem, int const patch, int const * ijk, mfem::Array< mfem::KnotVector const * > const & kv, bool & deleteRule) -> IntegrationRule"""
        return _intrules.NURBSMeshRules_GetElementRule(self, elem, patch, ijk, kv, deleteRule)
