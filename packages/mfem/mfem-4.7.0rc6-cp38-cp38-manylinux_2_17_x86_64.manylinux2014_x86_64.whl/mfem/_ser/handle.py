...
MFEM_SKIP_RETURN_VALUE = _handle.MFEM_SKIP_RETURN_VALUE
...
class OperatorHandle(object):
    ...
    def AddMult(self, x, y, a=1.0):
        r"""AddMult(OperatorHandle self, Vector x, Vector y, mfem::real_t const a=1.0)"""
    ...
    def AddMultTranspose(self, x, y, a=1.0):
        r"""AddMultTranspose(OperatorHandle self, Vector x, Vector y, mfem::real_t const a=1.0)"""
    ...
    def ArrayAddMult(self, X, Y, a=1.0):
        r"""ArrayAddMult(OperatorHandle self, mfem::Array< mfem::Vector const * > const & X, VectorPtrArray Y, mfem::real_t const a=1.0)"""
    ...
    def ArrayAddMultTranspose(self, X, Y, a=1.0):
        r"""ArrayAddMultTranspose(OperatorHandle self, mfem::Array< mfem::Vector const * > const & X, VectorPtrArray Y, mfem::real_t const a=1.0)"""
