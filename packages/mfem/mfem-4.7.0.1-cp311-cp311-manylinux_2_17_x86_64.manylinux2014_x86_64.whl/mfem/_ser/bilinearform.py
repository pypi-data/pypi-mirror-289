...
class BilinearFormPtrArray(object):
    ...
    def MakeRef(self, *args):
        r"""
        MakeRef(BilinearFormPtrArray self, mfem::BilinearForm ** data_, int size_, bool own_data=False)
        MakeRef(BilinearFormPtrArray self, mfem::BilinearForm ** data_, int size, mfem::MemoryType mt, bool own_data)
    ...
    def __init__(self, *args):
        ...
        __init__(BilinearFormPtrArray self, mfem::BilinearForm ** data_, bool own_data=False) -> BilinearFormPtrArray
...
def Swap(*args):
    ...
    Swap(BilinearFormPtrArray arg1, BilinearFormPtrArray arg2)
    """
...
class BilinearForm(mfem._ser.matrix.Matrix):
    ...
    def GetDBFI_Marker(self):
        r"""GetDBFI_Marker(BilinearForm self) -> intArrayPtrArray"""
    ...
    def GetBBFI_Marker(self):
        r"""GetBBFI_Marker(BilinearForm self) -> intArrayPtrArray"""
    ...
    def GetBFBFI_Marker(self):
        r"""GetBFBFI_Marker(BilinearForm self) -> intArrayPtrArray"""
...
class MixedBilinearForm(mfem._ser.matrix.Matrix):
    ...
    def GetDBFI_Marker(self):
        r"""GetDBFI_Marker(MixedBilinearForm self) -> intArrayPtrArray"""
    ...
    def GetBBFI_Marker(self):
        r"""GetBBFI_Marker(MixedBilinearForm self) -> intArrayPtrArray"""
    ...
    def GetBTFBFI_Marker(self):
        r"""GetBTFBFI_Marker(MixedBilinearForm self) -> intArrayPtrArray"""
...
class DiscreteLinearOperator(MixedBilinearForm):
    ...
    def GetDI_Marker(self):
        r"""GetDI_Marker(DiscreteLinearOperator self) -> intArrayPtrArray"""
