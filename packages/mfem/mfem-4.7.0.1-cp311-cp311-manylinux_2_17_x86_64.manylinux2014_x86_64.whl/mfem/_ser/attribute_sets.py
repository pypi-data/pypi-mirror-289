...
class AttributeSets(object):
    ...
    def GetAttributeSet(self, set_name):
        r"""GetAttributeSet(AttributeSets self, std::string const & set_name) -> intArray"""
        return _attribute_sets.AttributeSets_GetAttributeSet(self, set_name)
