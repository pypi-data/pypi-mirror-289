...
class Matrix(mfem._ser.operators.Operator):
    ...
    def Elem(self, *args):
        r"""
        Elem(Matrix self, int i, int j) -> mfem::real_t
        Elem(Matrix self, int i, int j) -> mfem::real_t const &
        """
...
class AbstractSparseMatrix(Matrix):
    ...
    def EliminateZeroRows(self, threshold=1e-12):
        r"""EliminateZeroRows(AbstractSparseMatrix self, mfem::real_t const threshold=1e-12)"""
    ...
    def AddMult(self, x, y, val=1.):
        r"""AddMult(AbstractSparseMatrix self, Vector x, Vector y, mfem::real_t const val=1.)"""
    ...
    def AddMultTranspose(self, x, y, val=1.):
        r"""AddMultTranspose(AbstractSparseMatrix self, Vector x, Vector y, mfem::real_t const val=1.)"""
