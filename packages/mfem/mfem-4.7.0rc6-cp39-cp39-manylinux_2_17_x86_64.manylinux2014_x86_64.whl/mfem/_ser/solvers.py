...
MFEM_SKIP_RETURN_VALUE = _solvers.MFEM_SKIP_RETURN_VALUE
...
class IterativeSolverMonitor(object):
    ...
    def MonitorResidual(self, it, norm, r, final):
        r"""MonitorResidual(IterativeSolverMonitor self, int it, mfem::real_t norm, Vector r, bool final)"""
    ...
    def MonitorSolution(self, it, norm, x, final):
        r"""MonitorSolution(IterativeSolverMonitor self, int it, mfem::real_t norm, Vector x, bool final)"""
...
class IterativeSolver(mfem._ser.operators.Solver):
    ...
    def SetRelTol(self, rtol):
        r"""SetRelTol(IterativeSolver self, mfem::real_t rtol)"""
    ...
    def SetAbsTol(self, atol):
        r"""SetAbsTol(IterativeSolver self, mfem::real_t atol)"""
    ...
    def GetInitialNorm(self):
        r"""GetInitialNorm(IterativeSolver self) -> mfem::real_t"""
    ...
    def GetFinalNorm(self):
        r"""GetFinalNorm(IterativeSolver self) -> mfem::real_t"""
    ...
    def GetFinalRelNorm(self):
        r"""GetFinalRelNorm(IterativeSolver self) -> mfem::real_t"""
...
class OperatorJacobiSmoother(mfem._ser.operators.Solver):
    ...
    def __init__(self, *args):
        r"""
        __init__(OperatorJacobiSmoother self, mfem::real_t const damping=1.0) -> OperatorJacobiSmoother
        __init__(OperatorJacobiSmoother self, mfem::BilinearForm const & a, intArray ess_tdof_list, mfem::real_t const damping=1.0) -> OperatorJacobiSmoother
        __init__(OperatorJacobiSmoother self, Vector d, intArray ess_tdof_list, mfem::real_t const damping=1.0) -> OperatorJacobiSmoother
        """
...
class OperatorChebyshevSmoother(mfem._ser.operators.Solver):
    ...
    def __init__(self, *args):
        r"""
        __init__(OperatorChebyshevSmoother self, Operator oper_, Vector d, intArray ess_tdof_list, int order, mfem::real_t max_eig_estimate) -> OperatorChebyshevSmoother
        __init__(OperatorChebyshevSmoother self, Operator oper_, Vector d, intArray ess_tdof_list, int order, mfem::real_t max_eig_estimate) -> OperatorChebyshevSmoother
        __init__(OperatorChebyshevSmoother self, Operator oper_, Vector d, intArray ess_tdof_list, int order, int power_iterations=10, mfem::real_t power_tolerance=1e-8) -> OperatorChebyshevSmoother
        __init__(OperatorChebyshevSmoother self, Operator oper_, Vector d, intArray ess_tdof_list, int order, int power_iterations=10, mfem::real_t power_tolerance=1e-8) -> OperatorChebyshevSmoother
        """
...
def SLI(*args):
    r"""
    SLI(Operator A, Vector b, Vector x, int print_iter=0, int max_num_iter=1000, mfem::real_t RTOLERANCE=1e-12, mfem::real_t ATOLERANCE=1e-24)
    SLI(Operator A, Solver B, Vector b, Vector x, int print_iter=0, int max_num_iter=1000, mfem::real_t RTOLERANCE=1e-12, mfem::real_t ATOLERANCE=1e-24)
    """
...
def CG(A, b, x, print_iter=0, max_num_iter=1000, RTOLERANCE=1e-12, ATOLERANCE=1e-24):
    r"""CG(Operator A, Vector b, Vector x, int print_iter=0, int max_num_iter=1000, mfem::real_t RTOLERANCE=1e-12, mfem::real_t ATOLERANCE=1e-24)"""
...
def PCG(A, B, b, x, print_iter=0, max_num_iter=1000, RTOLERANCE=1e-12, ATOLERANCE=1e-24):
    r"""PCG(Operator A, Solver B, Vector b, Vector x, int print_iter=0, int max_num_iter=1000, mfem::real_t RTOLERANCE=1e-12, mfem::real_t ATOLERANCE=1e-24)"""
...
def GMRES(*args):
    r"""
    GMRES(Operator A, Vector x, Vector b, Solver M, int & max_iter, int m, mfem::real_t & tol, mfem::real_t atol, int printit) -> int
    GMRES(Operator A, Solver B, Vector b, Vector x, int print_iter=0, int max_num_iter=1000, int m=50, mfem::real_t rtol=1e-12, mfem::real_t atol=1e-24)
    """
...
def BiCGSTAB(*args):
    r"""
    BiCGSTAB(Operator A, Vector x, Vector b, Solver M, int & max_iter, mfem::real_t & tol, mfem::real_t atol, int printit) -> int
    BiCGSTAB(Operator A, Solver B, Vector b, Vector x, int print_iter=0, int max_num_iter=1000, mfem::real_t rtol=1e-12, mfem::real_t atol=1e-24)
    """
...
def MINRES(*args):
    r"""
    MINRES(Operator A, Vector b, Vector x, int print_it=0, int max_it=1000, mfem::real_t rtol=1e-12, mfem::real_t atol=1e-24)
    MINRES(Operator A, Solver B, Vector b, Vector x, int print_it=0, int max_it=1000, mfem::real_t rtol=1e-12, mfem::real_t atol=1e-24)
    """
...
class NewtonSolver(IterativeSolver):
    ...
    def ComputeScalingFactor(self, x, b):
        r"""ComputeScalingFactor(NewtonSolver self, Vector x, Vector b) -> mfem::real_t"""
    ...
    def SetAdaptiveLinRtol(self, *args, **kwargs):
        r"""SetAdaptiveLinRtol(NewtonSolver self, int const type=2, mfem::real_t const rtol0=0.5, mfem::real_t const rtol_max=0.9, mfem::real_t const alpha=0.5*(1.0+sqrt(5.0)), mfem::real_t const gamma=1.0)"""
...
def aGMRES(A, x, b, M, max_iter, m_max, m_min, m_step, cf, tol, atol, printit):
    r"""aGMRES(Operator A, Vector x, Vector b, Operator M, int & max_iter, int m_max, int m_min, int m_step, mfem::real_t cf, mfem::real_t & tol, mfem::real_t & atol, int printit) -> int"""
...
class OptimizationProblem(object):
    ...
    def CalcObjective(self, x):
        r"""CalcObjective(OptimizationProblem self, Vector x) -> mfem::real_t"""
...
class SLBQPOptimizer(OptimizationSolver):
    ...
    def SetLinearConstraint(self, w_, a_):
        r"""SetLinearConstraint(SLBQPOptimizer self, Vector w_, mfem::real_t a_)"""
...
class BlockILU(mfem._ser.operators.Solver):
    ...
    def GetBlockData(self):
        r"""GetBlockData(BlockILU self) -> mfem::real_t *"""
...
class ResidualBCMonitor(IterativeSolverMonitor):
    ...
    def MonitorResidual(self, it, norm, r, final):
        r"""MonitorResidual(ResidualBCMonitor self, int it, mfem::real_t norm, Vector r, bool final)"""
...
class PyIterativeSolver(IterativeSolver):
    ...
    def Dot(self, x, y):
        r"""Dot(PyIterativeSolver self, Vector x, Vector y) -> mfem::real_t"""
        return _solvers.PyIterativeSolver_Dot(self, x, y)
    Dot = _swig_new_instance_method(_solvers.PyIterativeSolver_Dot)
