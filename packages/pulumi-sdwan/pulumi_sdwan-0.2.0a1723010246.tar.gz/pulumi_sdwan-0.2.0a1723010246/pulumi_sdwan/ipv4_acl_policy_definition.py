...
class Ipv4AclPolicyDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 sequences: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ipv4AclPolicyDefinitionSequenceArgs']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] description: The description of the policy definition
        :param pulumi.Input[str] name: The name of the policy definition
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ipv4AclPolicyDefinitionSequenceArgs']]]] sequences: List of ACL sequences
        """
        ...
    @overload
    def __init__(__self__,
