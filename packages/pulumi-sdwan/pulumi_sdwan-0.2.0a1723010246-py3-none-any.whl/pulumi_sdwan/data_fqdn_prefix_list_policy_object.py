...
class DataFqdnPrefixListPolicyObject(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 entries: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DataFqdnPrefixListPolicyObjectEntryArgs']]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        example = sdwan.DataFqdnPrefixListPolicyObject("example",
            name="Example",
            entries=[sdwan.DataFqdnPrefixListPolicyObjectEntryArgs(
                fqdn="cisco.com",
            )])
        ```
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DataFqdnPrefixListPolicyObjectEntryArgs']]]] entries: List of entries
        :param pulumi.Input[str] name: The name of the policy object
        """
        ...
    @overload
