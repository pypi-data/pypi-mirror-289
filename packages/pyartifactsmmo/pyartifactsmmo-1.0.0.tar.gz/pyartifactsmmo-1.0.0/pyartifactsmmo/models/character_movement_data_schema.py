...
class CharacterMovementDataSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cooldown", "destination", "character"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "destination": MapSchema.from_dict(obj["destination"]) if obj.get("destination") is not None else None,
