...
class MonstersApi:
    ...
    async def get_all_monsters_monsters_get(
        ...
        :param min_level: Monster minimum level.
        :type min_level: int
        :param max_level: Monster maximum level.
        :type max_level: int
        ...
        _param = self._get_all_monsters_monsters_get_serialize(
            min_level=min_level,
            max_level=max_level,
            drop=drop,
            page=page,
    ...
    async def get_all_monsters_monsters_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DataPageMonsterSchema]:
        """Get All Monsters
    ...
    def _get_all_monsters_monsters_get_serialize(
        self,
        min_level,
        max_level,
        drop,
    ...
    async def get_monster_monsters_code_get(
        ...
        _param = self._get_monster_monsters_code_get_serialize(
            code=code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def get_monster_monsters_code_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MonsterResponseSchema]:
        """Get Monster
    ...
    def _get_monster_monsters_code_get_serialize(
        self,
        code,
        _request_auth,
        _content_type,
