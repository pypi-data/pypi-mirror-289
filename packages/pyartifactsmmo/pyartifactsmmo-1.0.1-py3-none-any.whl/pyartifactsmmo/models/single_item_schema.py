...
class SingleItemSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["item", "ge"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ge
        if self.ge:
            _dict['ge'] = self.ge.to_dict()
        # set to None if ge (nullable) is None
        # and model_fields_set contains the field
        if self.ge is None and "ge" in self.model_fields_set:
            _dict['ge'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ge": GEItemSchema.from_dict(obj["ge"]) if obj.get("ge") is not None else None
        })
        return _obj
