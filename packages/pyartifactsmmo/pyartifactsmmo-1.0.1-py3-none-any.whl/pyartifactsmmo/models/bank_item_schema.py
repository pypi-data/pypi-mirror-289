...
class BankItemSchema(BaseModel):
    ...
    bank: List[SimpleItemSchema] = Field(description="Items in your banks.")
    character: CharacterSchema = Field(description="Player details.")
    __properties: ClassVar[List[str]] = ["cooldown", "item", "bank", "character"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.bank:
            for _item_bank in self.bank:
                if _item_bank:
                    _items.append(_item_bank.to_dict())
            _dict['bank'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bank": [SimpleItemSchema.from_dict(_item) for _item in obj["bank"]] if obj.get("bank") is not None else None,
