...
class CharacterFightDataSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cooldown", "fight", "character"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of fight
        if self.fight:
            _dict['fight'] = self.fight.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fight": FightSchema.from_dict(obj["fight"]) if obj.get("fight") is not None else None,
