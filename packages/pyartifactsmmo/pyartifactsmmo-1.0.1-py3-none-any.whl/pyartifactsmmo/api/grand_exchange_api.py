...
class GrandExchangeApi:
    ...
    async def get_all_ge_items_ge_get(
        ...
        _param = self._get_all_ge_items_ge_get_serialize(
            page=page,
            size=size,
    ...
    async def get_all_ge_items_ge_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DataPageGEItemSchema]:
        """Get All Ge Items
    ...
    def _get_all_ge_items_ge_get_serialize(
        self,
        page,
        size,
        _request_auth,
    ...
    async def get_ge_item_ge_code_get(
        ...
        _param = self._get_ge_item_ge_code_get_serialize(
            code=code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def get_ge_item_ge_code_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GEItemResponseSchema]:
        """Get Ge Item
    ...
    def _get_ge_item_ge_code_get_serialize(
        self,
        code,
        _request_auth,
        _content_type,
