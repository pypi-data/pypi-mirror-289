...
class MyCharactersListSchema(BaseModel):
    ...
    """ # noqa: E501
    data: List[CharacterSchema] = Field(description="List of your characters.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [CharacterSchema.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
