...
class AppiumImage:
    ...
    def _get_screenshot_as_base64_decoded(self) -> bytes:
        ...
        try:
            ...
            self.terminal.adb_shell(command='screencap', args='-p /sdcard/screen.png')
            self.terminal.pull(source='/sdcard/screen.png', destination='screen.png')
            self.terminal.adb_shell(command='rm', args='/sdcard/screen.png')
