        ...
        if proceed:
            ...
            if existing_patients:
                ...
                for patient_id, patient_name in existing_patients:
                    # Find the corresponding row in csv_data to get the surgery date
                    ...
                    print("{0:03d}: {3:%m-%d} (ID: {2}) {1} ".format(existing_patients.index((patient_id, patient_name))+1, patient_name, patient_id, surgery_date))
