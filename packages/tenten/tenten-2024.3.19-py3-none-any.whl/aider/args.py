...
def get_parser(default_config_files, git_root):
    parser = configargparse.ArgumentParser(
        description="Tenten is an AI code generation tool",
    ...
    group.add_argument(
        ...
        type=int,
        default=None,
        help="Max number of tokens to use for repo map, use 0 to disable (default: 1000)",
    )
    group.add_argument(
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Prefix commit messages with 'Tenten: ' (default: True)",
    )
    group.add_argument(
        "--commit",
        action="store_true",
