...
def setup_git(git_root, io):
    ...
    elif io.confirm_ask("No git repo found, create one to track changes (recommended)?"):
...
def main(argv=None, input=None, output=None, force_git_root=None, return_coder=False):
    ...
    if args.dark_mode:
        args.user_input_color = "#FB3BC5"
        args.tool_error_color = "red"
        args.assistant_output_color = "#00fd75"
        args.code_theme = "monokai"

    if args.light_mode:
        args.user_input_color = "#fb00ae"
        args.tool_error_color = "red"
        args.assistant_output_color = "#04fd00"
