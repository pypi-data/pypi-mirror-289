...
PROJECT_PACKAGE = 'gitlab_projects_issues'
PROJECT_SCRIPTS = [
    'gitlab-projects-issues = gitlab_projects_issues.cli.main:main',
]

# Setup configurations, pylint: disable=line-too-long
setup(
    name=PROJECT_NAME,
    ...
    url=f'https://gitlab.com/{PROJECT_NAMESPACE}/{PROJECT_NAME}',
    project_urls={
        'Bug Reports': f'https://gitlab.com/{PROJECT_NAMESPACE}/{PROJECT_NAME}/-/issues',
        'Changelog': f'https://gitlab.com/{PROJECT_NAMESPACE}/{PROJECT_NAME}/blob/main/CHANGELOG.md',
        'Documentation': f'https://gitlab.com/{PROJECT_NAMESPACE}/{PROJECT_NAME}#{PROJECT_NAME}',
        'Source': f'https://gitlab.com/{PROJECT_NAMESPACE}/{PROJECT_NAME}',
