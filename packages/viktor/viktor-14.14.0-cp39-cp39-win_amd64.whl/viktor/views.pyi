...
from .core import Color as Color, File as File, _Result
...
class View(ABC, metaclass=abc.ABCMeta):
    def __init__(self, label: str, duration_guess: int, *, description: str = None, update_label: str = None, **kwargs: Any) -> None: ...
    def __call__(self, view_function: Callable) -> Callable: ...

class GeometryView(View):
    def __init__(self, label: str, duration_guess: int, *, description: str = None, update_label: str = None, view_mode: Literal['2D', '3D'] = '3D', default_shadow: bool = False, up_axis: Literal['Y', 'Z'] = 'Z', x_axis_to_right: bool = None) -> None: ...
