...
def calculate_intersection_bounded_line_with_y(line: Line, y_intersection: float) -> float | None: ...
...
def x_between_bounds(x: float, x1: float, x2: float, inclusive: bool = True) -> bool: ...
def y_between_bounds(y: float, y1: float, y2: float, inclusive: bool = True) -> bool: ...
def point_is_on_bounded_line(point: Point | tuple[float, float, float], line: Line | tuple[tuple[float, float, float], tuple[float, float, float]], inclusive: bool = True) -> bool: ...
...
def calculate_intersection_extended_lines(extended_line1: Line, extended_line2: Line) -> Point | None: ...
def calculate_intersection_bounded_line_extended_line(bounded_line: Line, extended_line: Line, inclusive: bool = True) -> Point | None: ...
def calculate_intersection_bounded_lines(bounded_line1: Line, bounded_line2: Line, inclusive: bool = True) -> Point | None: ...
...
def points_are_coplanar(points: Sequence[Point | tuple[float, float, float]]) -> bool: ...
...
def translation_matrix(direction: Vector | tuple[float, float, float]) -> np.ndarray: ...
def scaling_matrix(scaling_vector: Vector | tuple[float, float, float]) -> np.ndarray: ...
def rotation_matrix(angle: float, direction: Vector | tuple[float, float, float], point: Point | tuple[float, float, float] = None) -> np.ndarray: ...
def reflection_matrix(point: Point | tuple[float, float, float], normal: Vector | tuple[float, float, float]) -> np.ndarray: ...
def unit_vector(data: Any, axis: int = None, out: Any = None) -> np.ndarray | None: ...
def mirror_object(obj: TransformableObject, point: Point, normal: Vector | tuple[float, float, float]) -> TransformableObject: ...
...
def find_overlap(region_a: tuple[float, float], region_b: tuple[float, float], inclusive: bool = False) -> None | tuple[float, float]: ...
