...
![這是一張圖片](https://imgur.com/bm8r7jF)
![這是一張圖片](https://imgur.com/BNnrolV)
cs_mb(custom_messagebox) #對話框
cs_string(custom_string) #對話框
![這是一張圖片](https://imgur.com/YTzMqq0)
cs_yn(custom_yes_or_no) #是與否
cs_yn_for_printer(custom_yes_or_no_for_printer) #是否列印
![這是一張圖片](https://example.com/image.png)
cs_info(custom_information) #資訊
![這是一張圖片](https://imgur.com/tYsweC8)
cs_error(custom_error) #錯誤
![這是一張圖片](https://imgur.com/vlMgkek)
cs_warning(custom_warning) #警告
![這是一張圖片](https://imgur.com/x90tf2w)
