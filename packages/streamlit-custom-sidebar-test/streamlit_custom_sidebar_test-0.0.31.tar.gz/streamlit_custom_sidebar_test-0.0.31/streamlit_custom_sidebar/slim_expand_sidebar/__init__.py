        ...
        js_el = f'''
                    ...
                    <script>
                        ...
                        if (sidebar.length < 1){{
                            ...
                            const logoutBtnContainer = document.createElement("div");
                            logoutBtnContainer.className = "navigation-selections-container";
                            logoutBtnContainer.style = 'display:flex; flex-direction:column; width:100%; row-gap:1px; margin-top:auto;';
