...
class KNNRegModeller(Modeller):
    ...
    def __init__(
        ...
        **kwargs) -> None:
        ...
        self.model = KNeighborsRegressor(n_neighbors=n_neighbors, **self.kwargs)
    ...
    def fit(self):
        ...
        for i in range(self.iterations):
            ...
            if self.retrain:
                ...
                self.model = KNeighborsRegressor(n_neighbors=self.model.n_neighbors, **self.kwargs)
