...
class File(BaseModel):
    ...
    def upload_file_to_regscale(
        ...
        if regscale_file := File._create_regscale_file(
            ...
            mime_type = File.determine_mime_type(api, Path(file_name).suffix)
            if not mime_type:
                return False
    ...
    def _create_regscale_file(
        ...
        file_type_header = File.determine_mime_type(api, file_type)
    ...
    @staticmethod
    def determine_mime_type(api: Api, file_type: str) -> Optional[str]:
        """
        ...
        try:
            ...
            if file_type == ".xlsx":
                ...
                api.logger.warning(f"Unacceptable file type for upload: {file_type}")
                return None
