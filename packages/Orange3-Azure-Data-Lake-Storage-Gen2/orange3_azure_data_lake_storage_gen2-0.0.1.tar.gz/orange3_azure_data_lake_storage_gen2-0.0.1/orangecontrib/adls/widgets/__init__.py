...
Widgets for loading and saving files to/from ADLS
"""
import sysconfig

NAME = "ADLS"
DESCRIPTION = "ADLS Widgets"
...
("{}/help/orange3-azure-data-late-storage-gen2/index.html".format(sysconfig.get_path("data")),
 None),
...
("http://orange3-azure-data-late-storage-gen2.readthedocs.io/en/latest/", "")
)
