...
class Altmind(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        self.login = resources.LoginResource(self)
...
class AsyncAltmind(AsyncAPIClient):
    login: resources.AsyncLoginResource
    ...
    def __init__(
        ...
        *,
        ...
        self.login = resources.AsyncLoginResource(self)
...
class AltmindWithRawResponse:
    def __init__(self, client: Altmind) -> None:
        self.login = resources.LoginResourceWithRawResponse(client.login)
...
class AsyncAltmindWithRawResponse:
    def __init__(self, client: AsyncAltmind) -> None:
        self.login = resources.AsyncLoginResourceWithRawResponse(client.login)
...
class AltmindWithStreamedResponse:
    def __init__(self, client: Altmind) -> None:
        self.login = resources.LoginResourceWithStreamingResponse(client.login)
...
class AsyncAltmindWithStreamedResponse:
    def __init__(self, client: AsyncAltmind) -> None:
        self.login = resources.AsyncLoginResourceWithStreamingResponse(client.login)
