...
const plugin: JupyterFrontEndPlugin<void> = {
  ...
  activate: (
    ...
    const themeKey = '@jupyterlab/apputils-extension:themes';
    settingRegistry?.set(themeKey, 'themeScrollbars', false);
    settingRegistry?.set(themeKey, 'showThemeInSettings', false);
