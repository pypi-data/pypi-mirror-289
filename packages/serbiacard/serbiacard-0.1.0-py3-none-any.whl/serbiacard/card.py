...
from id_card_memory_addresses import (
    EID_CERTIFICATE,
    EID_DOCUMENT_DATA,
...
class IDCard:
    ...
    def readerStart(self):
        ...
        celik_path = os.path.abspath("card.dll")
        self.celikApi = ctypes.WinDLL(celik_path)

        self.celikApi.EidStartup(3)
    ...
    def validate(self):
        ...
        """
        if not self.idCheck:
            raise Exception("ID is not loaded correctly.")
        return True
