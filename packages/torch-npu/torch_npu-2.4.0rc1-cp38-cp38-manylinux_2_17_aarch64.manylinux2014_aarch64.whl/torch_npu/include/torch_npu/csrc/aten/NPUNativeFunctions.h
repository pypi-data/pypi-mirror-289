...
static at::Tensor fft_rfft(const at::Tensor & self, ::std::optional<int64_t> n=::std::nullopt, int64_t dim=-1, ::std::optional<c10::string_view> norm=::std::nullopt);
...
static at::Tensor npu_moe_finalize_routing(const at::Tensor & expanded_permuted_rows, const at::Tensor & skip1, const ::std::optional<at::Tensor> & skip2, const at::Tensor & bias, const at::Tensor & scales, const at::Tensor & expanded_src_to_dst_row, const at::Tensor & export_for_source_row);
...
static at::Tensor npu_weight_quant_batchmatmul(const at::Tensor & x, const at::Tensor & weight, const at::Tensor & antiquant_scale, const ::std::optional<at::Tensor> & antiquant_offset={}, const ::std::optional<at::Tensor> & quant_scale={}, const ::std::optional<at::Tensor> & quant_offset={}, const ::std::optional<at::Tensor> & bias={}, int64_t antiquant_group_size=0);
