...
# ----------------------------------------------------------------------------------------------------------------------------------------  
    async def doRunServer(self):
        try:
            ...
            IuLog.doInfo(__name__, f"SSL key password: {not IuText.StringEmpty(ssl_key_password_env)}")
            IuLog.doInfo(__name__, f"SSL key: {not IuText.StringEmpty(ssl_key_env)}")
            ...
            IuLog.doInfo(__name__, f"Public key: {self.eApiConfig.publicKey.hex()}")
