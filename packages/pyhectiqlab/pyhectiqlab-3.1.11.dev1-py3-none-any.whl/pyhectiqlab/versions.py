...
class PackageVersion:
    ...
    def get_package_git_diff(package_name: str):
        ...
        try:
            ...
            excluded_extensions = [".parquet", ".csv", ".png", ".jpg", ".jpeg", ".pdf", ".html", ".ipynb", ".pkl", ".pt", ".pth"]
            accepted_diffs = [d for d in diffs if not any((d.a_path or "").endswith(ext) or (d.b_path or "").endswith(ext) for ext in excluded_extensions)]
