...
// TODO: Bezier controller: To use bezier controller, change 0 to 1
...
#define APPLY_WCTUNER FALSE // 是否使用新的调参器
...
#define VL_TS          (VL_EXE_PER_CL_EXE*CL_TS)
#define PL_TS          VL_TS
#define SPEED_LOOP_CEILING (VL_EXE_PER_CL_EXE)
    #define TS_UPSAMPLING_FREQ_EXE 1 //1.0 //0.5
...
#define CL_SERIES_KI_D_CODE (CL_SERIES_KI_D*CL_SERIES_KP_D*CL_TS)
#define CL_SERIES_KI_Q_CODE (CL_SERIES_KI_Q*CL_SERIES_KP_Q*CL_TS)
#define CURRENT_LOOP_LIMIT_VOLTS DC_BUS_VOLTAGE * 0.57735 // dq轴控制器的输出上限为母线电压的1/sqrt(3)倍数

// 速度环 increase to 3 times because of the bug in dynamics clamping
#define VL_SERIES_KI_CODE (VL_SERIES_KI*VL_SERIES_KP*VL_TS)
#define SPEED_LOOP_LIMIT_AMPERE       (1 * INIT_IN) // (1.0*1.414*INIT_IN)
