...
def load(
    ...
    Args:
        ...
        mount_point (Path, optional): The directory where the e-reader should be mounted. Defaults to /mnt.
        books_orgmode_path (Path, optional): The path to the Org-mode file to update. If not provided, uses the environment variable BOOKS_ORGMODE_PATH.
    """
...
def export_highlights(
    ...
    Args:
        ...
        epub_path (Path): The path to the EPUB file inside the mount point.
        learn_orgmode_path (Optional[Path]): The path to the Org-mode file to save highlights.
            Defaults to the LEARN_ORGMODE_PATH environment variable if not provided.
    """
