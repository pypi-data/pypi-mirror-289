...
class UserContextAccountDetails(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["default_environment_id", b"default_environment_id", "environment_by_id", b"environment_by_id", "id", b"id", "name", b"name", "preferences", b"preferences", "tier", b"tier", "type", b"type", "user_context_environment_by_id", b"user_context_environment_by_id"]) -> None: ...
...
class AccountDetails(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["preferences", b"preferences"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["default_environment_id", b"default_environment_id", "environments_by_id", b"environments_by_id", "id", b"id", "name", b"name", "preferences", b"preferences", "tier", b"tier", "type", b"type"]) -> None: ...
