...
class Account(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "default_environment_id", b"default_environment_id", "id", b"id", "last_modified_at", b"last_modified_at", "name", b"name", "preferences", b"preferences", "status", b"status", "tier", b"tier", "type", b"type"]) -> None: ...
