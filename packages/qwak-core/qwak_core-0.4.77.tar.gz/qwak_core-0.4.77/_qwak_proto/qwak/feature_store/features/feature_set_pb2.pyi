...
class FeatureSetSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["entity", b"entity", "feature_set_type", b"feature_set_type", "features", b"features", "git_commit", b"git_commit", "metadata", b"metadata", "name", b"name", "qwak_internal_protocol_version", b"qwak_internal_protocol_version"]) -> None: ...
