...
def delete(
    ...
    """Cancel and delete a training run, list of training runs, or all runs under a single MLflow experiment id.
    If the run does not exist, an error will be raised.
