...
class JelverAPIException(Exception):
    ...
    def __str__(self):
        return Fore.RED + Style.BRIGHT + \
           ...
           Style.RESET_ALL + \
           Fore.CYAN + \
           'https://app.jelver.com/integration\n' + \
           Style.RESET_ALL 

class JelverBrowserException(Exception):
    def __init__(self, message):
        self.message = message
        super().__init__(self.message)

    def __str__(self):
        broswer_types = ", ".join(BrowserType._member_names_)
        return Fore.RED + Style.BRIGHT + \
           f'\n\nJelverBrowserException: {self.message}' + \
           Style.RESET_ALL + \
           '\n\n' + \
           Style.DIM + \
           'Please check the browser type you are using\n\n' + \
           Style.RESET_ALL + \
           Fore.BLUE + \
           f'\tSupported: {broswer_types}' + \
           Style.RESET_ALL
...
class JelverTestException(Exception):
    ...
    def __str__(self):
        ...
        message_error += (
            ...
            f'https://app.jelver.com/report?jobId={self.job_id}'
        )
