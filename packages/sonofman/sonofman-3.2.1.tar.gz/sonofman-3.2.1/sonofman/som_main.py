...
def set_locale(locale):
    ...
    if locale == "en":
        _resource = {
            ...
            "ERR_KJV2000_LIMIT_500": "No more than 500 verses © KJ2K, RVA1989, LND1991, IRV2017, NJB1973, CUVS, NTB2001, BCL2016, RUC1928, BW1975, SUV1997",
            "ERR_KJV2000_LIMIT_FULLBOOK": "No full book © KJ2K, RVA1989, LND1991, IRV2017, NJB1973, CUVS, NTB2001, BCL2016, RUC1928, BW1975, SUV1997",
            "FILTER": "Filter",
            "FOUND": "Found",
            "HELP": "Help",
            "KEYS": "Keys",
...
def show_bible_multi():
    ...
    dict_menu = {
        ...
        13: "(CN) Chinese Union Version Simplified (C)",
...
def show_bible_colors():
    ...
    dict_menu = {0: "(**) {0}".format(res("HIGHLIGHT_SEARCH")), 1: "(EN) King James 1611 (K)", 2: "(EN) King James 2000 (2)", 3: "(ES) Reina Valera 1909 (V)",
                 ...
                 13: "(CN) Chinese Union Version Simplified (C)", 14: "(JP) New Japanese Bible 1973 (J)",
    ...
    if not _useColors:
        ...
        # TODO: add more colors and make pagination, add COLOR_TERM (color of terminal)
        dict_menu_colors = {
            0: ["Normal", "u.A_NORMAL"],
            1: ["Dim", "u.A_DIM"],
            2: ["Bold", "u.A_BOLD"],
...
def generate_text_for_clipboard():
    try:
        ...
        for i in range(0, len(bbnames)):
            ...
            if bbname == "c":
                bbnames_verbose = f"{bbnames_verbose}, CUVS"
            if bbname == "j":
...
def show_about():
    dict_menu = {
        ...
        3: "Website   : {0}".format(somversion.website),
...
def get_bible_dict_verbose():
    return {
        ...
        12: "(CN) Chinese Union Version Simplified (C)",
