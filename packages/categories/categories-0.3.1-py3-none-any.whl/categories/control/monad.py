...
from categories.control.applicative import Applicative, ApplicativeIO, ApplicativeLambda, ApplicativeList, ApplicativeStream
from categories.type import IO, Lambda, Stream, Yield, _, hkt, typeclass
