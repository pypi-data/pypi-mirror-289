...
class LogStatus:
    def __init__(self, log_status_path="./users/botrun_ask_folder/status_tracker/", backup_folder="./users/botrun_ask_folder/status_tracker/backup/"):
...
# 使用示例
# generate_log_viewer_html('./data/{collection_name}/html/status.html', '/api/users/botrun_ask_folder/status_tracker/', force_update=True)
