...
def rag_plus_completion_call(
    ...
    try:
        ...
        try:
            ...
            generate_ref = generate_ref_section(lst_refs, generated_page_name)
...
def generate_ref_section(lst_refs: List[Dict], generated_page_name: str) -> str:
    if len(lst_refs) == 0:
        return ""
    ref_files = {}
    ...
    if generated_page_name is not None:
