...
class Extractor:
    ...
    def extract(self, file) -> GeometriesList:
        ...
        if file_extension in file_type_map:
            ...
            with open(file, 'rb') as f:
                file_data = f.read()
                file_instance = file_class(BytesIO(file_data))
    ...
    def _extract_points_from_waypoint_file(self, waypoints: List[WaypointFile]):
        for waypoint in waypoints:
            ...
            self._create_geometry(geometry_type=Point,
                                  ...
                                  outline_color=standardize_color(file_level_metadata["color"][-1]) if
    ...
    def _extract_lines_from_route_file(self, routes: List[RouteFile]):
        ...
        for route in routes:
            ...
            self._create_geometry(geometry_type=Line,
                                  ...
                                  outline_color=standardize_color(point_metadata["color"][-1])
        ...
        for track in tracks:
            ...
            for wp in track.waypoints.waypoints:
                ...
                self._create_geometry(geometry_type=Point,
                                      ...
                                      metadata=point_metadata,
                                      outline_color=standardize_color(point_metadata["color"][-1]) if
            ...
            for segment in track.track_segments.segments:
                ...
                self._create_geometry(geometry_type=Line,
                                      ...
                                      outline_color=standardize_color(segment_metadata["color"][-1]) if
        ...
        for area in areas:
            ...
            for polygon in area.polygons.polygons:
                ...
                self._create_geometry(geometry_type=Polygon,
                                      ...
                                      outline_color=standardize_color(polygon_metadata["color"][-1]) if
    ...
    def _create_geometry(self, geometry_type, name, coordinates, metadata, outline_color):
        try:
            geometry = geometry_type(name=name, coordinates=coordinates, metadata=metadata, outline_color=outline_color)
