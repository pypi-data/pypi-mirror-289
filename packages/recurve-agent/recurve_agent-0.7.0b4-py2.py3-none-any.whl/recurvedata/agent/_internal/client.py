...
from ..exceptions import APIError, MaxRetriesExceededException
from .schemas import Heartbeat, LoginPayload, Pagination, TaskItem, UpdateTaskInstanceStatus
        ...
        **kwargs,
        ...
        for attempt in range(retries):
            try:
                ...
                logger.debug(f"[{method}] {resp.url} ({resp.status_code}), elapsed: {duration:.2f}ms")
