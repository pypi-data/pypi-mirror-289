...
def st_datatable(data: pd.DataFrame | list[dict] = None, boolean_to_string: bool = False, column_order: List[str] = None, options: Dict = None, dt_config: str = "default", class_name: str = None, common_js_functions: Dict = None, context_menu: Dict = None,  js_scripts: List[str] = None, stylesheets: List[str] = None, disabled: bool = False, enable_top_navigation: bool = False, date_format: str = None, is_datetime: bool = False, export_file_name: str = None, on_select: Optional[Union[Literal["ignore"], Literal["rerun"], Callable]] = "rerun", on_change: Optional[Callable] = None, on_click: Optional[Callable] = None, ajax_reload: bool = False, ajax_setup: Dict = None, enable_diagnostics: bool = False, args: Optional[Tuple[Any, ...]] = None,
    ...
    context_menu: Dict or None
        ...
        The context menu items are dynamically set using the provided name, hrefFunctionName, and target attributes.  The hrefFunctionName 
...
if not _RELEASE:
    ...
    with content_column:
        with st.container(border=True):
            ...
            context_menu["items"] = [
                {"name": "View", "hrefFunctionName": "setViewHref", "target": "_blank"},
                {"name": "Edit", "hrefFunctionName": "setEditHref", "target": "_blank"},
                {"name": "Download", "hrefFunctionName": "setDownloadHref",
                    "target": "_blank"},
                {"name": "Search", "hrefFunctionName": "setSearchHref",
                    "target": "_blank"},
            ]
