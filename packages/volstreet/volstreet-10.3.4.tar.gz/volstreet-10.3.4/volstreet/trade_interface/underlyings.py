...
class Index:
    ...
    def get_otm_strikes(
        ...
        :param strike_range: The range of strikes to consider.
        :param option_type: The type of option (CALL/PUT).
        :param spill: The number of strikes to consider as ITM.
        :param cut_off_pct: The percentage of strikes to consider from the ATM strike.
        :param spot_price: The spot price of the underlying.
        :param graduated_at: Percentage beyond which to apply graduation. If np.inf, no graduation is applied.
        :param default_graduation: If True, the default graduation percentage is used.
        """
        ...
        strike_array = (
            np.array(list(strike_range))
            if not isinstance(strike_range, np.ndarray)
            else strike_range
        )
        ...
        if option_type == OptionType.CALL:
            ...
            regular_mask = (strike_array > (ltp - spill * self.base)) & (
