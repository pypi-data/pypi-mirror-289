...
class Sanitize:
    ...
    def _endbehavior(self):
        ...
        if self._exit and not self._good:
            from sys import exit  # Lazy/deferred import.
            exit(1)
    ...
    def pka_string(self, Range: list = []):
        ...
        try:
            ...
            self._error('should be convertible to float or have "ph"')
    ...
    def path(self, ext: str = '', out: bool = False, abs: bool = False):
        ...
        if abs and not path.isabs(self.var):
