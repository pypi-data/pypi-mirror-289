...
from windmillmodelv1.metadata.metadata import metadata
...
def update_metadata(args):
    ...
    model_uri = f"/home/windmill/{time.time()}/model"
    ...
    # 3. update metadata
    metadata(graph=graph, model_metadata=response.metadata, input_uri=model_uri)
