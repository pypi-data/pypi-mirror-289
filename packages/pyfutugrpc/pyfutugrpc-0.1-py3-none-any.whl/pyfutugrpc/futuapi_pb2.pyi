import pyfutugrpc.order_pb2 as _order_pb2
import pyfutugrpc.position_pb2 as _position_pb2
import pyfutugrpc.deal_pb2 as _deal_pb2
import pyfutugrpc.orderfee_pb2 as _orderfee_pb2
import pyfutugrpc.orderbook_pb2 as _orderbook_pb2
import pyfutugrpc.seqquote_pb2 as _seqquote_pb2
import pyfutugrpc.stocksnapshot_pb2 as _stocksnapshot_pb2
...
class PlaceOrder_Req(_message.Message):
    __slots__ = ("code", "side", "order_type", "qty", "price")
    ...
    qty: int
    price: float
    def __init__(self, code: _Optional[str] = ..., side: _Optional[str] = ..., order_type: _Optional[str] = ..., qty: _Optional[int] = ..., price: _Optional[float] = ...) -> None: ...
