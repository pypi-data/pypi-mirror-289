...
class DEBUGGER:
    def __init__(self, name, level='info', fullSyntax=False, onscreen=True,log_rotation=3,homePath=None,id=getRandomKey(9) , global_debugger=None,disable_log_write=False,file_name=None):
        env = custom_env()
