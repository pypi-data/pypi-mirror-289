    ...
    def get_user_settings(
        ...
        **Permission Required:** `kelvin.permission.users.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.UserSettingsGet, "400": response.Error, "401": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def update_user_settings(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.UserSettingsUpdate, "400": response.Error, "401": response.Error, "404": response.Error},
            False,
            _dry_run,
            kwargs,
        )
