...
from NEMO_billing.utilities import number_of_months_between_dates
...
def get_prepayment_info_for_status(prepaid_project: ProjectPrepaymentDetail, fund_start_date):
    ...
    charges, charges_amount = prepaid_project.get_charges_amount_between(start_in_month, until)
