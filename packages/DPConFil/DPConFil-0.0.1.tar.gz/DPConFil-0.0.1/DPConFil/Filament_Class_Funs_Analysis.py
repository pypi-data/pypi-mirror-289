...
def Get_Sub_Mask(point,regions_data,related_ids_T,connected_ids_dict,clump_coords_dict):
    ...
    if len(skeleton_coords_2D)>3:
        ...
        for point_id in range(len(points)):
            ...
            if np.round(points[point_id][0]) > 0 and np.round(points[point_id][1]) >0 \
                ...
                if CalSub:
                    fil_mask = Get_Sub_Mask(points[point_id],regions_data,related_ids_T,connected_ids_dict,clump_coords_dict)
