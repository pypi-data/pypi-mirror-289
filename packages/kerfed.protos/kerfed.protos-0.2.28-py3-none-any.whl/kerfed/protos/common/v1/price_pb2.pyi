...
class LinePrice(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["outcome", b"outcome", "price", b"price", "stock", b"stock"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["address_id", b"address_id", "extents", b"extents", "geom_id", b"geom_id", "line_id", b"line_id", "mass", b"mass", "method_id", b"method_id", "operations", b"operations", "outcome", b"outcome", "price", b"price", "quantity", b"quantity", "shop_id", b"shop_id", "stock", b"stock"]) -> None: ...
