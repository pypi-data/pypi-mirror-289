...
Dio = {
    "CN": {
        "ins": "输入结构文件，括号中星号代表任意字符(*.h5/*.json/*.pdb/*.as/*.hzw/*.xyz/*.cif/*POSCAR*/*CHGCAR*/vasprun*.xml*/...): ",
...
Dselect = {
    "CN": [
        ...
        "请选择沿着哪个或哪些轴平均（按Tab键查看可选项，以空格分隔): ",
        "请选择输出格式： ",
        "请选择是否平移费米能级？(y/n): ",
    ...
    "EN": [
        ...
        "Please select average along which axis or axes (separated by space): ",
