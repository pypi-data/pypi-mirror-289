...
class StaticAnalysis:
    ...
    def load_trackers_signatures(self):
        """
        Load trackers signatures from the official peepapp database.
        :return: a dictionary containing signatures.
        """
        self.signatures = []
        #peepapp_url = "https://reports.exodus-privacy.eu.org/api/trackers"
        peepapp_url = "https://raw.githubusercontent.com/oatkrs/peepapp-core/main/trackers"
        r = requests.get(peepapp_url)
        data = r.json()
