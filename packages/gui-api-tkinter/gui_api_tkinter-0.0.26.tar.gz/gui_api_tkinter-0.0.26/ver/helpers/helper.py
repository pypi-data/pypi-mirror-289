...
class Helper:
    ...
    def click_later_menuitem(self):
        ...
        svc.th.menu_click(menu_path)

    # --------------------
    def click_nested1_menuitem(self):
        menu_path = [1, 1, 1]  # path to the "File | Nested | nested1" menu item
        svc.th.menu_click(menu_path)

    # --------------------
    def click_nested2_menuitem(self):
        menu_path = [1, 1, 2]  # path to the "File | Nested | nested2" menu item
