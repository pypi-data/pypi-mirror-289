...
The [`Either[L, R]`][wraps.core.either.Either] type is symmetric and treats its variants the same way,
without preference.
For representing results (values and errors), use the [`Result[T, E]`][wraps.core.result.Result] instead.
"""
...
class Left(EitherProtocol[L, Never]):
    """[`Left[L]`][wraps.core.either.Left] variant of [`Either[L, R]`][wraps.core.either.Either]."""
...
class Right(EitherProtocol[Never, R]):
    """[`Right[R]`][wraps.core.either.Right] variant of [`Either[L, R]`][wraps.core.either.Either]."""
...
"""Either value, expressed as the union of [`Left[L]`][wraps.core.either.Left]
and [`Right[R]`][wraps.core.either.Right].
"""
