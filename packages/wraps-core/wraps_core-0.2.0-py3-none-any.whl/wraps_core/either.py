...
The [`Either[L, R]`][wraps_core.either.Either] type is symmetric and treats its variants the same way,
without preference.
For representing results (values and errors), use the [`Result[T, E]`][wraps_core.result.Result] instead.
"""
...
"""Either value, expressed as the union of [`Left[L]`][wraps_core.either.Left]
and [`Right[R]`][wraps_core.either.Right].
"""
