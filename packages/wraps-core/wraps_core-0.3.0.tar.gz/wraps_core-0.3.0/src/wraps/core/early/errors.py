...
class EarlyOption(AnyError):
    """The internal error raised by the [`early`][wraps.core.option.OptionProtocol.early] method."""
...
class EarlyResult(AnyError, Generic[E]):
    """The internal error raised by the [`early`][wraps.core.result.ResultProtocol.early] method."""
