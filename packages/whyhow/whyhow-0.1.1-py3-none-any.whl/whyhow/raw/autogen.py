...
#   timestamp: 2024-08-03T23:25:40+00:00
...
class CostTimeCategoryWithDetails(BaseModel):
    category: Annotated[
        Literal["low", "medium", "high"], Field(title="Category")
    ]
    details: Annotated[Optional[str], Field(None, title="Details")]
    domain: Annotated[Literal["cost", "time"], Field(title="Domain")]
...
class CreateGraphDetailsResponse(BaseModel):
    ...
    cost: Annotated[
        Optional[CostTimeCategoryWithDetails],
        Field(description="Cost category of the graph creation."),
    ]
    time: Annotated[
        CostTimeCategoryWithDetails,
        Field(description="Time category of the graph creation."),
    ]
...
class QueryOut(BaseModel):
    ...
    nodes: Annotated[
        ...
        Field(
            None,
            description="Node ids associated with the query",
            title="Nodes",
        ),
    ]
    status: Annotated[
