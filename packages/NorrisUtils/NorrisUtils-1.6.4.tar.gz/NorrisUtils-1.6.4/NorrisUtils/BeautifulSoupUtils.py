...
def extract_logic_bym_img(soup, url, **kwargs):
    # 使用更简洁的选择器语法
    images = soup.select('a.fancybox > img')
    return images
...
# urll = (find_links_with_keyword('https://www.zrfan.com/category/zhinan/', '2024-8-5'))
#
# tags = find_tags_by_query(urll, tag="blockquote", query='京东')
# print('\n aaaaa:' + str(tags))
