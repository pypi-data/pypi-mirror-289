    ...
    class trend:
        ...
        class MACDIndicator:
            ...
            def _calculate_ema_slow(self):
                ema_slow = FiinIndicator.trend.EMAIndicator(self.column, self.window_slow).ema()
                return ema_slow

            def _calculate_ema_fast(self):
                ema_fast = FiinIndicator.trend.EMAIndicator(self.column, self.window_fast).ema()
                return ema_fast
            ...
            def _calculate_macd_signal(self):
                macd_signal = FiinIndicator.trend.EMAIndicator(self.macd_line, self.window_signal).ema()
                return macd_signal
        ...
        class ADXIndicator:
            ...
            def _calculate_adx(self):
                ...
                adx = FiinIndicator.trend.SMAIndicator(dx, self.window).sma()       
                return adx
