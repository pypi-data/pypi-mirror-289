...
class TickerData:
    def __init__(self, data):
        # Chuyển đổi dữ liệu trong DataFrame thành kiểu dữ liệu mong muốn
        data_converted = self._convert_data_types(data)
        
        # Lưu dữ liệu đã chuyển đổi vào thuộc tính private
        self.__private_attribute = data_converted
        
        # Gán giá trị cho các thuộc tính khác từ dữ liệu đã chuyển đổi
