class DerivativeData:
    def __init__(self,data):
        ...
        self.DerivativeCode = data_converted['DerivativeCode'][0]
        ...
        self.OpenInterest = data_converted['OpenInterest'][0]
    def _convert_data_types(self,data):
        data_converted = {
            ...
            'DerivativeCode': [data['DerivativeCode'].values[0]],
            ...
            'OpenInterest': [int(data['OpenInterest'].values[0])]
        }
