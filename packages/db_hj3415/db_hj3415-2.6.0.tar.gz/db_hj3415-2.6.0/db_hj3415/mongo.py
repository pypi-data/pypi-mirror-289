...
class Corps(Base):
    ...
    def drop_page_in_all_codes(cls, page):
        ...
        for code in codes:
            cls.client[code].drop_collection(page)
            try:
...
class C101(Corps):
    ...
    def save(cls, code: str,  c101_data: dict) -> bool:
        ...
        if (set(c101_template) - set(c101_data.keys())) == set():
            ...
            cls.client[code]['c101'].create_index([('date', pymongo.ASCENDING)], unique=True)
            try:
...
class C106(Corps):
    ...
    def save(cls, code: str, page: str, c106_df: pd.DataFrame):
        ...
        cls.client[code][page].create_index([('항목', pymongo.TEXT)], unique=True)
...
class C108(Corps):
    ...
    def save(cls, code: str, c108_data: pd.DataFrame):
        ...
        cls.client[code][page].create_index([('날짜', pymongo.ASCENDING)])
