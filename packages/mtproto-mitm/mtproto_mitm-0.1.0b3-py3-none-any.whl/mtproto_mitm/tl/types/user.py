...
@tl_object(id=0x215c4438, name="types.User")
class User(TLObject):
    ...
    contact_require_premium: bool = TLField(flag=1 << 10, flagnum=2)
    id: Long = TLField()
    ...
    color: Optional[TLObject] = TLField(flag=1 << 8, flagnum=2)
    profile_color: Optional[TLObject] = TLField(flag=1 << 9, flagnum=2)
