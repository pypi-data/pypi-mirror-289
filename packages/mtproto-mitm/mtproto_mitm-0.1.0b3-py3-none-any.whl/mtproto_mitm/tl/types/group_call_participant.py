...
@tl_object(id=0xeba636fe, name="types.GroupCallParticipant")
class GroupCallParticipant(TLObject):
    ...
    video_joined: bool = TLField(flag=1 << 15)
    ...
    video: Optional[TLObject] = TLField(flag=1 << 6)
    presentation: Optional[TLObject] = TLField(flag=1 << 14)
