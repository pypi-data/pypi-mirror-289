...
@tl_object(id=0xf2bcb6f, name="types.ChannelFull")
class ChannelFull(TLObject):
    ...
    antispam: bool = TLField(flag=1 << 1, flagnum=2)
    participants_hidden: bool = TLField(flag=1 << 2, flagnum=2)
    translations_disabled: bool = TLField(flag=1 << 3, flagnum=2)
    stories_pinned_available: bool = TLField(flag=1 << 5, flagnum=2)
    view_forum_as_messages: bool = TLField(flag=1 << 6, flagnum=2)
    id: Long = TLField()
    about: str = TLField()
    ...
    stories: Optional[TLObject] = TLField(flag=1 << 4, flagnum=2)
    wallpaper: Optional[TLObject] = TLField(flag=1 << 7, flagnum=2)
