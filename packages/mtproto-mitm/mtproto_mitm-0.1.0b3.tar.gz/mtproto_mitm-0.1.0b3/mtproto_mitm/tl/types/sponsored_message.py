...
@tl_object(id=0xed5383f7, name="types.SponsoredMessage")
class SponsoredMessage(TLObject):
    ...
    webpage: Optional[TLObject] = TLField(flag=1 << 9)
    app: Optional[TLObject] = TLField(flag=1 << 10)
    message: str = TLField()
    entities: Optional[list[TLObject]] = TLField(flag=1 << 1)
    button_text: Optional[str] = TLField(flag=1 << 11)
