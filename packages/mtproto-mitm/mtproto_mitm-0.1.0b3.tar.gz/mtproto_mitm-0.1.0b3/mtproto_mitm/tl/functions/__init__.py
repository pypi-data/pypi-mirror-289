...
from .init_connection_15 import InitConnection_15
from .init_connection_67 import InitConnection_67
from .init_connection_78 import InitConnection_78
from . import auth, account, users, contacts, messages, updates, photos, upload, help, channels, bots, payments, stickers, phone, langpack, folders, stats, chatlists, stories, premium, geochats, wallet