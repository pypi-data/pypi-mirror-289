...
class SamotpravilClient:
    def __init__(self, api_key, base_url='https://api.samotpravil.ru', timeout=10):
    ...
    def send_email(self, email_to, subject, message_text, email_from, **kwargs):
    ...
    def get_statistics(self, date_from, date_to, **kwargs):
    ...
    def get_non_delivery_by_date(self, date_from, date_to, **kwargs):
    ...
    def get_non_delivery_by_issue(self, issuen, **kwargs):
    ...
    def get_fbl_report_by_date(self, date_from, date_to, **kwargs):
    ...
    def get_fbl_report_by_issue(self, issuen, **kwargs):
    ...
    def domain_remove(self, domain):
        endpoint = "/api/v2/blist/domains/remove"
        data = {"domain": domain}
        return self._post(endpoint, data)

    def domain_check_verification(self, domain):
