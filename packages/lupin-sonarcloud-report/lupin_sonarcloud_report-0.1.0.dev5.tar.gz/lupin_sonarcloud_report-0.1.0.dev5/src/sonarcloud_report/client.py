...
from sonarcloud_report.logger_manager import log_info
...
def query_sonarcloud_project_report(
    ...
    log_info(f"Querying SonarCloud project info for '{project_name}'")
    ...
    log_info(f"Querying latest analysis details for '{project_name}'")
