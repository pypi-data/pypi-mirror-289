...
from sqlalchemy_snowpark.datawarehouse_connector.snowflake_session import SnowflakeSession
from sqlalchemy_snowpark.datawarehouse_connector.postgresql_session import PostgreSqlSession
...
class DBConnector:
    ...
    def create_session(connection_string):
        try:
            ...
            elif db_source == REDSHIFT or "redshift+redshift_connector" in connection_string:
            ...
            # by default connection will be to snowflake data warehouse
                ...
                logger.error(RED + " DataSource " + {db_source} + " not supported at the moment... " + ENDC)
                return None
            return session
    ...
    def get_db_session(connection_string=None):
        try:
            ...
            session = DBConnector.create_session(connection_string)
            db_session = (
