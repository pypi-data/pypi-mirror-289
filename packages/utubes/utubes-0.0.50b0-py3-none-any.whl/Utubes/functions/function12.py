...
#===============================================================================
    ...
    async def started(songid, config, loop):
        engine = Downloader(config, loop)
        return engine.download_song(songid)

#===============================================================================

    async def download(songid, config, loop=False):
        try:
            runner = asyncio.get_event_loop() if loop else None
            moonus = await DownloadSR.started(songid, config, runner)
