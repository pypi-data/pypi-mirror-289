...
/*  default is float    @mhall: changed to double*/
#define kiss_fft_scalar double
	 ...
	 * malloc. The returned value should be free()d when done to avoid memory
	 * leaks.
	 *
...
#define kiss_fft_free KISS_FFT_FREE
	...
	/*
	 ...
	 but it might clean up your compiler output to call this before you exit.
	*/
