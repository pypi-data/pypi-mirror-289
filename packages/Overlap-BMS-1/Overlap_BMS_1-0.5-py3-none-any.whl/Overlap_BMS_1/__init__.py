...
def Overlap_Summary(Id, Month, Sales, Tactic, Start_Month, End_Month, Cube_Data_fnl):
    Required_Cube_Data = pd.DataFrame(Cube_Data_fnl[[Id, Month, Sales, Tactic]])
