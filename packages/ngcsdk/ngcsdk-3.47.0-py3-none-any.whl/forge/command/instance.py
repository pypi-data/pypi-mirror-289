...
from ngcbpc.util.utils import get_columns_help, get_environ_tag, has_org_role
...
class InstanceCommand(ForgeCommand):  # noqa: D101
    ...
    IB_TYPE = CONFIG_TYPE if (get_environ_tag() <= STAGING_ENV) else DISABLE_TYPE
    ...
    def update(self, args):
        ...
        resp = self.api.update(
            org_name, team_name, args.instance, args.name, args.reboot, args.reboot_custom_ipxe, args.enable_phone_home
        )
        self.printer.print_info(resp)
