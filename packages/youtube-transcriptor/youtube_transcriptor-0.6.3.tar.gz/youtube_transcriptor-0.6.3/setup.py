...
def get_test_suite():
    ...
    test_suite = test_loader.discover(
        ...
        top_level_dir='{dirname}/youtube_transcriptor'.format(dirname=os.path.dirname(__file__))
    )
    return test_suite
...
setuptools.setup(
    ...
    url="https://github.com/doggy8088/youtube-transcript-api",
    ...
    entry_points={
        'console_scripts': [
            'youtube_transcriptor = youtube_transcriptor.__main__:main',
        ],
    },
)
