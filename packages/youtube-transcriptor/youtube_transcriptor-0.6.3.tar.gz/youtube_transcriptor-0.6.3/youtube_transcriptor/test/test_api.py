...
from youtube_transcriptor import (
...
class TestYouTubeTranscriptApi(TestCase):
    ...
    @patch('youtube_transcriptor.YouTubeTranscriptApi.get_transcript')
    ...
    @patch('youtube_transcriptor.YouTubeTranscriptApi.get_transcript', side_effect=Exception('Error'))
