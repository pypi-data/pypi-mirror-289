...
class TwentyLimit(BaseStrategy):
    def __init__(self,
                 code=None,
                 start_date=None,
                 end_date=None,
                 frequency='day'):
        super(TwentyLimit, self).__init__(code, start_date, end_date,
                                          frequency)
    ...
    def on_day_bar(self, bar):
        ...
        try:
            ...
            if high == limit and high_rate > 18 and volume > 1.2 * pre_volume:
                if open_rate > 10 and amount > 2 * pow(10,8):
...
if __name__ == '__main__':
    ...
    test = TwentyLimit(start_date="2021-09-21",
                       end_date=end_time,
                       frequency='daily')
