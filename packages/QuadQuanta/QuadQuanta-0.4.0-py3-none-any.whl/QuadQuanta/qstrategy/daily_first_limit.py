            ...
            if high == limit and high_rate > 9:
                if (amount > 1 * pow(10, 8)):
                    if pre_high < pre_high_limit * 0.99:
                        ...
                        symbol_data['type'] = 'daily_first_limit'
    ...
    def syn_backtest(self):
        for i in range(0, len(self.trading_date)):
            try:
                ...
                try:
                    save_mongodb('QuadQuanta', 'daily_first_limit', {'_id':date,'symbol_list':self.daily_limit_list})
                except:
                    pass
                self.daily_limit_list = []
...
if __name__ == '__main__':
    ...
    test = DailyReplay(start_date=start_time,
                       end_date=end_time,
                       frequency='daily')
