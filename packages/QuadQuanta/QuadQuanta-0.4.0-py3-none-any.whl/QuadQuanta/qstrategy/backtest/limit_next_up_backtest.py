...
class LimitNextUp(BaseStrategy):
    def __init__(self,
                 code=None,
                 start_date=None,
                 end_date=None,
                 frequency='day'):
        super(LimitNextUp, self).__init__(code, start_date, end_date,
                                          frequency)
    ...
    def syn_backtest(self):
        for i in range(1, len(self.trading_date)):
            try:
                ...
                logger.info(f"{date}")
                logger.info(f"{self.res_count/self.all_count}")
...
def daily_replay():
    ...
    replay = LimitNextUp(start_date='2023-05-01',
                         end_date='2023-07-01',
                         frequency='daily')
