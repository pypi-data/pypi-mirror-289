...
class ActiveLimitMA5(BaseStrategy):
    def __init__(self,
                 code=None,
                 start_date=None,
                 end_date=None,
                 frequency='day', init_cash=100000):
        super(ActiveLimitMA5, self).__init__(code, start_date, end_date,
    ...
    def on_day_bar(self, bars):
        ...
        if low_MA5_rate > -1 and low_MA5_rate < 5 and MA5 > MA10:
    ...
    def syn_backtest(self):
            ...
            for i in range(0, len(self.trading_date)):
                try:
                    ...
                    self.symbol_list = self.during_double_limit + self.positon_list
...
if __name__ == '__main__':
    ...
    test = ActiveLimitMA5(start_date='2021-04-01',
                          end_date='2021-10-31',
