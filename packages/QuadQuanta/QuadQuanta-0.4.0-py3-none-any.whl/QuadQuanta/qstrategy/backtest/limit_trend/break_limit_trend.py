...
class BreakLimitTrend(BaseStrategy):
    def __init__(self,
                 code=None,
                 start_date=None,
                 end_date=None,
                 frequency='day', init_cash=100000):
        super(BreakLimitTrend, self).__init__(code, start_date, end_date,
    ...
    def on_day_bar(self, next_bars, next_two_bars):
        ...
        save_mongodb('QuadQuanta', 'break_limit_trend', self.res_dict)
    ...
    def syn_backtest(self):
        ...
        for i in range(1, len(self.trading_date) - 1):
            try:
                ...
                self.during_limit_dict = query_mongodb('QuadQuanta', 'daily_break', sql={
                    'date': pre_date})
                logger.info(f"{date}")
...
if __name__ == '__main__':
    ...
    test = BreakLimitTrend(start_date='2021-01-01',
                           end_date='2021-10-31',
