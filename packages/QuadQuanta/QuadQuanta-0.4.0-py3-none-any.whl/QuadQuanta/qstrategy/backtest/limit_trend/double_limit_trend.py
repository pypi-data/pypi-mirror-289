...
class DoubleLimitTrend(BaseStrategy):
    def __init__(self,
                 code=None,
                 start_date=None,
                 end_date=None,
                 frequency='day', init_cash=100000):
        super(DoubleLimitTrend, self).__init__(code, start_date, end_date,
    ...
    def on_day_bar(self, next_bars, next_two_bars):
        ...
        save_mongodb('QuadQuanta', 'double_limit_trend', self.res_dict)
...
if __name__ == '__main__':
    ...
    test = DoubleLimitTrend(start_date='2021-11-01',
                            end_date='2021-12-11',
