        ...
        for i in range(0, len(self.trading_date)):
            try:
                ...
                if len(self.res_symbol) > 0:
                    ...
                    save_mongodb('QuadQuanta', 'N_limit',
                ...
                if len(self.res_two_symbol) > 0:
                    ...
                    save_mongodb('QuadQuanta', 'TwoN_limit',
                ...
                if len(self.res_break_symbol) > 0:
                    ...
                    save_mongodb('QuadQuanta', 'breakN_limit',
                ...
                if len(self.res_fall_symbol) > 0:
                    ...
                    save_mongodb('QuadQuanta', 'fallN_limit',
                                 {'_id': date, 'symbol_list': self.res_fall_symbol})
                    res_symbol = []
...
def n_limit():
    ...
    test = NLimit(start_date=start_time,
                  end_date=end_time,
                  frequency='daily')
    # test = NLimit(start_date='2022-04-20',
    #               end_date='2022-05-10',
    #               frequency='daily')
