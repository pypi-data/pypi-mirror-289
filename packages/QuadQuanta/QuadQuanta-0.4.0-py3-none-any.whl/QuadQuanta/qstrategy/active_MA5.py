...
class DoubleLimitMA5(BaseStrategy):
    def __init__(self,
                 code=None,
                 start_date=None,
                 end_date=None,
                 frequency='day', init_cash=100000):
        super(DoubleLimitMA5, self).__init__(code, start_date, end_date,
...
if __name__ == '__main__':
    ...
    test = DoubleLimitMA5(start_date=start_time,
                          end_date=end_time,
