...
class FirstLimit(BaseStrategy):
    def __init__(self,
                 ...
                 frequency='day',
                 init_cash=100000):
        super(FirstLimit, self).__init__(code, start_date, end_date, frequency, init_cash=init_cash)
    ...
    def on_day_bar(self, bar):
        ...
        if code in self.acc.positions.keys():
            ...
            if volume_long > 0:
                ...
                if self.acc.get_position(code).hold_days == 5:
...
if __name__ == '__main__':
    ...
    test = FirstLimit(start_date='2018-10-01',
                      end_date='2018-12-10',
