...
class DailyNLimitTest(BaseStrategy):
    def __init__(self,
                 code=None,
                 start_date=None,
                 end_date=None,
    ...
    def on_day_bar(self, bars: np.ndarray):
        ...
        if pre_close < pre_limit:
            # TODO 测试条件
            if pre_high_rate - pre_low_rate < 5:
    ...
    def on_two_day_bar(self, bars: np.ndarray):
        ...
        if pre_close < pre_limit:
            if pre_four_close < pre_four_limit:
...
if __name__ == '__main__':
    ...
    test = DailyNLimitTest(start_date='2022-02-01',
                           end_date='2022-03-01',
                           frequency='daily', solid=True)
    test.syn_backtest()
