...
class HighOpen(BaseStrategy):
    def __init__(self,
                 code=None,
                 start_date=None,
                 end_date=None,
                 frequency='day'):
        super(HighOpen, self).__init__(code, start_date, end_date,
                                       frequency)
    ...
    def on_day_bar(self, bar):
        ...
        try:
            ...
            if open_rate > self.down and open_rate < self.up and amount > 2 * pow(10,
                                                                                  8) and high_limit_rate > 9 and high_limit_rate < 11:
        ...
        for i in range(0, len(self.trading_date)):
            try:
                ...
                if (datetime.datetime.strptime(date,'%Y-%m-%d').weekday() == 4):
                    ...
                    logger.info(f"{date}")
                    logger.info(f"连板：{self.high_open_symbol_list}")
...
if __name__ == '__main__':
    ...
    test = HighOpen(start_date="2022-01-01",
                    end_date="2022-12-30",
                    frequency='daily')
