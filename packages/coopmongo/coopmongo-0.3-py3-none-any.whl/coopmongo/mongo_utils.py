...
from cooptools.protocols import IdentifiableProtocol, JsonableProtocol, DictableProtocol, UniqueIdentifier
...
class MongoStorableProtocol(IdentifiableProtocol, JsonableProtocol, DictableProtocol):
    pass
...
def insert_documents(collection: pmon.collection.Collection,
                     jsonable_objs: Iterable[MongoStorableProtocol],
                     facade_handler: DocumentFacadeHandler = None):
    try:
