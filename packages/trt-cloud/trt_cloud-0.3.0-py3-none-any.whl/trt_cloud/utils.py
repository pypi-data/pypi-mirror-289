...
from trt_cloud.build_spec.build_options import TRTLLMInputModelFamily
...
def _get_license_type_from_repo_id(repo_id: str):
    for model_family in TRTLLMInputModelFamily:
...
def check_and_display_huggingface_repo_engine_eulas(repo_ids: Iterable[str]):
    for repo_id in repo_ids:
        model_family = _get_license_type_from_repo_id(repo_id)
