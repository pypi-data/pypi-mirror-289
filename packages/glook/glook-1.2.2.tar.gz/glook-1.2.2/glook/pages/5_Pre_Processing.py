...
if sup_unsup == 'Unsupervised Learning':
	...
	preprocessing_action = st.sidebar.radio('Select preprocessing action', [
		...
		'Dummy Variables :green[(Full DF)]', 'Dummy Variable :orange[(For Col)]', 'Apply Scaling :green[(Full DF)]'], help=":orange[(For Col)] means -> operation on particular Column, :green[(Full DF)] means -> operation on full DataFrame")
