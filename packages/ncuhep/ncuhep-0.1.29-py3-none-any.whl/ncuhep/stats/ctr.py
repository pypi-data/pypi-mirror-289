...
class CTR(Histogram):
    ...
    def fit(self, risetime, decaytime, lightyield, iterations=1000, fwhm_resolution=1E-12):
    ...
    def fit_plot(self, resolution=160E-12, fill=False):
        ...
        fit_info = [
            ...
            f'FWHM \t\t{unit_uncertainty(self.fwhm, self.fwhm_error, "s")}\n',
            f'Sample Size \t{int(self.sample_size)} $[Events]$',
            f"Time Base \t{unit(resolution, 's/div')}\n",
