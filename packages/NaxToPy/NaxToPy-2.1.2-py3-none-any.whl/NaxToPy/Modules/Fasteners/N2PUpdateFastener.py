...
class N2PUpdateFastener:
    ...
    def __CBUSH_connected_RBE3(self, card: N2PModelInputData, nodoA: N2PNode, nodoB: N2PNode):
        """
    ...
    def __CBUSH_connected_nodes(self, card: N2PModelInputData, nodoA: N2PNode, nodoB: N2PNode):
        """
        Returns the input that will be used to compute the elastic modulus of a fastener.
    ...
    def __CFAST_connected_ELEM(self, card: N2PModelInputData, nodoA: N2PNode, nodoB: N2PNode):
        """
        Returns the input that will be used to compute the elastic modulus of a fastener.
