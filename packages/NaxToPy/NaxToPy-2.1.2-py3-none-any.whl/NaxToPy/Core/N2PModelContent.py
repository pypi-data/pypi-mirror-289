...
class N2PModelContent:
    ...
    def __init__(self, path, parallelprocessing, solver=None):
        ...
        if self.__vzmodel.NastranInfoInputFileData is not None:
            ...
            n2pmodelimpudata = list(self.__vzmodel.NastranInfoInputFileData.ListBulkDataCards)
            self.__modelinputdata = N2PModelInputData(ListaCards(n2pmodelimpudata),
...
def load_model(path: str, parallelprocessing: bool = False,
               file_type: Literal["InputFileNastran", "Binary"] = None) -> N2PModelContent:
