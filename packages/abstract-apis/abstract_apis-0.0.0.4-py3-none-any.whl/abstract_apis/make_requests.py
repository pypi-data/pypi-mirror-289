...
def make_request(url, data=None, headers=None, method='GET', endpoint=None, result='result', status_code=False, raw_response=False, response_result=None, load_nested_json=True):
