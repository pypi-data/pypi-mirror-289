    ...
    for category, components in diagrams_data.items():
        for component in components:
            if component.lower() in prompt.lower():
                if category not in relevant_imports:
                    relevant_imports[category] = []
                relevant_imports[category].append(component)
...
def extract_all_imports() -> dict:
    irrelevant_imports = {}
    for category, components in diagrams_data.items():
        if category not in irrelevant_imports:
            irrelevant_imports[category] = []
        irrelevant_imports[category].extend(components)
