...
__all__ = ['new_aws_client', 'new_aws_resource', 'boto3config', 'ClientError', 'EndpointConnectionError',
           'ResponseParserError', 'aws_credentials', 'aws_account_id', 'get_aws_regions', 'S3C', 'S3R', 'AWS_S3_NAME',
...
class RefreshableBotoSession:
    ...
    def refreshable_session(self) -> Session:
        ...
        os.environ['AWS_ACCESS_KEY_ID'] = refreshable_credentials.access_key
        os.environ['AWS_SECRET_ACCESS_KEY'] = refreshable_credentials.secret_key
        os.environ['AWS_SESSION_TOKEN'] = refreshable_credentials.token
    ...
    def refresh_session_periodically(self):
        with self.refresh_lock:
            ...
            # Start a new refresh timer after each refresh
            self.start_refresh_timer()
