...
def read_model_file(file=None):
    ...
    (SW_OPER_IBP_CLI_2__00000000T000000_99999999T999999_0003.cdf)
    ...
    if file == None:
        ...
        file = os.path.abspath(os.path.join(basepath,'SW_OPER_IBP_CLI_2__00000000T000000_99999999T999999_0003.cdf'))
