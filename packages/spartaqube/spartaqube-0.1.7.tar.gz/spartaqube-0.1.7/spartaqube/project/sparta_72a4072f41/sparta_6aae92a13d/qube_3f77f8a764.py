...
from project.sparta_c7fea0e6b9.sparta_59d6c977f6.qube_8fecad1919 import IPythonKernel as IPythonKernel
from project.sparta_c7fea0e6b9.sparta_59d6c977f6.qube_111fcc0c66 import sparta_9f0d17765d
...
from project.sparta_72a4072f41.sparta_07d0d78d96 import qube_78b017fa56 as qube_78b017fa56
	...
	def receive(A,text_data):
		...
		if len(M)>0:
			...
			if B=='init-socket'or B=='reconnect-kernel':E={G:1,F:B};A.start_kernel();D=json.dumps(E);A.send(text_data=D);return
				...
				O=[];P=[]
				for I in C[S]:
					X=A.kernel_obj.get_workspace_variable(kernel_variable=I);J=sparta_f9ee3f1f90(X,variable_name=I);print('workspace_variable_df');print(J);print(type(J))
					try:O.append(sparta_6954500354(J));P.append(I)
					except:pass
