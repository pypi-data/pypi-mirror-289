...
def sparta_0a37afeeba(user_obj):
	B=user_obj
	...
	return A
def sparta_a7b8a2feda(json_data,user_obj):
...
def sparta_0a472e5132(json_data,user_obj):
...
def sparta_59689bc91f(json_data,user_obj):
	...
	return{_C:1}
def sparta_3572569e4f(json_data,user_obj):
