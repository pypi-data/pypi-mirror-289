...
def sparta_d40142c8ce(json_data,userObj):
	A=json_data
	try:D=A[_A];E=A[_C];B=os.path.dirname(D);F,G=sparta_e9f989d0bb(B,E);C={_B:1,'files':G,_D:F,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_2706e9878c(json_data,userObj):
	A=json_data
	try:B=A[_A];D=A[_C];E,F=sparta_e9f989d0bb(B,D);C={_B:1,'files':F,_D:E,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_e9f989d0bb(currentPath,typeexplorer=None):
...
def sparta_9a5f28278b(currentPath):
