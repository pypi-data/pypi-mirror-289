	...
	def start_stream(self,gui_websocket,b_get_print_buffer=True):
		...
		def thread_streaming_processing_func():
			while not self.stop_event.is_set():
				while queue_connector:msg=queue_connector.pop();msg_df=sparta_f9ee3f1f90(msg);msg_json=sparta_6954500354(msg_df);res={_B:1,'msg':msg,'msg_json':msg_json,'maxlen':queue_connector.maxlen};resJson=json.dumps(res);gui_websocket.send(resJson)
