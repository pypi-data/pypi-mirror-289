...
import pytz
UTC=pytz.utc
def sparta_3c3855fe05():0
def sparta_95de2c852b():
...
def sparta_ca7987703f():
	...
	return A
def sparta_14c0536b2d():
	F='res'
	try:
		C=sparta_ca7987703f();A=sparta_95de2c852b();D=AppVersioning.objects.all();E=datetime.now().astimezone(UTC)
