...
from project.sparta_72a4072f41.sparta_6aae92a13d import qube_3f77f8a764,qube_2d912091cc
...
print(channels_ver)
def sparta_db4ee31205(this_class):
	A=this_class
	if channels_major<=2:return A
	else:return A.as_asgi()
urlpatterns=[url('ws/notebookWS',sparta_db4ee31205(qube_3f77f8a764.NotebookWS)),url('ws/wssConnectorWS',sparta_db4ee31205(qube_2d912091cc.WssConnectorWS))]
