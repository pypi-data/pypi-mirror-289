...
def sparta_faf09b8461(is_owner=_A):return{_F:is_owner,_B:_E,_C:_E,_D:_E}
def sparta_482b4c4645():return{_F:_A,_B:_A,_C:_A,_D:_A}
def sparta_2bfab65c70(user_obj,portfolio_obj):
	B=portfolio_obj;A=user_obj
	if B.user==A:return sparta_faf09b8461(_E)
	F=qube_ad878641d5.sparta_77d16a5798(A);E=[A.userGroup for A in F]
	...
	if D.count()==0:return sparta_482b4c4645()
	G=D[0];C=G.ShareRights
	if C.is_delete:return sparta_482b4c4645()
	return{_F:_A,_B:C.is_admin,_C:C.has_write_rights,_D:C.has_reshare_rights}
def sparta_407d039297(user_obj,universe_obj):
	B=universe_obj;A=user_obj
	if B.user==A:return sparta_faf09b8461()
	F=qube_ad878641d5.sparta_77d16a5798(A);E=[A.userGroup for A in F]
