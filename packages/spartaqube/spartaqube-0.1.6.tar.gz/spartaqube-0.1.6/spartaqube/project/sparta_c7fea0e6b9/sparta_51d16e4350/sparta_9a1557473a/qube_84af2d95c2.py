...
plot_example"""}]
def sparta_7be522e1e1():return sparta_3bff9d2bfe(type=_N)
def sparta_88b7ef11c6():return sparta_3bff9d2bfe(type='gauge2')
def sparta_6eec44d226():
	type='gauge3'
	if conf_settings.IS_DEV:B=_F
	else:B=_G
