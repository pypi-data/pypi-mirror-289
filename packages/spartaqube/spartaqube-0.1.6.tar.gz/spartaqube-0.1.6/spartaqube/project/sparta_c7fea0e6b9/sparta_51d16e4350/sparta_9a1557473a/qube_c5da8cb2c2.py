...
def sparta_e7017dfa24(type='candlestick'):
...
plot_example"""}]
def sparta_3bff9d2bfe(type='line2'):
	if conf_settings.IS_DEV:A=_E
	else:A=_F
...
plot_example"""}]
def sparta_f2ac39c059():return sparta_3bff9d2bfe('line2')
def sparta_0815f34855():return sparta_3bff9d2bfe('bar2')
def sparta_bb4a093aa4():return sparta_3bff9d2bfe('area2')
def sparta_3bf6eef849():return sparta_3bff9d2bfe('lollipop2')
def sparta_942dc883fa():
