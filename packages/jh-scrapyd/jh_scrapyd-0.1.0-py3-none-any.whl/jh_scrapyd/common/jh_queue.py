...
class RedisQueue(Queue):
    ...
    def put(self, z_key: str, key: str, data: dict, score: float = 1) -> bool:
        ...
        try:
            ...
            result = script(keys=[self._gen_set_key(z_key), self._gen_hash_key(z_key, key)],
    ...
    def list(self, z_key: str, desc: bool = True):
        try:
            ...
            hash_keys = [self._gen_hash_key(z_key, item[0]) for item in key_list]
    ...
    def _gen_hash_key(self, z_key, key) -> str:
        key_arr = [self.table, self.HASH_NAME]
