...
from diffusers import AutoencoderKL, UNet2DConditionModel, DDPMScheduler, get_scheduler, StableDiffusionPipeline, \
    StableDiffusionInpaintPipeline
from huggingface_hub import upload_folder
from torch.utils.data import Dataset
from tqdm.auto import tqdm
from transformers import CLIPTextModel, CLIPTokenizer, logger
from utils import DreamBoothInpaintDataset
...
class StableDiffusionInpaintingFineTune:
    ...
    def __call__(self, *args, **kwargs):
        ...
        if args.max_train_steps is None:
            args.max_train_steps = self.max_training_epochs * num_update_steps_per_epoch
