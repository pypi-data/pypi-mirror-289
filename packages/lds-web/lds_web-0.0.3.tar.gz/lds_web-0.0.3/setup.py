...
from lds_web.versions import version
...
"""
pip install -U lds_web
pip --no-cache-dir install -U lds_web
...
setup(
    ...
    # 官网地址
    url="https://github.com/ldsxp/lds_web",
    # 程序的下载地址
    download_url="https://pypi.org/project/lds_web",
    # 作者
    author="lds",
    # 作者的邮箱地址
