...
if TYPE_CHECKING:
    from wraps_core.typing import ResultAsyncCallable

    from wraps_futures.typing import FutureResultCallable
...
class FutureResult(Future[Result[T, E]]):
    """[`Future[Result[T, E]]`][wraps_futures_core.future.Future],
...
"""An alias of [`FutureResult.from_result`][wraps_futures.result.FutureResult.from_result]."""

future_ok = FutureResult.from_ok
"""An alias of [`FutureResult.from_ok`][wraps_futures.result.FutureResult.from_ok]."""

future_error = FutureResult.from_error
"""An alias of [`FutureResult.from_error`][wraps_futures.result.FutureResult.from_error]."""


def wrap_future_result(function: ResultAsyncCallable[P, T, E]) -> FutureResultCallable[P, T, E]:
    """Wraps an asynchronous `function` returning [`Result[T, E]`][wraps_core.result.Result]
    into a function returning [`FutureResult[T, E]`][wraps_futures.result.FutureResult].
