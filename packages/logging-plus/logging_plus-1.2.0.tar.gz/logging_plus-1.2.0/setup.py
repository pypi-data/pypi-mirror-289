...
setup(
    ...
    description="Add-on for Python logging supporting indentation and generic logging of function entry/exit",  # Optional
    ...
    url="https://github.com/signag/py-logging-plus",  # Optional
