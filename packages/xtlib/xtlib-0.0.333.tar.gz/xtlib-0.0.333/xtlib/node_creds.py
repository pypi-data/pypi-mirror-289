...
class NodeCreds():
    def __init__(self) -> None:
        ...
        if os.getenv("XT_STORE_CREDS"):
            ...
            #print("found XT_STORE_CREDS on compute node, using ManagedIdentityCredential()")
            self.node_credential = ManagedIdentityCredential()   # client_id=user_assigned_managed_identty)
            #print("node_credential=", self.node_credential)
