...
class AzureBatch(BackendBase):
    ...
    def create_mgmt_pool(self, vm_config, vm_size, network_config, is_distributed, args):
        ...
        uai_url = args["user_assigned_managed_identity"]
    ...
    def read(self):
        ...
        if not from_storage:
            ...
            try:
                ...
                if "Code: PoolNotFound" in ex_text or "Code: NodeNotReady" in ex_text or "Code: NodeNotFound" in ex_text:
                ...
                elif "OperationInvalidForCurrentState" in ex_text:   
                    ...
                    print("authentication failed; refreshing credentials")
                    ...
                    console.print("Unexpected exception reading batch log file (LIVE): {}".format(ex))
