...
#define ARB_FULL_BUILD_ID "source_id=unknown commit;version=0.10.0;arch=native;config=RELEASE;NEUROML_ENABLED;BUNDLED_ENABLED;"
#define ARB_VERSION "0.10.0"
#define ARB_VERSION_MAJOR 0
#define ARB_VERSION_MINOR 10
