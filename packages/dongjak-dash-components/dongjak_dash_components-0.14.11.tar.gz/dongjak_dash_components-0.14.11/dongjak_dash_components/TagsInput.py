...
- scrollAreaProps (dict; optional):
    ...
    - type (a value equal to: 'auto', 'always', 'scroll', 'hover', 'never'; optional):
        ...
        scrolled  - `always` – scrollbars are always visible  -
        `never` – scrollbars are always hidden  - `auto` – similar to
