...
class Danila_v10:
    ...
    def __init__(self, yolov5_dir):
        ...
        self.rama_spring_detect_model = Rama_detect_class(rama_spring_detect_model_path,
                                                             yolo_path)
        ...
        self.rama_spring_ruzhimmash_text_detect_model = Rama_text_detect_class(rama_spring_ruzhimmash_text_detect_model_path,
                                                                           yolo_path)
        rama_no_spring_bejickaya_text_detect_model_path = RAMA_BEGICKAYA_TEXT_DETECT_MODEL_ADDRESS
