...
from data.neuro.models import VAGON_NUMBER_DETECT_MODEL_ADDRESS, VAGON_NUMBER_DETECT_MODEL_ADDRESS_2, \
    VAGON_NUMBER_RECOGNIZE_MODEL_ADDRESS, VAGON_NUMBER_RECOGNIZE_MODEL_ADDRESS_2, \
    VAGON_NUMBER_RECOGNIZE_MODEL_ADDRESS_3, VAGON_NUMBER_RECOGNIZE_MODEL_ADDRESS_4


class Danila_vagon_text_recognize_base:
    def __init__(self, yolov5_dir, danila_vagon_text_recognize_params):
        ...
        if danila_vagon_text_recognize_params.vagon_text_recognize_version == 1:
            self.vagon_number_recognize_model = Vagon_number_recognize_yolo(VAGON_NUMBER_RECOGNIZE_MODEL_ADDRESS, yolov5_dir)
        elif danila_vagon_text_recognize_params.vagon_text_recognize_version == 2:
            self.vagon_number_recognize_model = Vagon_number_recognize_yolo(VAGON_NUMBER_RECOGNIZE_MODEL_ADDRESS_2, yolov5_dir)
        elif danila_vagon_text_recognize_params.vagon_text_recognize_version == 3:
            self.vagon_number_recognize_model = Vagon_number_recognize_yolo(VAGON_NUMBER_RECOGNIZE_MODEL_ADDRESS_3, yolov5_dir)
        elif danila_vagon_text_recognize_params.vagon_text_recognize_version == 4:
            self.vagon_number_recognize_model = Vagon_number_recognize_yolo(VAGON_NUMBER_RECOGNIZE_MODEL_ADDRESS_4, yolov5_dir)
