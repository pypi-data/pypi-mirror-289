...
class Danila_rama_text_recognize:
    def __init__(self, yolov5_dir, danila_rama_text_recognize_params):
        ...
        if (self.danila_rama_text_recognize_params.rama_text_recognize_version == 1) | (self.danila_rama_text_recognize_params.rama_text_recognize_version == 2):
        ...
        elif (self.danila_rama_text_recognize_params.rama_text_recognize_version == 3) | (self.danila_rama_text_recognize_params.rama_text_recognize_version == 4):
            self.danila_rama_text_recognize = Danila_rama_text_recognize_redone(yolov5_dir,
                                                                    self.danila_rama_text_recognize_params.rama_text_recognize_version
                                                                    )
