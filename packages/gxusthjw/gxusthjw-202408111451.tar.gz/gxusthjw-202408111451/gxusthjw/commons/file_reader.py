...
# Version:          0.0.1
# Created:          2012/01/01
# Description:      Main Function: 提供“读取文件”相关的类和方法。
...
from .file_helpers import FileInfo
from ..commons import DataTable


# ==================================================================
def read_txt(file: Union[str, FileInfo], sep: Optional[str] = None,
             skiprows: int = 0,
             cols: Optional[Mapping[int, Optional[str]]] = None,
             res_type: Optional[str] = None,
             encoding: str = "GBK"):
    """
    基于readline方法，读取文本文件中的数据。
    ...
    :param res_type: 返回值形式，可指定的值分别为：
                     ...
                     2. 如果为忽略大小写的”list“，则返回list对象，其中每列为numpy.ndarray,
                        列的顺序与cols指定的顺序相同。

                     3. 其他值，均返回pandas.DataFrame对象。
