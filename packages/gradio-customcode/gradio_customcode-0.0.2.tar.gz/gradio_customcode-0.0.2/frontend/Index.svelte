...
<script lang="ts">
	...
	import type { CodeData, SelectedCode } from "./shared/utils";
	import Code from "./shared/Code.svelte";
	import MergeView from "./shared/MergeView.svelte";
	import Widget from "./shared/Widgets.svelte";
	import { StatusTracker } from "@gradio/statustracker";
	import { Block, BlockLabel, Empty } from "@gradio/atoms";
	import { Code as CodeIcon } from "@gradio/icons";
  import { logHttpReqRes } from "@gradio/wasm/dist/http";
	...
	export let value: CodeData = {code:"", selected_code:{start:0,end:0,text:""}, diff:""};
	...
	// $: console.log("Selection updated (Index.svelte):", selection);
	
    let hasDiff: boolean;
    
    $: {
        hasDiff = value.diff !== "";
        // console.log("Value updated:", value, "Has diff:", hasDiff);
    }
</script>
...
>
	...
	{:else}
		<Widget {language} value={value.code} />
