...
enum class RecordType : int32_t {
  ...
  Ternary_TV = 20,
  Ternary_VAL = 21,
  Ternary_TV_TV_VAL = 22,
  Ternary_TV_VAL_TV = 23,
  Ternary_VAL_TV_TV = 24,
  Ternary_VAL_VAL_TV = 25,
  Ternary_TV_VAL_VAL = 26,
  Ternary_VAL_TV_VAL = 27,
  Ternary_Alpha_TV = 28,
  Ternary_Alpha_VAL = 29,
  Ternary_Alpha_TV_TV_VAL = 30,
  Ternary_Alpha_TV_VAL_TV = 31,
  Ternary_Alpha_VAL_TV_TV = 32,
  Ternary_Alpha_VAL_VAL_TV = 33,
  Ternary_Alpha_TV_VAL_VAL = 34,
  Ternary_Alpha_VAL_TV_VAL = 35,
  NormalDistOp = 36,
  OutputTv = 37,
  OutputVal = 38,
  PadOp = 39,
...
inline const char *EnumNameRecordType(RecordType e) {
  if (::flatbuffers::IsOutRange(e, RecordType::Base, RecordType::SdpaFwdOp)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const RecordData (&EnumValuesRecordData())[19] {
...
inline const char *EnumNameRecordData(RecordData e) {
  if (::flatbuffers::IsOutRange(e, RecordData::NONE, RecordData::Vector)) return "";
  const size_t index = static_cast<size_t>(e);
...
template<> struct RecordDataTraits<nvfuser::serde::Pad> {
  static const RecordData enum_value = RecordData::Pad;
};
...
struct FusionExecutorBuilder {
  ...
  void add_heuristic(int64_t heuristic) {
    fbb_.AddElement<int64_t>(FusionExecutor::VT_HEURISTIC, heuristic, 0);
  }
  ...
  void add_concrete_id(int64_t concrete_id) {
    fbb_.AddElement<int64_t>(FusionExecutor::VT_CONCRETE_ID, concrete_id, 0);
  }
  void add_runtime_id(int64_t runtime_id) {
    fbb_.AddElement<int64_t>(FusionExecutor::VT_RUNTIME_ID, runtime_id, 0);
  }
  void add_group_id(int64_t group_id) {
    fbb_.AddElement<int64_t>(FusionExecutor::VT_GROUP_ID, group_id, 0);
  }
  ...
  void add_index_type(int64_t index_type) {
    fbb_.AddElement<int64_t>(FusionExecutor::VT_INDEX_TYPE, index_type, 0);
  }
...
struct RecordFunctor FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const nvfuser::serde::Pad *data_as_Pad() const {
    return data_type() == nvfuser::serde::RecordData::Pad ? static_cast<const nvfuser::serde::Pad *>(data()) : nullptr;
  }
