...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, hidden=False, pulp_href=None, content_guard=None, pulp_labels=None, base_path=None, name=None, base_url=None, local_vars_configuration=None):  # noqa: E501
