...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, content_guard=None, base_path=None, hidden=False, pulp_created=None, name=None, base_url=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
