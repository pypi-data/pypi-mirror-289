...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, name=None, pulp_labels=None, base_url=None, pulp_href=None, content_guard=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
