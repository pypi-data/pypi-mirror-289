...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, base_url=None, base_path=None, pulp_last_updated=None, name=None, hidden=False, pulp_created=None, content_guard=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
