...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, pulp_labels=None, name=None, pulp_last_updated=None, pulp_href=None, hidden=False, pulp_created=None, base_path=None, base_url=None, local_vars_configuration=None):  # noqa: E501
