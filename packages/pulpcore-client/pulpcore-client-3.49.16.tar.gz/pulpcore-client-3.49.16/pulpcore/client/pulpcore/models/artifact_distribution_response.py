...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, pulp_labels=None, pulp_href=None, name=None, base_path=None, hidden=False, content_guard=None, pulp_last_updated=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
