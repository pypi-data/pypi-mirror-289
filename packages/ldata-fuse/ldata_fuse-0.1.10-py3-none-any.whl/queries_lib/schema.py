...
class PodTemplateVersionsOrderBy(Enum):
    ...
    ldata_pod_template_settings_by_pod_template_version_id__count_asc = "LDATA_POD_TEMPLATE_SETTINGS_BY_POD_TEMPLATE_VERSION_ID__COUNT_ASC"
    ldata_pod_template_settings_by_pod_template_version_id__count_desc = "LDATA_POD_TEMPLATE_SETTINGS_BY_POD_TEMPLATE_VERSION_ID__COUNT_DESC"
