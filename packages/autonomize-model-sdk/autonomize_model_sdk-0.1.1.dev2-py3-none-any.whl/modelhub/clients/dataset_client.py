...
class DatasetClient(BaseClient):
    ...
    def get_signed_url(self, dataset_id: str, file_path: str, version: Optional[int], is_read: bool = True) -> str:
        """
    ...
    def load_dataset(self, dataset_name: str, version: Optional[int] = None, split: Optional[str] = None, directory: Optional[str] = None) -> DatasetDict:
        ...
        split_file_urls = self._collect_split_file_urls(dataset["id"], version_data["files"], version=version, split=split, directory=directory)
    ...
    def _collect_split_file_urls(self, dataset_id: str, files: List[Dict[str, Any]], version: Optional[int], split: Optional[str], directory: Optional[str]) -> Dict[str, List[str]]:
        """
