...
default_embeds = 'src/insigen/resources/Data/embeds.pickle'
default_dataset = 'src/insigen/resources/Data/wiki.csv'
...
class insigen:
    ...
    def __init__(self,
                 ...
                 embed_file: str = 'src/insigen/resources/Data/embeds.pickle',
                 dataset_file: str = 'src/insigen/resources/Data/wiki.csv',
        ...
        if use_pretrained_embeds:
            self.embeds = self._load_embeds('src/insigen/resources/Data/embeds.pickle')
    ...
    def _load_wiki_dataset(self):
        ...
        """        
        return pd.read_csv('src/insigen/resources/Data/wiki.csv')
    ...
    def generate_summary(self, text, topic_match = None, topic_weight = 1, similarity_weight = 1, position_weight = 10, num_sentences = 10):
        ...
        embeds = pickle.load(open('src/insigen/resources/Data/embeds.pickle', 'rb'))
        topics = pickle.load(open('src/insigen/resources/Data/topics.pickle', 'rb'))
