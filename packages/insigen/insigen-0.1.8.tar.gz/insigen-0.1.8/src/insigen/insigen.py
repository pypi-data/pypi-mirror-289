...
default_embeds = data_path + 'embeds.pickle'
default_dataset = data_path + 'wiki.csv'
...
class insigen:
    ...
    def __init__(self,
                 ...
                 embed_file: str = data_path + 'embeds.pickle',
                 dataset_file: str = data_path + 'wiki.csv',
        ...
        if use_pretrained_embeds:
            self.embeds = self._load_embeds(data_path + 'embeds.pickle')
    ...
    def _load_wiki_dataset(self):
        ...
        """        
        return pd.read_csv(data_path + 'wiki.csv')
    ...
    def generate_summary(self, text, topic_match = None, topic_weight = 1, similarity_weight = 1, position_weight = 10, num_sentences = 10):
        ...
        embeds = pickle.load(open(data_path + 'embeds.pickle', 'rb'))
        topics = pickle.load(open(data_path + 'topics.pickle', 'rb'))
