...
def plot_uvvis(wavenumbers: ArrayLike, foscs: ArrayLike,
    ...
    '''
    Plots UV-Visible spectrum with oscillator strengths specifying intensity
...
def plot_ir(wavenumbers: ArrayLike, intensities: ArrayLike,
