...
class OrcaJob():
    ...
    def __init__(self, input_file, **kwargs) -> None:
    ...
    def job_file(self, value: str):
        if value == 'from_head':
            self._job_file = os.path.splitext(self.input_file)[0] + '.sh'
        else:
    ...
    @property
    def scheduler_job_class(self):
        return self.SCHEDULER_TO_CLASS[self._scheduler_name]
