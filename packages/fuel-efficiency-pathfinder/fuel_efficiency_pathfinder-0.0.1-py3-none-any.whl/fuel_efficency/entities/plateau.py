...
class Plateau(Node):
    """
    Represents a plateau node in a pathfinding grid.

    This class implements the Node protocol and represents flat terrai`
    that has a standard difficulty to traverse.
