...
class DownHill(Node):
    """
    Represents a downhill node in a pathfinding grid.

    This class implements the Node protocol and represents a terrain that is easier
    to traverse (i.e., going downhill), hence the lower weight.

    Attributes:
        weight (float): The cost of traversing this node. Defaults to 0.5, 
                        representing an easier passage compared to flat terrain.
    ...
    def __hash__(self):
        ...
        This allows DownHill objects to be used as dictionary keys or in sets.
