...
from cmd_stash.configuration.config_util import fetch_bundle
from cmd_stash.configuration.models import AppSettings
...
DEFAULT_SETTINGS_PATH = Path.home() / ".cmd_stash" / "cli_settings.yaml"
...
class ConfigManager:
    ...
    def _resolve_settings_path(self) -> Path:
        """Resolve the path to the configuration file, prioritizing .cmd_stash/cli_settings.yaml."""
