...
from cmd_stash.backup_service import (BackupCreationException,
                                      BackupDestructionException)
from cmd_stash.command_repository import CommandRepository
from cmd_stash.configuration.config_manager import ConfigManager
...
class CLIManager:
    ...
    def remove(self):
        ...
        def remove_command(category, subcategory, description):
            ...
            try:
                ...
                cmd_stash.remove_commands(category, subcategory, description)
                if description:
            ...
            for bundle_name in bundle_names:
                ...
                try:
                    ...
                    if fetched_file_path.is_file():
                        ...
                        cmd_stash = CommandRepository(file_path=self.location)
                        import_result = cmd_stash.import_commands(fetched_file_path)
    ...
    def list_categories(self):
        ...
        def list_categories_command():
            ...
            try:
                cmd_stash = CommandRepository(file_path=self.location)
                categories = cmd_stash.list_categories()
                if categories:
