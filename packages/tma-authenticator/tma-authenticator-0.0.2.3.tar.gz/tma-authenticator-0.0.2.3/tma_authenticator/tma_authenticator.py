...
from tma_authenticator.users import User, UserDB
from tma_authenticator import storage_provider
...
class TMAAuthenticator:
    ...
    def __init__(self, bot_token: str, admin_password: str, storage_provider: storage_provider):
        self.bot_token = bot_token
        self.admin_password = admin_password
        self.storage_provider = storage_provider

    def oauth2_scheme(self) -> OAuth2PasswordBearer:
        return OAuth2PasswordBearer(tokenUrl=f"/token/".replace("//", "/"))
