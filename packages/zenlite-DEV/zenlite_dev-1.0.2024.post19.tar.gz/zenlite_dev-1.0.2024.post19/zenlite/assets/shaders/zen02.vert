...
const int uv_indices[12] = int[12](
    1, 0, 2, 1, 2, 3,   // tex coords for vertices of even faces
    3, 0, 2, 3, 1, 0    // tex coords for vertices of odd faces
);

vec3 colorhash(float zvx_id) {
    vec3 p3 = fract(vec3(zvx_id*21.2) * vec3(0.1031, 0.1031, 0.0973));
