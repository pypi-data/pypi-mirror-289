...
class zvxchunk:
    def __init__(self, size:int=32, vxsize:float=1.0) -> None:
        self.size:int=size
        self.nvoxels:int=0
        self.mesh_id:int=-1
    ...
    def build(self, zenresources) -> None:
        self.mesh_id = zenresources.meshbank.make_mesh(
            ...
            shader_id=zenresources.shaders["default002"],
        )
