...
DEFAULT_WORDLIST = pkg_resources.resource_filename(__name__, 'wordlist/wordlist.txt')
DEFAULT_THREADS = 30
...
def print_banner():
 ...
 / / / / |/_/ / / / / ___/ ___/ __ `/ __ \
/ /_/ />  </ /_/ / / /  (__  ) /_/ / / / /
\____/_/|_/_____/_/_/  /____/\__,_/_/ /_/ v0.0.1
...
def get_wordlist_info(wordlist):
    try:
        ...
        print(f"{Fore.RED}Wordlist file not found at {wordlist}.{Style.RESET_ALL}")
...
def main():
    ...
    if not urls:
        print("No URLs provided. Use -u for URLs or -f for a file containing URLs.")
        exit(1)
