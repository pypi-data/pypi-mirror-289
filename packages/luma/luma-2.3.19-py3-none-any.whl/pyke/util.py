...
class Util:
  ...
  def build_req_args(self, data, json_data, headers, params, external=False):
    ...
    click.echo(f'Request headers: {req_args.get("headers")}')    
    click.echo(f'Request Data: A123_{self.login_token()}')
  ...
  def get_container_by_url_ref(self, url_ref, container_type):
    ...
    click.echo(f'Container: {container_list[0]}')
