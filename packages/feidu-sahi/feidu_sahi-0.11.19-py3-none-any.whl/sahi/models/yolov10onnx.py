...
class Yolov10OnnxDetectionModel(DetectionModel):
    ...
    def load_model(self, ort_session_kwargs: Optional[dict] = {}) -> None:
        ...
        try:
            ...
            ort_session = onnxruntime.InferenceSession(self.model_path, sess_options=options, providers=self.ep_list)
    ...
    def _post_process(
        ...
        for i in range(output.shape[0]):
            ...
            if confidence > self.confidence_threshold:
                ...
                prediction_result.append([xmin, ymin, xmax, ymax, confidence, label])
