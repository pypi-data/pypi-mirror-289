...
def add_format_outputs_arguments(parser:argparse.ArgumentParser=None,load_from_settings=True)->argparse.ArgumentParser:
  ...
  json_flag_default_value=load_arg_default_from_settings("json_output",False) if load_from_settings else False
  ...
  #Markdown
  markdown_flag_default_value=load_arg_default_from_settings("markdown_output",False) if load_from_settings else False
...
def add_patterns_arguments(parser:argparse.ArgumentParser=None,load_from_settings=True)->argparse.ArgumentParser:
  ...
  clh_default_value=load_arg_default_from_settings("columns_list_from_higher_tf",None) if load_from_settings else None
  ...
  pn_default_value=load_arg_default_from_settings("patternname",None) if load_from_settings else None
