...
from .datamodel import CommandData

if TYPE_CHECKING:
    from gradio.components import Timer

class AutocompleteTextbox(FormComponent):
    """
    Creates a very simple textbox for user to enter string input or display string output.
    """

    data_model = CommandData
    ...
    def __init__(
        self,
        value: CommandData | Callable | None = None,
    ...
    def preprocess(self, payload: CommandData) -> CommandData:
        """
        Parameters:
    ...
    def postprocess(self, value: str | CommandData | dict | None) -> CommandData:
        """
        Parameters:
        ...
        if isinstance(value, dict):
            return CommandData(command=value.get("command"), text=value.get("text", ""))
        elif isinstance(value, CommandData):
            return value
        elif isinstance(value, str):
            return CommandData(text=value)
        else:
            return CommandData()
