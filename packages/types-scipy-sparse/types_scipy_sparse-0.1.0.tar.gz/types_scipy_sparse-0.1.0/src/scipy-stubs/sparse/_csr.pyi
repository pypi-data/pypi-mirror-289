...
class csr_array(sparray[_ShapeAnno, _DType_co], IndexMixin):
    ...
    @property
    def real(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    @property
    def imag(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    def sin(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def tan(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def arcsin(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def arctan(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def sinh(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def tanh(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def arcsinh(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def arctanh(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def rint(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def sign(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def expm1(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def log1p(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def deg2rad(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def rad2deg(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def floor(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def ceil(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def trunc(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    def sqrt(self) -> csr_array[_ShapeAnno, np.dtype[Any]]: ...
    ###########################################################################
...
class csr_matrix(spmatrix[_ShapeAnno, _DType_co], IndexMixin):
    ...
    @property
    def real(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    @property
    def imag(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    # dynamically set unary ufuncs:
    def sin(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def tan(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def arcsin(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def arctan(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def sinh(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def tanh(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def arcsinh(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def arctanh(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def rint(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def sign(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def expm1(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def log1p(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def deg2rad(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def rad2deg(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def floor(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def ceil(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def trunc(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def sqrt(self) -> csr_matrix[_ShapeAnno, np.dtype[Any]]: ...
    ###########################################################################
    # common methods from _minmax_mixin
    ###########################################################################
    # TODO: is this return type correct? no coo_array?
