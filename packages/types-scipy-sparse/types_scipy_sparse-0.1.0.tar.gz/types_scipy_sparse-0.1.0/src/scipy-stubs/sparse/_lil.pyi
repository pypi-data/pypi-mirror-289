...
class lil_array(sparray[_ShapeAnno, _DType_co], IndexMixin):
    ...
    @overload
    def sum(
        self: lil_array[Any, np.dtype[np.bool_ | np.int_]],
        axis: None = ...,
        dtype: None = ...,
        out: None = ...,
    ) -> np.int_: ...
    @overload
    def sum(
        self: lil_array[Any, np.dtype[np.unsignedinteger[Any]]],
        axis: None = ...,
        dtype: None = ...,
        out: None = ...,
    ...
    @overload
    def sum(
        self: lil_array[Any, np.dtype[np.float_]],
        axis: None = ...,
        dtype: None = ...,
        out: None = ...,
    ) -> np.float_: ...
    @overload
    def sum(
        self: lil_array[Any, np.dtype[np.complex_]],
        axis: None = ...,
        dtype: None = ...,
        out: None = ...,
    ) -> np.complex_: ...
    ...
    @property
    def real(self) -> lil_array[_ShapeAnno, np.dtype[Any]]: ...
    @property
    def imag(self) -> lil_array[_ShapeAnno, np.dtype[Any]]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> lil_array[_ShapeAnno, np.dtype[Any]]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: _DTypeLike[_SCT],
    ) -> lil_array[_ShapeAnno, np.dtype[_SCT]]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    def __abs__(self) -> lil_array[_ShapeAnno, Any]: ...
    @overload
    def __round__(
        self: lil_array[Any, np.dtype[np.bool_]],
        ndigits: SupportsIndex = ...,
    ) -> lil_array[_ShapeAnno, np.dtype[np.float16]]: ...
    @overload
    def __round__(
        self: lil_array[Any, np.dtype[np.complex_ | np.object_]],
        ndigits: SupportsIndex = ...,
    ) -> lil_array[_ShapeAnno, np.dtype[Any]]: ...
    @overload
    def __round__(
        self: lil_array[Any, np.dtype[_SCT_uifcO]],
        ndigits: SupportsIndex = ...,
    ) -> lil_array[_ShapeAnno, np.dtype[_SCT_uifcO]]: ...
    @overload
    def __round__(
        self,
        ndigits: SupportsIndex = ...,
    ...
    @overload
    def __init__(
        self: lil_array[Any, np.dtype[_SCT_co]],
...
class lil_matrix(spmatrix[_ShapeAnno, _DType_co], IndexMixin):
    ...
    @overload
    def sum(
        self: lil_matrix[Any, np.dtype[np.bool_ | np.int_]],
        axis: None = ...,
        dtype: None = ...,
        out: None = ...,
    ) -> np.int_: ...
    @overload
    def sum(
        self: lil_matrix[Any, np.dtype[np.unsignedinteger[Any]]],
        axis: None = ...,
        dtype: None = ...,
        out: None = ...,
    ) -> np.unsignedinteger[Any]: ...
    @overload
    def sum(
        self: lil_matrix[Any, np.dtype[np.float_]],
        axis: None = ...,
        dtype: None = ...,
        out: None = ...,
    ) -> np.float_: ...
    @overload
    def sum(
        self: lil_matrix[Any, np.dtype[np.complex_]],
        axis: None = ...,
        dtype: None = ...,
        out: None = ...,
    ) -> np.complex_: ...
    ...
    @property
    def real(self) -> lil_matrix[_ShapeAnno, np.dtype[Any]]: ...
    @property
    def imag(self) -> lil_matrix[_ShapeAnno, np.dtype[Any]]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> lil_matrix[_ShapeAnno, np.dtype[Any]]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: _DTypeLike[_SCT],
    ) -> lil_matrix[_ShapeAnno, np.dtype[_SCT]]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    def __abs__(self) -> lil_matrix[_ShapeAnno, Any]: ...
    @overload
    def __round__(
        self: lil_matrix[Any, np.dtype[np.bool_]],
        ndigits: SupportsIndex = ...,
    ) -> lil_matrix[_ShapeAnno, np.dtype[np.float16]]: ...
    @overload
    def __round__(
        self: lil_matrix[Any, np.dtype[np.complex_ | np.object_]],
        ndigits: SupportsIndex = ...,
    ) -> lil_matrix[_ShapeAnno, np.dtype[Any]]: ...
    @overload
    def __round__(
        self: lil_matrix[Any, np.dtype[_SCT_uifcO]],
        ndigits: SupportsIndex = ...,
    ) -> lil_matrix[_ShapeAnno, np.dtype[_SCT_uifcO]]: ...
    @overload
    def __round__(
        self,
        ndigits: SupportsIndex = ...,
    ...
    @overload
    def __init__(
        self: lil_matrix[Any, np.dtype[_SCT_co]],
        arg1: sparray[Any, Any] | spmatrix[Any, Any],
        shape: _ShapeLike | None = ...,
        *,
        dtype: _DTypeLike[_SCT_co],
