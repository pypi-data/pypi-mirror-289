...
class coo_array(sparray[_ShapeAnno, _DType_co]):
    ...
    @overload
    def sum(
        self: coo_array[Any, np.dtype[np.bool_ | np.int_]],
        axis: None = ...,
        dtype: None = ...,
        out: None = ...,
    ) -> np.int_: ...
    @overload
    def sum(
        self: coo_array[Any, np.dtype[np.unsignedinteger[Any]]],
        axis: None = ...,
        dtype: None = ...,
        out: None = ...,
    ...
    @overload
    def sum(
        self: coo_array[Any, np.dtype[np.float_]],
        axis: None = ...,
        dtype: None = ...,
        out: None = ...,
    ) -> np.float_: ...
    @overload
    def sum(
        self: coo_array[Any, np.dtype[np.complex_]],
        axis: None = ...,
        dtype: None = ...,
        out: None = ...,
    ) -> np.complex_: ...
    ...
    @property
    def real(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    @property
    def imag(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: _DTypeLike[_SCT],
    ) -> coo_array[_ShapeAnno, np.dtype[_SCT]]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    def __abs__(self) -> coo_array[_ShapeAnno, Any]: ...
    @overload
    def __round__(
        self: coo_array[Any, np.dtype[np.bool_]],
        ndigits: SupportsIndex = ...,
    ) -> coo_array[_ShapeAnno, np.dtype[np.float16]]: ...
    @overload
    def __round__(
        self: coo_array[Any, np.dtype[np.complex_ | np.object_]],
        ndigits: SupportsIndex = ...,
    ) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    @overload
    def __round__(
        self: coo_array[Any, np.dtype[_SCT_uifcO]],
        ndigits: SupportsIndex = ...,
    ) -> coo_array[_ShapeAnno, np.dtype[_SCT_uifcO]]: ...
    @overload
    def __round__(
        self,
        ndigits: SupportsIndex = ...,
    ...
    def sin(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def tan(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def arcsin(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def arctan(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def sinh(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def tanh(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def arcsinh(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def arctanh(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def rint(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def sign(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def expm1(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def log1p(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def deg2rad(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def rad2deg(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def floor(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def ceil(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def trunc(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    def sqrt(self) -> coo_array[_ShapeAnno, np.dtype[Any]]: ...
    ###########################################################################
...
class coo_matrix(spmatrix[_ShapeAnno, _DType_co]):
    ...
    @overload
    def sum(
        self: coo_matrix[Any, np.dtype[np.bool_ | np.int_]],
        axis: None = ...,
        dtype: None = ...,
        out: None = ...,
    ) -> np.int_: ...
    @overload
    def sum(
        self: coo_matrix[Any, np.dtype[np.unsignedinteger[Any]]],
        axis: None = ...,
        dtype: None = ...,
        out: None = ...,
    ) -> np.unsignedinteger[Any]: ...
    @overload
    def sum(
        self: coo_matrix[Any, np.dtype[np.float_]],
        axis: None = ...,
        dtype: None = ...,
        out: None = ...,
    ) -> np.float_: ...
    @overload
    def sum(
        self: coo_matrix[Any, np.dtype[np.complex_]],
        axis: None = ...,
        dtype: None = ...,
        out: None = ...,
    ) -> np.complex_: ...
    ...
    @property
    def real(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    @property
    def imag(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: _DTypeLike[_SCT],
    ) -> coo_matrix[_ShapeAnno, np.dtype[_SCT]]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    def __abs__(self) -> coo_matrix[_ShapeAnno, Any]: ...
    @overload
    def __round__(
        self: coo_matrix[Any, np.dtype[np.bool_]],
        ndigits: SupportsIndex = ...,
    ) -> coo_matrix[_ShapeAnno, np.dtype[np.float16]]: ...
    @overload
    def __round__(
        self: coo_matrix[Any, np.dtype[np.complex_ | np.object_]],
        ndigits: SupportsIndex = ...,
    ) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    @overload
    def __round__(
        self: coo_matrix[Any, np.dtype[_SCT_uifcO]],
        ndigits: SupportsIndex = ...,
    ) -> coo_matrix[_ShapeAnno, np.dtype[_SCT_uifcO]]: ...
    @overload
    def __round__(
        self,
        ndigits: SupportsIndex = ...,
    ...
    # dynamically set unary ufuncs:
    def sin(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def tan(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def arcsin(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def arctan(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def sinh(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def tanh(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def arcsinh(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def arctanh(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def rint(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def sign(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def expm1(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def log1p(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def deg2rad(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def rad2deg(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def floor(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def ceil(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def trunc(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    def sqrt(self) -> coo_matrix[_ShapeAnno, np.dtype[Any]]: ...
    ###########################################################################
    # common methods from _minmax_mixin
    ###########################################################################
    # TODO: is this return type correct? no coo_array?
