...
class ProcessData():
    def __init__(self,description:str, coupled_annuli, medium_type, medium_id, tscw_module:str = 'gaca'):
        ...
        assert tscw_module in ['gaca', 'tsgf'], f'Incorrect module name: {tscw_module}.'
    ...
    def export_processData(self,save_folder:Path,project_name:str, subfolder = ''):
        ...
        map_module_to_fileExt = {
            'gaca' : '_gaca.pd.txt',
            'tsgf' : '_tsgf.pd.txt'
        }

        file_name =  save_path.joinpath(project_name + subfolder + map_module_to_fileExt[self.tscw_module])
