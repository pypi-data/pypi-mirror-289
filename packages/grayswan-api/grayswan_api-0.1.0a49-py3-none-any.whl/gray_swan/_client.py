...
from ._exceptions import GraySwanError, APIStatusError
...
class GraySwan(SyncAPIClient):
    chat: resources.ChatResource
    moderation: resources.ModerationResource
    with_raw_response: GraySwanWithRawResponse
    with_streaming_response: GraySwanWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Gray Swan client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("GRAY_SWAN_BASE_URL")
        if base_url is None:
        ...
        self.with_raw_response = GraySwanWithRawResponse(self)
        self.with_streaming_response = GraySwanWithStreamedResponse(self)
...
class AsyncGraySwan(AsyncAPIClient):
    chat: resources.AsyncChatResource
    moderation: resources.AsyncModerationResource
    with_raw_response: AsyncGraySwanWithRawResponse
    with_streaming_response: AsyncGraySwanWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async Gray Swan client instance.
        ...
        self.with_raw_response = AsyncGraySwanWithRawResponse(self)
        self.with_streaming_response = AsyncGraySwanWithStreamedResponse(self)
...
class GraySwanWithRawResponse:
    def __init__(self, client: GraySwan) -> None:
...
class AsyncGraySwanWithRawResponse:
    def __init__(self, client: AsyncGraySwan) -> None:
...
class GraySwanWithStreamedResponse:
    def __init__(self, client: GraySwan) -> None:
...
class AsyncGraySwanWithStreamedResponse:
    def __init__(self, client: AsyncGraySwan) -> None:
