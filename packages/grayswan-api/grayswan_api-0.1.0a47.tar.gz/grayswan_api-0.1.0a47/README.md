# Gray Swan AI Python API library
...
These methods return an [`APIResponse`](https://github.com/grayswanai/grayswan-python/tree/main/src/gray_swan_ai/_response.py) object.
