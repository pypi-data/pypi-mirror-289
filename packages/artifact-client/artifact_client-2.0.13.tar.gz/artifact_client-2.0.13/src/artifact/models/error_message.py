...
class ErrorMessage(object):
    ...
    @property
    def name(self):
        """Gets the name of this ErrorMessage.  # noqa: E501


        :return: The name of this ErrorMessage.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ErrorMessage.


        :param name: The name of this ErrorMessage.  # noqa: E501
        :type: str
        """
