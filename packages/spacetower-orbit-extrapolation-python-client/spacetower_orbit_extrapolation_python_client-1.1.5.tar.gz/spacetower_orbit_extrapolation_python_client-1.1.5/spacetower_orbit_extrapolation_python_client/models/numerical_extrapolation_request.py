...
class NumericalExtrapolationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["targetDate", "initialOrbit", "initialCovarianceMatrix", "attitudeSequence", "spaceObject", "batteryModel", "referenceFramesConfiguration", "perturbationsConfiguration", "maneuverSchedule", "integratorConfiguration", "eventGenerationRequests", "ephemerisGenerationRequests"]
