...
class OrbitalCovarianceEphemeris(BaseModel):
    ...
    covariance_type: Optional[InitialOrbitType] = Field(default=None, alias="covarianceType")
    ...
    __properties: ClassVar[List[str]] = ["dates", "description", "covarianceType", "positionAngleType", "frame", "data"]
