...
class TleExtrapolationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["targetDate", "tle", "orbitalEventsRequest", "stationEventRequest", "osculatingOrbitEphemerisRequest", "positionVelocityEphemerisRequest", "geodeticEphemerisRequest", "referenceFramesConfiguration"]
