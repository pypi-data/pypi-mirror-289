...
class TleExtrapolationResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["osculatingOrbitEphemeris", "geodeticEphemeris", "positionVelocityEphemeris", "orbitalEventLogs", "stationEventLogs", "fieldOfViewEventLogs", "closestApproachEventLogs"]
