...
class StreamOrderbookUpdatesRequest(_message.Message):
    __slots__ = ("clob_pair_id", "subaccount_ids")
    CLOB_PAIR_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, clob_pair_id: _Optional[_Iterable[int]] = ..., subaccount_ids: _Optional[_Iterable[_Union[_subaccount_pb2.SubaccountId, _Mapping]]] = ...) -> None: ...
...
class StreamUpdate(_message.Message):
    __slots__ = ("orderbook_update", "order_fill", "taker_order", "subaccount_update", "block_height", "exec_mode")
    ...
    subaccount_update: StreamSubaccountUpdate
    block_height: int
    exec_mode: int
    def __init__(self, orderbook_update: _Optional[_Union[StreamOrderbookUpdate, _Mapping]] = ..., order_fill: _Optional[_Union[StreamOrderbookFill, _Mapping]] = ..., taker_order: _Optional[_Union[StreamTakerOrder, _Mapping]] = ..., subaccount_update: _Optional[_Union[StreamSubaccountUpdate, _Mapping]] = ..., block_height: _Optional[int] = ..., exec_mode: _Optional[int] = ...) -> None: ...
