...
class ElectricMachineResultsTimeStep(_0.APIBase):
    ...
    def results_for_stator_teeth(
        ...
        """List[mastapy._private.electric_machines.results.ElectricMachineResultsForStatorToothAtTimeStep]
    ...
    def results_at_locations(
        ...
        """List[mastapy._private.electric_machines.results.ElectricMachineResultsTimeStepAtLocation]
    ...
    def results_for_line_to_line(
        ...
        """List[mastapy._private.electric_machines.results.ElectricMachineResultsLineToLineAtTimeStep]
    ...
    def results_for_phases(
        ...
        """List[mastapy._private.electric_machines.results.ElectricMachineResultsForPhaseAtTimeStep]
