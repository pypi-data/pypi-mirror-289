...
class ElectricMachineResultsViewable(_182.ElmerResultsViewable):
    ...
    def force_view_options(self: "Self") -> "_1386.ElectricMachineForceViewOptions":
        """mastapy._private.electric_machines.results.ElectricMachineForceViewOptions"""
    ...
    def results(
        ...
        """ListWithSelectedItem[mastapy._private.electric_machines.results.ElectricMachineResults]"""
    ...
    def parts_to_view(self: "Self") -> "List[_1896.EnumWithBoolean[_1339.RegionID]]":
        """List[mastapy._private.utility.property.EnumWithBoolean[mastapy._private.electric_machines.RegionID]]
