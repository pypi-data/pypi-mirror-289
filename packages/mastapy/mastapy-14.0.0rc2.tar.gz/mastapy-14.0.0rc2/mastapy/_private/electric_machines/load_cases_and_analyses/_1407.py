...
class ElectricMachineLoadCaseBase(_0.APIBase):
    ...
    def temperatures(self: "Self") -> "_1425.Temperatures":
        """mastapy._private.electric_machines.load_cases_and_analyses.Temperatures
    ...
    def analyses(self: "Self") -> "List[_1400.ElectricMachineAnalysis]":
        """List[mastapy._private.electric_machines.load_cases_and_analyses.ElectricMachineAnalysis]
    ...
    def analysis_for(
        ...
        """mastapy._private.electric_machines.load_cases_and_analyses.ElectricMachineAnalysis
    ...
    def copy_to(
        ...
        Args:
            another_group (mastapy._private.electric_machines.load_cases_and_analyses.ElectricMachineLoadCaseGroup)
        """
        method_result = pythonnet_method_call(
    ...
    def remove_analysis(
        ...
        Args:
            electric_machine_analysis (mastapy._private.electric_machines.load_cases_and_analyses.ElectricMachineAnalysis)
        """
        pythonnet_method_call(
            self.wrapped,
            "RemoveAnalysis",
