...
class ElectricMachineLoadCaseGroup(_0.APIBase):
    ...
    def dynamic_forces_load_cases(self: "Self") -> "List[_1396.DynamicForceLoadCase]":
        """List[mastapy._private.electric_machines.load_cases_and_analyses.DynamicForceLoadCase]
    ...
    def dynamic_forces_load_cases_without_non_linear_dq_model(
        ...
        """List[mastapy._private.electric_machines.load_cases_and_analyses.BasicDynamicForceLoadCase]
    ...
    def efficiency_map_load_cases(self: "Self") -> "List[_1399.EfficiencyMapLoadCase]":
        """List[mastapy._private.electric_machines.load_cases_and_analyses.EfficiencyMapLoadCase]
    ...
    def mechanical_load_cases(
        ...
        """List[mastapy._private.electric_machines.load_cases_and_analyses.ElectricMachineMechanicalLoadCase]
    ...
    def single_operating_point_load_cases_with_non_linear_dq_model(
        ...
        """List[mastapy._private.electric_machines.load_cases_and_analyses.SpeedTorqueLoadCase]
    ...
    def single_operating_point_load_cases_without_non_linear_dq_model(
        ...
        """List[mastapy._private.electric_machines.load_cases_and_analyses.ElectricMachineLoadCase]
    ...
    def speed_torque_curve_load_cases(
        ...
        """List[mastapy._private.electric_machines.load_cases_and_analyses.SpeedTorqueCurveLoadCase]
    ...
    def add_load_case(
        ...
        Args:
            load_case_type (mastapy._private.electric_machines.load_cases_and_analyses.LoadCaseType)
        """
    ...
    def perform_compound_analysis(
        ...
        """mastapy._private.utility.MethodOutcome
    ...
    def perform_compound_analysis_with_progress(
        ...
        Args:
            setup (mastapy._private.electric_machines.ElectricMachineSetup)
            load_case_type (mastapy._private.electric_machines.load_cases_and_analyses.LoadCaseType)
            task_progress (mastapy._private.TaskProgress)
        """
        load_case_type = conversion.mp_to_pn_enum(
            load_case_type,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.LoadCaseType",
    ...
    def try_remove_load_case(
        ...
        Args:
            load_case (mastapy._private.electric_machines.load_cases_and_analyses.ElectricMachineLoadCaseBase)
        """
        method_result = pythonnet_method_call(
