...
class ElectricMachineSetup(_0.APIBase):
    ...
    def two_d_fe_model_for_electromagnetic_analysis(
        ...
        """mastapy._private.electric_machines.TwoDimensionalFEModelForAnalysis[mastapy._private.electric_machines.ElectricMachineMeshingOptions]
    ...
    def two_d_fe_model_for_mechanical_analysis(
        ...
        """mastapy._private.electric_machines.TwoDimensionalFEModelForAnalysis[mastapy._private.electric_machines.ElectricMachineMechanicalAnalysisMeshingOptions]
    ...
    def eccentricity(self: "Self") -> "_1303.Eccentricity":
        """mastapy._private.electric_machines.Eccentricity
