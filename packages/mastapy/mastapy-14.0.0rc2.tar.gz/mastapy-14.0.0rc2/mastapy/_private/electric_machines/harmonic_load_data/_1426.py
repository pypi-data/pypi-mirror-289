...
class ElectricMachineHarmonicLoadDataBase(_1431.SpeedDependentHarmonicLoadData):
    ...
    def display_option_for_slice_data(
        ...
        """EnumWithSelectedValue[mastapy._private.electric_machines.harmonic_load_data.ForceDisplayOption]"""
    ...
    def force_distribution_3d(self: "Self") -> "_1919.ThreeDVectorChartDefinition":
        """mastapy._private.utility_gui.charts.ThreeDVectorChartDefinition
    ...
    def slice(
        ...
        """ListWithSelectedItem[mastapy._private.electric_machines.RotorSkewSlice]"""
    ...
    def temporal_spatial_harmonics_chart(
        ...
        """mastapy._private.utility_gui.charts.ScatterChartDefinition
    ...
    def rotor_x_force(self: "Self") -> "_1569.MultipleFourierSeriesInterpolator":
        """mastapy._private.math_utility.MultipleFourierSeriesInterpolator
    ...
    def stator_axial_loads(self: "Self") -> "_1433.StatorToothLoadInterpolator":
        """mastapy._private.electric_machines.harmonic_load_data.StatorToothLoadInterpolator
    ...
    def stator_tooth_moments(self: "Self") -> "_1434.StatorToothMomentInterpolator":
        """mastapy._private.electric_machines.harmonic_load_data.StatorToothMomentInterpolator
    ...
    def multiple_fourier_series_interpolator_for(
        ...
        Args:
            harmonic_load_data_type (mastapy._private.electric_machines.harmonic_load_data.HarmonicLoadDataType)
            slice_index (int)
        """
