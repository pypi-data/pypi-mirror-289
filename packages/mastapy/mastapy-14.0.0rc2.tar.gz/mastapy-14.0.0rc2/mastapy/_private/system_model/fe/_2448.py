...
class FESubstructureWithSelectionForModalAnalysis(_2445.FESubstructureWithSelection):
    ...
    def modal_draw_style(self: "Self") -> "_201.FEModelModalAnalysisDrawStyle":
        """mastapy._private.nodal_analysis.dev_tools_analyses.FEModelModalAnalysisDrawStyle
    ...
    def fe_modal_frequencies(self: "Self") -> "List[_64.FEModalFrequencyComparison]":
        """List[mastapy._private.nodal_analysis.FEModalFrequencyComparison]
    ...
    def full_fe_mode_shapes_at_condensation_nodes(
        ...
        """List[mastapy._private.system_model.fe.FESubstructureNodeModeShapes]
