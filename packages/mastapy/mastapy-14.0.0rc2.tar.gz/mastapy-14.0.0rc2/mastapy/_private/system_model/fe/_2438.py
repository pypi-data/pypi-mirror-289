...
class FESubstructure(_66.FEStiffness):
    ...
    def alignment_method(self: "Self") -> "_2410.AlignmentMethod":
        """mastapy._private.system_model.fe.AlignmentMethod"""
    ...
    def bearing_node_alignment(self: "Self") -> "_2416.BearingNodeAlignmentOption":
        """mastapy._private.system_model.fe.BearingNodeAlignmentOption"""
    ...
    def component_to_align_to(
        ...
        """ListWithSelectedItem[mastapy._private.system_model.part_model.Component]"""
    ...
    def gravity_force_source(self: "Self") -> "_70.GravityForceSource":
        """mastapy._private.nodal_analysis.GravityForceSource
    ...
    def reduction_mode_type(self: "Self") -> "_246.ReductionModeType":
        """mastapy._private.nodal_analysis.component_mode_synthesis.ReductionModeType"""
    ...
    def thermal_expansion_option(
        ...
        """EnumWithSelectedValue[mastapy._private.system_model.fe.ThermalExpansionOption]"""
    ...
    def type_(
        ...
        """EnumWithSelectedValue[mastapy._private.system_model.fe.FESubstructureType]"""
    ...
    def acoustic_radiation_efficiency(
        ...
        """mastapy._private.materials.AcousticRadiationEfficiency
    ...
    def alignment_using_axial_node_positions(
        ...
        """mastapy._private.system_model.fe.AlignmentUsingAxialNodePositions
    ...
    def alignment_to_component(
        ...
        """mastapy._private.system_model.RelativeComponentAlignment[mastapy._private.system_model.part_model.Component]
    ...
    def cms_model(self: "Self") -> "_239.CMSModel":
        """mastapy._private.nodal_analysis.component_mode_synthesis.CMSModel
    ...
    def export(self: "Self") -> "_2439.FESubstructureExportOptions":
        """mastapy._private.system_model.fe.FESubstructureExportOptions
    ...
    def fe_meshing_options(self: "Self") -> "_88.ShaftFEMeshingOptions":
        """mastapy._private.nodal_analysis.ShaftFEMeshingOptions
    ...
    def geometry_modeller_design_information(
        ...
        """mastapy._private.nodal_analysis.geometry_modeller_link.GeometryModellerDesignInformation
    ...
    def geometry_modeller_dimensions(self: "Self") -> "_165.GeometryModellerDimensions":
        """mastapy._private.nodal_analysis.geometry_modeller_link.GeometryModellerDimensions
    ...
    def sound_pressure_enclosure(self: "Self") -> "_296.SoundPressureEnclosure":
        """mastapy._private.materials.SoundPressureEnclosure
    ...
    def gear_meshing_options(self: "Self") -> "List[_2450.GearMeshingOptions]":
        """List[mastapy._private.system_model.fe.GearMeshingOptions]
    ...
    def geometries(self: "Self") -> "List[_2436.FEStiffnessGeometry]":
        """List[mastapy._private.system_model.fe.FEStiffnessGeometry]
    ...
    def independent_masta_created_condensation_nodes(
        ...
        """List[mastapy._private.system_model.fe.IndependentMASTACreatedCondensationNode]
    ...
    def links(self: "Self") -> "List[_2473.FELink]":
        """List[mastapy._private.system_model.fe.links.FELink]
    ...
    def shafts_that_can_be_replaced(
        ...
        """List[mastapy._private.system_model.fe.ReplacedShaftSelectionHelper]
    ...
    def thermal_expansion_displacements(
        ...
        """List[mastapy._private.math_utility.measured_vectors.VectorWithLinearAndAngularComponents]
    ...
    def convert_shafts_to_fe(
        ...
        Args:
            operation (mastapy._private.nodal_analysis.FEMeshingOperation)
    ...
    def create_fe_substructure_with_selection_components(
        ...
        """mastapy._private.system_model.fe.FESubstructureWithSelectionComponents"""
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(
        ...
        """mastapy._private.system_model.fe.FESubstructureWithSelectionForHarmonicAnalysis"""
        method_result = pythonnet_method_call(
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(
        ...
        """mastapy._private.system_model.fe.FESubstructureWithSelectionForModalAnalysis"""
        method_result = pythonnet_method_call(
    ...
    def create_fe_substructure_with_selection_for_static_analysis(
        ...
        """mastapy._private.system_model.fe.FESubstructureWithSelectionForStaticAnalysis"""
        method_result = pythonnet_method_call(
    ...
    def duplicate(self: "Self", name: "str") -> "FESubstructure":
        """mastapy._private.system_model.fe.FESubstructure
    ...
    def import_fe_mesh(
        ...
        Args:
            file_path (str)
            format_ (mastapy._private.nodal_analysis.fe_export_utility.FEExportFormat)
            length_scale (float, optional)
            force_scale (float, optional)
            progress (mastapy._private.TaskProgress, optional)
        """
    ...
    def import_node_positions(
        ...
        Args:
            file_name (str)
            distance_unit (mastapy._private.utility.units_and_measurements.Unit)
        """
    ...
    def import_reduced_stiffness(
        ...
        Args:
            file_name (str)
            distance_unit (mastapy._private.utility.units_and_measurements.Unit)
            force_unit (mastapy._private.utility.units_and_measurements.Unit)
        """
        file_name = str(file_name)
        pythonnet_method_call(
            self.wrapped,
    ...
    def load_stl_geometry(
        ...
        Args:
            length_unit (mastapy._private.utility.units_and_measurements.Unit)
            file_name (str)
        """
        file_name = str(file_name)
        pythonnet_method_call(
