...
class ElectricMachineDataSet(_0.APIBase):
    ...
    def node_for_first_tooth(
        ...
        """ListWithSelectedItem[mastapy._private.system_model.fe.FESubstructureNode]"""
    ...
    def torque_ripple_input_type(self: "Self") -> "_7126.TorqueRippleInputType":
        """mastapy._private.system_model.analyses_and_results.static_loads.TorqueRippleInputType"""
