...
class RollingRingConnectionCompoundStabilityAnalysis(
    ...
    def connection_analysis_cases_ready(
        ...
        """List[mastapy._private.system_model.analyses_and_results.stability_analyses.RollingRingConnectionStabilityAnalysis]
    ...
    def planetaries(
        ...
        """List[mastapy._private.system_model.analyses_and_results.stability_analyses.compound.RollingRingConnectionCompoundStabilityAnalysis]
