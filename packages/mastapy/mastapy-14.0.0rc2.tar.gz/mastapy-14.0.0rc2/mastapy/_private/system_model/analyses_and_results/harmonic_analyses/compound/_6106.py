...
class RollingRingCompoundHarmonicAnalysis(_6051.CouplingHalfCompoundHarmonicAnalysis):
    ...
    def component_analysis_cases_ready(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.RollingRingHarmonicAnalysis]
    ...
    def planetaries(self: "Self") -> "List[RollingRingCompoundHarmonicAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.compound.RollingRingCompoundHarmonicAnalysis]
