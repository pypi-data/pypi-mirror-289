...
class SpiralBevelGearSetCompoundParametricStudyTool(
    ...
    def spiral_bevel_gears_compound_parametric_study_tool(
        ...
        """List[mastapy._private.system_model.analyses_and_results.parametric_study_tools.compound.SpiralBevelGearCompoundParametricStudyTool]
    ...
    def spiral_bevel_meshes_compound_parametric_study_tool(
        ...
        """List[mastapy._private.system_model.analyses_and_results.parametric_study_tools.compound.SpiralBevelGearMeshCompoundParametricStudyTool]
