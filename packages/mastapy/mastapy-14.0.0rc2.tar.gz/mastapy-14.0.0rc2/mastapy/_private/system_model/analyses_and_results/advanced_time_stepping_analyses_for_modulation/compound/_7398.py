...
class SpringDamperHalfCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    def component_analysis_cases_ready(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.SpringDamperHalfAdvancedTimeSteppingAnalysisForModulation]
