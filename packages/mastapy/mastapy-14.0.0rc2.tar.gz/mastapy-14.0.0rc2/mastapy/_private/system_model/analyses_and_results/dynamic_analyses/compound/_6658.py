...
class StraightBevelDiffGearSetCompoundDynamicAnalysis(
    ...
    def straight_bevel_diff_gears_compound_dynamic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.compound.StraightBevelDiffGearCompoundDynamicAnalysis]
    ...
    def straight_bevel_diff_meshes_compound_dynamic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.compound.StraightBevelDiffGearMeshCompoundDynamicAnalysis]
