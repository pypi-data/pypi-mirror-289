...
class SpringDamperConnectionCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    def connection_analysis_cases_ready(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.SpringDamperConnectionSteadyStateSynchronousResponseAtASpeed]
