...
class KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis(
    ...
    def conical_gears_critical_speed_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.critical_speed_analyses.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis]
    ...
    def conical_meshes_critical_speed_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.critical_speed_analyses.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis]
