...
class GearSetAdvancedTimeSteppingAnalysisForModulation(
    ...
    def eignenmodes_indexed_by_mode_id(self: "Self") -> "List[_1556.Eigenmodes]":
        """List[mastapy._private.math_utility.Eigenmodes]
    ...
    def gears_advanced_time_stepping_analysis_for_modulation(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.GearAdvancedTimeSteppingAnalysisForModulation]
    ...
    def meshes_advanced_time_stepping_analysis_for_modulation(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.GearMeshAdvancedTimeSteppingAnalysisForModulation]
