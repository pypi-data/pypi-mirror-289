...
class WormGearSetDynamicAnalysis(_6478.GearSetDynamicAnalysis):
    ...
    def gears_dynamic_analysis(self: "Self") -> "List[_6543.WormGearDynamicAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.WormGearDynamicAnalysis]
    ...
    def meshes_dynamic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.WormGearMeshDynamicAnalysis]
