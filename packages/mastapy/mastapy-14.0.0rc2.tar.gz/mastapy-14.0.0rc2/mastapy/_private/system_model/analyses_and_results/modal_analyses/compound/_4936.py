...
class RollingRingCompoundModalAnalysis(_4881.CouplingHalfCompoundModalAnalysis):
    ...
    def component_analysis_cases_ready(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.RollingRingModalAnalysis]
    ...
    def planetaries(self: "Self") -> "List[RollingRingCompoundModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.compound.RollingRingCompoundModalAnalysis]
