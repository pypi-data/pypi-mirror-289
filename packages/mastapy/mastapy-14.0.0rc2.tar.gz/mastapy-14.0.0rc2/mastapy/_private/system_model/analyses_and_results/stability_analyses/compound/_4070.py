...
class KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis(
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_stability_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.stability_analyses.compound.KlingelnbergCycloPalloidHypoidGearCompoundStabilityAnalysis]
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_stability_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.stability_analyses.compound.KlingelnbergCycloPalloidHypoidGearMeshCompoundStabilityAnalysis]
