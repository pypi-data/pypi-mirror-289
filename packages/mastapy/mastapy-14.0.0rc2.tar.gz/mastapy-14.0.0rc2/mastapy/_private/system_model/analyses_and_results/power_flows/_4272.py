...
class ZerolBevelGearSetPowerFlow(_4154.BevelGearSetPowerFlow):
    ...
    def bevel_gears_power_flow(self: "Self") -> "List[_4271.ZerolBevelGearPowerFlow]":
        """List[mastapy._private.system_model.analyses_and_results.power_flows.ZerolBevelGearPowerFlow]
    ...
    def bevel_meshes_power_flow(
        ...
        """List[mastapy._private.system_model.analyses_and_results.power_flows.ZerolBevelGearMeshPowerFlow]
