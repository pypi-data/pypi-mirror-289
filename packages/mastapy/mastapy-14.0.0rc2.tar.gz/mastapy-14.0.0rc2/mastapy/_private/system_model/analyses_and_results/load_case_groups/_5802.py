...
class TimeSeriesLoadCaseGroup(_5790.AbstractLoadCaseGroup):
    ...
    def load_cases(self: "Self") -> "List[_6953.TimeSeriesLoadCase]":
        """List[mastapy._private.system_model.analyses_and_results.static_loads.TimeSeriesLoadCase]
    ...
    def compound_multibody_dynamics_analysis(
        ...
        """mastapy._private.system_model.analyses_and_results.CompoundMultibodyDynamicsAnalysis
