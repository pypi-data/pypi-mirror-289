...
class KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection(
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_system_deflection(
        ...
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.compound.KlingelnbergCycloPalloidHypoidGearCompoundSystemDeflection]
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_system_deflection(
        ...
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.compound.KlingelnbergCycloPalloidHypoidGearMeshCompoundSystemDeflection]
