...
class KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtASpeed(
    ...
    def klingelnberg_cyclo_palloid_conical_gears_modal_analysis_at_a_speed(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_speed.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysisAtASpeed]
    ...
    def klingelnberg_cyclo_palloid_conical_meshes_modal_analysis_at_a_speed(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_speed.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysisAtASpeed]
