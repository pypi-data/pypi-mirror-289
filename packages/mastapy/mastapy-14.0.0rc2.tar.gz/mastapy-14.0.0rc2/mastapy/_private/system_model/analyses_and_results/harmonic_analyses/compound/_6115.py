...
class SpiralBevelGearSetCompoundHarmonicAnalysis(
    ...
    def spiral_bevel_gears_compound_harmonic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.compound.SpiralBevelGearCompoundHarmonicAnalysis]
    ...
    def spiral_bevel_meshes_compound_harmonic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.compound.SpiralBevelGearMeshCompoundHarmonicAnalysis]
