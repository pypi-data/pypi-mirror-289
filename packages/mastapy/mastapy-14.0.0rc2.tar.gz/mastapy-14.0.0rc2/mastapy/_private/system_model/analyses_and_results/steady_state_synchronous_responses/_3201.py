...
class WormGearSetSteadyStateSynchronousResponse(
    ...
    def gears_steady_state_synchronous_response(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.WormGearSteadyStateSynchronousResponse]
    ...
    def meshes_steady_state_synchronous_response(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.WormGearMeshSteadyStateSynchronousResponse]
