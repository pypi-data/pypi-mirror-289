...
class KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis(
    ...
    def klingelnberg_cyclo_palloid_conical_gears_stability_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.stability_analyses.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis]
    ...
    def klingelnberg_cyclo_palloid_conical_meshes_stability_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.stability_analyses.KlingelnbergCycloPalloidSpiralBevelGearMeshStabilityAnalysis]
