...
class KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow(
    ...
    def klingelnberg_cyclo_palloid_conical_gears_power_flow(
        ...
        """List[mastapy._private.system_model.analyses_and_results.power_flows.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]
    ...
    def klingelnberg_cyclo_palloid_conical_meshes_power_flow(
        ...
        """List[mastapy._private.system_model.analyses_and_results.power_flows.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow]
