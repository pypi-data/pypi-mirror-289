...
class HarmonicAnalysisFEExportOptions(
    ...
    def complex_number_output_option(
        ...
        """EnumWithSelectedValue[mastapy._private.system_model.analyses_and_results.harmonic_analyses.HarmonicAnalysisFEExportOptions.ComplexNumberOutput]"""
    ...
    def element_face_group_to_export(
        ...
        """ListWithSelectedItem[mastapy._private.nodal_analysis.component_mode_synthesis.CMSElementFaceGroup]"""
    ...
    def fe_export_format(
        ...
        """EnumWithSelectedValue[mastapy._private.nodal_analysis.fe_export_utility.FEExportFormat]"""
    ...
    def eigenvalue_options(self: "Self") -> "_191.EigenvalueOptions":
        """mastapy._private.nodal_analysis.dev_tools_analyses.EigenvalueOptions
