...
class BevelGearSetMultibodyDynamicsAnalysis(
    ...
    def agma_gleason_conical_gears_multibody_dynamics_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.mbd_analyses.BevelGearMultibodyDynamicsAnalysis]
    ...
    def agma_gleason_conical_meshes_multibody_dynamics_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.mbd_analyses.BevelGearMeshMultibodyDynamicsAnalysis]
