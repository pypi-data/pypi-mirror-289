...
class _Cast_PartToPartShearCouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "PartToPartShearCouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation"
...
class PartToPartShearCouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    def connection_analysis_cases_ready(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses_single_excitation.PartToPartShearCouplingConnectionHarmonicAnalysisOfSingleExcitation]
