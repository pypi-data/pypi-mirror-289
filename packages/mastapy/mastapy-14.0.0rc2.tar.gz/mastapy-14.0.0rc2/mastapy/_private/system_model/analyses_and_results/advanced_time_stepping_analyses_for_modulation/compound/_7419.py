...
class WormGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    def worm_gears_compound_advanced_time_stepping_analysis_for_modulation(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound.WormGearCompoundAdvancedTimeSteppingAnalysisForModulation]
    ...
    def worm_meshes_compound_advanced_time_stepping_analysis_for_modulation(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound.WormGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]
