...
class RollingRingCompoundStabilityAnalysis(_4038.CouplingHalfCompoundStabilityAnalysis):
    ...
    def component_analysis_cases_ready(
        ...
        """List[mastapy._private.system_model.analyses_and_results.stability_analyses.RollingRingStabilityAnalysis]
    ...
    def planetaries(self: "Self") -> "List[RollingRingCompoundStabilityAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.stability_analyses.compound.RollingRingCompoundStabilityAnalysis]
