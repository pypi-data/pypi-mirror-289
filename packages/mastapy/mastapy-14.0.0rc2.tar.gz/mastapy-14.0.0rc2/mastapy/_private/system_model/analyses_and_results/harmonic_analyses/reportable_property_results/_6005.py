...
class ResultsForOrderIncludingSurfaces(_6004.ResultsForOrderIncludingNodes):
    ...
    def fe_surfaces(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]
