...
class StraightBevelDiffGearSetCompoundAdvancedSystemDeflection(
    ...
    def straight_bevel_diff_gears_compound_advanced_system_deflection(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound.StraightBevelDiffGearCompoundAdvancedSystemDeflection]
    ...
    def straight_bevel_diff_meshes_compound_advanced_system_deflection(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound.StraightBevelDiffGearMeshCompoundAdvancedSystemDeflection]
