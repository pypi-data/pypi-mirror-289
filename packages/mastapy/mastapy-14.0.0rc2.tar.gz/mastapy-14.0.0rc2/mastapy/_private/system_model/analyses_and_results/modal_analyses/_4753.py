...
class HypoidGearSetModalAnalysis(_4690.AGMAGleasonConicalGearSetModalAnalysis):
    ...
    def agma_gleason_conical_gears_modal_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.HypoidGearModalAnalysis]
    ...
    def agma_gleason_conical_meshes_modal_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.HypoidGearMeshModalAnalysis]
