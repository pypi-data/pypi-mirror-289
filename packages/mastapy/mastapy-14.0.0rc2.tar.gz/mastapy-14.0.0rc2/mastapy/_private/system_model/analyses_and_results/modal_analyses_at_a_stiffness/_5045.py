...
class KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtAStiffness(
    ...
    def klingelnberg_cyclo_palloid_conical_gears_modal_analysis_at_a_stiffness(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_stiffness.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtAStiffness]
    ...
    def klingelnberg_cyclo_palloid_conical_meshes_modal_analysis_at_a_stiffness(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_stiffness.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtAStiffness]
