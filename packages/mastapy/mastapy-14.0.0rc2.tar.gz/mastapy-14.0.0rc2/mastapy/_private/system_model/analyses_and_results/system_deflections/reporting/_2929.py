...
class FlexibleGearChart(_0.APIBase):
    ...
    def planets(
        ...
        """ListWithSelectedItem[mastapy._private.system_model.analyses_and_results.system_deflections.CylindricalGearSystemDeflection]"""
    ...
    def chart(self: "Self") -> "_1909.LegacyChartMathChartDefinition":
        """mastapy._private.utility_gui.charts.LegacyChartMathChartDefinition
