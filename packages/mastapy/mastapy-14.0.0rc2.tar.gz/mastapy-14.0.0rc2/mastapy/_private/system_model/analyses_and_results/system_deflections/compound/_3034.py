...
class RootAssemblyCompoundSystemDeflection(_2944.AssemblyCompoundSystemDeflection):
    ...
    def duty_cycle_efficiency_results(
        ...
        """mastapy._private.system_model.analyses_and_results.system_deflections.compound.DutyCycleEfficiencyResults
    ...
    def root_assembly_compound_power_flow(
        ...
        """mastapy._private.system_model.analyses_and_results.power_flows.compound.RootAssemblyCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        ...
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.RootAssemblySystemDeflection]
    ...
    def peak_to_peak_transmission_error_chart(
        ...
        Args:
            mesh_duty_cycles (List[mastapy._private.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearMeshMicroGeometryDutyCycle])
            header (str)
            x_axis_title (str)
            y_axis_title (str)
        """
