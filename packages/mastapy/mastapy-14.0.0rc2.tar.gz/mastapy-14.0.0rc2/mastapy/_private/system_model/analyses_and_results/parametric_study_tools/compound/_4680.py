...
class WormGearSetCompoundParametricStudyTool(_4613.GearSetCompoundParametricStudyTool):
    ...
    def worm_gears_compound_parametric_study_tool(
        ...
        """List[mastapy._private.system_model.analyses_and_results.parametric_study_tools.compound.WormGearCompoundParametricStudyTool]
    ...
    def worm_meshes_compound_parametric_study_tool(
        ...
        """List[mastapy._private.system_model.analyses_and_results.parametric_study_tools.compound.WormGearMeshCompoundParametricStudyTool]
