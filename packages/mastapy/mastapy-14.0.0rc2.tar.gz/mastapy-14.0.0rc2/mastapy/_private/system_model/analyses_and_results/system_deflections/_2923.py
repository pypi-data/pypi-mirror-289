...
class WormGearSetSystemDeflection(_2844.GearSetSystemDeflection):
    ...
    def rating(self: "Self") -> "_389.WormGearSetRating":
        """mastapy._private.gears.rating.worm.WormGearSetRating
    ...
    def gears_system_deflection(self: "Self") -> "List[_2924.WormGearSystemDeflection]":
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.WormGearSystemDeflection]
    ...
    def meshes_system_deflection(
        ...
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.WormGearMeshSystemDeflection]
