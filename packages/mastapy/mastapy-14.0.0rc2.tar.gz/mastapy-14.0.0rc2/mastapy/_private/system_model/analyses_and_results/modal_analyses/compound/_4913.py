...
class KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis(
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_modal_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.compound.KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysis]
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_modal_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.compound.KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysis]
