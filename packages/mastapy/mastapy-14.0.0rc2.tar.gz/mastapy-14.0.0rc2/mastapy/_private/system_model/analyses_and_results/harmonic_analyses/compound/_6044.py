...
class ConicalGearCompoundHarmonicAnalysis(_6070.GearCompoundHarmonicAnalysis):
    ...
    def planetaries(self: "Self") -> "List[ConicalGearCompoundHarmonicAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.compound.ConicalGearCompoundHarmonicAnalysis]
    ...
    def component_analysis_cases(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.ConicalGearHarmonicAnalysis]
