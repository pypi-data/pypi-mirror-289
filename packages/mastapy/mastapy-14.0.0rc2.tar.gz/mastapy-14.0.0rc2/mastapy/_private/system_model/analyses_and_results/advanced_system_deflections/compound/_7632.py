...
class KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection(
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_advanced_system_deflection(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound.KlingelnbergCycloPalloidHypoidGearCompoundAdvancedSystemDeflection]
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_advanced_system_deflection(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound.KlingelnbergCycloPalloidHypoidGearMeshCompoundAdvancedSystemDeflection]
