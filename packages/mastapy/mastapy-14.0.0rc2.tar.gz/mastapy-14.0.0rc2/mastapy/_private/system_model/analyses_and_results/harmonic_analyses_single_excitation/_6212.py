...
class _Cast_KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysisOfSingleExcitation"
...
class KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysisOfSingleExcitation(
    ...
    def conical_gears_harmonic_analysis_of_single_excitation(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses_single_excitation.KlingelnbergCycloPalloidConicalGearHarmonicAnalysisOfSingleExcitation]
    ...
    def conical_meshes_harmonic_analysis_of_single_excitation(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses_single_excitation.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysisOfSingleExcitation]
