...
class ZerolBevelGearSetCompoundParametricStudyTool(
    ...
    def zerol_bevel_gears_compound_parametric_study_tool(
        ...
        """List[mastapy._private.system_model.analyses_and_results.parametric_study_tools.compound.ZerolBevelGearCompoundParametricStudyTool]
    ...
    def zerol_bevel_meshes_compound_parametric_study_tool(
        ...
        """List[mastapy._private.system_model.analyses_and_results.parametric_study_tools.compound.ZerolBevelGearMeshCompoundParametricStudyTool]
