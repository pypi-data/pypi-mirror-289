...
class WormGearSetCompoundMultibodyDynamicsAnalysis(
    ...
    def worm_gears_compound_multibody_dynamics_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.mbd_analyses.compound.WormGearCompoundMultibodyDynamicsAnalysis]
    ...
    def worm_meshes_compound_multibody_dynamics_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.mbd_analyses.compound.WormGearMeshCompoundMultibodyDynamicsAnalysis]
