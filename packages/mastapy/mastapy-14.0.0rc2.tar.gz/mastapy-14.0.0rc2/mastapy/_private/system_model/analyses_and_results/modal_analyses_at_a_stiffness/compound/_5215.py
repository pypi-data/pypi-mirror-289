...
class StraightBevelDiffGearSetCompoundModalAnalysisAtAStiffness(
    ...
    def straight_bevel_diff_gears_compound_modal_analysis_at_a_stiffness(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound.StraightBevelDiffGearCompoundModalAnalysisAtAStiffness]
    ...
    def straight_bevel_diff_meshes_compound_modal_analysis_at_a_stiffness(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound.StraightBevelDiffGearMeshCompoundModalAnalysisAtAStiffness]
