...
class ZerolBevelGearSetCompoundPowerFlow(_4291.BevelGearSetCompoundPowerFlow):
    ...
    def zerol_bevel_gears_compound_power_flow(
        ...
        """List[mastapy._private.system_model.analyses_and_results.power_flows.compound.ZerolBevelGearCompoundPowerFlow]
    ...
    def zerol_bevel_meshes_compound_power_flow(
        ...
        """List[mastapy._private.system_model.analyses_and_results.power_flows.compound.ZerolBevelGearMeshCompoundPowerFlow]
