...
class KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis(
    ...
    def klingelnberg_cyclo_palloid_conical_gears_modal_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis]
    ...
    def klingelnberg_cyclo_palloid_conical_meshes_modal_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis]
