...
class KlingelnbergCycloPalloidHypoidGearSetSystemDeflection(
    ...
    def rating(self: "Self") -> "_423.KlingelnbergCycloPalloidHypoidGearSetRating":
        """mastapy._private.gears.rating.klingelnberg_hypoid.KlingelnbergCycloPalloidHypoidGearSetRating
    ...
    def klingelnberg_cyclo_palloid_conical_gears_system_deflection(
        ...
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.KlingelnbergCycloPalloidHypoidGearSystemDeflection]
