...
class RootAssemblyHarmonicAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    def combined_orders(self: "Self") -> "_6001.ResultsForMultipleOrdersForGroups":
        """mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.ResultsForMultipleOrdersForGroups
    ...
    def excitations(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.RootAssemblySingleWhineAnalysisResultsPropertyAccessor]
    ...
    def orders_for_combined_excitations(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.ResultsForOrderIncludingGroups]
