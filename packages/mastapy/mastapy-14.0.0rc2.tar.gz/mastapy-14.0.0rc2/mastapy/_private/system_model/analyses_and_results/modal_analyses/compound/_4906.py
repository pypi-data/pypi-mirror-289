...
class HypoidGearSetCompoundModalAnalysis(
    ...
    def hypoid_gears_compound_modal_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.compound.HypoidGearCompoundModalAnalysis]
    ...
    def hypoid_meshes_compound_modal_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.compound.HypoidGearMeshCompoundModalAnalysis]
