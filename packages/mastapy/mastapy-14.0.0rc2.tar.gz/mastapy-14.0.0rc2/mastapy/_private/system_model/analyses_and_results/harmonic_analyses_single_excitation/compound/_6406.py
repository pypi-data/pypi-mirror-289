...
class ZerolBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    def zerol_bevel_gears_compound_harmonic_analysis_of_single_excitation(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound.ZerolBevelGearCompoundHarmonicAnalysisOfSingleExcitation]
    ...
    def zerol_bevel_meshes_compound_harmonic_analysis_of_single_excitation(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound.ZerolBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation]
