...
class StraightBevelGearSetCompoundAdvancedSystemDeflection(
    ...
    def straight_bevel_gears_compound_advanced_system_deflection(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound.StraightBevelGearCompoundAdvancedSystemDeflection]
    ...
    def straight_bevel_meshes_compound_advanced_system_deflection(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_system_deflections.compound.StraightBevelGearMeshCompoundAdvancedSystemDeflection]
