...
class HarmonicAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    def excitations(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.SingleWhineAnalysisResultsPropertyAccessor]
    ...
    def orders_for_combined_excitations(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.ResultsForOrderIncludingNodes]
