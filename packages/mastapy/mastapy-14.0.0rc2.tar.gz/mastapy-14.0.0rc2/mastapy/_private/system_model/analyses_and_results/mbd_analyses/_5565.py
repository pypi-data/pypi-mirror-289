...
class GearSetMultibodyDynamicsAnalysis(
    ...
    def gears_multibody_dynamics_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.mbd_analyses.GearMultibodyDynamicsAnalysis]
    ...
    def meshes_multibody_dynamics_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.mbd_analyses.GearMeshMultibodyDynamicsAnalysis]
