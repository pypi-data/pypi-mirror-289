...
class FaceGearSetCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    def face_gears_compound_steady_state_synchronous_response_at_a_speed(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound.FaceGearCompoundSteadyStateSynchronousResponseAtASpeed]
    ...
    def face_meshes_compound_steady_state_synchronous_response_at_a_speed(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound.FaceGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]
