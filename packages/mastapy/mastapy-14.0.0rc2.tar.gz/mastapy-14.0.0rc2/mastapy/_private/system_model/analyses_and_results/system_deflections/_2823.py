...
class CylindricalGearMeshSystemDeflection(_2843.GearMeshSystemDeflection):
    ...
    def misalignment_data(self: "Self") -> "_55.CylindricalMisalignmentCalculator":
        """mastapy._private.nodal_analysis.CylindricalMisalignmentCalculator
    ...
    def mesh_deflections_left_flank(
        ...
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.reporting.MeshDeflectionResults]
    ...
    def planetaries(self: "Self") -> "List[CylindricalGearMeshSystemDeflection]":
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.CylindricalGearMeshSystemDeflection]
