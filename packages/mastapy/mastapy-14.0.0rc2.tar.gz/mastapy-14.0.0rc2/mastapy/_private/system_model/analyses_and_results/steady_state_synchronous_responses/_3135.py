...
class HypoidGearSetSteadyStateSynchronousResponse(
    ...
    def agma_gleason_conical_gears_steady_state_synchronous_response(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.HypoidGearSteadyStateSynchronousResponse]
    ...
    def agma_gleason_conical_meshes_steady_state_synchronous_response(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.HypoidGearMeshSteadyStateSynchronousResponse]
