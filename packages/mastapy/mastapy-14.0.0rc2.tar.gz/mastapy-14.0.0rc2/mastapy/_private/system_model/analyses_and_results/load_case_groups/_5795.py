...
class DutyCycle(_5791.AbstractStaticLoadCaseGroup):
    ...
    def duty_cycle_design_states(
        ...
        """List[mastapy._private.system_model.analyses_and_results.load_case_groups.SubGroupInSingleDesignState]
    ...
    def time_series_importer(self: "Self") -> "_7151.TimeSeriesImporter":
        """mastapy._private.system_model.analyses_and_results.static_loads.duty_cycle_definition.TimeSeriesImporter
    ...
    def remove_design_state_sub_group(
        ...
        Args:
            sub_group (mastapy._private.system_model.analyses_and_results.load_case_groups.SubGroupInSingleDesignState)
        """
        pythonnet_method_call(
            self.wrapped,
