...
class SpiralBevelGearSetCompoundSteadyStateSynchronousResponse(
    ...
    def spiral_bevel_gears_compound_steady_state_synchronous_response(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.compound.SpiralBevelGearCompoundSteadyStateSynchronousResponse]
    ...
    def spiral_bevel_meshes_compound_steady_state_synchronous_response(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.compound.SpiralBevelGearMeshCompoundSteadyStateSynchronousResponse]
