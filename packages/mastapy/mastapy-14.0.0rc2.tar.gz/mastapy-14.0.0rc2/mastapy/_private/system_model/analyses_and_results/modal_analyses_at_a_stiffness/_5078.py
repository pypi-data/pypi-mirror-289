...
class SpiralBevelGearSetModalAnalysisAtAStiffness(
    ...
    def bevel_gears_modal_analysis_at_a_stiffness(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_stiffness.SpiralBevelGearModalAnalysisAtAStiffness]
    ...
    def bevel_meshes_modal_analysis_at_a_stiffness(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_stiffness.SpiralBevelGearMeshModalAnalysisAtAStiffness]
