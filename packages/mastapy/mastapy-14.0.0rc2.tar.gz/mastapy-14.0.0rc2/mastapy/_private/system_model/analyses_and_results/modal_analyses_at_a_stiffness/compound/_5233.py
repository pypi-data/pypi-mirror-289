...
class WormGearSetCompoundModalAnalysisAtAStiffness(
    ...
    def worm_gears_compound_modal_analysis_at_a_stiffness(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound.WormGearCompoundModalAnalysisAtAStiffness]
    ...
    def worm_meshes_compound_modal_analysis_at_a_stiffness(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound.WormGearMeshCompoundModalAnalysisAtAStiffness]
