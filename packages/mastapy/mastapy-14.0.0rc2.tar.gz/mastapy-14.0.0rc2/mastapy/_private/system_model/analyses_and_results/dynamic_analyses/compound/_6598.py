...
class CylindricalGearSetCompoundDynamicAnalysis(_6609.GearSetCompoundDynamicAnalysis):
    ...
    def cylindrical_gears_compound_dynamic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.compound.CylindricalGearCompoundDynamicAnalysis]
    ...
    def cylindrical_meshes_compound_dynamic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.compound.CylindricalGearMeshCompoundDynamicAnalysis]
