...
class KlingelnbergCycloPalloidHypoidGearSetCompoundCriticalSpeedAnalysis(
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_critical_speed_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.critical_speed_analyses.compound.KlingelnbergCycloPalloidHypoidGearCompoundCriticalSpeedAnalysis]
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_critical_speed_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.critical_speed_analyses.compound.KlingelnbergCycloPalloidHypoidGearMeshCompoundCriticalSpeedAnalysis]
