...
class _Cast_AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness"
...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness(
    ...
    def connection_analysis_cases(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_stiffness.AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness]
