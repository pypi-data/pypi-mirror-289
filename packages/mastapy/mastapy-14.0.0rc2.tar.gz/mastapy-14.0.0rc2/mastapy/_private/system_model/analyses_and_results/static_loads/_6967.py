...
class BearingLoadCase(_6998.ConnectorLoadCase):
    ...
    def ball_bearing_analysis_method(
        ...
        """EnumWithSelectedValue[mastapy._private.bearings.bearing_results.rolling.BallBearingAnalysisMethod]"""
    ...
    def ball_bearing_contact_calculation(
        ...
        """Overridable[mastapy._private.bearings.bearing_results.rolling.BallBearingContactCalculation]"""
    ...
    def ball_bearing_friction_model_for_gyroscopic_moment(
        ...
        """Overridable[mastapy._private.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment]"""
        temp = pythonnet_property_get(
    ...
    def bearing_element_orbit_model(
        ...
        """Overridable[mastapy._private.system_model.analyses_and_results.mbd_analyses.BearingElementOrbitModel]"""
    ...
    def bearing_stiffness_model(self: "Self") -> "_5511.BearingStiffnessModel":
        """mastapy._private.system_model.analyses_and_results.mbd_analyses.BearingStiffnessModel"""
    ...
    def force_at_zero_displacement_input_method(
        ...
        """Overridable[mastapy._private.system_model.part_model.BearingF0InputMethod]"""
        temp = pythonnet_property_get(
    ...
    def hertzian_contact_deflection_calculation_method(
        ...
        """EnumWithSelectedValue[mastapy._private.math_utility.hertzian_contact.HertzianContactDeflectionCalculationMethod]"""
        temp = pythonnet_property_get(
    ...
    def include_fitting_effects(
        ...
        """EnumWithSelectedValue[mastapy._private.utility.LoadCaseOverrideOption]"""
    ...
    def roller_analysis_method(
        ...
        """Overridable[mastapy._private.bearings.bearing_results.rolling.RollerAnalysisMethod]"""
    ...
    def dynamic_analysis_options(self: "Self") -> "_2168.DynamicBearingAnalysisOptions":
        """mastapy._private.bearings.bearing_results.rolling.dysla.DynamicBearingAnalysisOptions
    ...
    def inner_ring_detail(self: "Self") -> "_1969.RingDetail":
        """mastapy._private.bearings.tolerances.RingDetail
