...
class SpiralBevelGearSetCompoundModalAnalysis(_4860.BevelGearSetCompoundModalAnalysis):
    ...
    def spiral_bevel_gears_compound_modal_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.compound.SpiralBevelGearCompoundModalAnalysis]
    ...
    def spiral_bevel_meshes_compound_modal_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.compound.SpiralBevelGearMeshCompoundModalAnalysis]
