...
class ConceptGearSetSteadyStateSynchronousResponseAtASpeed(
    ...
    def gears_steady_state_synchronous_response_at_a_speed(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.ConceptGearSteadyStateSynchronousResponseAtASpeed]
    ...
    def meshes_steady_state_synchronous_response_at_a_speed(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.ConceptGearMeshSteadyStateSynchronousResponseAtASpeed]
