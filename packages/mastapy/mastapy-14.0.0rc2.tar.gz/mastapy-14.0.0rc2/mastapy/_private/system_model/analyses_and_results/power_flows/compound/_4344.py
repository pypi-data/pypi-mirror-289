...
class KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow(
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_power_flow(
        ...
        """List[mastapy._private.system_model.analyses_and_results.power_flows.compound.KlingelnbergCycloPalloidHypoidGearCompoundPowerFlow]
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_power_flow(
        ...
        """List[mastapy._private.system_model.analyses_and_results.power_flows.compound.KlingelnbergCycloPalloidHypoidGearMeshCompoundPowerFlow]
