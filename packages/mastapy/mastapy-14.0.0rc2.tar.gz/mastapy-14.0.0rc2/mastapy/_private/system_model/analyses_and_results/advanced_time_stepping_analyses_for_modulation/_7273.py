...
class StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation(
    ...
    def bevel_gears_advanced_time_stepping_analysis_for_modulation(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.StraightBevelGearAdvancedTimeSteppingAnalysisForModulation]
    ...
    def bevel_meshes_advanced_time_stepping_analysis_for_modulation(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]
