...
class Design(_0.APIBase):
    ...
    def masta_gui(self: "Self") -> "_1899.MASTAGUI":
        """mastapy._private.system_model_gui.MASTAGUI
    ...
    def axial_contact_ratio_requirement(
        ...
        """mastapy._private.gears.ContactRatioRequirements"""
    ...
    def efficiency_rating_method_for_bearings(
        ...
        """mastapy._private.materials.efficiency.BearingEfficiencyRatingMethod"""
    ...
    def efficiency_rating_method_if_skf_loss_model_does_not_provide_losses(
        ...
        """EnumWithSelectedValue[mastapy._private.materials.efficiency.BearingEfficiencyRatingMethod]"""
    ...
    def gear_set_configuration(
        ...
        """ListWithSelectedItem[mastapy._private.system_model.part_model.gears.ActiveGearSetDesignSelectionGroup]"""
    ...
    def shaft_diameter_modification_due_to_rolling_bearing_rings(
        ...
        """EnumWithSelectedValue[mastapy._private.system_model.part_model.ShaftDiameterModificationDueToRollingBearingRing]"""
        temp = pythonnet_property_get(
    ...
    def thermal_expansion_for_grounded_nodes(
        ...
        """mastapy._private.system_model.ThermalExpansionOptionForGroundedNodes"""
    ...
    def unbalanced_mass_inclusion(
        ...
        """mastapy._private.system_model.part_model.UnbalancedMassInclusionOption"""
    ...
    def acoustic_analysis_setups(
        ...
        """mastapy._private.system_model.part_model.acoustics.AcousticAnalysisSetupCollection
    ...
    def detailed_spline_settings(self: "Self") -> "_1439.DetailedSplineJointSettings":
        """mastapy._private.detailed_rigid_connectors.splines.DetailedSplineJointSettings
    ...
    def electric_machine_group(self: "Self") -> "_2265.MAAElectricMachineGroup":
        """mastapy._private.system_model.MAAElectricMachineGroup
    ...
    def fe_batch_operations(self: "Self") -> "_2415.BatchOperations":
        """mastapy._private.system_model.fe.BatchOperations
    ...
    def iso14179_coefficient_of_friction_constants_and_exponents_for_external_external_meshes(
        ...
        """mastapy._private.gears.materials.ISOTR1417912001CoefficientOfFrictionConstants
    ...
    def skf_loss_moment_multipliers(self: "Self") -> "_1649.SKFLossMomentMultipliers":
        """mastapy._private.utility.SKFLossMomentMultipliers
    ...
    def selected_gear_set_selection_group(
        ...
        """mastapy._private.system_model.part_model.gears.ActiveGearSetDesignSelectionGroup
    ...
    def settings(self: "Self") -> "_2259.DesignSettings":
        """mastapy._private.system_model.DesignSettings
    ...
    def shafts(self: "Self") -> "_35.ShaftSafetyFactorSettings":
        """mastapy._private.shafts.ShaftSafetyFactorSettings
    ...
    def system(self: "Self") -> "_2276.SystemReporting":
        """mastapy._private.system_model.SystemReporting
    ...
    def bearing_detail_configurations(
        ...
        """List[mastapy._private.system_model.part_model.configurations.BearingDetailConfiguration]
    ...
    def fe_substructure_configurations(
        ...
        """List[mastapy._private.system_model.part_model.configurations.ActiveFESubstructureSelectionGroup]
    ...
    def gear_set_configurations(
        ...
        """List[mastapy._private.system_model.part_model.gears.ActiveGearSetDesignSelectionGroup]
    ...
    def iso14179_settings_per_bearing_type(
        ...
        """List[mastapy._private.bearings.bearing_results.rolling.ISO14179SettingsPerBearingType]
    ...
    def shaft_detail_configurations(
        ...
        """List[mastapy._private.system_model.part_model.configurations.ActiveShaftDesignSelectionGroup]
    ...
    def databases(self: "Self") -> "_2318.Databases":
        """mastapy._private.system_model.database_access.Databases
    ...
    def design_states(self: "Self") -> "List[_5794.DesignState]":
        """List[mastapy._private.system_model.analyses_and_results.load_case_groups.DesignState]
    ...
    def duty_cycles(self: "Self") -> "List[_5795.DutyCycle]":
        """List[mastapy._private.system_model.analyses_and_results.load_case_groups.DutyCycle]
    ...
    def gear_set_config(self: "Self") -> "_2590.GearSetConfiguration":
        """mastapy._private.system_model.part_model.gears.GearSetConfiguration"""
    ...
    def masta_settings(self: "Self") -> "_2266.MASTASettings":
        """mastapy._private.system_model.MASTASettings
    ...
    def system_optimiser(self: "Self") -> "_2293.SystemOptimiser":
        """mastapy._private.system_model.optimization.system_optimiser.SystemOptimiser
    ...
    def time_series_load_case_groups(
        ...
        """List[mastapy._private.system_model.analyses_and_results.load_case_groups.TimeSeriesLoadCaseGroup]
    ...
    def add_design_state(
        ...
        """mastapy._private.system_model.analyses_and_results.load_case_groups.DesignState
    ...
    def add_synchroniser_shift_empty(self: "Self") -> "_3070.SynchroniserShift":
        """mastapy._private.system_model.analyses_and_results.synchroniser_analysis.SynchroniserShift"""
    ...
    def new_belt_creation_options(
        ...
        """mastapy._private.system_model.part_model.creation_options.BeltCreationOptions
    ...
    def new_cycloidal_assembly_creation_options(
        ...
        """mastapy._private.system_model.part_model.creation_options.CycloidalAssemblyCreationOptions
    ...
    def new_cylindrical_gear_linear_train_creation_options(
        ...
        """mastapy._private.system_model.part_model.creation_options.CylindricalGearLinearTrainCreationOptions
    ...
    def new_cylindrical_gear_pair_creation_options(
        ...
        """mastapy._private.gears.gear_designs.creation_options.CylindricalGearPairCreationOptions"""
        method_result = pythonnet_method_call(
    ...
    def new_hypoid_gear_set_creation_options(
        ...
        """mastapy._private.gears.gear_designs.creation_options.HypoidGearSetCreationOptions"""
        method_result = pythonnet_method_call(
    ...
    def new_nodal_matrix(
        ...
        """mastapy._private.nodal_analysis.NodalMatrix
    ...
    def new_planet_carrier_creation_options(
        ...
        """mastapy._private.system_model.part_model.creation_options.PlanetCarrierCreationOptions
    ...
    def new_shaft_creation_options(
        ...
        """mastapy._private.system_model.part_model.creation_options.ShaftCreationOptions
    ...
    def new_spiral_bevel_gear_set_creation_options(
        ...
        """mastapy._private.gears.gear_designs.creation_options.SpiralBevelGearSetCreationOptions"""
        method_result = pythonnet_method_call(
    ...
    def remove_bearing_from_database(
        ...
        Args:
            rolling_bearing (mastapy._private.bearings.bearing_designs.rolling.RollingBearing)
        """
        pythonnet_method_call(
            self.wrapped,
    ...
    def remove_synchroniser_shift(
        ...
        Args:
            shift (mastapy._private.system_model.analyses_and_results.synchroniser_analysis.SynchroniserShift)
        """
        pythonnet_method_call(
    ...
    def save_load_case_results(
        ...
        Args:
            file_name (str)
            load_cases (List[mastapy._private.system_model.analyses_and_results.static_loads.LoadCase])
        """
        file_name = str(file_name)
    ...
    def all_parts(self: "Self") -> "List[_2525.Part]":
        """List[mastapy._private.system_model.part_model.Part]"""
    ...
    def all_parts_of_type_assembly(self: "Self") -> "List[_2488.Assembly]":
        """List[mastapy._private.system_model.part_model.Assembly]"""
    ...
    def all_parts_of_type_abstract_assembly(
        ...
        """List[mastapy._private.system_model.part_model.AbstractAssembly]"""
    ...
    def all_parts_of_type_abstract_shaft(self: "Self") -> "List[_2490.AbstractShaft]":
        """List[mastapy._private.system_model.part_model.AbstractShaft]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_abstract_shaft_or_housing(
        ...
        """List[mastapy._private.system_model.part_model.AbstractShaftOrHousing]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_bearing(self: "Self") -> "List[_2494.Bearing]":
        """List[mastapy._private.system_model.part_model.Bearing]"""
    ...
    def all_parts_of_type_bolt(self: "Self") -> "List[_2497.Bolt]":
        """List[mastapy._private.system_model.part_model.Bolt]"""
    ...
    def all_parts_of_type_bolted_joint(self: "Self") -> "List[_2498.BoltedJoint]":
        """List[mastapy._private.system_model.part_model.BoltedJoint]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_connector(self: "Self") -> "List[_2502.Connector]":
        """List[mastapy._private.system_model.part_model.Connector]"""
    ...
    def all_parts_of_type_datum(self: "Self") -> "List[_2503.Datum]":
        """List[mastapy._private.system_model.part_model.Datum]"""
    ...
    def all_parts_of_type_external_cad_model(
        ...
        """List[mastapy._private.system_model.part_model.ExternalCADModel]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_fe_part(self: "Self") -> "List[_2508.FEPart]":
        """List[mastapy._private.system_model.part_model.FEPart]"""
    ...
    def all_parts_of_type_flexible_pin_assembly(
        ...
        """List[mastapy._private.system_model.part_model.FlexiblePinAssembly]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_guide_dxf_model(self: "Self") -> "List[_2510.GuideDxfModel]":
        """List[mastapy._private.system_model.part_model.GuideDxfModel]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_mass_disc(self: "Self") -> "List[_2517.MassDisc]":
        """List[mastapy._private.system_model.part_model.MassDisc]"""
    ...
    def all_parts_of_type_measurement_component(
        ...
        """List[mastapy._private.system_model.part_model.MeasurementComponent]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_microphone(self: "Self") -> "List[_2519.Microphone]":
        """List[mastapy._private.system_model.part_model.Microphone]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_microphone_array(
        ...
        """List[mastapy._private.system_model.part_model.MicrophoneArray]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_mountable_component(
        ...
        """List[mastapy._private.system_model.part_model.MountableComponent]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_oil_seal(self: "Self") -> "List[_2523.OilSeal]":
        """List[mastapy._private.system_model.part_model.OilSeal]"""
    ...
    def all_parts_of_type_planet_carrier(self: "Self") -> "List[_2526.PlanetCarrier]":
        """List[mastapy._private.system_model.part_model.PlanetCarrier]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_point_load(self: "Self") -> "List[_2528.PointLoad]":
        """List[mastapy._private.system_model.part_model.PointLoad]"""
    ...
    def all_parts_of_type_power_load(self: "Self") -> "List[_2529.PowerLoad]":
        """List[mastapy._private.system_model.part_model.PowerLoad]"""
    ...
    def all_parts_of_type_root_assembly(self: "Self") -> "List[_2531.RootAssembly]":
        """List[mastapy._private.system_model.part_model.RootAssembly]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_specialised_assembly(
        ...
        """List[mastapy._private.system_model.part_model.SpecialisedAssembly]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_unbalanced_mass(self: "Self") -> "List[_2534.UnbalancedMass]":
        """List[mastapy._private.system_model.part_model.UnbalancedMass]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_virtual_component(
        ...
        """List[mastapy._private.system_model.part_model.VirtualComponent]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_shaft(self: "Self") -> "List[_2539.Shaft]":
        """List[mastapy._private.system_model.part_model.shaft_model.Shaft]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_agma_gleason_conical_gear(
        ...
        """List[mastapy._private.system_model.part_model.gears.AGMAGleasonConicalGear]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_agma_gleason_conical_gear_set(
        ...
        """List[mastapy._private.system_model.part_model.gears.AGMAGleasonConicalGearSet]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_bevel_differential_gear(
        ...
        """List[mastapy._private.system_model.part_model.gears.BevelDifferentialGear]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_bevel_differential_gear_set(
        ...
        """List[mastapy._private.system_model.part_model.gears.BevelDifferentialGearSet]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_bevel_differential_planet_gear(
        ...
        """List[mastapy._private.system_model.part_model.gears.BevelDifferentialPlanetGear]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_bevel_differential_sun_gear(
        ...
        """List[mastapy._private.system_model.part_model.gears.BevelDifferentialSunGear]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_bevel_gear(self: "Self") -> "List[_2576.BevelGear]":
        """List[mastapy._private.system_model.part_model.gears.BevelGear]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_bevel_gear_set(self: "Self") -> "List[_2577.BevelGearSet]":
        """List[mastapy._private.system_model.part_model.gears.BevelGearSet]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_concept_gear_set(
        ...
        """List[mastapy._private.system_model.part_model.gears.ConceptGearSet]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_conical_gear_set(
        ...
        """List[mastapy._private.system_model.part_model.gears.ConicalGearSet]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_face_gear(self: "Self") -> "List[_2585.FaceGear]":
        """List[mastapy._private.system_model.part_model.gears.FaceGear]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_face_gear_set(self: "Self") -> "List[_2586.FaceGearSet]":
        """List[mastapy._private.system_model.part_model.gears.FaceGearSet]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_gear(self: "Self") -> "List[_2587.Gear]":
        """List[mastapy._private.system_model.part_model.gears.Gear]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_hypoid_gear(self: "Self") -> "List[_2591.HypoidGear]":
        """List[mastapy._private.system_model.part_model.gears.HypoidGear]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_hypoid_gear_set(self: "Self") -> "List[_2592.HypoidGearSet]":
        """List[mastapy._private.system_model.part_model.gears.HypoidGearSet]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_conical_gear(
        ...
        """List[mastapy._private.system_model.part_model.gears.KlingelnbergCycloPalloidConicalGear]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_conical_gear_set(
        ...
        """List[mastapy._private.system_model.part_model.gears.KlingelnbergCycloPalloidConicalGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears",
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear(
        ...
        """List[mastapy._private.system_model.part_model.gears.KlingelnbergCycloPalloidHypoidGear]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears",
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(
        ...
        """List[mastapy._private.system_model.part_model.gears.KlingelnbergCycloPalloidHypoidGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears",
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear(
        ...
        """List[mastapy._private.system_model.part_model.gears.KlingelnbergCycloPalloidSpiralBevelGear]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears",
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(
        ...
        """List[mastapy._private.system_model.part_model.gears.KlingelnbergCycloPalloidSpiralBevelGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears",
    ...
    def all_parts_of_type_planetary_gear_set(
        ...
        """List[mastapy._private.system_model.part_model.gears.PlanetaryGearSet]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_spiral_bevel_gear_set(
        ...
        """List[mastapy._private.system_model.part_model.gears.SpiralBevelGearSet]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_straight_bevel_diff_gear_set(
        ...
        """List[mastapy._private.system_model.part_model.gears.StraightBevelDiffGearSet]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_straight_bevel_gear(
        ...
        """List[mastapy._private.system_model.part_model.gears.StraightBevelGear]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_straight_bevel_gear_set(
        ...
        """List[mastapy._private.system_model.part_model.gears.StraightBevelGearSet]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_straight_bevel_planet_gear(
        ...
        """List[mastapy._private.system_model.part_model.gears.StraightBevelPlanetGear]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_straight_bevel_sun_gear(
        ...
        """List[mastapy._private.system_model.part_model.gears.StraightBevelSunGear]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_worm_gear(self: "Self") -> "List[_2608.WormGear]":
        """List[mastapy._private.system_model.part_model.gears.WormGear]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_worm_gear_set(self: "Self") -> "List[_2609.WormGearSet]":
        """List[mastapy._private.system_model.part_model.gears.WormGearSet]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_zerol_bevel_gear(
        ...
        """List[mastapy._private.system_model.part_model.gears.ZerolBevelGear]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_zerol_bevel_gear_set(
        ...
        """List[mastapy._private.system_model.part_model.gears.ZerolBevelGearSet]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_cycloidal_assembly(
        ...
        """List[mastapy._private.system_model.part_model.cycloidal.CycloidalAssembly]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_cycloidal_disc(self: "Self") -> "List[_2626.CycloidalDisc]":
        """List[mastapy._private.system_model.part_model.cycloidal.CycloidalDisc]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_ring_pins(self: "Self") -> "List[_2627.RingPins]":
        """List[mastapy._private.system_model.part_model.cycloidal.RingPins]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_belt_drive(self: "Self") -> "List[_2634.BeltDrive]":
        """List[mastapy._private.system_model.part_model.couplings.BeltDrive]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_clutch(self: "Self") -> "List[_2636.Clutch]":
        """List[mastapy._private.system_model.part_model.couplings.Clutch]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_clutch_half(self: "Self") -> "List[_2637.ClutchHalf]":
        """List[mastapy._private.system_model.part_model.couplings.ClutchHalf]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_concept_coupling(
        ...
        """List[mastapy._private.system_model.part_model.couplings.ConceptCoupling]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_concept_coupling_half(
        ...
        """List[mastapy._private.system_model.part_model.couplings.ConceptCouplingHalf]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_coupling(self: "Self") -> "List[_2642.Coupling]":
        """List[mastapy._private.system_model.part_model.couplings.Coupling]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_cvt(self: "Self") -> "List[_2645.CVT]":
        """List[mastapy._private.system_model.part_model.couplings.CVT]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_cvt_pulley(self: "Self") -> "List[_2646.CVTPulley]":
        """List[mastapy._private.system_model.part_model.couplings.CVTPulley]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_part_to_part_shear_coupling(
        ...
        """List[mastapy._private.system_model.part_model.couplings.PartToPartShearCoupling]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_part_to_part_shear_coupling_half(
        ...
        """List[mastapy._private.system_model.part_model.couplings.PartToPartShearCouplingHalf]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_pulley(self: "Self") -> "List[_2650.Pulley]":
        """List[mastapy._private.system_model.part_model.couplings.Pulley]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_rolling_ring(self: "Self") -> "List[_2656.RollingRing]":
        """List[mastapy._private.system_model.part_model.couplings.RollingRing]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_rolling_ring_assembly(
        ...
        """List[mastapy._private.system_model.part_model.couplings.RollingRingAssembly]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_shaft_hub_connection(
        ...
        """List[mastapy._private.system_model.part_model.couplings.ShaftHubConnection]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_spring_damper(self: "Self") -> "List[_2663.SpringDamper]":
        """List[mastapy._private.system_model.part_model.couplings.SpringDamper]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_spring_damper_half(
        ...
        """List[mastapy._private.system_model.part_model.couplings.SpringDamperHalf]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_synchroniser(self: "Self") -> "List[_2665.Synchroniser]":
        """List[mastapy._private.system_model.part_model.couplings.Synchroniser]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_synchroniser_half(
        ...
        """List[mastapy._private.system_model.part_model.couplings.SynchroniserHalf]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_synchroniser_part(
        ...
        """List[mastapy._private.system_model.part_model.couplings.SynchroniserPart]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_synchroniser_sleeve(
        ...
        """List[mastapy._private.system_model.part_model.couplings.SynchroniserSleeve]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_torque_converter(
        ...
        """List[mastapy._private.system_model.part_model.couplings.TorqueConverter]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_torque_converter_pump(
        ...
        """List[mastapy._private.system_model.part_model.couplings.TorqueConverterPump]"""
        cast_type = python_net_import(
    ...
    def all_parts_of_type_torque_converter_turbine(
        ...
        """List[mastapy._private.system_model.part_model.couplings.TorqueConverterTurbine]"""
        cast_type = python_net_import(
    ...
    def load(
        ...
        Args:
            file_path (str)
            load_full_fe_option (mastapy._private.utility.ExternalFullFEFileOption, optional)
        """
    ...
    def load_example(example_string: "str") -> "Design":
        ...
        method_result = pythonnet_method_call(
            Design.TYPE, "LoadExample", example_string if example_string else ""
        )
        type_ = method_result.GetType()
        return (
            constructor.new(type_.Namespace, type_.Name)(method_result)
    ...
    @enforce_parameter_types
    def create_from_example(self: "Self", example_string: "str") -> "Design":
        """mastapy._private.system_model.Design
        ...
        example_string = str(example_string)
        method_result = pythonnet_method_call(
            self.wrapped, "CreateFromExample", example_string if example_string else ""
        )
        type_ = method_result.GetType()
        return (
            constructor.new(type_.Namespace, type_.Name)(method_result)
    ...
    def compare_for_test_only(self: "Self", design: "Design", sb: "str") -> "bool":
        ...
        Args:
            design (mastapy._private.system_model.Design)
            sb (str)
        """
        sb = str(sb)
        method_result = pythonnet_method_call(
