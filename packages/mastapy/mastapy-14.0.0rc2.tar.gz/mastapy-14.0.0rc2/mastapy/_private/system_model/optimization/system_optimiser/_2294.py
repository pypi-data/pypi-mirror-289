...
class SystemOptimiserDetails(_0.APIBase):
    ...
    def criteria_for_selecting_configurations_to_keep(
        ...
        """mastapy._private.system_model.analyses_and_results.load_case_groups.SystemOptimiserTargets"""
    ...
    def gear_set_optimisation(
        ...
        """mastapy._private.system_model.analyses_and_results.load_case_groups.SystemOptimiserGearSetOptimisation"""
    ...
    def planet_gear_options(self: "Self") -> "List[_2292.PlanetGearOptions]":
        """List[mastapy._private.system_model.optimization.system_optimiser.PlanetGearOptions]
