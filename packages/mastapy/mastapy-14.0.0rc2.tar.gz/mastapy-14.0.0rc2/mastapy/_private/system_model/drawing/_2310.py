...
class ShaftDeflectionDrawingNodeItem(_0.APIBase):
    ...
    def node_detail(self: "Self") -> "_1608.ForceAndDisplacementResults":
        """mastapy._private.math_utility.measured_vectors.ForceAndDisplacementResults
    ...
    def section_to_the_left_side(self: "Self") -> "_2889.ShaftSectionSystemDeflection":
        """mastapy._private.system_model.analyses_and_results.system_deflections.ShaftSectionSystemDeflection
