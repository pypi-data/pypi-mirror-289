...
class ConceptCoupling(_2642.Coupling):
    ...
    def coupling_type(self: "Self") -> "_54.CouplingType":
        """mastapy._private.nodal_analysis.CouplingType"""
    ...
    def half_positioning(self: "Self") -> "_2641.ConceptCouplingHalfPositioning":
        """mastapy._private.system_model.part_model.couplings.ConceptCouplingHalfPositioning"""
    ...
    def stiffness(
        ...
        """mastapy._private.nodal_analysis.NodalMatrixEditorWrapperConceptCouplingStiffness
