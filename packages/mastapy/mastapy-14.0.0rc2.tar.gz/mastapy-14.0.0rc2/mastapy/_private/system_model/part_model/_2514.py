...
class InternalClearanceTolerance(_0.APIBase):
    ...
    def clearance_class(
        ...
        """EnumWithSelectedValue[mastapy._private.bearings.tolerances.InternalClearanceClass]"""
    ...
    def definition_option(
        ...
        """EnumWithSelectedValue[mastapy._private.bearings.tolerances.BearingToleranceDefinitionOptions]"""
