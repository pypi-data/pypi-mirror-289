...
class Shaft(_2490.AbstractShaft):
    ...
    def cad_model(
        ...
        """ListWithSelectedItem[mastapy._private.system_model.part_model.GuideDxfModel]"""
    ...
    def active_definition(self: "Self") -> "_43.SimpleShaftDefinition":
        """mastapy._private.shafts.SimpleShaftDefinition
    ...
    def guide_image(self: "Self") -> "_2511.GuideImage":
        """mastapy._private.system_model.part_model.GuideImage
    ...
    def mount_component(
        ...
        Args:
            component (mastapy._private.system_model.part_model.MountableComponent)
            offset (float)
        """
        offset = float(offset)
        pythonnet_method_call(
