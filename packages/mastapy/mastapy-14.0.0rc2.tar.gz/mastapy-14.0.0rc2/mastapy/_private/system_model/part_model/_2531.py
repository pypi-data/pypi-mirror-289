...
class RootAssembly(_2488.Assembly):
    ...
    def packaging_limits(self: "Self") -> "_321.PackagingLimits":
        """mastapy._private.geometry.PackagingLimits
    ...
    def parallel_part_groups(self: "Self") -> "List[_2547.ParallelPartGroup]":
        """List[mastapy._private.system_model.part_model.part_groups.ParallelPartGroup]
    ...
    def parallel_part_groups_drawing_order(
        ...
        """List[mastapy._private.system_model.part_model.projections.SpecifiedParallelPartGroupDrawingOrder]
