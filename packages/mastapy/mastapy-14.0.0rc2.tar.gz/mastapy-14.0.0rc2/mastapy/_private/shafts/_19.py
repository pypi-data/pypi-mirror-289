...
class ShaftDamageResults(_0.APIBase):
    ...
    def cyclic_degrees_of_utilisation(self: "Self") -> "List[_1574.RealVector]":
        """List[mastapy._private.math_utility.RealVector]
    ...
    def shaft_section_end_with_worst_fatigue_safety_factor(
        ...
        """mastapy._private.shafts.ShaftSectionEndDamageResults
    ...
    def shaft_section_damage_results(
        ...
        """List[mastapy._private.shafts.ShaftSectionDamageResults]
    ...
    def shaft_section_end_results_by_offset_with_worst_safety_factor(
        ...
        """List[mastapy._private.shafts.ShaftSectionEndDamageResults]
