...
class GeometricConstants(_0.APIBase):
    ...
    def geometric_constants_for_rolling_frictional_moments(
        ...
        """mastapy._private.bearings.bearing_designs.rolling.GeometricConstantsForRollingFrictionalMoments
    ...
    def geometric_constants_for_sliding_frictional_moments(
        ...
        """mastapy._private.bearings.bearing_designs.rolling.GeometricConstantsForSlidingFrictionalMoments
