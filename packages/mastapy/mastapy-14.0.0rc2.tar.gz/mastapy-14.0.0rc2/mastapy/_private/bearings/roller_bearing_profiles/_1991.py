...
class RollerBearingUserSpecifiedProfile(_1989.RollerBearingProfile):
    ...
    def data_to_use(self: "Self") -> "_1980.ProfileDataToUse":
        """mastapy._private.bearings.roller_bearing_profiles.ProfileDataToUse"""
    ...
    def profile_to_fit(self: "Self") -> "_1982.ProfileToFit":
        """mastapy._private.bearings.roller_bearing_profiles.ProfileToFit"""
    ...
    def points(self: "Self") -> "List[_1993.UserSpecifiedProfilePoint]":
        """List[mastapy._private.bearings.roller_bearing_profiles.UserSpecifiedProfilePoint]
