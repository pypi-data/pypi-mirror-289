...
class LoadedBallBearingRow(_2088.LoadedRollingBearingRow):
    ...
    def loaded_bearing(self: "Self") -> "_2056.LoadedBallBearingResults":
        """mastapy._private.bearings.bearing_results.rolling.LoadedBallBearingResults
    ...
    def race_results(self: "Self") -> "List[_2055.LoadedBallBearingRaceResults]":
        """List[mastapy._private.bearings.bearing_results.rolling.LoadedBallBearingRaceResults]
