...
class Frequencies(_2150.SKFCalculationResult):
    ...
    def frequency_of_over_rolling(self: "Self") -> "_2136.FrequencyOfOverRolling":
        """mastapy._private.bearings.bearing_results.rolling.skf_module.FrequencyOfOverRolling
    ...
    def rotational_frequency(self: "Self") -> "_2148.RotationalFrequency":
        """mastapy._private.bearings.bearing_results.rolling.skf_module.RotationalFrequency
