...
class MASTAGUI(_0.APIBase):
    ...
    def open_designs(self: "Self") -> "List[_2254.Design]":
        """List[mastapy._private.system_model.Design]
    ...
    def operation_mode(self: "Self") -> "_1841.OperationMode":
        """mastapy._private.utility.operation_modes.OperationMode"""
    ...
    def selected_design_entity(self: "Self") -> "_2257.DesignEntity":
        """mastapy._private.system_model.DesignEntity"""
    ...
    def add_electric_machine_from_cad_face_group(
        ...
        Args:
            cad_face_group (mastapy._private.geometry.two_d.CADFaceGroup)
            geometry_modeller_design_information (mastapy._private.nodal_analysis.geometry_modeller_link.GeometryModellerDesignInformation)
            dimensions (Dict[str, mastapy._private.nodal_analysis.geometry_modeller_link.GeometryModellerDimension])
        """
        pythonnet_method_call(
            self.wrapped,
    ...
    def add_fe_substructure_from_data(
        ...
        Args:
            vertices_and_facets (mastapy._private.math_utility.FacetedBody)
            geometry_modeller_design_information (mastapy._private.nodal_analysis.geometry_modeller_link.GeometryModellerDesignInformation)
            dimensions (Dict[str, mastapy._private.nodal_analysis.geometry_modeller_link.GeometryModellerDimension])
            body_moniker (str)
        """
    ...
    def add_line_from_geometry_modeller(
        ...
        Args:
            circles_on_axis (mastapy._private.math_utility.CirclesOnAxis)
        """
        pythonnet_method_call(
            self.wrapped,
    ...
    def are_new_input_available(self: "Self") -> "_170.MeshRequest":
        """mastapy._private.nodal_analysis.geometry_modeller_link.MeshRequest"""
    ...
    def circle_pairs_from_geometry_modeller(
        ...
        Args:
            preselection_circles (mastapy._private.math_utility.CirclesOnAxis)
            selected_circles (List[mastapy._private.math_utility.CirclesOnAxis])
        """
    ...
    def create_geometry_modeller_dimension(
        ...
        """mastapy._private.nodal_analysis.geometry_modeller_link.GeometryModellerDimension"""
        method_result = pythonnet_method_call(
    ...
    def create_mesh_request_result(self: "Self") -> "_171.MeshRequestResult":
        """mastapy._private.nodal_analysis.geometry_modeller_link.MeshRequestResult"""
    ...
    def create_new_cad_face_group(self: "Self") -> "_323.CADFaceGroup":
        """mastapy._private.geometry.two_d.CADFaceGroup"""
    ...
    def create_new_circles_on_axis(self: "Self") -> "_1541.CirclesOnAxis":
        """mastapy._private.math_utility.CirclesOnAxis"""
    ...
    def create_new_faceted_body(self: "Self") -> "_1559.FacetedBody":
        """mastapy._private.math_utility.FacetedBody"""
    ...
    def set_mesh_request_result(
        ...
        Args:
            mesh_request_result (mastapy._private.nodal_analysis.geometry_modeller_link.MeshRequestResult)
        """
        pythonnet_method_call(
            self.wrapped,
