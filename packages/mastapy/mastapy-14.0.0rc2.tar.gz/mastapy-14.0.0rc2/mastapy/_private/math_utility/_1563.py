...
class GriddedSurface(_0.APIBase):
    ...
    def data_value_interpolated_at(
        ...
        Args:
            row_value (float)
            column_value (float)
            row_extrapolation_option (mastapy._private.math_utility.ExtrapolationOptions)
            column_extrapolation_option (mastapy._private.math_utility.ExtrapolationOptions)
        """
