...
class ListWithSelectedItem_HarmonicAnalysisWithVaryingStiffnessStaticLoadCase(
    ...
    def selected_value(
        ...
        """mastapy._private.system_model.analyses_and_results.harmonic_analyses.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase
    ...
    def available_values(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase]
