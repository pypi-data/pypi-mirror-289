...
class EnumWithSelectedValue_AGMAGleasonConicalGearGeometryMethods(
    ...
    def selected_value(self: "Self") -> "_1219.AGMAGleasonConicalGearGeometryMethods":
        """mastapy._private.gears.gear_designs.bevel.AGMAGleasonConicalGearGeometryMethods
    ...
    def available_values(
        ...
        """List[mastapy._private.gears.gear_designs.bevel.AGMAGleasonConicalGearGeometryMethods]
