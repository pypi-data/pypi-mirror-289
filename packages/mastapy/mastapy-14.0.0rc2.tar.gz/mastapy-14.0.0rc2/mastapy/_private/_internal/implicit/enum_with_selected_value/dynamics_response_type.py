...
class EnumWithSelectedValue_DynamicsResponseType(
    ...
    def selected_value(self: "Self") -> "_4739.DynamicsResponseType":
        """mastapy._private.system_model.analyses_and_results.modal_analyses.DynamicsResponseType
    ...
    def available_values(self: "Self") -> "List[_4739.DynamicsResponseType]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.DynamicsResponseType]
