...
class EnumWithSelectedValue_SpecifyTorqueOrCurrent(
    ...
    def selected_value(self: "Self") -> "_1420.SpecifyTorqueOrCurrent":
        """mastapy._private.electric_machines.load_cases_and_analyses.SpecifyTorqueOrCurrent
    ...
    def available_values(self: "Self") -> "List[_1420.SpecifyTorqueOrCurrent]":
        """List[mastapy._private.electric_machines.load_cases_and_analyses.SpecifyTorqueOrCurrent]
