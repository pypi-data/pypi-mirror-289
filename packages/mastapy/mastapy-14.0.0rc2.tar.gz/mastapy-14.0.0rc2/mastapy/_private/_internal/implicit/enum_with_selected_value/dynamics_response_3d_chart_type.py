...
class EnumWithSelectedValue_DynamicsResponse3DChartType(
    ...
    def selected_value(self: "Self") -> "_4738.DynamicsResponse3DChartType":
        """mastapy._private.system_model.analyses_and_results.modal_analyses.DynamicsResponse3DChartType
    ...
    def available_values(self: "Self") -> "List[_4738.DynamicsResponse3DChartType]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.DynamicsResponse3DChartType]
