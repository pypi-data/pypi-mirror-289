...
class EnumWithSelectedValue_DestinationDesignState(
    ...
    def selected_value(self: "Self") -> "_7141.DestinationDesignState":
        """mastapy._private.system_model.analyses_and_results.static_loads.duty_cycle_definition.DestinationDesignState
    ...
    def available_values(self: "Self") -> "List[_7141.DestinationDesignState]":
        """List[mastapy._private.system_model.analyses_and_results.static_loads.duty_cycle_definition.DestinationDesignState]
