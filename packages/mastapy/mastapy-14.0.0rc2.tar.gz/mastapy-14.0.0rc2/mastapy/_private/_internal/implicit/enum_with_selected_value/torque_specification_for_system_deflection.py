...
class EnumWithSelectedValue_TorqueSpecificationForSystemDeflection(
    ...
    def selected_value(self: "Self") -> "_7127.TorqueSpecificationForSystemDeflection":
        """mastapy._private.system_model.analyses_and_results.static_loads.TorqueSpecificationForSystemDeflection
    ...
    def available_values(
        ...
        """List[mastapy._private.system_model.analyses_and_results.static_loads.TorqueSpecificationForSystemDeflection]
