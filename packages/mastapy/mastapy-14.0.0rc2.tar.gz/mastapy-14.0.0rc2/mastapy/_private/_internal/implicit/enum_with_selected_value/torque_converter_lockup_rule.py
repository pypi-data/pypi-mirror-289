...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    def selected_value(self: "Self") -> "_5637.TorqueConverterLockupRule":
        """mastapy._private.system_model.analyses_and_results.mbd_analyses.TorqueConverterLockupRule
    ...
    def available_values(self: "Self") -> "List[_5637.TorqueConverterLockupRule]":
        """List[mastapy._private.system_model.analyses_and_results.mbd_analyses.TorqueConverterLockupRule]
