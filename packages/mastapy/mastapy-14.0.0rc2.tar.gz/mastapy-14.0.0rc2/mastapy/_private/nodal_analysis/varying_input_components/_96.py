...
class AbstractVaryingInputComponent(_0.APIBase):
    ...
    def input_type(
        ...
        """EnumWithSelectedValue[mastapy._private.nodal_analysis.ValueInputOption]"""
    ...
    def single_point_selection_method_for_value_vs_time(
        ...
        """EnumWithSelectedValue[mastapy._private.nodal_analysis.varying_input_components.SinglePointSelectionMethod]"""
