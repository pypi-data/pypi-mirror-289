...
class ToothFlankFractureAnalysisSettings(
    ...
    def residual_stress_calculation_method(
        ...
        """EnumWithSelectedValue[mastapy._private.gears.gear_designs.cylindrical.ResidualStressCalculationMethod]"""
    ...
    def muller_residual_stress_calculator(
        ...
        """mastapy._private.gears.gear_designs.cylindrical.MullerResidualStressDefinition
