...
class CylindricalGearDefaults(_1643.PerMachineSettings):
    ...
    def finish_stock_type(self: "Self") -> "_1124.FinishStockType":
        """mastapy._private.gears.gear_designs.cylindrical.thickness_stock_and_backlash.FinishStockType"""
    ...
    def rough_cutter_creation_settings(
        ...
        """mastapy._private.gears.manufacturing.cylindrical.cutters.RoughCutterCreationSettings
