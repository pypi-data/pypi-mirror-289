...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    def left_flank(self: "Self") -> "_1039.CylindricalGearAbstractRackFlank":
        """mastapy._private.gears.gear_designs.cylindrical.CylindricalGearAbstractRackFlank
    ...
    def shaper_for_agma_rating(self: "Self") -> "_739.CylindricalGearShaper":
        """mastapy._private.gears.manufacturing.cylindrical.cutters.CylindricalGearShaper
    ...
    def flanks(self: "Self") -> "List[_1039.CylindricalGearAbstractRackFlank]":
        """List[mastapy._private.gears.gear_designs.cylindrical.CylindricalGearAbstractRackFlank]
