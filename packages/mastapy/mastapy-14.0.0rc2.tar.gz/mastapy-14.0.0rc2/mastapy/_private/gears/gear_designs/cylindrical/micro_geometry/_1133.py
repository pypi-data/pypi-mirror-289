...
class CylindricalGearMeshMicroGeometryDutyCycle(_1262.GearMeshDesignAnalysis):
    ...
    def peak_to_peak_te(
        ...
        """mastapy._private.utility.property.DutyCyclePropertySummaryVeryShortLength[mastapy._private.gears.ltca.cylindrical.CylindricalGearMeshLoadDistributionAnalysis]
