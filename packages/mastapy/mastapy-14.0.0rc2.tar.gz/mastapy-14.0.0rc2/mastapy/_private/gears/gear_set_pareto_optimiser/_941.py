...
class MicroGeometryDesignSpaceSearch(
    ...
    def select_gear(
        ...
        """ListWithSelectedItem[mastapy._private.gears.ltca.cylindrical.CylindricalGearLoadDistributionAnalysis]"""
    ...
    def select_mesh(
        ...
        """ListWithSelectedItem[mastapy._private.gears.ltca.cylindrical.CylindricalGearMeshLoadDistributionAnalysis]"""
    ...
    def load_case_duty_cycle(
        ...
        """mastapy._private.gears.ltca.cylindrical.CylindricalGearSetLoadDistributionAnalysis
