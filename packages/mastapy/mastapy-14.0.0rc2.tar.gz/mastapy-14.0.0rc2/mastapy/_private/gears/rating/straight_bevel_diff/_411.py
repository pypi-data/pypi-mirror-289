...
class StraightBevelDiffGearMeshRating(_552.ConicalGearMeshRating):
    ...
    def meshed_gears(self: "Self") -> "List[_414.StraightBevelDiffMeshedGearRating]":
        """List[mastapy._private.gears.rating.straight_bevel_diff.StraightBevelDiffMeshedGearRating]
    ...
    def straight_bevel_diff_gear_ratings(
        ...
        """List[mastapy._private.gears.rating.straight_bevel_diff.StraightBevelDiffGearRating]
