...
class GearMeshLoadDistributionAnalysis(_1263.GearMeshImplementationAnalysis):
    ...
    def load_distribution_analyses_at_single_rotation(
        ...
        """List[mastapy._private.gears.ltca.GearMeshLoadDistributionAtRotation]
    ...
    def maximum_root_stress_with_flanks(
        ...
        Args:
            gear (mastapy._private.gears.ltca.GearLoadDistributionAnalysis)
            flank (mastapy._private.gears.GearFlanks)
            stress_type (mastapy._private.nodal_analysis.StressResultsType)
        """
