...
class BearingDynamicResultsUIWrapper(_0.APIBase):
    ...
    def bearing_results(
        ...
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.BearingDynamicResultsPropertyWrapper]
    ...
    def element_results(
        ...
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.BearingDynamicElementPropertyWrapper]
    ...
    def post_analysis_results(
        ...
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.BearingDynamicPostAnalysisResultWrapper]
