...
class SpiralBevelGearSetCompoundSystemDeflection(
    ...
    def spiral_bevel_gears_compound_system_deflection(
        ...
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.compound.SpiralBevelGearCompoundSystemDeflection]
    ...
    def spiral_bevel_meshes_compound_system_deflection(
        ...
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.compound.SpiralBevelGearMeshCompoundSystemDeflection]
