...
class StraightBevelDiffGearSetCompoundSystemDeflection(
    ...
    def straight_bevel_diff_gears_compound_system_deflection(
        ...
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.compound.StraightBevelDiffGearCompoundSystemDeflection]
    ...
    def straight_bevel_diff_meshes_compound_system_deflection(
        ...
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.compound.StraightBevelDiffGearMeshCompoundSystemDeflection]
