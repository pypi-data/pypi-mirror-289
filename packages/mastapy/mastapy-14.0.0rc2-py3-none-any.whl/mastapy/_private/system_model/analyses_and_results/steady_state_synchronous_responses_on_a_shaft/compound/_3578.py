...
class StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    def straight_bevel_diff_gears_compound_steady_state_synchronous_response_on_a_shaft(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound.StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft]
    ...
    def straight_bevel_diff_meshes_compound_steady_state_synchronous_response_on_a_shaft(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound.StraightBevelDiffGearMeshCompoundSteadyStateSynchronousResponseOnAShaft]
