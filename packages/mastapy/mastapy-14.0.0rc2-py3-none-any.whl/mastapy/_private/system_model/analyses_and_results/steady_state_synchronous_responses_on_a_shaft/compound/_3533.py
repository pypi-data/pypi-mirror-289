...
class HypoidGearSetCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    def hypoid_gears_compound_steady_state_synchronous_response_on_a_shaft(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound.HypoidGearCompoundSteadyStateSynchronousResponseOnAShaft]
    ...
    def hypoid_meshes_compound_steady_state_synchronous_response_on_a_shaft(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound.HypoidGearMeshCompoundSteadyStateSynchronousResponseOnAShaft]
