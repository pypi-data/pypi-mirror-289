...
class _Cast_ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft"
...
class ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    def connection_analysis_cases_ready(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.ConceptCouplingConnectionSteadyStateSynchronousResponseOnAShaft]
