...
class ConicalGearMeshCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    def planetaries(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound.ConicalGearMeshCompoundSteadyStateSynchronousResponseOnAShaft]
    ...
    def connection_analysis_cases(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.ConicalGearMeshSteadyStateSynchronousResponseOnAShaft]
