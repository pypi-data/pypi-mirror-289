...
class KlingelnbergCycloPalloidSpiralBevelGearSetMultibodyDynamicsAnalysis(
    ...
    def klingelnberg_cyclo_palloid_conical_gears_multibody_dynamics_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.mbd_analyses.KlingelnbergCycloPalloidSpiralBevelGearMultibodyDynamicsAnalysis]
    ...
    def klingelnberg_cyclo_palloid_conical_meshes_multibody_dynamics_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.mbd_analyses.KlingelnbergCycloPalloidSpiralBevelGearMeshMultibodyDynamicsAnalysis]
