...
class _Cast_BevelDifferentialSunGearCompoundAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "BevelDifferentialSunGearCompoundAdvancedTimeSteppingAnalysisForModulation"
...
class BevelDifferentialSunGearCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    def component_analysis_cases_ready(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation]
