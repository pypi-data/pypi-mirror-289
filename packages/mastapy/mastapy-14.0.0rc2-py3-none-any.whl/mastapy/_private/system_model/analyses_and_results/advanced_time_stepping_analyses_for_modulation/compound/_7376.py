...
class _Cast_PartToPartShearCouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "PartToPartShearCouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation"
...
class PartToPartShearCouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    def component_analysis_cases_ready(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.PartToPartShearCouplingHalfAdvancedTimeSteppingAnalysisForModulation]
