...
class _Cast_StraightBevelPlanetGearCompoundAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "StraightBevelPlanetGearCompoundAdvancedTimeSteppingAnalysisForModulation"
...
class StraightBevelPlanetGearCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    def component_analysis_cases_ready(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation]
