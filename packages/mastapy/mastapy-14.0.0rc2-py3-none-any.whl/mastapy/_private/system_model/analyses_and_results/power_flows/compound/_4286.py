...
class BevelDifferentialGearSetCompoundPowerFlow(_4291.BevelGearSetCompoundPowerFlow):
    ...
    def bevel_differential_gears_compound_power_flow(
        ...
        """List[mastapy._private.system_model.analyses_and_results.power_flows.compound.BevelDifferentialGearCompoundPowerFlow]
    ...
    def bevel_differential_meshes_compound_power_flow(
        ...
        """List[mastapy._private.system_model.analyses_and_results.power_flows.compound.BevelDifferentialGearMeshCompoundPowerFlow]
