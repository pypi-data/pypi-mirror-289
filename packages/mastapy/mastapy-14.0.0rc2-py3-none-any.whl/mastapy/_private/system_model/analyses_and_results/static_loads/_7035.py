...
class FEPartLoadCase(_6956.AbstractShaftOrHousingLoadCase):
    ...
    def angle_source(self: "Self") -> "_2413.AngleSource":
        """mastapy._private.system_model.fe.AngleSource
    ...
    def fe_substructure(
        ...
        """ListWithSelectedItem[mastapy._private.system_model.fe.FESubstructure]"""
    ...
    def surfaces_for_data_logging(
        ...
        """List[mastapy._private.system_model.analyses_and_results.static_loads.CMSElementFaceGroupWithSelectionOption]
