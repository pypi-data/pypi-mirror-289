...
class StraightBevelGearSetLoadCase(_6977.BevelGearSetLoadCase):
    ...
    def bevel_gears_load_case(self: "Self") -> "List[_7112.StraightBevelGearLoadCase]":
        """List[mastapy._private.system_model.analyses_and_results.static_loads.StraightBevelGearLoadCase]
    ...
    def bevel_meshes_load_case(
        ...
        """List[mastapy._private.system_model.analyses_and_results.static_loads.StraightBevelGearMeshLoadCase]
