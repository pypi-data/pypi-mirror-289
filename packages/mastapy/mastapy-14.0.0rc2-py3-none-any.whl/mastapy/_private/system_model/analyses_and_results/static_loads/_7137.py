...
class ZerolBevelGearSetLoadCase(_6977.BevelGearSetLoadCase):
    ...
    def bevel_gears_load_case(self: "Self") -> "List[_7135.ZerolBevelGearLoadCase]":
        """List[mastapy._private.system_model.analyses_and_results.static_loads.ZerolBevelGearLoadCase]
    ...
    def bevel_meshes_load_case(
        ...
        """List[mastapy._private.system_model.analyses_and_results.static_loads.ZerolBevelGearMeshLoadCase]
