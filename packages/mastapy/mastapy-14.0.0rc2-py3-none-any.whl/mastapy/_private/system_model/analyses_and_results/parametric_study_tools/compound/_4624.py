...
class KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool(
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_parametric_study_tool(
        ...
        """List[mastapy._private.system_model.analyses_and_results.parametric_study_tools.compound.KlingelnbergCycloPalloidHypoidGearCompoundParametricStudyTool]
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_parametric_study_tool(
        ...
        """List[mastapy._private.system_model.analyses_and_results.parametric_study_tools.compound.KlingelnbergCycloPalloidHypoidGearMeshCompoundParametricStudyTool]
