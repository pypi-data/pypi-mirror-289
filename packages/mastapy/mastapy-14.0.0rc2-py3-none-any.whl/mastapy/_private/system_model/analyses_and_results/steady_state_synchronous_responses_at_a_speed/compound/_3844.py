...
class StraightBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    def straight_bevel_gears_compound_steady_state_synchronous_response_at_a_speed(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound.StraightBevelGearCompoundSteadyStateSynchronousResponseAtASpeed]
    ...
    def straight_bevel_meshes_compound_steady_state_synchronous_response_at_a_speed(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound.StraightBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]
