...
class StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed(
    ...
    def bevel_gears_steady_state_synchronous_response_at_a_speed(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.StraightBevelGearSteadyStateSynchronousResponseAtASpeed]
    ...
    def bevel_meshes_steady_state_synchronous_response_at_a_speed(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed]
