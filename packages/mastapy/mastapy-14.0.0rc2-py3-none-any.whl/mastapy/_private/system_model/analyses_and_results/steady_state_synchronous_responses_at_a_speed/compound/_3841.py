...
class StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    def straight_bevel_diff_gears_compound_steady_state_synchronous_response_at_a_speed(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound.StraightBevelDiffGearCompoundSteadyStateSynchronousResponseAtASpeed]
    ...
    def straight_bevel_diff_meshes_compound_steady_state_synchronous_response_at_a_speed(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound.StraightBevelDiffGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]
