...
class BevelDifferentialGearSetHarmonicAnalysisOfSingleExcitation(
    ...
    def bevel_gears_harmonic_analysis_of_single_excitation(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses_single_excitation.BevelDifferentialGearHarmonicAnalysisOfSingleExcitation]
    ...
    def bevel_meshes_harmonic_analysis_of_single_excitation(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses_single_excitation.BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation]
