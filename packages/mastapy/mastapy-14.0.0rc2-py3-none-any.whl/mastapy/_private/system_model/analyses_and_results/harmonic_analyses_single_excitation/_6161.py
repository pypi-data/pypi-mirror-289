...
class BevelGearSetHarmonicAnalysisOfSingleExcitation(
    ...
    def agma_gleason_conical_gears_harmonic_analysis_of_single_excitation(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses_single_excitation.BevelGearHarmonicAnalysisOfSingleExcitation]
    ...
    def agma_gleason_conical_meshes_harmonic_analysis_of_single_excitation(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses_single_excitation.BevelGearMeshHarmonicAnalysisOfSingleExcitation]
