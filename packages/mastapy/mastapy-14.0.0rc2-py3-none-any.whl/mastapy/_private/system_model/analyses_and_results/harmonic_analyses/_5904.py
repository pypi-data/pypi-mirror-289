...
class HypoidGearSetHarmonicAnalysis(_5816.AGMAGleasonConicalGearSetHarmonicAnalysis):
    ...
    def agma_gleason_conical_gears_harmonic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.HypoidGearHarmonicAnalysis]
    ...
    def agma_gleason_conical_meshes_harmonic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.HypoidGearMeshHarmonicAnalysis]
