...
class ZerolBevelGearSetCompoundHarmonicAnalysis(
    ...
    def zerol_bevel_gears_compound_harmonic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.compound.ZerolBevelGearCompoundHarmonicAnalysis]
    ...
    def zerol_bevel_meshes_compound_harmonic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.compound.ZerolBevelGearMeshCompoundHarmonicAnalysis]
