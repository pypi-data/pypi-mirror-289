...
class ResultsForOrderIncludingNodes(_6002.ResultsForOrder):
    ...
    def node_results_global_coordinate_system(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic]
