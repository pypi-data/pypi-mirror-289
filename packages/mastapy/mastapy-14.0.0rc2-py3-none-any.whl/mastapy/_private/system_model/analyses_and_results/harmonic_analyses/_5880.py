...
class FaceGearSetHarmonicAnalysis(_5889.GearSetHarmonicAnalysis):
    ...
    def gears_harmonic_analysis(self: "Self") -> "List[_5878.FaceGearHarmonicAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.FaceGearHarmonicAnalysis]
    ...
    def meshes_harmonic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.FaceGearMeshHarmonicAnalysis]
