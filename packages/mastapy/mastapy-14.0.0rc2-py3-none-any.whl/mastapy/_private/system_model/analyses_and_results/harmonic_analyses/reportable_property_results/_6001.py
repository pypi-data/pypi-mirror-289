...
class ResultsForMultipleOrdersForGroups(_5999.ResultsForMultipleOrders):
    ...
    def groups(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic]
