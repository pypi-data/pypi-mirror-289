...
class ResultsForResponseOfAComponentOrSurfaceInAHarmonic(_0.APIBase):
    ...
    def magnitude(
        ...
        """mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic
    ...
    def result_at_reference_speed(
        ...
        """mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.DataPointForResponseOfAComponentOrSurfaceAtAFrequencyToAHarmonic
    ...
    def data_points(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.DataPointForResponseOfAComponentOrSurfaceAtAFrequencyToAHarmonic]
