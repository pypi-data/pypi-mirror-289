...
class DataPointForResponseOfANodeAtAFrequencyToAHarmonic(_0.APIBase):
    ...
    def get_scalar_result(
        ...
        Args:
            scalar_result (mastapy._private.math_utility.DynamicsResponseScalarResult)
            complex_magnitude_method (mastapy._private.math_utility.ComplexMagnitudeMethod, optional)
        """
