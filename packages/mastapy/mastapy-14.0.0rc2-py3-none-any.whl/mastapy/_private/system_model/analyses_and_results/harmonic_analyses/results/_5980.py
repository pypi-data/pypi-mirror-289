...
class ExcitationSourceSelectionGroup(_5979.ExcitationSourceSelectionBase):
    ...
    def sub_items(self: "Self") -> "List[_5979.ExcitationSourceSelectionBase]":
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.results.ExcitationSourceSelectionBase]
    ...
    def include_only_harmonics_with_order(
        ...
        Args:
            order (mastapy._private.math_utility.RoundedOrder)
        """
        pythonnet_method_call(
            self.wrapped,
