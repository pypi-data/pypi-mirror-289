...
class FEPartHarmonicAnalysisResultsPropertyAccessor(
    ...
    def combined_orders(self: "Self") -> "_6000.ResultsForMultipleOrdersForFESurface":
        """mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.ResultsForMultipleOrdersForFESurface
    ...
    def excitations(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.FEPartSingleWhineAnalysisResultsPropertyAccessor]
    ...
    def orders_for_combined_excitations(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.ResultsForOrderIncludingSurfaces]
