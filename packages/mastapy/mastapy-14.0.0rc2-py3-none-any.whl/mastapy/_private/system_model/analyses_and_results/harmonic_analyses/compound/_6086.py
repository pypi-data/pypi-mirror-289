...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundHarmonicAnalysis(
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_harmonic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.compound.KlingelnbergCycloPalloidSpiralBevelGearCompoundHarmonicAnalysis]
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_harmonic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.compound.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundHarmonicAnalysis]
