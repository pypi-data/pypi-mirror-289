...
class RollingRingCompoundCriticalSpeedAnalysis(
    ...
    def component_analysis_cases_ready(
        ...
        """List[mastapy._private.system_model.analyses_and_results.critical_speed_analyses.RollingRingCriticalSpeedAnalysis]
    ...
    def planetaries(self: "Self") -> "List[RollingRingCompoundCriticalSpeedAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.critical_speed_analyses.compound.RollingRingCompoundCriticalSpeedAnalysis]
