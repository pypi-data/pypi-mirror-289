...
class KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis(
    ...
    def klingelnberg_cyclo_palloid_conical_gears_critical_speed_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.critical_speed_analyses.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]
    ...
    def klingelnberg_cyclo_palloid_conical_meshes_critical_speed_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.critical_speed_analyses.KlingelnbergCycloPalloidHypoidGearMeshCriticalSpeedAnalysis]
