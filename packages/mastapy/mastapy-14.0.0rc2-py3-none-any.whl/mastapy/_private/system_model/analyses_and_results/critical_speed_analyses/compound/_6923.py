...
class SpiralBevelGearSetCompoundCriticalSpeedAnalysis(
    ...
    def spiral_bevel_gears_compound_critical_speed_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.critical_speed_analyses.compound.SpiralBevelGearCompoundCriticalSpeedAnalysis]
    ...
    def spiral_bevel_meshes_compound_critical_speed_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.critical_speed_analyses.compound.SpiralBevelGearMeshCompoundCriticalSpeedAnalysis]
