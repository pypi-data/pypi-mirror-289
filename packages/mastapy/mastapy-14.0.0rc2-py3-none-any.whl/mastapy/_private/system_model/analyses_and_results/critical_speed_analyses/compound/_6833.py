...
class BevelDifferentialGearSetCompoundCriticalSpeedAnalysis(
    ...
    def bevel_differential_gears_compound_critical_speed_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.critical_speed_analyses.compound.BevelDifferentialGearCompoundCriticalSpeedAnalysis]
    ...
    def bevel_differential_meshes_compound_critical_speed_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.critical_speed_analyses.compound.BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis]
