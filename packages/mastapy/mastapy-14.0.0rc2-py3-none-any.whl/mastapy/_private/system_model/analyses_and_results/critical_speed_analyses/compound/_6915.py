...
class RollingRingConnectionCompoundCriticalSpeedAnalysis(
    ...
    def connection_analysis_cases_ready(
        ...
        """List[mastapy._private.system_model.analyses_and_results.critical_speed_analyses.RollingRingConnectionCriticalSpeedAnalysis]
    ...
    def planetaries(
        ...
        """List[mastapy._private.system_model.analyses_and_results.critical_speed_analyses.compound.RollingRingConnectionCompoundCriticalSpeedAnalysis]
