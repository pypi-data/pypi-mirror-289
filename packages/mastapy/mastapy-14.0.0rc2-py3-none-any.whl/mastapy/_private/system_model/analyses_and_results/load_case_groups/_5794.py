...
class DesignState(_5789.AbstractDesignStateLoadCaseGroup):
    ...
    def clutch_engagement_status_for(
        ...
        """mastapy._private.system_model.analyses_and_results.load_case_groups.ClutchEngagementStatus

        Args:
            clutch_connection (mastapy._private.system_model.connections_and_sockets.couplings.ClutchConnection)
        """
    ...
    def concept_synchro_gear_engagement_status_for(
        ...
        """mastapy._private.system_model.analyses_and_results.load_case_groups.ConceptSynchroGearEngagementStatus

        Args:
            gear (mastapy._private.system_model.part_model.gears.CylindricalGear)
        """
        method_result = pythonnet_method_call(
            self.wrapped,
