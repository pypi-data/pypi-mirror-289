...
class CylindricalGearMeshAdvancedSystemDeflection(
    ...
    def cylindrical_gear_mesh_system_deflection_results(
        ...
        """List[mastapy._private.system_model.analyses_and_results.system_deflections.CylindricalGearMeshSystemDeflectionTimestep]
    ...
    def max_pressure_contact_chart_for_each_tooth_pass_for_gear_a(
        ...
        """List[mastapy._private.system_model.analyses_and_results.advanced_system_deflections.ContactChartPerToothPass]
