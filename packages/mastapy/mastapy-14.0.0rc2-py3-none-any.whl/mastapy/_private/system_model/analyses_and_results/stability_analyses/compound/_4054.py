...
class FaceGearSetCompoundStabilityAnalysis(_4059.GearSetCompoundStabilityAnalysis):
    ...
    def face_gears_compound_stability_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.stability_analyses.compound.FaceGearCompoundStabilityAnalysis]
    ...
    def face_meshes_compound_stability_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.stability_analyses.compound.FaceGearMeshCompoundStabilityAnalysis]
