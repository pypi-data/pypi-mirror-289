...
class HypoidGearSetStabilityAnalysis(_3868.AGMAGleasonConicalGearSetStabilityAnalysis):
    ...
    def agma_gleason_conical_gears_stability_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.stability_analyses.HypoidGearStabilityAnalysis]
    ...
    def agma_gleason_conical_meshes_stability_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.stability_analyses.HypoidGearMeshStabilityAnalysis]
