...
class SpiralBevelGearSetCompoundStabilityAnalysis(
    ...
    def spiral_bevel_gears_compound_stability_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.stability_analyses.compound.SpiralBevelGearCompoundStabilityAnalysis]
    ...
    def spiral_bevel_meshes_compound_stability_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.stability_analyses.compound.SpiralBevelGearMeshCompoundStabilityAnalysis]
