...
class HypoidGearSetCompoundModalAnalysisAtASpeed(
    ...
    def hypoid_gears_compound_modal_analysis_at_a_speed(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_speed.compound.HypoidGearCompoundModalAnalysisAtASpeed]
    ...
    def hypoid_meshes_compound_modal_analysis_at_a_speed(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_speed.compound.HypoidGearMeshCompoundModalAnalysisAtASpeed]
