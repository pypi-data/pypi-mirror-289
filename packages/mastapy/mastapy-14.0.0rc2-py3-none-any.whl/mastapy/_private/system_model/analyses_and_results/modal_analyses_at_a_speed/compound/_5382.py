...
class BevelDifferentialGearSetCompoundModalAnalysisAtASpeed(
    ...
    def bevel_differential_gears_compound_modal_analysis_at_a_speed(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_speed.compound.BevelDifferentialGearCompoundModalAnalysisAtASpeed]
    ...
    def bevel_differential_meshes_compound_modal_analysis_at_a_speed(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_speed.compound.BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed]
