...
class FaceGearSetDynamicAnalysis(_6478.GearSetDynamicAnalysis):
    ...
    def gears_dynamic_analysis(self: "Self") -> "List[_6471.FaceGearDynamicAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.FaceGearDynamicAnalysis]
    ...
    def meshes_dynamic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.FaceGearMeshDynamicAnalysis]
