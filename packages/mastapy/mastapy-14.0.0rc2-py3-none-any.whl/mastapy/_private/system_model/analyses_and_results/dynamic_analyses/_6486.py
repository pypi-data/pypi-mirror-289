...
class KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis(
    ...
    def conical_gears_dynamic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.KlingelnbergCycloPalloidConicalGearDynamicAnalysis]
    ...
    def conical_meshes_dynamic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.KlingelnbergCycloPalloidConicalGearMeshDynamicAnalysis]
