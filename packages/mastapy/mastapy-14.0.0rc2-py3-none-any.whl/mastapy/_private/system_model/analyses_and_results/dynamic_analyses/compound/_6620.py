...
class KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis(
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_dynamic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.compound.KlingelnbergCycloPalloidHypoidGearCompoundDynamicAnalysis]
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_dynamic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.compound.KlingelnbergCycloPalloidHypoidGearMeshCompoundDynamicAnalysis]
