...
class SpiralBevelGearSetCompoundDynamicAnalysis(
    ...
    def spiral_bevel_gears_compound_dynamic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.compound.SpiralBevelGearCompoundDynamicAnalysis]
    ...
    def spiral_bevel_meshes_compound_dynamic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.compound.SpiralBevelGearMeshCompoundDynamicAnalysis]
