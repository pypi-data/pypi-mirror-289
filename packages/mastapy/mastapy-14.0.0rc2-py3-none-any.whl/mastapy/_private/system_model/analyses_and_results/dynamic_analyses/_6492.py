...
class KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis(
    ...
    def klingelnberg_cyclo_palloid_conical_gears_dynamic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.KlingelnbergCycloPalloidSpiralBevelGearDynamicAnalysis]
    ...
    def klingelnberg_cyclo_palloid_conical_meshes_dynamic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.KlingelnbergCycloPalloidSpiralBevelGearMeshDynamicAnalysis]
