...
class HypoidGearSetCompoundDynamicAnalysis(
    ...
    def hypoid_gears_compound_dynamic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.compound.HypoidGearCompoundDynamicAnalysis]
    ...
    def hypoid_meshes_compound_dynamic_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.dynamic_analyses.compound.HypoidGearMeshCompoundDynamicAnalysis]
