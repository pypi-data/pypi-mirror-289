...
class WormGearSetModalAnalysis(_4749.GearSetModalAnalysis):
    ...
    def gears_modal_analysis(self: "Self") -> "List[_4825.WormGearModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.WormGearModalAnalysis]
    ...
    def meshes_modal_analysis(self: "Self") -> "List[_4824.WormGearMeshModalAnalysis]":
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.WormGearMeshModalAnalysis]
