...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis(
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_modal_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.compound.KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysis]
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_modal_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.compound.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundModalAnalysis]
