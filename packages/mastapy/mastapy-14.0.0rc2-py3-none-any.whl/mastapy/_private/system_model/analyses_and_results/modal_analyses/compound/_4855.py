...
class BevelDifferentialGearSetCompoundModalAnalysis(
    ...
    def bevel_differential_gears_compound_modal_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.compound.BevelDifferentialGearCompoundModalAnalysis]
    ...
    def bevel_differential_meshes_compound_modal_analysis(
        ...
        """List[mastapy._private.system_model.analyses_and_results.modal_analyses.compound.BevelDifferentialGearMeshCompoundModalAnalysis]
