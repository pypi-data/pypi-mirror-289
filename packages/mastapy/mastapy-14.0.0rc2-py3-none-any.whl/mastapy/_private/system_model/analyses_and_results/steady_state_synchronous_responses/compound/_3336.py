...
class ZerolBevelGearSetCompoundSteadyStateSynchronousResponse(
    ...
    def zerol_bevel_gears_compound_steady_state_synchronous_response(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.compound.ZerolBevelGearCompoundSteadyStateSynchronousResponse]
    ...
    def zerol_bevel_meshes_compound_steady_state_synchronous_response(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.compound.ZerolBevelGearMeshCompoundSteadyStateSynchronousResponse]
