...
class RollingRingConnectionCompoundSteadyStateSynchronousResponse(
    ...
    def connection_analysis_cases_ready(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.RollingRingConnectionSteadyStateSynchronousResponse]
    ...
    def planetaries(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.compound.RollingRingConnectionCompoundSteadyStateSynchronousResponse]
