...
class StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse(
    ...
    def straight_bevel_diff_gears_compound_steady_state_synchronous_response(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.compound.StraightBevelDiffGearCompoundSteadyStateSynchronousResponse]
    ...
    def straight_bevel_diff_meshes_compound_steady_state_synchronous_response(
        ...
        """List[mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses.compound.StraightBevelDiffGearMeshCompoundSteadyStateSynchronousResponse]
