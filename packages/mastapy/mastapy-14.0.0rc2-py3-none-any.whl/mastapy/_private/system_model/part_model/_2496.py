...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    def axial_mounting(
        ...
        """EnumWithSelectedValue[mastapy._private.bearings.bearing_results.RaceAxialMountingType]"""
    ...
    def simple_radial_mounting(
        ...
        """EnumWithSelectedValue[mastapy._private.bearings.bearing_results.RaceRadialMountingType]"""
