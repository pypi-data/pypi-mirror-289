...
class Assembly(_2489.AbstractAssembly):
    ...
    def oil_level_specification(self: "Self") -> "_2522.OilLevelSpecification":
        """mastapy._private.system_model.part_model.OilLevelSpecification
    ...
    @property
    def microhone_arrays(self: "Self") -> "List[_2520.MicrophoneArray]":
        """List[mastapy._private.system_model.part_model.MicrophoneArray]

        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "MicrohoneArrays")
    ...
    def add_part(
        ...
        Args:
            part_type (mastapy._private.system_model.part_model.Assembly.PartType)
            name (str)
        """
    ...
    def add_bearing_with_name_and_rolling_bearing_type(
        ...
        Args:
            name (str)
            type_ (mastapy._private.bearings.RollingBearingType)
        """
        name = str(name)
    ...
    def add_belt_drive_with_options(
        ...
        Args:
            belt_creation_options (mastapy._private.system_model.part_model.creation_options.BeltCreationOptions, optional)
        """
        method_result = pythonnet_method_call_overload(
            self.wrapped,
            "AddBeltDrive",
    ...
    def add_cycloidal_assembly_with_options(
        ...
        Args:
            cycloidal_assembly_creation_options (mastapy._private.system_model.part_model.creation_options.CycloidalAssemblyCreationOptions, optional)
        """
        method_result = pythonnet_method_call_overload(
            self.wrapped,
    ...
    def add_cylindrical_gear_pair_with_options(
        ...
        Args:
            cylindrical_gear_pair_creation_options (mastapy._private.gears.gear_designs.creation_options.CylindricalGearPairCreationOptions, optional)
        """
        method_result = pythonnet_method_call_overload(
            self.wrapped,
    ...
    def add_cylindrical_gear_set_with_options(
        ...
        Args:
            cylindrical_gear_linear_train_creation_options (mastapy._private.system_model.part_model.creation_options.CylindricalGearLinearTrainCreationOptions, optional)
        """
        method_result = pythonnet_method_call_overload(
            self.wrapped,
    ...
    def add_cylindrical_gear_set_extended(
        ...
        Args:
            ...
            helix_angle (float)
            normal_module (float)
            pinion_hand (mastapy._private.gears.Hand)
            centre_distances (List[float])
        """
        name = str(name)
    ...
    def add_hypoid_gear_set_detailed(
        ...
        Args:
            ...
            design_method (mastapy._private.gears.gear_designs.bevel.AGMAGleasonConicalGearGeometryMethods, optional)
        """
        name = str(name)
    ...
    def add_planet_carrier_with_options(
        ...
        Args:
            planet_carrier_creation_options (mastapy._private.system_model.part_model.creation_options.PlanetCarrierCreationOptions, optional)
        """
        method_result = pythonnet_method_call_overload(
            self.wrapped,
            "AddPlanetCarrier",
    ...
    def add_rolling_bearing_from_catalogue(
        ...
        Args:
            catalogue (mastapy._private.bearings.BearingCatalog)
            designation (str)
            name (str)
        """
    ...
    def add_shaft_with_options(
        ...
        Args:
            shaft_creation_options (mastapy._private.system_model.part_model.creation_options.ShaftCreationOptions)
        """
        method_result = pythonnet_method_call_overload(
            self.wrapped,
            "AddShaft",
    ...
    def add_spiral_bevel_gear_set_with_options(
        ...
        Args:
            spiral_bevel_gear_set_creation_options (mastapy._private.gears.gear_designs.creation_options.SpiralBevelGearSetCreationOptions, optional)
        """
        method_result = pythonnet_method_call_overload(
            self.wrapped,
    ...
    def import_fe_mesh_from_file(
        ...
        Args:
            file_name (str)
            stiffness_matrix (mastapy._private.nodal_analysis.NodalMatrix)
        """
