...
class ElectricMachineGroup(_0.APIBase):
    ...
    def electric_machine_details(self: "Self") -> "List[_1304.ElectricMachineDetail]":
        """List[mastapy._private.electric_machines.ElectricMachineDetail]
    ...
    def electric_machine_load_case_groups(
        ...
        """List[mastapy._private.electric_machines.load_cases_and_analyses.ElectricMachineLoadCaseGroup]
    ...
    def add_electric_machine_detail(
        ...
        """mastapy._private.electric_machines.NonCADElectricMachineDetail

        Args:
            type_ (mastapy._private.electric_machines.ElectricMachineType)
            name (str, optional)
        """
    ...
    def add_load_case_group(
        ...
        """mastapy._private.electric_machines.load_cases_and_analyses.ElectricMachineLoadCaseGroup
    ...
    def duplicate_electric_machine_detail(
        ...
        Args:
            detail (mastapy._private.electric_machines.ElectricMachineDetail)
        """
        method_result = pythonnet_method_call(
            self.wrapped,
    ...
    def remove_electric_machine_detail(
        ...
        Args:
            motor (mastapy._private.electric_machines.ElectricMachineDetail)
        """
        method_result = pythonnet_method_call(
            self.wrapped,
    ...
    def try_remove_load_case_group(
        ...
        Args:
            load_case_group (mastapy._private.electric_machines.load_cases_and_analyses.ElectricMachineLoadCaseGroup)
        """
        method_result = pythonnet_method_call(
            self.wrapped,
