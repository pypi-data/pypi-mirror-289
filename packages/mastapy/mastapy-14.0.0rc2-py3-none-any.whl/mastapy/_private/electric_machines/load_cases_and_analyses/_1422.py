...
class SpeedTorqueCurveAnalysis(_1400.ElectricMachineAnalysis):
    ...
    def load_case(self: "Self") -> "_1423.SpeedTorqueCurveLoadCase":
        """mastapy._private.electric_machines.load_cases_and_analyses.SpeedTorqueCurveLoadCase
    ...
    def results_points(self: "Self") -> "List[_1389.MaximumTorqueResultsPoints]":
        """List[mastapy._private.electric_machines.results.MaximumTorqueResultsPoints]
