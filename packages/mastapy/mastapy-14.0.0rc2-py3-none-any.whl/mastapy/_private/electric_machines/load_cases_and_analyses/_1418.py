...
class SingleOperatingPointAnalysis(_1400.ElectricMachineAnalysis):
    ...
    def electric_machine_results(
        ...
        """mastapy._private.electric_machines.results.ElectricMachineResultsForOpenCircuitAndOnLoad
    ...
    def load_case(self: "Self") -> "_1406.ElectricMachineLoadCase":
        """mastapy._private.electric_machines.load_cases_and_analyses.ElectricMachineLoadCase
    ...
    def slot_section_details_for_analysis(
        ...
        """List[mastapy._private.electric_machines.load_cases_and_analyses.SlotDetailForAnalysis]
