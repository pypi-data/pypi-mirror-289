...
class ElectricMachineResultsForOpenCircuitAndOnLoad(_0.APIBase):
    ...
    def on_load_results(self: "Self") -> "_1392.OnLoadElectricMachineResults":
        """mastapy._private.electric_machines.results.OnLoadElectricMachineResults
    ...
    def open_circuit_results(self: "Self") -> "_1393.OpenCircuitElectricMachineResults":
        """mastapy._private.electric_machines.results.OpenCircuitElectricMachineResults
    ...
    def all_on_load_results(self: "Self") -> "List[_1392.OnLoadElectricMachineResults]":
        """List[mastapy._private.electric_machines.results.OnLoadElectricMachineResults]
    ...
    def all_open_circuit_results(
        ...
        """List[mastapy._private.electric_machines.results.OpenCircuitElectricMachineResults]
