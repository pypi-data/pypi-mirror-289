...
class EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption(
    ...
    def selected_value(
        ...
        """mastapy._private.detailed_rigid_connectors.splines.DudleyEffectiveLengthApproximationOption
    ...
    def available_values(
        ...
        """List[mastapy._private.detailed_rigid_connectors.splines.DudleyEffectiveLengthApproximationOption]
