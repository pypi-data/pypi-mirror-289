...
class EnumWithSelectedValue_ConicalMachineSettingCalculationMethods(
    ...
    def selected_value(self: "Self") -> "_1197.ConicalMachineSettingCalculationMethods":
        """mastapy._private.gears.gear_designs.conical.ConicalMachineSettingCalculationMethods
    ...
    def available_values(
        ...
        """List[mastapy._private.gears.gear_designs.conical.ConicalMachineSettingCalculationMethods]
