...
class EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification(
    ...
    def selected_value(self: "Self") -> "_7088.PointLoadLoadCase.ForceSpecification":
        """mastapy._private.system_model.analyses_and_results.static_loads.PointLoadLoadCase.ForceSpecification
    ...
    def available_values(
        ...
        """List[mastapy._private.system_model.analyses_and_results.static_loads.PointLoadLoadCase.ForceSpecification]
