...
class EnumWithSelectedValue_AnalysisType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def selected_value(self: "Self") -> "_6965.AnalysisType":
        """mastapy._private.system_model.analyses_and_results.static_loads.AnalysisType
    ...
    def available_values(self: "Self") -> "List[_6965.AnalysisType]":
        """List[mastapy._private.system_model.analyses_and_results.static_loads.AnalysisType]
