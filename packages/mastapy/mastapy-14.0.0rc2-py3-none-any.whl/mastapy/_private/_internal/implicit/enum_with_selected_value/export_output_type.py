...
class EnumWithSelectedValue_ExportOutputType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def selected_value(self: "Self") -> "_5876.ExportOutputType":
        """mastapy._private.system_model.analyses_and_results.harmonic_analyses.ExportOutputType
    ...
    def available_values(self: "Self") -> "List[_5876.ExportOutputType]":
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.ExportOutputType]
