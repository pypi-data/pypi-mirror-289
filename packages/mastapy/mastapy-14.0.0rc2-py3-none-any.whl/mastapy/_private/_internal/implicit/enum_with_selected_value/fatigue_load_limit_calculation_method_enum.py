...
class EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum(
    ...
    def selected_value(self: "Self") -> "_2206.FatigueLoadLimitCalculationMethodEnum":
        """mastapy._private.bearings.bearing_designs.rolling.FatigueLoadLimitCalculationMethodEnum
    ...
    def available_values(
        ...
        """List[mastapy._private.bearings.bearing_designs.rolling.FatigueLoadLimitCalculationMethodEnum]
