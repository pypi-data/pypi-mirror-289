...
class EnumWithSelectedValue_StiffnessOptionsForHarmonicAnalysis_StepCreation(
    ...
    def selected_value(
        ...
        """mastapy._private.system_model.analyses_and_results.harmonic_analyses.StiffnessOptionsForHarmonicAnalysis.StepCreation
    ...
    def available_values(
        ...
        """List[mastapy._private.system_model.analyses_and_results.harmonic_analyses.StiffnessOptionsForHarmonicAnalysis.StepCreation]
