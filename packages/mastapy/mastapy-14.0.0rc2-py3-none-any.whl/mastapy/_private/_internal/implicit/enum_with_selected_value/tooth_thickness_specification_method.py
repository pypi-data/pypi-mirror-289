...
class EnumWithSelectedValue_ToothThicknessSpecificationMethod(
    ...
    def selected_value(self: "Self") -> "_1230.ToothThicknessSpecificationMethod":
        """mastapy._private.gears.gear_designs.bevel.ToothThicknessSpecificationMethod
    ...
    def available_values(
        ...
        """List[mastapy._private.gears.gear_designs.bevel.ToothThicknessSpecificationMethod]
