...
class EnumWithSelectedValue_HarmonicExcitationType(
    ...
    def selected_value(self: "Self") -> "_7045.HarmonicExcitationType":
        """mastapy._private.system_model.analyses_and_results.static_loads.HarmonicExcitationType
    ...
    def available_values(self: "Self") -> "List[_7045.HarmonicExcitationType]":
        """List[mastapy._private.system_model.analyses_and_results.static_loads.HarmonicExcitationType]
