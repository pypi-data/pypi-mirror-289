...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    def selected_value(self: "Self") -> "_2654.RigidConnectorToothSpacingType":
        """mastapy._private.system_model.part_model.couplings.RigidConnectorToothSpacingType
    ...
    def available_values(self: "Self") -> "List[_2654.RigidConnectorToothSpacingType]":
        """List[mastapy._private.system_model.part_model.couplings.RigidConnectorToothSpacingType]
