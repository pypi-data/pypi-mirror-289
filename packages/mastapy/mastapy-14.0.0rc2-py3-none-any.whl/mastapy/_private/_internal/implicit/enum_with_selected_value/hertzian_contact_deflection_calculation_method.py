...
class EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod(
    ...
    def selected_value(
        ...
        """mastapy._private.math_utility.hertzian_contact.HertzianContactDeflectionCalculationMethod
    ...
    def available_values(
        ...
        """List[mastapy._private.math_utility.hertzian_contact.HertzianContactDeflectionCalculationMethod]
