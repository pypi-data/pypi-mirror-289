...
class EnumWithSelectedValue_DoeValueSpecificationOption(
    ...
    def selected_value(self: "Self") -> "_4457.DoeValueSpecificationOption":
        """mastapy._private.system_model.analyses_and_results.parametric_study_tools.DoeValueSpecificationOption
    ...
    def available_values(self: "Self") -> "List[_4457.DoeValueSpecificationOption]":
        """List[mastapy._private.system_model.analyses_and_results.parametric_study_tools.DoeValueSpecificationOption]
