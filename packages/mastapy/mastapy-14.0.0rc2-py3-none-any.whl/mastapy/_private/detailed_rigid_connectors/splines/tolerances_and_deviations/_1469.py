...
class FitAndTolerance(_0.APIBase):
    ...
    def fit_class(
        ...
        """EnumWithSelectedValue[mastapy._private.detailed_rigid_connectors.splines.SplineFitClassType]"""
    ...
    def tolerance_class(
        ...
        """EnumWithSelectedValue[mastapy._private.detailed_rigid_connectors.splines.SplineToleranceClassTypes]"""
