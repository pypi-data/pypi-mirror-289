...
class KeywayRating(_1497.InterferenceFitRating):
    ...
    def keyed_joint_design(self: "Self") -> "_1485.KeyedJointDesign":
        """mastapy._private.detailed_rigid_connectors.keyed_joints.KeyedJointDesign
    ...
    def keyway_half_ratings(self: "Self") -> "List[_1489.KeywayHalfRating]":
        """List[mastapy._private.detailed_rigid_connectors.keyed_joints.rating.KeywayHalfRating]
