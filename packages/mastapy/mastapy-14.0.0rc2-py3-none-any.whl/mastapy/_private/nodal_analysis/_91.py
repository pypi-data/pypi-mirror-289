...
class TransientSolverOptions(_0.APIBase):
    ...
    def damping_scaling_for_initial_transients(
        ...
        """mastapy._private.nodal_analysis.DampingScalingTypeForInitialTransients"""
        temp = pythonnet_property_get(
    ...
    def integration_method(
        ...
        """EnumWithSelectedValue[mastapy._private.nodal_analysis.IntegrationMethod]"""
    ...
    def result_logging_frequency(self: "Self") -> "_86.ResultLoggingFrequency":
        """mastapy._private.nodal_analysis.ResultLoggingFrequency"""
    ...
    def solver_tolerance_input_method(
        ...
        """mastapy._private.nodal_analysis.TransientSolverToleranceInputMethod"""
