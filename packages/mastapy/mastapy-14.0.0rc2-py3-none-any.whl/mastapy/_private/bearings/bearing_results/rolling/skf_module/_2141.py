...
class GreaseLifeAndRelubricationInterval(_2150.SKFCalculationResult):
    ...
    def grease(self: "Self") -> "_2140.Grease":
        """mastapy._private.bearings.bearing_results.rolling.skf_module.Grease
    ...
    def grease_quantity(self: "Self") -> "_2142.GreaseQuantity":
        """mastapy._private.bearings.bearing_results.rolling.skf_module.GreaseQuantity
    ...
    def initial_fill(self: "Self") -> "_2143.InitialFill":
        """mastapy._private.bearings.bearing_results.rolling.skf_module.InitialFill
