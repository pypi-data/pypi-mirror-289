...
class Friction(_2150.SKFCalculationResult):
    ...
    def friction_sources(self: "Self") -> "_2139.FrictionSources":
        """mastapy._private.bearings.bearing_results.rolling.skf_module.FrictionSources
    ...
    def frictional_moment(self: "Self") -> "_2138.FrictionalMoment":
        """mastapy._private.bearings.bearing_results.rolling.skf_module.FrictionalMoment
