...
class ISO14179Settings(_1882.NamedDatabaseItem):
    ...
    def isotr141792001f1_specification_method(
        ...
        """mastapy._private.bearings.bearing_results.rolling.PowerRatingF1EstimationMethod"""
    ...
    def power_rating_f0_scaling_factor_one_dimensional_lookup_table(
        ...
        """mastapy._private.math_utility.measured_data.OnedimensionalFunctionLookupTable
    ...
    def power_rating_f1_two_dimensional_lookup_table(
        ...
        """mastapy._private.math_utility.measured_data.TwodimensionalFunctionLookupTable
