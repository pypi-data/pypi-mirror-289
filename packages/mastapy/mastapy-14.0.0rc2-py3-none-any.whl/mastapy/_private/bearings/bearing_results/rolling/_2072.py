...
class LoadedFourPointContactBallBearingRow(_2057.LoadedBallBearingRow):
    ...
    def loaded_bearing(
        ...
        """mastapy._private.bearings.bearing_results.rolling.LoadedFourPointContactBallBearingResults
    ...
    def race_results(
        ...
        """List[mastapy._private.bearings.bearing_results.rolling.LoadedFourPointContactBallBearingRaceResults]
