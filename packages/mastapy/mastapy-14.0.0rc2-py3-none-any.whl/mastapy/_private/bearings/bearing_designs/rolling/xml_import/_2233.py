...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    def files(self: "Self") -> "List[_2231.BearingImportFile]":
        """List[mastapy._private.bearings.bearing_designs.rolling.xml_import.BearingImportFile]
    ...
    def variables(self: "Self") -> "List[_2230.AbstractXmlVariableAssignment]":
        """List[mastapy._private.bearings.bearing_designs.rolling.xml_import.AbstractXmlVariableAssignment]
