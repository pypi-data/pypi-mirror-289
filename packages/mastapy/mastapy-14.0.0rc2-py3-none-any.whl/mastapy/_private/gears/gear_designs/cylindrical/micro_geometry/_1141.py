...
class CylindricalGearSetMicroGeometry(_1271.GearSetImplementationDetail):
    ...
    def cylindrical_mesh_micro_geometries(
        ...
        """List[mastapy._private.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearMeshMicroGeometry]
    ...
    def duplicate_and_add_to(
        ...
        Args:
            gear_set_design (mastapy._private.gears.gear_designs.cylindrical.CylindricalGearSetDesign)
        """
    ...
    def duplicate_specifying_separate_micro_geometry_for_each_planet(
        ...
        """mastapy._private.gears.analysis.GearSetImplementationDetail"""
        method_result = pythonnet_method_call(
    ...
    def duplicate_specifying_separate_micro_geometry_for_each_planet_and_add_to(
        ...
        Args:
            gear_set_design (mastapy._private.gears.gear_designs.cylindrical.CylindricalPlanetaryGearSetDesign)
        """
        method_result = pythonnet_method_call(
            self.wrapped,
