...
class GearSetManufacturingConfigurationSetup(_0.APIBase):
    ...
    def create_new_suitable_cutters(
        ...
        """mastapy._private.gears.gear_designs.cylindrical.CreateNewSuitableCutterOption"""
    ...
    def gears(self: "Self") -> "List[_1080.GearManufacturingConfigSetupViewModel]":
        """List[mastapy._private.gears.gear_designs.cylindrical.GearManufacturingConfigSetupViewModel]
