...
class LinearBacklashSpecification(_0.APIBase):
    ...
    def circumferential_backlash_pitch_circle(
        ...
        """mastapy._private.gears.gear_designs.cylindrical.CylindricalMeshLinearBacklashSpecification
    ...
    def linear_backlash(
        ...
        """List[mastapy._private.gears.gear_designs.cylindrical.CylindricalMeshLinearBacklashSpecification]
