...
class StraightBevelGearSetRating(_569.BevelGearSetRating):
    ...
    def straight_bevel_gear_ratings(
        ...
        """List[mastapy._private.gears.rating.straight_bevel.StraightBevelGearRating]
    ...
    def straight_bevel_mesh_ratings(
        ...
        """List[mastapy._private.gears.rating.straight_bevel.StraightBevelGearMeshRating]
