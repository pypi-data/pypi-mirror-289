...
class ISO6336AbstractMetalMeshSingleFlankRating(
    ...
    def scuffing_temperature_method(
        ...
        """mastapy._private.gears.gear_designs.cylindrical.ScuffingTemperatureMethodsISO
    ...
    def single_flank_rating_of_test_gears_for_micropitting(
        ...
        """mastapy._private.gears.rating.cylindrical.iso6336.ISO63362006MeshSingleFlankRating
    ...
    def sorted_micro_pitting_results(
        ...
        """mastapy._private.gears.rating.cylindrical.CylindricalGearMicroPittingResults
    ...
    def isodin_cylindrical_gear_single_flank_ratings(
        ...
        """List[mastapy._private.gears.rating.cylindrical.iso6336.ISO6336AbstractMetalGearSingleFlankRating]
