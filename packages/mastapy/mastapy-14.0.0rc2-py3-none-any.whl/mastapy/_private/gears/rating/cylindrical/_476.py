...
class CylindricalGearSetDutyCycleRating(_375.GearSetDutyCycleRating):
    ...
    def reduced_equivalent_duty_cycle(
        ...
        """mastapy._private.gears.rating.cylindrical.ReducedCylindricalGearSetDutyCycleRating
    ...
    def gear_mesh_duty_cycle_ratings(
        ...
        """List[mastapy._private.gears.rating.cylindrical.CylindricalMeshDutyCycleRating]
