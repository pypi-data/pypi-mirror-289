...
class CylindricalGearToothFatigueFractureResults(_0.APIBase):
    ...
    def critical_section(self: "Self") -> "_537.ToothFlankFractureAnalysisContactPoint":
        """mastapy._private.gears.rating.cylindrical.iso6336.ToothFlankFractureAnalysisContactPoint
    ...
    def analysis_rows(
        ...
        """List[mastapy._private.gears.rating.cylindrical.iso6336.ToothFlankFractureAnalysisContactPoint]
