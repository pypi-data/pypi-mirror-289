...
class KlingelnbergCycloPalloidHypoidGearMeshRating(
    ...
    def kn3030_pitting_and_bending_klingelnberg_mesh_single_flank_rating(
        ...
        """mastapy._private.gears.rating.klingelnberg_conical.kn3030.KlingelnbergCycloPalloidHypoidMeshSingleFlankRating
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_ratings(
        ...
        """List[mastapy._private.gears.rating.klingelnberg_hypoid.KlingelnbergCycloPalloidHypoidGearRating]
