...
class PlungeShaverInputsAndMicroGeometry(_0.APIBase):
    ...
    def lead_measurement_method(
        ...
        """EnumWithSelectedValue[mastapy._private.gears.manufacturing.cylindrical.plunge_shaving.MicroGeometryDefinitionMethod]"""
    ...
    def micro_geometry_source(
        ...
        """EnumWithSelectedValue[mastapy._private.gears.manufacturing.cylindrical.plunge_shaving.MicroGeometryDefinitionType]"""
    ...
    def points_of_interest_left_flank(self: "Self") -> "List[_678.PointOfInterest]":
        """List[mastapy._private.gears.manufacturing.cylindrical.plunge_shaving.PointOfInterest]
