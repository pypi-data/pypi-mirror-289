...
class HobbingProcessSimulationInput(_710.ProcessSimulationInput):
    ...
    def process_method(
        ...
        """EnumWithSelectedValue[mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new.ActiveProcessMethod]"""
    ...
    def hob_manufacture_error(self: "Self") -> "_701.HobManufactureError":
        """mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new.HobManufactureError
    ...
    def hob_resharpening_error(self: "Self") -> "_702.HobResharpeningError":
        """mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new.HobResharpeningError
