...
class PlungeShaverOutputs(_0.APIBase):
    ...
    def chart(
        ...
        """EnumWithSelectedValue[mastapy._private.gears.manufacturing.cylindrical.plunge_shaving.ChartType]"""
    ...
    def selected_flank(
        ...
        """EnumWithSelectedValue[mastapy._private.gears.manufacturing.cylindrical.Flank]"""
    ...
    def calculation_details(self: "Self") -> "_674.PlungeShaverGeneration":
        """mastapy._private.gears.manufacturing.cylindrical.plunge_shaving.PlungeShaverGeneration
