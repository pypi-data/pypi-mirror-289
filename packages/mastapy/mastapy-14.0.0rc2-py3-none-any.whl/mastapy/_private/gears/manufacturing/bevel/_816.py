...
class ConicalSetManufacturingConfig(_818.ConicalSetMicroGeometryConfigBase):
    ...
    def machine_setting_calculation_method(
        ...
        """EnumWithSelectedValue[mastapy._private.gears.gear_designs.conical.ConicalMachineSettingCalculationMethods]"""
    ...
    def manufacture_method(
        ...
        """EnumWithSelectedValue[mastapy._private.gears.gear_designs.conical.ConicalManufactureMethods]"""
    ...
    def gear_manufacturing_configurations(
        ...
        """List[mastapy._private.gears.manufacturing.bevel.ConicalGearManufacturingConfig]
    ...
    def meshes(self: "Self") -> "List[_810.ConicalMeshManufacturingConfig]":
        """List[mastapy._private.gears.manufacturing.bevel.ConicalMeshManufacturingConfig]
    ...
    def duplicate(self: "Self") -> "ConicalSetManufacturingConfig":
        """mastapy._private.gears.manufacturing.bevel.ConicalSetManufacturingConfig"""
