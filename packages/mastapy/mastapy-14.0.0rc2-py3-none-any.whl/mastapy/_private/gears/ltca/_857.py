...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    def gear_load_distribution_analysis(
        ...
        """mastapy._private.gears.ltca.cylindrical.CylindricalGearLoadDistributionAnalysis
    ...
    def worst_contact_charts(
        ...
        """mastapy._private.gears.cylindrical.CylindricalGearWorstLTCAContactCharts
    ...
    def worst_contact_charts_as_text_files(
        ...
        """mastapy._private.gears.cylindrical.CylindricalGearWorstLTCAContactChartDataAsTextFile
    ...
    def contact_charts(self: "Self") -> "List[_1249.CylindricalGearLTCAContactCharts]":
        """List[mastapy._private.gears.cylindrical.CylindricalGearLTCAContactCharts]
    ...
    def contact_charts_as_text_files(
        ...
        """List[mastapy._private.gears.cylindrical.CylindricalGearLTCAContactChartDataAsTextFile]
    ...
    def contact_patch_as_text(
        ...
        Args:
            result_type (mastapy._private.gears.ltca.ContactResultType)
            include_tip_contact (bool)
            file_name_with_path (str)
    ...
    def contact_patch(
        ...
        """mastapy._private.math_utility.GriddedSurface
