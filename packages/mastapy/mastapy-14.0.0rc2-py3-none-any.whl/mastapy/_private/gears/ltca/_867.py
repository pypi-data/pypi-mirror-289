...
class GearMeshLoadDistributionAtRotation(_0.APIBase):
    ...
    def gear_a_in_mesh(
        ...
        """mastapy._private.gears.ltca.MeshedGearLoadDistributionAnalysisAtRotation
    ...
    def loaded_contact_lines(self: "Self") -> "List[_868.GearMeshLoadedContactLine]":
        """List[mastapy._private.gears.ltca.GearMeshLoadedContactLine]
    ...
    def meshed_gears(
        ...
        """List[mastapy._private.gears.ltca.MeshedGearLoadDistributionAnalysisAtRotation]
