...
from typing import Tuple, List, Literal, Optional, Any, Iterator, AsyncIterator, Union
...
class ProtocolStepProtocolExperiment(BaseModel):
...
class ProtocolStepProtocol(BaseModel):
    typename: Optional[Literal["Protocol"]] = Field(alias="__typename", exclude=True)
    id: ID
    name: str
    experiment: ProtocolStepProtocolExperiment
...
class CreateProtocolStepMutation(BaseModel):
    ...
    class Meta:
        document = "fragment ProtocolStep on ProtocolStep {\n  id\n  t\n  protocol {\n    id\n    name\n    experiment {\n      id\n      name\n      description\n    }\n  }\n  description\n  reagents {\n    id\n    name\n  }\n  views {\n    id\n    specimen {\n      id\n    }\n    image {\n      id\n    }\n  }\n}\n\nmutation CreateProtocolStep($protocol: ID!, $t: Int!, $kind: ID!, $reagents: [ID!], $description: String) {\n  createProtocolStep(\n    input: {protocol: $protocol, t: $t, reagents: $reagents, description: $description, kind: $kind}\n  ) {\n    ...ProtocolStep\n  }\n}"
