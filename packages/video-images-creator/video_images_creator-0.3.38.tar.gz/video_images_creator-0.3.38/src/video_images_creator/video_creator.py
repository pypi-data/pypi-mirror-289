...
def run_ffmpeg_v5(directory_name, uniq_code, temp_text_file, tts_output_2_channel_filename, total_duration):
    ...
    "-colorspace", "bt709",
     "-vsync", "vfr", 
    "-preset", "fast",
    f"outputs/output_temp_vid{uniq_code}.mp4"   # Specify a temporary output video file
    ]
    ...
    "-y",
    "-i", intro_outro_video,
    "-i", f"outputs/output_temp_vid{uniq_code}.mp4",
    "-i", intro_outro_video,
    ...
    "-preset", "ultrafast",
    "-tune", "fastdecode",
    f"outputs/output_temp_concat-vid{uniq_code}.mp4"
    ]
    ...
    "ffmpeg",
    "-y",
    "-i", f"outputs/output_temp_concat-vid{uniq_code}.mp4",  # Input the temporary video file
