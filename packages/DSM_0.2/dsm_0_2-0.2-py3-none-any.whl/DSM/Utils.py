...
def read_csv(filepath: str, time_interval: str, value_column_name: str, time_column_name: str, header: int = 0,
  ...
  obj = dsm_timeseries('Unnamed', df, value_column_name, time_interval, time_column_name)

  return obj


def read_xlsx(filepath: str, time_interval: str, value_column_name: str, time_column_name: str, header: int = 0,
              fill: str = False, fill_method: str = 'mean') -> int:
  """
...
def transform(data: Union[pd.DataFrame, np.ndarray, dsm_timeseries], limit_pdk_value: float, bias: float,
              value_column_index: int = None, value_column_name: str = None) -> Union[
  pd.DataFrame, np.ndarray, dsm_timeseries]:
  """
...
def fillna(data: Union[pd.DataFrame, np.ndarray, dsm_timeseries], method: str) -> Union[
  pd.DataFrame, np.ndarray, dsm_timeseries]:
  """
...
def time_rebase(data: Union[pd.DataFrame, dsm_timeseries], new_interval: str, time_column_name: str) -> Union[
  pd.DataFrame, dsm_timeseries]:
  """
