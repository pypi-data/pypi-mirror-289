...
class PhoenixVision:
    ...
    def set_camera_source(self, ip_camera_url=None):
        """
        Configura a fonte de captura de vídeo.

        Args:
            ip_camera_url (str, optional): URL da câmera IP. Se None, usa a webcam padrão. 
        """
        if ip_camera_url:
    ...
    def recognize(self, ip_camera_url=None):
        self.set_camera_source(ip_camera_url)
    ...
    def start(self, ip_camera_url=None):
        # Configura a fonte da câmera antes de iniciar o loop
        self.set_camera_source(ip_camera_url)
