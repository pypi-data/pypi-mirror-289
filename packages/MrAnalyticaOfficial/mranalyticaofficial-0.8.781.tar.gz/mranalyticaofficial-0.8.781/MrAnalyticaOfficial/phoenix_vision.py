...
class PhoenixVision:
    def __init__(self, training_data_dir='training_data', model_path='face_recognition_model.keras'):
        ...
        if os.path.exists(self.model_path):
            ...
            # Carrega os labels do arquivo somente se o modelo foi carregado
    ...
    def recognize(self):
        ...
        # Reconstruindo o modelo antes do treinamento
    ...
    def start(self):
        # Se a câmera IP não foi configurada, usa a webcam padrão
        ...
        while True:
            ...
            # ---> Movemos o código para fora do 'if ret:'
            # Exibe a imagem da câmera IP
            cv2.imshow('Câmera IP', frame)

            # Imprime informações da imagem no terminal
            ...
            # Verificação do 'ret' apenas para a mensagem de erro
            if not ret: 
