...
class PhoenixVision:
    def __init__(self, training_data_dir='training_data', model_path='face_recognition_model.keras'):
        ...
        # C:\\Users\\mathe\\OneDrive\\Desktop\\m  
    ...
    def set_cam_ip(self, ip_address):
        """
            ip_address (str) Endereço IP e porta da camera no formato "IP:Porta". Só posso por nesse formato
        """
        try:
    ...
    def start(self, ip_camera_url=None):
        # o cap tem que iniciar aq, fora do if
        if ip_camera_url:
        ...
        self.cap.release()  # Lembrar* NÃO POSSO REMOVER para que ele saiba que ela sempre existe
        cv2.destroyAllWindows()