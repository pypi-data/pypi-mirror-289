...
values: list[schema.docket] = sheets.get_range(spreadsheetId="148J47DO_RZe-bbCbN_1yyqHB6MWS9JNKjvjPsg_5wlA",range="Dockets!A2:R",credentials="/home/wayne/sheets-api-credentials.json")
...
#    print(row[docketcolumns.status])
    if row[schema.columns.status] == "Completed":
