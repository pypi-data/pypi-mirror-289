...
class Sdms(SyncAPIResource):
    ...
    # 新增样本
    def sample_add(self, owner_id, name, description=""):
        """
        新增样本
        ...
        return self.client.sample_add(owner_id, name, description)
    ...
    def data_add(self, owner_id: int, name: str, content: str):
        """
        添加数据文件
        ...
        """
        self._ensure_base_path()
        return self.client.data_add(owner_id, name, content)
    ...
    def data_put(self, owner_id: int, name: str, content: str):
        ...
        """
        self._ensure_base_path()
        return self.client.data_put(owner_id, name, content)
